...
mysqli_query($appConnect,"Insert into api_test set request='".$postData."',type='Demo',other_reference='".$other_reference."',date_created='".date('Y-m-d H:i:s')."',hotel_code='".$hotelCode."'");
...
if($appNumberOfRows=='1'){	
	...
	include_once("../../config/api_auto_loader_demo.php");
