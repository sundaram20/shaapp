...
<div class="content-wrapper">
  ...
  <script type="text/javascript">
	  ...
	  swal({
	   ...
	   if (isConfirm)
	   {  
	        self.location='managePurch.php?delId='+sid+'&action=delete&page=<?=$_REQUEST["page"]?>&submenu=<?php echo $_GET["submenu"]; ?>&doc_type=<?=$_REQUEST["doc_type"]?>';
	   } 
	   else
	   {
	      self.location='managePurch.php?doc_type=<?=$_REQUEST["doc_type"]?>&submenu=<?php echo $_GET["submenu"]; ?>';
	    }
	   });
	  }
  </script> 
