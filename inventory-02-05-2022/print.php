   ...
   <div class="row">
              ...
              <div class="box-body" id="printTable" >
		   	...
		   	<td style="border-bottom: 0.4px solid #000;padding:0px!important;">
              	  ...
              	  <table  class="table table-striped  dataTable no-footer" width="100%" border="0"  cellspacing="0" cellpadding="10" >
			          ...
			          <tbody  >
			                <tr >
			                    <td style="width: 30%;border-right:.4px solid #000!important;" > 
			                   	<img src="<?php echo $SITE_URL; ?>/uploaded_files/shop/<?php echo $image; ?>" width="177px"  alt=""> 
			                   </td> 
			                    <td class="pm" style="width: 40%;font-size:12px;font-family: sans-serif;border-right:.1px solid #000;"><center><p style="font-size:12px"><?php echo $name; ?></p></center>
			                    ...
			                    <td class="pm" style="width: 30%;font-family: sans-serif;font-size:12px;">
									...
									<center><p> <b><?php echo $name_no; ?></b> <?php echo stripslashes($prefix).''.stripslashes($row->indent_no).''.stripslashes($suffix); ?> </p></center>
									<center><p><b>Date: </b><?php echo date('d-M-Y',strtotime($row->indent_date)); ?></p></center>
									<center><p ><b>Department : </b><?php 
		...
		<tr>
			<td style="padding:0px!important;">
				  ...
				  <tr>
				  	<td>
				        <table  style=" padding-top:200px;padding-bottom:20px;border-color:black;" id="myTable1" class="table   dataTable" width="100%" border="0" cellspacing="0" cellpadding="10"  >
				        	<thead>
				                <tr>
