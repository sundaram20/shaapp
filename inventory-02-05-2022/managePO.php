...
<td>
  ...
  <script type="text/javascript">
	  ...
	  swal({
	   ...
	   if (isConfirm)
	   {  
	        self.location='managePO.php?delId='+sid+'&submenu=<?php echo $_GET["submenu"] ?>&action=delete&page=<?=$_REQUEST["page"]?>';
	   } 
	   else
	   {
	      self.location='managePO.php?submenu=<?php echo $_GET["submenu"]; ?>';
	    }
	   });
	  }
  </script> 
