...
if($session=='182'){
	...
	$doc_type='8';
       ...
       <div class="form-group col-xs-12 col-md-2 col-sm-2 c-box">
				...
				<a title="Edit" href="<?php echo $edit ?>?eId=<?=encryptor(encrypt, $row->id)?>&submenu=<?php echo $_GET['submenu'] ?>&session=<?php echo $_GET['session']; ?>&action=edit&page=<?=$_REQUEST['page']?>&doc_type=5&print=0 ">
	              	...
	              	<table  class="table table-striped  dataTable no-footer" width="100%" border="0" cellspacing="0" cellpadding="10"   >
				          ...
				          <tbody>
			                    ...
			                    <td  class="pm" style="width:30%;font-size:12px;font-family: sans-serif;">
									...
									<center><p><b>Purch No: </b><?php echo stripslashes($prefix).''.stripslashes($row->po_no).''.stripslashes($suffix); ?> </p></center>
