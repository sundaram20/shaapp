										 ...
										 <?php $categoryDropDown = '<option value="">Select Tax Register</option>';
										  ...
										  ?>
					                  	 ...
					                  	 <div id="interstates<?php echo $k;?>" name="interstates<?php echo $k;?>">
											...
											<?php $categoryDropDown = '<option value="">Inter --Select Tax Register</option>';
				                  	...
				                  	<td width="5%">
				                  	  <!--<input type="text"  placeholder="Tax here"  class="form-control" value="" />-->
				                  		<div id="localss<?php echo $k;?>" name="localss<?php echo $k;?>" >
					                  		<span style="color:red;font-size:11px;" id="s_amount<?php echo $k;?>">
												<?php echo $sgst;?>
											</span>
											<span style="color:red;font-size:11px;" id="c_amount<?php echo $k;?>">
												<?php echo $cgst;?>
											</span>

											<span style="color:red;font-size:11px;" id="vat_amount<?php echo $k;?>">
												<?php echo $vat;?>
											</span>
												
											<span style="color:red;font-size:11px;" id="cess_amount<?php echo $k;?>">
												<?php echo $cess;?>
											</span>
												
											
											<span style="color:red;font-size:11px;" id="surcharge_amount<?php echo $k;?>">
												<?php echo $surcharge;?>
											</span>
										</div>
										
										 <div id="interstatess<?php echo $k;?>" name="interstatess<?php echo $k;?>">
											<span style="color:red;font-size:11px;" id="i_amount<?php echo $k;?>">
													<?php echo $igst;?>
											</span>
										</div>
									</td>
...
//Select 2  Resolve Here
    ...
    $("#addrow1").on("click", function () { 	
		...
		// var newRow11 = $('<tr id="trdeletes' + counter1 + '">');
		 	 ...
		 	 cols1 += '<td><div id="local'+counter1+'" name="local'+counter1+'" style="display:none;"><select data-parsley-required  name="id_mst_charges_purchase_local' + counter1 + '" id="id_mst_charges_purchase_local' + counter1 + '" class="form-control select3" onchange="po_locals(this.id)" style="width:100%;"><option>Select Tax Register</option><?php 
 $sql = "SELECT mst_charges.* FROM mst_charges WHERE mst_charges.id_shop = '".addslashes($_SESSION['shop'])."' AND  charges_account = '2' and transaction_type = '1'";
	                ...
	                cols1 += '<td><div id="localsss'+counter1+'" name="localsss'+counter1+'" style="display:none;"><span style="color:red;font-size:11px;" id="s_amount'+counter1+'"></span> <span style="color:red;font-size:11px;" id="c_amount'+counter1+'"></span><span style="color:red;font-size:11px;" id="vat_amount'+counter1+'"></span><span style="color:red;font-size:11px;" id="cess_amount'+counter1+'"></span><span style="color:red;font-size:11px;" id="surcharge_amount'+counter1+'"></span></div><div id="interstatesss'+counter1+'" name="interstatesss'+counter1+'" style="display:none;"><span style="color:red;font-size:11px;" id="i_amount' + counter1 + '" name="i_amount' + counter1 + '"></span></div></td>';
