              ...
              <div class="box-body" id="printTable">
			     ...
			     <tr>
			       <td style="border-bottom: 0.4px solid #000;padding:0px!important;">
			          ...
			          <tbody >
			                <tr>
			                    <td class="pm" style="width: 30%;border-right:.4px solid #000!important;"> 
			                   	<img src="<?php echo $SITE_URL; ?>/uploaded_files/shop/<?php echo $image; ?>"  width="177px" alt=""> 
			                   </td> 
			                    <td  class="pm" style="width: 40%;font-family: sans-serif;font-size:12px;border-right:0.4px solid #000;">
			                    	<center><p><?php echo $name; ?></p></center>
			                    ...
			                    <td class="pm" style="width:30%;font-size:12px;font-family: sans-serif;">
									...
									<center><p ><b>Purchase No:</b> <?php echo stripslashes($prefix).''.stripslashes($row->po_no).''.stripslashes($suffix); ?> </p></center>
									<center><p ><b>Date: </b><?php echo date('d-M-Y',strtotime($row->po_date)); ?></p></center>
			              			<center><p ><b>Credit Days: </b><?php 
			    ...
			    <table  class="table dataTable table-striped no-footer " width="100%" border="0" cellspacing="0" cellpadding="10"   >
			    	<thead >
			    		<td class="pm" style="width:50%;font-size:12px;font-family: sans-serif;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:0;margin:0;"><b><center><p style="padding:5px;margin:0;">Supplier</p></center></b></td>
			    		<td class="pm" style="width:50%;font-size:12px;font-family: sans-serif;border-bottom:.4px solid #000;padding:0;margin:0;" ><b><center><p style="padding:5px;margin:0;">Delivery</p></center></b></td>
			    	</thead>
			         
			          <tbody>
			                <tr>
			                    <td class="pm"  style="width:50%;border-bottom:.4px solid #000;border-right:.4px solid #000;font-size:12px;font-family: sans-serif;"> 
			                    ...
			                    <td  class="pm" style="width:50%;border-bottom:.4px solid #000;font-family: sans-serif;"><p style="font-size:12px;"><?php 
									  	$resCat = selectSql(TBL_PARTY,"where id_shop='".$_SESSION['shop']."' and status = '1' AND id = $row->id_mst_party_billtobe ");
									  if($db->num_rows2($resCat)){
									  	while($resultCat = $db->fetch_object2($resCat)){ 
											echo ucfirst($resultCat->company_name).'<br>';
 					...
 					<table id="myTable1" class="table table-striped no-footer dataTable" width="100%" border="0" cellspacing="0" cellpadding="10" >
				            <thead>
				                <tr >
				                    ...
				                    <td  class="pm" style="font-size:12px;font-family: sans-serif;width: 5%;padding:5px;margin:0;border-right: 0.4px solid #000;border-bottom: 0.4px solid #000;"><p style="margin:3px;"><b>Rate/Unit</b></p></td>  
				            ...
				            <tbody>
				            	<tr>
				            		<p style="text-align: center;padding:5px;font-size:12px;font-family: sans-serif;border-bottom:0.4px solid #000;margin:0;"><b>Purchase Order Details</b></p>
				            	</tr>
				            	<?php
				            	$k='';
				            	if($row->id ==''){
				                ...
				                <tr>
				                    ...
				                    <td class="pm" style="width: 15%;padding:5px;margin:0;border-right:.4px solid #000;"><p style="font-size:12px;font-family: sans-serif;"><?php echo $item_description; ?><br><span style="font-size: 10px;">Remarks:<?php echo stripslashes($array['item_remarks'.''.$j]); ?></span></td>  
				        ...
				        <table id="myTable1" class="table table-striped no-footer dataTable " width="100%" border="0" cellspacing="0" cellpadding="10" >
				            <thead>
				                <tr >
				                   ...
				                   <?php /*?> <td style="width: 20%;padding:5px;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;"><p style="font-size:12px;font-family: sans-serif;margin:3px;"><b>Disc(%)</b></p></td> <?php */?>
				            ...
				            <tbody>
				                ...
				                <tr>
				                   ...
				                   <?php /*?> <td class="pm" style="border-bottom:0.4px solid #000;font-family: sans-serif;border-right:.4px solid #000;padding:5px;margin:0;"><p style="font-size:12px;"><?php echo stripslashes($array['others_charges_percent'.''.$j]); ?></p></td><?php */?>  
				    ...
				    <tr>
				    	<td class="border-bottom: 0.4px solid #000;padding:0px!important;">
				         ...
				         <table id="myTable1" class="table table-striped  dataTable no-footer" width="100%" border="0" cellspacing="0" cellpadding="10" >
				        	...
				        	<tbody>
				        		<tr>
				            		<p style="padding-left:10px;margin:0;text-align:left;font-family:sans-serif;font-size: 12px;"><b>Terms and Conditions</b></p>
				            	</tr>
				            	<?php
				            	$k='';
				            	if($row->id ==''){
				            ...
				            ?>
				            	...
				            	<tr>
				        			<td style="font-family:sans-serif;font-size: 12px;"><?php echo stripslashes($array['terms'.''.$j]); ?></td> 
				        		</tr>
				        		<?php } ?>
				        	</tbody>
