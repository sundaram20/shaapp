   ...
   <?php  $session=$_GET['submenu']; ?>
    <section class="content-header">
      <!--<h3 style="margin:0px 0px 0px 0px !important;padding:0px 0px 0px 0px !important;">
        ...
        <h5 class="box-title"><?php echo $_REQUEST['eId']==''?'Save':'Edit'?> <?php echo currentNavigation_id($session)['submenu']; ?> : <span style="color:#3c8dbc"> <?php echo $row->mdoc_no ?> </span></h5>
		               ...
		               <!--   <input data-parsley-required type="text" class="form-control pickerdate" placeholder="Enter PO Date" id="po_date" name="po_date" value="<?php if($_POST) echo $_POST['po_date'];else echo stripslashes($row->po_date);?>" onchange="hideandshow()" <?php echo $readonly; ?>> -->
		                ...
		                <div class="form-group col-xs-12 col-md-2 col-sm-6 p-0">
	              		...
	              		<div class="form-group col-xs-12 col-md-2 col-sm-6" >
	              			...
	              			<select class="form-control select2" name="id_mst_party_supplier" id="id_mst_party_supplier" onchange="supplier()" data-parsley-required  data-parsley-errors-container="#outletError"  <?php echo $readonly; ?> style="width:100%">
		                ...
		                <div class="form-group  col-xs-12 col-md-2 col-sm-6">
		                  ...
		                  <div class="input-group"> 
			                  ...
			                  <select onchange="billtobe()" class="form-control select2" name="id_mst_party_billtobe" id="id_mst_party_billtobe" data-parsley-required data-parsley-errors-container="#outletError2"  style="width:100%">
		                ...
		                <div class="form-group col-xs-12 col-md-2 col-sm-6" id="base_currency" name="base_currency">
		                ...
		                <div class="form-group col-xs-12 col-md-2 col-sm-6" id="xchange_rate" name="xchange_rate">
		                ...
		                <div class="form-group col-xs-12 col-md-2 col-sm-6" id="trans_currency" name="trans_currency">
		         ...
		         <div class="box-body  ">
              	...
              	<div class="card text-dark bg-light">
					    ...
					    <div class="modal-dialog">
					      ...
					      <!--<button type="button" class="close" data-dismiss="modal"  onclick="dismiss()">&times;</button>-->
					        ...
					        <div class="modal-body ox-sl">
					        	<input type="text" id="myInput"  class="wd-40 p-5 br-grey"  onkeyup="myFunction()" placeholder="Search For Item Description" title="Type In Item Description">
					        	 <input type="checkbox" name="checkbox" id="checkbox"  onclick="popupshow_checkbox(this.id);" ><span> Show All</span>
					        	 <br><br>
					        	<table id="myTables" class="table table-striped  table-bordered dataTable no-footer" style="background:#fff;width:1226px;display: table-caption;" border="1"> 
					        	</table>
					        </div>
		            ...
		            <div class="row">
		            	...
		            	<table id="myTable1" class="table table-striped table-responsive table-bordered dataTable no-footer order-list1">
				            <thead>
				                <tr>
				                    <th class="wd-15">Indent No</th> 
				                    <th class="wd-10">Item Code</th>
				                    <th class="wd-15">Item Description</th> 
				                    <th class="wd-10">Qty</th> 
				                    <th class="wd-10">Unit</th> 
				                    <th class="wd-10">Rate</th>  
				                    <th class="wd-10">Per</th>  
				                    <th class="wd-10">%Discount</th> 
				                    <th class="wd-10">Amount</th>    
				                </tr>
				            </thead>
				            <tbody>
				            	<?php
							...
							$array['final'.''.$i] = selectColumn('inv_indent','indent_no','where id="'.$array['id_indentt'.''.$i].'" ');
				                ...
				                <tr id="edittrdelete<?php echo $k;?>">
										...
										<?php $categoryDropDown = '<option value="">Select Indent No</option>'.'<option value="na">NA</option>';
											...
											if($row->id !=''){
												if($_REQUEST['id_inv_indent'] == $row1->id){
													$selected = 'selected="selected"';
												}elseif($array['final'.''.$j] == $row1->indent_no){
													$selected = 'selected="selected"';													
												}else{
													$selected = '';
												}
												...
												if($_REQUEST['id_inv_indent'] == $row1->id){
													$selected = 'selected="selected"';
												}elseif($array['id_inv_indent'.''.$j] == $row1->indent_no){
													$selected = 'selected="selected"';													
												}else{
													$selected = '';
												}
					               ...
					               <input type="text"  autocomplete="off" name="id_inv_indent_details<?php echo $k;?>" id="id_inv_indent_details<?php echo $k;?>" placeholder="ID"  class="form-control"  value="<?php if($_POST) echo $_POST['id_inv_indent_details'];else echo stripslashes($array['id_inv_indent_details'.''.$j]); ?>" readonly  style="display:none;" />
					                ...
					                <td class="form-group col-md-2"> 
					                 	 <input type="text"  autocomplete="off"  name="item_amount<?php echo $k;?>" id="item_amount<?php echo $k;?>" placeholder="Amount"  class="form-control discountvalue" value="<?php if($array['item_amount'.''.$j]=='') echo '0';else echo stripslashes($array['item_amount'.''.$j]); ?>" readonly/>
					                </td>					                
		            ...
		            <div class="card text-dark bg-light">
	              		<div class="text-center ">
	              			<h6 class="tb-heads ">Others Charges</h6>
	              		</div>  
			            <div class="row">
			            	<table id="myTable2" class="table  table-striped table-bordered order-list2">
				            <thead>
				                <tr>
<!--<td>Others Charges</td>-->
					                	...
					                	<div id="others<?php echo $k;?>" name="others<?php echo $k;?>">
					                 		<select class="form-control select2" name="id_mst_charges_others<?php echo $k;?>" id="id_mst_charges_others<?php echo $k;?>"  style="width: 100%;" onchange="charges_others(this.id)" style="width:100%">
												<?php $categoryDropDown = '<option value="">Select Others Charges</option>';
							                   	...
							                   	$sql = "SELECT mst_charges.*FROM mst_charges WHERE mst_charges.id_shop = '".addslashes($_SESSION['shop'])."' AND mst_charges.charges_account IN (4,6) ";
							                   	 $db->query($sql); 
							                    while($row1 = $db->fetch_object()){	
				            ...
				            <tfoot>
				                <tr> 
				                        <td colspan="12" style="text-align: left;">
											  ...
											  <a  type="button" class="btn n-btn btn-block" style="font-size:14px;font-weight:700" id="addrow2" value="Add Row"> <span style="font-size:14px;font-weight:700"><i class="fa fa-plus"></i> Add Row</span> </a>
				                        </td> 
				                </tr>
				                <tr>
				                </tr>
		        	...
		        	<!-- Terms And Conditions -->
		        	 <div class="card text-dark bg-light">
	              		<div class="text-center ">
	              			<h6 class="tb-heads">Terms and Conditions</h6>
	              		</div>  
			            <div class="row">
			            	<table id="myTable3" class="table  table-striped table-bordered order-list3">
					            <thead>
					                <tr>
					              		...
					              		<tfoot>
						                	<tr> 
						                        <td colspan="12" style="text-align: left;">
													  ...
													  <a  type="button" class="btn n-btn btn-block" style="font-size:14px;font-weight:700" id="addrow3" value="Add Row"> <span style="font-size:14px;font-weight:700"><i class="fa fa-plus"></i> Add Row</span> </a>
						                        </td> 
							                </tr> 
							            </tfoot>
				                	</div>
		            ...
		            <div class="card text-dark bg-light add-l">
			            ...
			            <div class="row">
			                ...
			                <div class="form-group mb-3 col-xs-12 col-md-3 col-sm-2">
	...
	////////////////////////////////////////////////////////////////////////					
		...
		if(isNaN(oc_igst_toal) == true ){
			...
			var oc_igst_toal1 = oc_igst_toal;
			 			...
			 			if(ledger_id == 2){
			 				//IGST
			 				oc_igst_toal = Number(oc_igst_toal1) + Number(igst_start);
			...
			var total_discount_items = document.getElementById("total_discount_items1").value;
 			...
 			<?php if($row->id !=''){?>
	 			...
	 			$.ajax({
					...
					data:{clicked_id:dbid, others:others, ot:id_ot},
					success: function(data){
						var mydata = JSON.parse(data);  
						if(mydata['delete'] == 1){      
						} 
