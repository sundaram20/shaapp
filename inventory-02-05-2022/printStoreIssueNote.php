        ...
        <div class="col-md-7 col-lg-7">
          <!-- general form elements -->
			          ...
			          <tbody>
			                <tr>
			                    ...
			                    <td class="pm" style="width: 30%;font-family: sans-serif;font-size:12px;">
									...
									<center><p> <b><?php echo $name_no; ?> </b><?php echo stripslashes($prefix).''.stripslashes($row->po_no).''.stripslashes($suffix); ?> </p></center>
									<center><p><b>Date:</b> <?php echo date('d-M-Y',strtotime($row->po_date)); ?></p></center>
									<center><p><b>Departmetns: </b><?php 
			...
			<td style="padding:0px!important;">
				  ...
				  <tr>
				  	<td>
				        <table  style=" padding-top:200px;padding-bottom:20px;border-color:black;" id="myTable1" class="table  dataTable no-footer" width="100%" border="0" cellspacing="0" cellpadding="10" >
				        	<thead>
