...
$po_date  =  selectColumn('inv_po','po_date'," WHERE  `id` = '".addslashes($row->id_inv_po)."'");
...
$returnData.= '<td style="width:10%;" ><select onchange="popupshow(this.id);" onclick="popupshow(this.id);" name="id_inv_po'.$i.'" id="id_inv_po'.$i.'" class="form-control select2" style="width:100%;">';
...
while($rowCharge = mysqli_fetch_object($resCharge)){
	...
	$selected="";}
	$returnData.='<option '.$selected.' value="'.$rowCharge->id.'">'.$rowCharge->po_no.' | '.$date_po. '</option>';
}
    $returnData.='</select>';
	
$returnData.= '<td style="width:10%;"  id="hideshow_item_code"><input type="text"  autocomplete="off"  class="form-control" name="item_code'.$i.'" value='.$item_code.' id="item_code'.$i.'" readonly /></td><td class="form-group col-md-2"><input type="text"  autocomplete="off" class="form-control" name="item_description'.$i.'" value="'.$item_description.'" id="item_description'.$i.'" readonly /><input type="hidden"  autocomplete="off" class="form-control" name="counterby" value="'.$i.'" id="counterby" readonly /></td>';
	
	
$returnData.= '<td style="width:6%;"><select class="form-control select2" name="id_mst_attributes_store'.$i.'" id="id_mst_attributes_store'.$i.'" style="width:100%;" >';
...
$returnData.= '<td  style="width:6%;"><select onchange="po_locals(this.id);" class="form-control select2" name="id_mst_charges_purchase_local'.$i.'" id="id_mst_charges_purchase_local'.$i.'" style="width:100%;" >';
...
$returnData.= '<td style="width:6%;"><select  onchange="po_interstate(this.id)" class="form-control select2" name="id_mst_charges_purchase_interstate'.$i.'" id="id_mst_charges_purchase_interstate'.$i.'" style="width:100%;" >';
...
$returnData.='<td style="width:12%"><div id="localss'.$i.'" name="localss'.$i.'" >
...
<span style="color:red;font-size:14px;" id="c_amount'.$i.'">'.$cgst.'</span>
 ...
 <div id="interstatess'.$i.'" name="interstatess'.$i.'">
	...
	$returnData.= '<td style="width:12%"><input style="width:190px" type="text"  autocomplete="off" class="form-control" name="item_remarks'.$i.'" id="item_remarks'.$i.'" placeholder="Remarks4" value='.$row->item_remarks.' ></td>';
