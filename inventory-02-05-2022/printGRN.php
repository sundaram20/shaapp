...
?>		
        <div class="form-group col-xs-12 col-md-2 col-sm-2 c-box">
		  <a title="Add" href="<?php echo $edit; ?>?submenu=<?php echo $_GET['submenu'] ?>&session=<?php echo $_GET['session'] ?>&doc_type=4">
       ...
       <div class="form-group col-xs-12 col-md-2 col-sm-2 c-box">
				...
				<a title="Edit" href="<?php echo $edit ?>?eId=<?=encryptor(encrypt, $row->id)?>&submenu=<?php echo $_GET['submenu'] ?>&session=<?php echo $_GET['session']; ?>&action=edit&page=<?=$_REQUEST['page']?>&doc_type=4&print=0 ">
			...
			<table  class="table  dataTable   no-footer table-responsive out-table" width="100%" border="0" cellspacing="0" cellpadding="10" style="border:0.4px solid #000;">
			          ...
			          <tbody>
			                <tr>
			                    ...
			                    <td  class="pm" style="width:30%;font-size:12px;font-family: sans-serif;">
									...
									<center><p><b>GRN No: </b><?php echo stripslashes($prefix).''.stripslashes($row->po_no).''.stripslashes($suffix); ?> </p></center>
			    ...
			    <tr>
			     <td  style="padding:0px!important;">
			       <table  class="table table-striped  dataTable no-footer" width="100%" border="0" cellspacing="0" cellpadding="10"   >
			    	<thead>
			    		<td class="pm" style="width:100%;font-size:12px;font-family: sans-serif;border-bottom:.4px solid #000;padding:0;margin:0;"><b><center><p style="padding:5px;margin:0;">Supplier</p></center></b></td>
			   ...
			   <tr>
			   	<td style="padding:0px!important;border-bottom: 0.4px solid #000;">
 					...
 					<table id="myTable1" class="table table-striped  dataTable no-footer" width="100%" border="0" cellspacing="0" cellpadding="10" >
				            ...
				            <tbody>
				            	<tr>
				            		<p style="text-align: center;padding:5px;font-size:12px;font-family: sans-serif;border-bottom:0.4px solid #000;margin:0;"><b>Goods Order Details</b></p>
				            	</tr>
				            	<?php
				            	$k='';
				            	if($row->id ==''){
				                ...
				                <tr>
				                    ...
				                    <td class="pm" style="width: 15%;padding:5px;margin:0;border-right:.4px solid #000;"><p style="font-size:12px;font-family: sans-serif;"><?php echo $item_description; ?><br><span style="font-size: 10px;">Remarks:<?php echo stripslashes($array['item_remarks'.''.$j]); ?></span></p></td>  
