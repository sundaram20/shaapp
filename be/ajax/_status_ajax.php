...
$statusQuery = "UPDATE `".$table_name."` SET status = case when status = 1 then 0 else 1 end, last_modified='".currenDateTime()."', id_mst_user_modified_by='".$_SESSION['userId']."' where id='".$id."'";
