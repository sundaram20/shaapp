            ...
            <!-- form start -->  			        
			 <form name="indent_form"  method="post" enctype="multipart/form-data" data-parsley-validate autocomplete="off" id="indent_form">
              ...
              <div class="box-body" id="printTable">
			          ...
			          <tbody style="border: 1">
			                <tr>
			                    ...
			                    <td  style="width: 40%">
									...
									<center><h4>Purch No: <?php echo stripslashes($prefix).''.stripslashes($row->po_no).''.stripslashes($suffix); ?> </h4></center>
			    ...
			    <table  class="table table-striped  dataTable no-footer" width="100%" border="1" cellspacing="0" cellpadding="10"   >
			    	<thead>
			    		<td style="padding: 0px;"><b><center>Supplier</center></b></td>
			    		<!--<td><b><center>Delivery</center></b></td>-->
			    	</thead>
			         
			          <tbody style="border: 1">
			                <tr>
			                    <td style="width: 100%;padding:1px 0px 0px 3px;"> 
 					...
 					<table id="myTable1" class="table table-striped  dataTable no-footer" width="100%" border="1" cellspacing="0" cellpadding="10" >
				            <thead>
				                <tr style="font-weight: 800;">
				                    ...
				                    <td style="width: 5%;padding:1px 0px 0px 2px;">Rate/Unit</td>  
				            ...
				            <tbody>
				            	<tr>
				            		<h4 style="padding: 2px;text-align: center;">Details</h4>
				            	</tr>
				            	<?php
				            	$k='';
				            	if($row->id ==''){
				                ...
				                <tr>
				                	<td style="padding:1px 0px 0px 2px;"> 
					                 	<?php echo $count++; ?> 
					                </td> 
					                <?php 
			                		//Name Get
			                		...
			                		?>
				                    <td style="padding:1px 0px 0px 2px;"><?php echo $item_code; ?></td>  
				                    <td style="padding:1px 0px 0px 2px;"><?php echo $item_description; ?><br><span style="font-size: 10px;">Remarks:<?php echo stripslashes($array['item_remarks'.''.$j]); ?></span></td>  
				                    <td style="padding:1px 0px 0px 2px;"><?php echo stripslashes($array['qty'.''.$j]); ?>&nbsp;&nbsp;<?php echo $array['transaction_unit'.''.$j];?></td>   
				                    <td style="padding:1px 0px 0px 2px;"><?php echo round($array['rate_per_main_unit'.''.$j],2); ?>/<?php echo $array['per_unit'.''.$j];?></td>  
				                    
				                    <td style="padding:1px 0px 0px 2px;"><?php echo stripslashes($array['discount_percent'.''.$j]); ?></td>  
				                    <td style="padding:1px 0px 0px 2px;"><?php echo stripslashes($array['item_amount'.''.$j]); ?></td>  
				                    <td style="padding:1px 0px 0px 2px;"><?php 
				    ...
				    <table id="myTable1" class="table table-striped  dataTable no-footer" width="100%" border="1" cellspacing="0" cellpadding="10" >
				            <thead>
				                <tr style="font-weight: 800;">
				                    <td style="padding: 0px;">S.No</td> 
				                    <td style="width: 35%;padding: 0px;">Charges/Discount</td>
				                    <td style="width: 20%;padding: 0px;">Disc(%)</td> 
				                    <td style="width: 15%;padding: 0px;">Amount</td>
				                    <td style="width: 30%;padding: 0px;">Taxes</td> 
				                </tr>
				            </thead>
				            <tbody>
				            	<tr>
				                ...
				                <tr>
				                    ...
				                    <td style="padding:1px 0px 0px 2px;"><?php echo stripslashes($array['others_charges_percent'.''.$j]); ?></td>  
				                    <td style="padding:1px 0px 0px 2px;"><?php  echo stripslashes($array['others_charges_amount'.''.$j]); ?></td>   
				                    <td style="padding:1px 0px 0px 2px;">
					                    <?php 
				       ...
				       <table id="myTable1" class="table table-striped  dataTable no-footer" width="100%"  >
				        	...
				        	<tbody> 
				            	<tr>
				            		<td ><b>Sub Total:</b> <?php echo stripslashes($row->sub_total_items); ?></td>
				            		<td><b>Discount:</b> <?php echo stripslashes($row->total_discount_items); ?></td>
				            	...
				            	<tr>
				            		<td></td>
				            		<td></td>
				            		<td style="text-align: right;"><b>Additional Discount Amount:</b> </td>
				            	...
				            	<tr>
				            		<td></td>
				            		<td></td>
				            		<td style="text-align: right;"><b>Round Of Amount:</b> </td>
