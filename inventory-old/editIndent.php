...
if($_POST['Save']){
	...
	if($_POST['qty']>'0' && 1){	
				...
				if($_POST['another']!=''){
					header("location:editIndent.php?submenu=".$_GET['submenu']."&session=".$_GET['session']."&print=1");	
				}else{
					header("location:editIndent.php?eId=".addslashes(encryptor(encrypt,$lastInsertId))."&submenu=".$_GET['submenu']."&action=edit&page=".$_REQUEST['page']."&print=1");
				}
				exit;
			}else{
				$err++;
		...
		//Update Section Here
			...
			if(1){
				...
				if($_POST['another']!=''){
					...
					header("location:editIndent.php?eId=".$_GET['eId']."&submenu=".$_GET['submenu']."&action=edit&page=".$_REQUEST['page']."&print=1"); 
				}
					exit;
			}else{
				//echo "not";
              ...
              <div class="box-body">
              	...
              	<div class="card text-dark bg-light">
		            ...
		            <div class="row">	
	              		...
	              		<div class="form-group col-xs-12 col-md-6 col-sm-2" >
	              			...
	              			<?php $categoryDropDown = '<select class="form-control select2" name="id_mst_attributes_department" id="id_mst_attributes_department" data-parsley-required style="width:100%">
		        ...
		        <hr>
		         ...
		         <div class="box-body">
              	...
              	<div class="card text-dark bg-light">
              		<div class="bg-primary text-center ">
              			<h5 style="padding: 5px;">Requisition Details</h5>
              		</div>  
	              	<div class="row">
	              		<?php 
				            ...
				            <tbody id="tableBody">
				                ...
				                <tr>
				                	<td class="form-group col-xs-12 col-md-3 col-sm-2"> 
					                 ...
					                 <select class="form-control select2" name="id_inv_items<?php echo $k;?>" id="id_inv_items<?php echo $k;?>" onchange="itemget(this.id)" data-parsley-required style="width:100%">
...
<!-- End Another Modal -->
			 ...
			 <div class="box-footer">                                       
				...
				&nbsp;&nbsp;&nbsp;&nbsp; 
			   <input type='button' value='Cancel' class="btn btn-success" onclick='location.replace("manageIndent.php?submenu=<?php echo $_GET['submenu']?>&session=<?php echo $_GET['session']?>"); '>
