            ...
            <!-- form start -->  			        
			 <form name="indent_form"  method="post" enctype="multipart/form-data" data-parsley-validate autocomplete="off" id="indent_form">
              ...
              <div class="box-body" id="printTable">
			          ...
			          <tbody style="border: 1">
			                <tr>
			                    ...
			                    <td  style="width: 40%">
									...
									<center><h4>Purchase No: <?php echo stripslashes($prefix).''.stripslashes($row->po_no).''.stripslashes($suffix); ?> </h4></center>
			    ...
			    <table  class="table table-striped  dataTable no-footer" width="100%" border="1" cellspacing="0" cellpadding="10"   >
			    	<thead>
			    		<td style="padding: 1px;"><b><center>Supplier</center></b></td>
			    		<td style="padding: 1px;"><b><center>Delivery</center></b></td>
			    	</thead>
 					...
 					<table id="myTable1" class="table table-striped  dataTable no-footer" width="100%" border="1" cellspacing="0" cellpadding="10" >
				            <thead>
				                <tr style="font-weight: 800;">
				                    <td style="width: 1%;padding: 2px;">S.No</td>
				                    <td style="width: 10%;padding: 2px;">Item Code</td> 
				                    <td style="width: 15%;padding: 2px;">Item Description</td> 
				                    <td style="width: 3%;padding: 2px;">Qty</td>  
				                    <td style="width: 5%;padding: 2px;">Rate/Unit</td>  
				                    <td style="width: 5%;padding: 2px;">Disc(%)</td>  
				                    <td style="width: 10%;padding: 2px;">Amount</td>  
				                    <td style="width: 20%;padding: 2px;">Taxes</td>    
				                </tr>
				            </thead>
				            <tbody>
				            	<tr>
				            		<h4 style="padding: 3px;text-align: center;">Purchase Order Details</h4>
				            	</tr>
				            	<?php
				            	$k='';
				            	if($row->id ==''){
				                ...
				                <tr>
			                		...
			                		?>
				                    <td style="padding:2px;"><?php echo $item_code; ?></td>  
				                    <td style="padding:2px;"><?php echo $item_description; ?><br><span style="font-size: 10px;">Remarks:<?php echo stripslashes($array['item_remarks'.''.$j]); ?></span></td>  
				                    <td style="padding:2px;"><?php echo stripslashes($array['qty'.''.$j]); ?>&nbsp;&nbsp;<?php echo $array['transaction_unit'.''.$j];?></td>   
				                    <td style="padding:2px;"><?php echo round($array['rate_per_main_unit'.''.$j],2); ?>/<?php echo $array['per_unit'.''.$j];?></td>  
				                    
				                    <td style="padding:2px;"><?php echo stripslashes($array['discount_percent'.''.$j]); ?></td>  
				                    <td style="padding:2px;"><?php echo stripslashes($array['item_amount'.''.$j]); ?></td>  
				    ...
				    <table id="myTable1" class="table table-striped  dataTable no-footer" width="100%" border="1" cellspacing="0" cellpadding="10" >
				            <thead>
				                <tr style="font-weight: 800;">
				                    <td style="padding: 2px;">S.No</td> 
				                    <td style="width: 35%;padding: 2px;">Charges/Discount</td>
				                    <td style="width: 20%;padding: 2px;">Disc(%)</td> 
				                    <td style="width: 15%;padding: 2px;">Amount</td>
				                    <td style="width: 30%;padding: 2px;">Taxes</td> 
				                </tr>
				            </thead>
				            <tbody>
				            	<tr>
				                ...
				                <tr>
				                    ...
				                    <td style="padding:2px 0px 0px 2px;"><?php echo stripslashes($array['others_charges_percent'.''.$j]); ?></td>  
				                    <td style="padding:2px 0px 0px 2px;"><?php  echo stripslashes($array['others_charges_amount'.''.$j]); ?></td>   
				                    <td style="padding:2px 0px 0px 2px;">
					                    <?php 
				       ...
				       <table id="myTable1" class="table table-striped  dataTable no-footer" width="100%"  >
				         ...
				         <table id="myTable1" class="table table-striped  dataTable no-footer" width="100%" border="1" cellspacing="0" cellpadding="10" >
				        	...
				        	<tbody>
				        		<tr>
				            		<h4 style="padding: 5px;text-align: center;">Terms and Conditions</h4>
				            	</tr>
				            	<?php
				            	$k='';
				            	if($row->id ==''){
				            ...
				            ?>
				            	...
				            	<tr>
				        			<td><?php echo stripslashes($array['terms'.''.$j]); ?></td> 
				        		</tr>
				        		<?php } ?>
				        	</tbody>
