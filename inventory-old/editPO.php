			...
			if(1){  
				...
				if($_POST['another']!=''){
					header("location:editPO.php?submenu=".$_GET['submenu']."&session=".$_GET['session']."&print=1");	
						...
						header("location:editPO.php?eId=".$_GET['eId']."&submenu=".$_GET['submenu']."&session=".$_GET['session']."&action=edit&page=".$_REQUEST['page']."&print=1"); 
				}
				exit;
					              		...
					              		<tfoot>
						                	<tr> 
						                        <td colspan="12" style="text-align: left;">
													  ...
													  <input  type="button" class="btn btn-sm btn-block" style="font-size:14px;font-weight:700" id="addrow3" value="Add Row" />
						                        </td> 
							                </tr> 
							            </tfoot>
				                	</div>
...
<!-- End Another Modal -->		 
			 ...
			 <div class="box-footer">                                       
				...
				&nbsp;&nbsp;&nbsp;&nbsp; 
			   <input type='button' value='Cancel' class="btn btn-success" onclick='location.replace("managePO.php?submenu=<?php echo $_GET['submenu']; ?>"); '>
