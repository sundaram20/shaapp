...
if($_POST['Save']){
	...
	if($err == 0){//No error
		if(($_POST['Save'] == 'Add') && empty($_POST['eId'])){//add 
			 ...
			 $sql5 = " SELECT * FROM `".TBL_INV_INDENT."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' AND  `indent_no`='".$indent_no."' and `doc_type` = '2' ";
				$db->query($sql5);
				$numRows= $db->num_rows();
					if($numRows > 0)   {
			...
			$addSql = "   	INSERT INTO `".TBL_INV_INDENT."` SET
							...
							`indent_no` = '".addslashes($indent_no)."',  
			...
			if(1){
				...
				if($_POST['another']!=''){
					header("location:editIndentPO.php?submenu=".$_GET['submenu']."&session=".$_GET['session']."&print=1");	
				}else{
					header("location:editIndentPO.php?eId=".addslashes(encryptor(encrypt,$lastInsertId))."&submenu=".$_GET['submenu']."&action=edit&page=".$_REQUEST['page']."&print=1");
				}
...
executeSql($auditeditSql);							
			...
			if(1){  
				...
				if($_POST['another']!=''){
					...
					header("location:editIndentPO.php?eId=".$_GET['eId']."&submenu=".$_GET['submenu']."&action=edit&page=".$_REQUEST['page']."&print=1");
				}
              ...
              <div class="box-body">
              	...
              	<div class="card text-dark bg-light">
	              	...
	              	<div class="row">	
	              		...
	              		<div class="form-group col-xs-12 col-md-3 col-sm-2" >
		                  	...
		                  	<input data-parsley-required type="text" class="form-control pickerdate" placeholder="Enter Indent Date" id="indent_date" name="indent_date" value="<?php if($_POST) echo $_POST['indent_date'];elseif($row->indent_date!='') echo date('d-m-Y',strtotime($row->indent_date));else echo date('d-m-Y'); ?>" onclick="hideandshow()"> 
		                  	</div>
	              		</div>
		                  ...
		                  <?php if($row->id ==''){?>
	              			...
	              			<div id="ind" name="ind">
		              			...
		              			<div class=" col-xs-12 col-md-4 col-sm-6">
		              				...
		              				<input type="text" class="form-control" placeholder="Indent No" id="indent_no" name="indent_no" value="<?php if($_POST) echo $_POST['indent_no'];else echo stripslashes($row->indent_no);?>" readonly> 
		              				</div>
			                	</div>
			                	<div class=" col-xs-12 col-md-4 col-sm-6">
		            ...
		            <div class="row">	
	              		...
	              		<div class="form-group col-xs-12 col-md-6 col-sm-2" >
							...
							id="id_mst_attributes_department"
	              			name="id_mst_attributes_department" data-parsley-required>
				...
				<div class="modal" id="config_model">
				    <div class="modal-dialog">
				      <div class="modal-content"  style="width: 120%; padding-right: 3%;">
				      
				        <!-- Modal Header -->
				        <div class="modal-header">
				          <h4 class="modal-title">User/Production Indent Status</h4>
				        ...
				        <div class="modal-body">
							...
							<div style="float:right"><b> Suggestion = (Requirment+Min Stock Level) - (Stock In Hand+Po Balance+Indent Balance) </b></div>
				            ...
				            <thead>
				                <tr style="text-align: center; font-size: 14px;">
				                    ...
				                    <th  style="width: 10%;">Requirment</th> 
				                    <th style="width: 10%;">Stock In Hand</th> 
				                    <th style="width: 10%;">Min Stock Level</th> 
				                    <th style="width: 10%;">PO Balance</th> 			                    
				                    <th style="width: 10%;">Indent Balance</th> <!-- pending -->
				        ...
				        <div class="modal-footer">
				        	<button type="button" class="btn btn-success"  data-dismiss="modal" onclick="indent_po();"><i class="fa fa-plus-circle" aria-hidden="true" > Create Indent </i></button>
		         ...
		         <div class="box-body">
		         	<div class="row">
              			...
              			<div class="col-xs-12 col-md-2"> 
              				<button type="button" id="config_button" name="config_button" class="btn btn-info" data-toggle="modal" data-target="#config_model"><i class="fa fa-check-square-o"> Indent Help</i>
    						</button> 
              			</div>
              		</div>
              	...
              	<div class="card text-dark bg-light">
              		<div class="bg-primary text-center ">
              			<h5 style="padding: 5px;">Indent  Details</h5>
              		</div>  
				            ...
				            <tbody>
				                ...
				                <tr>
				                	<td class="form-group col-xs-12 col-md-3 col-sm-2"> 
					                 ...
					                 <select class="form-control select2" name="id_inv_items<?php echo $k;?>" id="id_inv_items<?php echo $k;?>" onchange="itemget(this.id)" data-parsley-required >
				            ...
				            <tfoot>
				                <tr> 
									<td colspan="7" style="text-align: left;">
										...
										<button type="button" class="btn btn-sm btn-block"  id="addrow1"  value="Add More" > <span style="font-size:14px;font-weight:700">Add Row</span> </button>
									</td> 
				                </tr>
				                <tr>
				                </tr>
...
<div class="modal fade" id="anotherModal" tabindex="-1" role="dialog" aria-labelledby="anotherModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
           ...
           <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> 
               <!-- <h4 class="modal-title" id="roomtypeModalLabel">Rooms Select</h4>  -->
                <label class="modal-title" id="roomtitle1" style="font-size:22px;">Indent</label>
            </div>
            <div class="modal-body">
                <table class="table table-bordered table-striped">
...
<!-- End Another Modal -->  		
			 ...
			 <div class="box-footer">                                       
				...
				&nbsp;&nbsp;&nbsp;&nbsp; 
			   <input type='button' value='Cancel' class="btn btn-success" onclick='location.replace("manageIndentPO.php?submenu=<?php echo $_GET["submenu"] ?>&session=<?php echo $_GET['session']?>"); '>
...
$('document').ready(function(){
	...
	$( document ).ready(function() {
 		var dates = '<?php echo ($indent_date!=""?date("d-m-Y",strtotime($indent_date)):date("d-m-Y")); ?>'; 
...
<?php 
	$sql2 = " SELECT max(indent_date) as indent_date FROM `".TBL_INV_INDENT."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' AND  `doc_type`='".'2'."' ";
		$db->query($sql2);   
			while($row2 = $db->fetch_object()){ 
	    ...
	    <div class="modal-dialog">
	      <div class="modal-content" style="margin-top: 50%; width: 70%;margin-left: 20%;">    	         
	       ...
	       <!--   <a href="print.php?eId='<?php echo $_GET['eId']; ?>'&action=edit&page=<?php $_REQUEST['page']?>" target="_blank" type="button" class="btn btn-primary"  id="buttons_radius"><i class="fa fa-print" aria-hidden="true"> Print</i></a> -->
	          ...
	          <a href="manageIndentPO.php?submenu=<?php echo $_GET["submenu"] ?>&session=<?php echo $_GET['session']; ?>" type="button" class="btn btn-info"  id="buttons_radius"><i class="fa fa-info-circle" aria-hidden="true"> Close</i></a>   
        	</center>
	        </div> 
...
$sqlResult1 = "SELECT * FROM ".TBL_ATTRIBUTES." WHERE table_name = 'items_type' AND field_category IN ('Ingredients Items','Both') ";
	$QuerySQL1	=	mysqli_query($connNew,$sqlResult1);
