...
function FlashReport($DateArray,$id_report_type,$report_show,$showItemReport,$kot_nc,$appConnect,$connNew,$id_shop,$cronSet,$pdfName,$objPHPExcel){	
...
while($Records	   =	mysqli_fetch_object($query)){
	...
	$name = selectColumn(TBL_OUTLETS,'name','WHERE id="'.$Records->id_mst_outlet.'" AND id_shop="'.$_SESSION['shop'].'" ');
    ...
    $OutletSql="SELECT * FROM ".TBL_OUTLETS."   WHERE id='".$id_mst_outlet_prim."' AND id_shop='".$_SESSION['shop']."' ";
...
$DataList ='<div class="col-xs-12"> 
  ...
  <div class="box">
    <div class="row">
     ...
     $printer.='<div style="text-align:right;text-align:right;width:100%;"><span style="text-align:right;font-size:12px;margin-right:15px;">Time:'.date('h:i A').'</span></div>';              
     $printer.='<div style="text-align:center;">';             				 
