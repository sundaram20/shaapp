...
$reportArray=array();	
 ...
 if(($_REQUEST['pdf']==1 && $Report_reportType==1) ||($CronSet==1 && $Report_reportType==1)  || ($Report_summaryReportType == '7' && $Report_reportType==1)){//Team Wise  Summary PDF reportType Pickup Report
 ...
 if(($_REQUEST['pdf']==1 && $Report_reportType==2) ||($CronSet==1 && $Report_reportType==2) || ($Report_summaryReportType == '7' && $Report_reportType==2)){//Team Wise  Summary PDF reportType BOB Report
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."' AND ( ( `fs_order_detail` .dated BETWEEN '".date('Y-m-d',strtotime($from_book))."' And '".date('Y-m-d',strtotime($to_book))."'))".$allUser." ".$condBOB." 
GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_COMPANY."`.id_default_group Order BY `".TBL_GROUP_MASTER."`.display_order,`mst_team`.id_group,`fs_users`.myownteam_id";
  ...
  //================Team View END ======================================================
   ...
   if(($_REQUEST['pdf']==1 && $Report_reportType==1) ||($CronSet==1 && $Report_reportType==1)  || ($Report_summaryReportType == '55' && $Report_reportType==1)){//Booked By  Summary PDF reportType Pickup Report
     ...
     $sql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`".TBL_ORDERS."`.created_by,`fs_users`.myownteam_id as MyOwnteam,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
       ...
       ".$cond." ".$allUser."  GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_ORDERS."`.created_by,`".TBL_USERS."`.name Order BY `".TBL_GROUP_MASTER."`.display_order, `mst_team`.id_group,`fs_users`.myownteam_id";
      //echo $sql;
      //die;
     //  LEFT JOIN  `".TBL_TEAM."` ON `".TBL_TEAM."`.ids_team REGEXP CONCAT('(^|,)(', REPLACE('".$id_teams."', ',', '|'), ')(,|$)') AND  FIND_IN_SET(myownteam_id,'".$id_teams."') 
 ...
 if(($_REQUEST['pdf']==1 && $Report_reportType==2) ||($CronSet==1 && $Report_reportType==2) || ($Report_summaryReportType == '55' && $Report_reportType==2)){//Booked By  Summary PDF reportType BOB Report
...
if(($_REQUEST['pdf']==1 && $Report_reportType==1) ||($CronSet==1 && $Report_reportType==1) || ($Report_summaryReportType == '1' && $Report_reportType==1)){//Executivewise  Summary PDF
...
if(($_REQUEST['pdf']==1 && $Report_reportType==2) ||($CronSet==1 && $Report_reportType==2) || ($Report_summaryReportType == '1' && $Report_reportType==2)){//Executivewise  Summary PDF Bob
...
////Hotel Wise Start=====================================================================================================================
 if(($_REQUEST['pdf']==1 && $Report_reportType==1) || ($CronSet==1 && $Report_reportType==1) || ($Report_summaryReportType == '2' && $Report_reportType==1)){//Hotel Wise  Summary PDF PICKUP Report
 ...
 if(($_REQUEST['pdf']==1 && $Report_reportType==2) ||($CronSet==1 && $Report_reportType==2) || ($Report_summaryReportType == '2' && $Report_reportType==2)){//Hotel Wise  Summary PDF BOP
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."' AND ( ( `fs_order_detail` .dated BETWEEN '".date('Y-m-d',strtotime($from_book))."' And '".date('Y-m-d',strtotime($to_book))."')) ".$allUser." ".$condBOB."  GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_ORDERS."`.id_hotel,`".TBL_USERS."`.name Order BY `".TBL_GROUP_MASTER."`.display_order,`fs_users`.myownteam_id";
 ...
 // Booking Through======================================================================================================================
  if(($_REQUEST['pdf']==1 && $Report_reportType==1) || ($CronSet==1 && $Report_reportType==1) || ($Report_summaryReportType == '5' && $Report_reportType==1)){//Hotel Wise  Summary PDF PICKUP Report
    ...
    $sql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`fs_users`.myownteam_id as MyOwnteam,`".TBL_ORDERS."`.booking_hrough,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
       ...
       ".$cond." ".$allUser."  GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_ORDERS."`.booking_hrough,`".TBL_USERS."`.name Order BY `".TBL_GROUP_MASTER."`.display_order, `mst_team`.id_group,`fs_users`.myownteam_id";
      //echo $sql;
      //die;
     //  LEFT JOIN  `".TBL_TEAM."` ON `".TBL_TEAM."`.ids_team REGEXP CONCAT('(^|,)(', REPLACE('".$id_teams."', ',', '|'), ')(,|$)') AND  FIND_IN_SET(myownteam_id,'".$id_teams."') 
...
$GroupArray[$teamGroup][$TeamName]['Arr']=$SumTeamTotalArray;
    ...
    if($teamGroup!='name'){
        ...
        <td style="border-left:1px solid #fff;background-color:#c2d69a;text-align:center;">'.$SumTotalArray.'</td></tr>';
    }
...
array_multisort($RoomNights, SORT_DESC, $RoomRevenue, SORT_ASC, $GroupArray);       
       ...
       foreach($GroupArray as $name => $GroupNameArray){    
                 ...
                 foreach($GroupArray as $name => $GroupNameArray){
                     if(strtoupper($name)!='UNIT'){
                    $contentGroup .='<tr ><td style="text-align:left;background-color:#c2d69a;">'.strtoupper($name).'</td><td style="text-align:center;background-color:#c2d69a;">'.$GroupNameArray['CancelledRoomNights'].'</td><td style="text-align:center;background-color:#c2d69a;">'.$GroupNameArray['RoomNights'].'</td><td style="text-align:center;background-color:#c2d69a;">'.round($GroupNameArray['RoomRevenue']/100000,2).'</td><td style="background-color:#c2d69a;text-align:center;">'.round($GroupNameArray['Arr']).'</td><td style="text-align:center;background-color:#c2d69a;">'.round(($GroupNameArray['RoomNights']/$TotalTeamWiseRoomNightContribution)*100,2).'</td></tr>';
                    foreach($GroupNameArray as $name2 => $GroupNameArray2){
                        if((strtoupper($name2) != 'ROOMNIGHTS') && (strtoupper($name2) != 'CANCELLEDROOMNIGHTS') && (strtoupper($name2) != 'ROOMREVENUE')  && (strtoupper($name2) != 'ARR')  ){
                         $contentGroup .='<tr ><td style="text-align:left;">'.strtoupper($name2).'</td><td style="text-align:center;">'.$GroupNameArray2['CancelledRoomNights'].'</td><td style="text-align:center;">'.$GroupNameArray2['RoomNights'].'</td><td style="text-align:center;">'.$GroupNameArray2['RoomRevenue'].'</td><td style="text-align:center;">'.round($GroupNameArray2['Arr']).'</td><td style="text-align:center;">'.round(($GroupNameArray2['RoomNights']/$TotalTeamWiseRoomNightContribution)*100,2).'</td></tr>';
                        }
                    }    
             ...
             $contentGroup .=    '<tr ><th style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a; ">Office</th><th style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a;">Cancelled Room Nights</th><th style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a;">Room Nights</th><th style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a;">Revenue</th><th style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a;">ARR</th><th style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a;">% of Contribution</th></tr>';
                $TotalTeamWiseRoomNightContribution='';
                 ...
                 foreach($GroupArray as $name => $GroupNameArray){
                     if(strtoupper($name)=='UNIT'){$contentGroup .='<tr ><td style="text-align:left;background-color:#4F6228;color:#fff;">'.strtoupper($name).'</td><td style="text-align:center;background-color:#4F6228;color:#fff;">'.$GroupNameArray['CancelledRoomNights'].'</td><td style="text-align:center;background-color:#4F6228;color:#fff;">'.$GroupNameArray['RoomNights'].'</td><td style="text-align:center;background-color:#4F6228;color:#fff;">'.$GroupNameArray['RoomRevenue'].'</td><td style="background-color:#4F6228;text-align:center;color:#fff;">'.round($GroupNameArray['Arr']).'</td><td style="text-align:center;background-color:#4F6228;color:#fff;">'.round(($GroupNameArray['RoomNights']/$TotalTeamWiseRoomNightContribution)*100,2).'</td></tr>';
                    foreach($GroupNameArray as $name2 => $GroupNameArray2){
                        if((strtoupper($name2) != 'ROOMNIGHTS') && (strtoupper($name2) != 'CANCELLEDROOMNIGHTS') && (strtoupper($name2) != 'ROOMREVENUE')  && (strtoupper($name2) != 'ARR')  ){
                         $contentGroup .='<tr ><td style="text-align:left;">'.strtoupper($name2).'</td><td style="text-align:center;">'.$GroupNameArray2['CancelledRoomNights'].'</td><td style="text-align:center;">'.$GroupNameArray2['RoomNights'].'</td><td style="text-align:center;">'.$GroupNameArray2['RoomRevenue'].'</td><td style="text-align:center;">'.round($GroupNameArray2['Arr']).'</td><td style="text-align:center;">'.round(($GroupNameArray2['RoomNights']/$TotalTeamWiseRoomNightContribution)*100,2).'</td></tr>';
                        }
...
//===============================================================================================================================================================
function CompareViewfunction($Report_period,$Report_id_hotel,$Report_id_group_master,$Report_reportType,$Report_viewMonthwise,$Report_summaryReportType,$CronSet){
global $connNew;
$PeriodDateArray	=	explode('to',$Report_period);
//print_r($PeriodDateArray);
$from = date('Y-m-d',strtotime($PeriodDateArray[0]));
...
$GroupOrder = "  GROUP BY `".TBL_USERS."`.myownteam_id,`fs_users`.id,`".TBL_ORDERS."`.id_hotel Order BY `".TBL_GROUP_MASTER."`.display_order,`mst_team`.id_group,`fs_users`.myownteam_id";
}
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."' AND ( ( `fs_order_detail` .dated BETWEEN '".date('Y-m-d',strtotime($from_book))."' And '".date('Y-m-d',strtotime($to_book))."')) ".$allUser." ".$condBOB."   GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_COMPANY."`.id_default_group Order BY `mst_team`.id_group,`fs_users`.myownteam_id";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."' AND ( ( `fs_order_detail` .dated BETWEEN '".date('Y-m-d',strtotime($from_book))."' And '".date('Y-m-d',strtotime($to_book))."')) ".$allUser." ".$condBOB."  GROUP BY `".TBL_USERS."`.myownteam_id,`fs_users`.id,`".TBL_ORDERS."`.id_hotel Order BY `mst_team`.id_group,`fs_users`.myownteam_id";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."' AND ( ( `fs_order_detail` .dated BETWEEN '".date('Y-m-d',strtotime($from_book))."' And '".date('Y-m-d',strtotime($to_book))."')) ".$allUser." ".$condBOB."  GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_ORDERS."`.id_hotel,`".TBL_USERS."`.name Order BY `fs_users`.myownteam_id";
...
foreach($reportArray as $maintitle=>$mainDatalist){
    ...
    $contentTeam ='<table class="table table-striped text-center">';
	$contentTeam .='<tr><th colspan="10" style="vertical-align:central;text-align:center;color:#fff;background-color:#4f6228; font-size:16px !important"><b>'.$ReportTypeMainTitle.' Compare '.$maintitle.'  Breakup For Period '.$reportPeriod.'</b></th></tr>';
    $contentTeam .='<tr>
    ...
    <th  colspan="3" style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a; ">ARR</th></tr>';
	 $TotalRoomNight='';
	 $TotalConfimedRevenue='';
	 $GroupArray=array(); 
    foreach($mainDatalist as $teamGroup=>$subDataList1){
...
//echo $teamGroup;
if($teamGroup!='name'){
 $contentTeam .='<tr style="vertical-align:central;"><th colspan="10" style="vertical-align:central;text-align:center;color:#fff;background-color:#4f6228; font-size:15px !important"><b>Group '.$teamGroup.'</b></th></tr>';
...
//Sorting Order Number Height to Low
      ...
      foreach($subDataList as $list=> $DataList){
           if($DataList['roomnights']>0 || $DataList['lastYearroomnights']>0){
                    if($DataList['confimed_revenue']>0 ){
                    $mtrArr =$DataList['roomnights']>0?($DataList['confimed_revenue']/$DataList['roomnights']):'0';
                    }else{
                    $mtrArr =0;
                    }
                      if($DataList['lastYearconfimed_revenue'] >0 ){
                    $lastYearComparViewmtrArr =$DataList['lastYearroomnights']>0?($DataList['lastYearconfimed_revenue']/$DataList['lastYearroomnights']):'0';
                    }else{
                    $lastYearComparViewmtrArr =0;
                      ...
                      $GolyListData      =    $lastYearComparViewmtrArr>0?round((($mtrArr-$lastYearComparViewmtrArr)/$lastYearComparViewmtrArr)*100,2):'0';
                        ...
                        $golyRowWiseConfimedRevenue    = $DataList['lastYearconfimed_revenue']>0?round((($DataList['confimed_revenue']-$DataList['lastYearconfimed_revenue'])/$DataList['lastYearconfimed_revenue']) *100,2):'0';
                        ...
                        $contentTeamBody .='<td style="text-align:center;background-color:#e9f7cd">'.round($mtrArr).'</td>';
                         $contentTeamBody .='<td style="text-align:center;background-color:#e9f7cd">'.round($GolyListData).'</td>';
            ...
            //Team Total
            $SumTeamTotalCYArray= $TotalTeamConfimedRevenue>0?round($TotalTeamConfimedRevenue/$TotalTeamRoomNight):'0';
            ...
            $SumTeamTotalgolyConfimedRevenue=$TotalTeamConfimedRevenuelastYear>0?round((($TotalTeamConfimedRevenue-$TotalTeamConfimedRevenuelastYear)/$TotalTeamConfimedRevenuelastYear) *100,2):'0';
           ...
           $SumTeamTotalgolyRoomNightsColor=$SumTeamTotalgolyRoomNights>=0?"":"color:red;";
            ...
            if($TotalTeamRoomNight>0){
                ...
                <th  style="vertical-align:central;text-align:center;color:#000;background-color:#e2f7b8; font-size:12px !important"><b> '.$SumTeamTotalLYArray.'</b></th>
                 ...
                 <th  style="vertical-align:central;text-align:center;color:#000;background-color:#e2f7b8; font-size:12px !important"><b> '.$SumTeamTotalOccpanGoly.'</b></th>
    ...
    <td style="border-left:1px solid #fff;background-color:#c2d69a;text-align:center;">'.$OccpanGolyMTD.'</td>
    ...
    $contentGroup .=    '<tr >
             ...
             <th style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a;">LY</th>
...
array_multisort($RoomNights, SORT_DESC, $RoomRevenue, SORT_ASC, $GroupArray);       
     ...
     foreach($GroupArray as $name => $GroupNameArray){    
                 ...
                 foreach($GroupArray as $name => $GroupNameArray){
                    ...
                    $contentGroup .='<td style="text-align:center;background-color:#C2D69A;">'.round($GroupNameArray['ArrGoly']).'</td>';
                    ...
                    foreach($GroupNameArray as $name2 => $GroupNameArray2){
                        if((strtoupper($name2) != 'ROOMNIGHTS') && (strtoupper($name2) != 'LASTYEARROOMNIGHTS') && (strtoupper($name2) != 'LASTYEARCONFIMED_REVENUE')  && (strtoupper($name2) != 'ARRCY') && (strtoupper($name2) != 'ARRLY') && (strtoupper($name2) != 'ARRGOLY') && (strtoupper($name2) !='ROOMREVENUE') ){
                         $contentGroup .='<tr ><td style="text-align:left;">'.strtoupper($name2).'</td><td style="text-align:center;">'.$GroupNameArray2['lastYearroomnights'].'</td><td style="text-align:center;">'.$GroupNameArray2['RoomNights'].'</td><td style="text-align:center;">'.round((($GroupNameArray2['RoomNights']-$GroupNameArray2['lastYearroomnights'])/$GroupNameArray2['lastYearroomnights'])*100,2).'</td><td style="text-align:center;">'.round($GroupNameArray2['lastYearconfimed_revenue']/100000,2).'</td><td style="text-align:center;">'.round($GroupNameArray2['RoomRevenue']/100000,2).'</td><td style="text-align:center;">'.round((($GroupNameArray2['RoomRevenue']-$GroupNameArray2['lastYearconfimed_revenue'])/$GroupNameArray2['lastYearconfimed_revenue'])*100,2).'</td><td style="text-align:center;">'.round($GroupNameArray2['ArrLY']).'</td><td style="text-align:center;">'.round($GroupNameArray2['ArrCY']).'</td><td style="text-align:center;">'.$GroupNameArray2['ArrGoly'].'</td></tr>';
                        }
                    } 
