...
$UniqueCodeGen = 'UNIC'.rand(0000,9999);
    $image_path="images/steward/";
	 ...
	 $sqlNat = "SELECT * FROM `".TBL_DOC_TYPE_CONFIG."` WHERE   `doc_type`='22' order by id desc ";
...
<style>
	.discountvalue{border-radius:1px;width:22px!important;float: left;padding: 1px 4px!important;text-align:center;height: 17px!important;display:flex;align-items:center;
    ...
    <section class="content-header"> 
        ...
        <div class="col-md-4 col-xs-12 dd-f">
            ...
            <div class="btn-group"> <a type="button"  title="List Bill" class="btn n-btn pull-right" href="manageOutletBilling.php?submenu=177&session=21" > <i class="fas fa-list "></i> Bill</a> </div>
              <div class="btn-group"> <a type="button"  title="List KOT" class="btn n-btn pull-right" href="pendingkots.php?submenu=178" > <i class="fas fa-table"></i> KOT Table View</a> </div>
            <div class="btn-group"> <a type="button" onClick="AddPosGuest();" title="List KOT" class="btn n-btn pull-right"> <i class="fas fa-plus"></i> POS Guest </a></div>
...
<div class="tooltiptable">Hover over me
  <span class="tooltiptext" id="tooltiptext">Tooltip text</span>
               ...
               <div class="col-md-2 col-xs-5 p-0 shiftbox">
      ...
      <div class="modal-body">
        ...
        <div id="myDIV">
            <div class="row">
                ...
                <div class="col-md-3 box-header with-border paxbox" style="display:hnone;">
...
<?php       
		 if($enable_nationality=='1'){ ?>            
              <div class="col-md-3 box-header with-border paxbox paxbox2" style="display:hnone;">
...
echo $categoryDropDown ='<tr><td><a href="#" name="TableGroup" id="TableGroup_'.$resultCat->id.'" type="button" class="'.$ClassName.'" value="'.ucfirst($resultCat->field_value).'"  onclick="getTable(this.id);" >'.ucfirst($resultCat->field_value).'</a></td></tr>';
...

  {
	 ...
	 ?>
                            <td style="hi" class="btn tableviewBlockedbtn" onclick="TabeleSelect(this.id); PreviousOrderPax(this.id,<?php echo '\''.$UniqueCodeGen.'\''?>);PreviousOrder(this.id,<?php echo '\''.$UniqueCodeGen.'\''?>);ajaxRemoveAllItemList('removeAll',<?php echo '\''.$UniqueCodeGen.'\''?>);" id="TableGroup_<?php echo $rowContact->id ?>_<?php echo $rowContact->field_value;?>"><?php echo $rowContact->field_value;?></td>
...
<!-- Modal ends -->
    ...
    <!--Guest Modal Starts-->
      ...
      <div class="form-group">
        ...
        <a  href="manageKot.php?submenu=178&session=22" class="cancelpop_close btn c-btn"><i class="far fa-window-close"></i> Close</a>
      </div>
