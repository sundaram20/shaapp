...
class NetworkPrintConnector extends FilePrintConnector
{
     ...
     */
    //public function __construct(string $ip, int $port = 8083, int $timeout = 60)
	public function __construct(string $ip, int $port=8084, int $timeout = 60)
    {		
        if ($timeout == -1) { //echo 'Open';
