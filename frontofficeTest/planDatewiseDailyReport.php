   ...
   <!--<div class="input-group-addon"> <i class="fa fa-dot-circle-o"></i> </div>-->
      <select class="form-control select2 parsley-error"  name="id_report_type" data-parsley-required id="id_report_type" style="width:100%">
        ...
        <?php
           ...
           ?>
        <option <?php echo $selected ?> value="1">Resevation vs Occupied with Meal Plan</option>
        <?php /*?><option <?php echo $selected ?> value="2"> Availability Reports</option><?php */?>
...
//Form Data Clear
	...
	var showItemReport = $("#showItemReport").val();
        ...
        let url2 = 'ajax/ajaxPlanDateWiseDailyReports.php?period='+period+'&id_report_type='+id_report_type+'&id_main_group='+id_main_group+'&id_sub_group='+id_sub_group+'&id_item='+id_item+'&ReportShowType='+ReportShowType+'&id_order_by='+id_order_by+'&showItemReport='+showItemReport;
         window.open(url2);
	...
	// alert(id_report_type);
     ...
     $("#loading").show();
	  var id_order_by = $("#id_order_by").val();
		...
		if(id_report_type=='1'){
		 reportTypeFile  ='ajaxPlanDateWiseDailyReports.php';
		}else{
