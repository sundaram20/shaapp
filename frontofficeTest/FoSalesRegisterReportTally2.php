...
<?php include_once("../includes/header.php")?>
  ...
  <?php 
  include_once("functions/functionfrontofficeSalesRegisterReportTally2.php");
...
$id_charges_name =$_REQUEST['id_charges_name'];
	 $shop=$_SESSION['shop'];
	  frontofficeSalesRegisterReportTally2($Date,$id_outlet,$id_shift,$objPHPExcel,$connNew,$shop,$cronSet,$pdfNameReport3,$id_charges_name);
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-2">
			  ...
			  <div class="col-md-2">                                
             <div class="form-group">
                <label>Display (Charges Name/ Alias Name)  <span class="text-danger"></span></label>
						
								 <select class="form-control select2" name="id_charges_name" data-parsley-required id="id_charges_name"  style="width:100%">	
								 <?php
                               

							echo $hotelDropDown = '<option  value="1">'.ucfirst('Charges Name').'</option><option  value="2">'.ucfirst('Alias Name').'</option>';			
