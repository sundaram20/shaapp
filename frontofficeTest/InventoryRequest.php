...
$SQL="SELECT *  from api_inv_request where 1=1 $searchDocumentType ORDER BY id desc
";
 ...
 //$resCat = selectSql("pos_purch_details WHERE qty-adj_qty>0 AND id_pos_purch  IN  (SELECT id FROM pos_purch WHERE pos_bill_type= '1')");
                    ...
                    <tr>
                      ...
                      <td><?php echo $row->date_created;//.'=='.$row->id;?></td>
						<td><?php echo $channel_id = selectColumn('fs_channel_manager','name','Where id="'.$row->id_channel.'" ');?></td>
