...
while($RecordsSalesReportPayment	   =	mysqli_fetch_object($querySalesReportPayment)){
	...
	if($RecordsSalesReportPayment->payment_mode=='COMPANY'){
	$payment_mode	=$CompanyName;//$RecordsSalesReportPayment->payment_mode;
	}else{
	$payment_mode	=$RecordsSalesReportPayment->payment_mode;
	}
	...
	$SalesRegisterArray[$RecordsSalesReportPayment->receipt_doc_date][$RecordsSalesReportPayment->id_fo_folio][$RecordsSalesReportPayment->id]['payment_mode']=$payment_mode.' '.$paymentIsAdvance;
