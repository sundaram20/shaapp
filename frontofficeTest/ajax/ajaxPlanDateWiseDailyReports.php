...
include_once("../functions/functionPlanDateWiseDailyReport.php");
...
$shop=addslashes($_SESSION['shop']);$pdfNameReport3='';
echo FoPlanDateWiseReportDaily($_REQUEST['period'],$id_main_group,$id_sub_group,$id_items,$_REQUEST['id_report_type'],$report_show,$_REQUEST['id_order_by'],$_REQUEST['showItemReport'],$_REQUEST['res_bookingStatus_new'],$_REQUEST['hk_status'],$shop,$pdfNameReport3,$id_mst_shops,$cronSet); 
