...
$id_mst_hotels=$HotelSplit[0];
  ...
  $sql = "SELECT * FROM `".FO_RESERVATIONS."` where `id` = '".addslashes(encryptor('decrypt',$_REQUEST['id']))."'";
	...
	$room_additional_charges	=	  selectColumn('fo_reservations_addons_details','sum(rate)','WHERE `id_fo_reservations` = "'.addslashes(encryptor('decrypt',$_REQUEST['id'])).'" ');
	$room_additional_charges_tax_val	=	  selectColumn('fo_reservations_addons_details','sum(tax_value)','WHERE `id_fo_reservations` = "'.addslashes(encryptor('decrypt',$_REQUEST['id'])).'" ');
    ...
    <div style="display : flex!important; flex-direction : column!important;">
      <div style="padding : 5px 10px;">
       ...
       border: 1px solid #fefefe; margin-top : 2.5rem;"> <a href="javascript:void(0);" style="color:black;" id="res_guestAddId"><i
        ...
        <div class="form-group col-sm-2">
          <label for="checkin" style="float:left;" readonly="readonly">Mode of payment</label>
          <select class="form-control select2" style="width: 100%;" id="res_payment_status" name="res_payment_status"  >  
                    ...
                    ?> </select>
            <?php /*?><option value="0">Pending</option>
            <option value="1"  <?php echo $selectedres_payment_status; ?>>Advance Received</option>
          </select><?php */?>
        </div>
        <div class="form-group col-sm-2">
...
$dataArr='';
	...
	while($rowneww = mysqli_fetch_object($resneww)){
		...
		//room type========================
        ?>
     <?php /*?> <div class="form-group col-sm-2" style="padding-left : 20px!important; margin-bottom : 0!important;">
        <input type="text" class="form-control "  placeholder="2 Standard Rooms" id="room_tariff_price33" name="room_tariff_price333" value="2 Standard Rooms" style="font-weight : 700;">
      </div><?php */?>
        ...
        ?>
			...
			echo '<option value="1" '.$selectedAdultNo1.'>1</option>
                  ...
                  <td><select
                                                ...
                                                id="child_below_5_year_<?php echo $rowOrderDetail->id;?>" data-parsley-required=""
                                                class="form-control child_below_5_year_<?php echo $rowOrderDetail->id;?>">
                      <?php 
			if($rowOrderDetail->child_below_5_year == '0' ){$selectedChildNo1 =  'selected="selected"';}else{$selectedChildNo1 =''; }
				if($rowOrderDetail->child_below_5_year == '1' ){$selectedChildNo2 =  'selected="selected"';}else{$selectedChildNo2 =''; }
				if($rowOrderDetail->child_below_5_year == '2' ){$selectedChildNo3 =  'selected="selected"';}else{$selectedChildNo3 =''; }
echo '<option value="0" '.$selectedChildNo1.'>0</option>
                  ...
                  <td ><select
                                                ...
                                                id="child_above_5_year_<?php echo $rowOrderDetail->id;?>" data-parsley-required=""
                                                class="form-control child_above_5_year_<?php echo $rowOrderDetail->id;?>">
                      <?php 
				if($rowOrderDetail->child_above_5_year == '0' ){$selectedChildNo1 =  'selected="selected"';}else{$selectedChildNo1 =''; }
				if($rowOrderDetail->child_above_5_year == '1' ){$selectedChildNo2 =  'selected="selected"';}else{$selectedChildNo2 =''; }
				if($rowOrderDetail->child_above_5_year == '2' ){$selectedChildNo3 =  'selected="selected"';}else{$selectedChildNo3 =''; }
echo '<option value="0" '.$selectedChildNo1.'>0</option>
				   <option value="1" '.$selectedChildNo2.'>1</option>
				   <option value="2" '.$selectedChildNo3.'>2</option>';
				   ?>
      ...
      <div style="margin-top : 1rem!important; padding: 5px 10px;">
        ...
        <div class="form-group col-md-1 ">
          ...
          <input type="text" class="form-control " <?php echo $readonly; ?> placeholder="Additional Charges"
                id="room_additional_charges" name="room_additional_charges" value="<?php echo $room_additional_charges==''?'0':$room_additional_charges;?>">
        </div>
        <div class="form-group col-md-1">
          ...
          <input type="text" class="form-control " <?php echo $readonly; ?> placeholder="Taxes" id="total_tax_edit"
                name="total_tax_edit" value="<?php echo $total_tax+$room_additional_charges_tax_val;?>">
        </div>
        <div class="form-group col-md-1">
          <label for="checkin" style="float:left;">Tota1</label>
          <input type="text" class="form-control " <?php echo $readonly; ?> placeholder="Total"
                id="net_booking_amount_edit" name="net_booking_amount_edit" value="<?php echo $net_booking_amount+$room_additional_charges+$room_additional_charges_tax_val;?>">
        </div>
        <div class="form-group col-sm-1">
          ...
          <input type="text" class="form-control " <?php echo $readonly; ?> placeholder="Balance" id="balance_edit"
                name="balance_edit" value="<?php echo $balance+$room_additional_charges+$room_additional_charges_tax_val;?>">
        </div>
        <div class="form-group col-sm-2">
      ...
      <table class="table order-list1 table-hover table-striped table-bordered" cellspacing="0">
        <thead>
         ...
         <tbody id="tableOtherChargesBody">
             ...
             <input type="hidden" class="form-control pickerdate" placeholder="Enter checkin Date"
                    id="dateRange" name="dateRange" value="<?php echo $Checkindata;  ?>"  >
		...
		<?php  $ChargesUnit ='<option value="1">Per room</option><option value="2">Per Adult</option> <option value="3">Per Nos</option>';?>	 
...
?>
                    ...
                    <?php
			$start	=1;
			$sqlOrderDetail = mysqli_query($connNew,"Select  `fo_reservations_addons_details`.* from `fo_reservations_addons_details` where `id_fo_reservations` = '".addslashes(encryptor(decrypt,$_REQUEST['id']))."' ORDER BY  dated ");
		if(mysqli_num_rows($sqlOrderDetail) >0 ){
			//$rowOrderDetail->id_mst_room_types;
				while($rowOrderDetail= mysqli_fetch_object($sqlOrderDetail)){ 
			   ...
			   ?>
				...
				//echo $id_reservation_detailArray	=implode(',',$id_reservation_detailArray);
					 ...
					 ?>
                                    ...
                                    <input style="width: 126px;" type="hidden" class="form-control"
                                        id="id_reservation_detail"
                                        name="EditPostChargesDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][id_reservation_detail][]"
                                        value="<?php echo $rowOrderDetail->id;?>" >
                                    <input style="width: 126px;" type="hidden" class="form-control" id="order_by_room"
                                        name="EditPostChargesDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][order_by_room][]"
                                        value="<?php echo $rowOrderDetail->order_by_room;?>">
                                    <tr data-reservation-id="<?php echo $rowOrderDetail->id; ?>">
                                    <?php echo $RecordTD2; ?>
                                        <td style="width: 120px;"><input type="text"
                                                class="form-control" id="res_date"
                                                name="EditPostChargesDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][resdate][]"
                                                value="<?php echo date('d-m-Y',strtotime($rowOrderDetail->dated));?>" readonly></td>         
                                        ...
                                        <td style="width: 180px;"><select
                                                name="EditPostChargesDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][room_type_id][]"
                                                id="room_type_id[]" data-parsley-required=""
				...
				?>
                                          ...
                                          <td style="width: 100px;"><input type="text" class="form-control"
                                                onKeyUp="tariffCalculationNew(<?php echo $rowOrderDetail->id;?>);"
                                                id="tariff_per_room_per_night_<?php echo $rowOrderDetail->id;?>"
                                                name="EditPostChargesDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][tariff_per_room_per_night][]"
                                                value="<?php echo $rowOrderDetail->days;?>"  readonly="readonly">
                                        </td>
                                        
                                         <td style="width: 100px;"><select
                                                name="EditPostChargesDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][res_unit][]"
			...
			echo '<option value="1" '.$selectedAdultNo1.'>Per room</option>
				  ...
				  <option value="3" '.$selectedAdultNo3.'>Per Nos</option>';?>
                                         ...
                                         <td style="width: 100px;"><input type="text" class="form-control"
                                                ...
                                                name="EditPostChargesDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][res_no_of_Room][]"
                                                value="<?php echo $rowOrderDetail->qty;?>" readonly>
                                        </td>
                                        ...
                                        <td style="width: 100px;"><input type="text" class="form-control"
                                                id="perday_tax_<?php echo $rowOrderDetail->id;?>"
                                                name="EditPostChargesDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][perday_tax][]"
                                                value="<?php echo $rowOrderDetail->tax_value;?>"  readonly="readonly"></td>
                                                
                                        <td style="width: 100px;"><input type="text" class="form-control"
                                                id="tariff_per_room_inclusive_tax_<?php echo $rowOrderDetail->id;?>"
                                                name="EditPostChargesDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][tariff_per_room_inclusive_tax][]"
                                        ...
                                        <td style="width: 100px;"><input type="text" class="form-control"
                                                ...
                                                name="EditPostChargesDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][total][]"
                                        ...
                                        <td style="width: 83px;"><button type="button" value="Remove"
                                                onClick="RemoveTextBoxOtherChargesEdit('<?php echo $rowOrderDetail->id; ?>')" class="deleteBox">
