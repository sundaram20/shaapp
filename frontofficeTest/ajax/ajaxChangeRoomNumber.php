...
">
		...
		if(mysqli_num_rows($sqlOrderDetail) >0 ){
		  ...
		  <?php /*?>  
           ...
           <?php */?> <td>
            <select class="form-control parsley-error" name="reservation[<?php echo $rowOrderDetail->id;?>][roomtype]" id="roomtype_<?php echo date('Y-m-d',strtotime($rowOrderDetail->dated));?>" onchange="roomtypechangepopup(this.id,this.value);" style="width: 100px;" <?php echo $readonly; ?> required 
...
$dataArr='';
	...
	while($rowneww = mysqli_fetch_object($resneww)){
        ...
        ?>
            ...
            <td><select class="form-control parsley-error" name="reservation[<?php echo $rowOrderDetail->id;?>][plan]" id="plan_<?php echo date('Y-m-d',strtotime($rowOrderDetail->dated));?>" onchange="getval(this.id)" style="width: 80px;" <?php echo $readonly; ?> required 
    data-parsley-required="true">
               <?php 
			    $dataArrplan='';
              ...
              <td>
              <select class="form-control parsley-error roombuttonpopup" name="reservation[<?php echo $rowOrderDetail->id;?>][id_mst_room_no_allocation]" id="id_mst_room_no_allocation_<?php echo date('Y-m-d',strtotime($rowOrderDetail->dated));?>" onchange="getval(this.id)" style="width: 80px;" <?php echo $readonly; ?> required 
    data-parsley-required="true">
               <?php 
			   $dataArrplan='';
