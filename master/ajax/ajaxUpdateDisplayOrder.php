<?php
	...
	$result = mysqli_query($appConnect, "UPDATE ".TBL_REPORT." SET display_order='".addslashes($display_order)."',date_created='".currenDateTime()."',last_modified='".currenDateTime()."',id_mst_user_modified_by='".$sessionUserId."',id_mst_user_created_by='".$sessionUserId."' WHERE ".$condition);                      
