		...
		if($err == 0){//No error
			if(($_POST['Save'] == 'Add') && empty($_POST['eId'])){//add
				...
				$addSql = "INSERT INTO `".TBL_HOTELS."` SET 
							...
							`ids_mst_hotel_general_services` = '".addslashes(implode(',',$_POST['ids_mst_hotel_general_services']))."',
							
							`ids_mst_hotel_kids_related_services` = '".addslashes(implode(',',$_POST['ids_mst_hotel_kids_related_services']))."',

							`ids_mst_hotel_outdoor_services` = '".addslashes(implode(',',$_POST['ids_mst_hotel_outdoor_services']))."',

							`ids_mst_hotel_conference_services` = '".addslashes(implode(',',$_POST['ids_mst_hotel_conference_services']))."',

							`ids_mst_hotel_dining_services` = '".addslashes(implode(',',$_POST['ids_mst_hotel_dining_services']))."',
...
$sql1 = executeSql("SELECT * FROM `".TBL_HOTELS."` ORDER BY id DESC LIMIT 1");
  ...
  $auditresSQL = mysqli_query($connNew, $auditquery);	
	...
	if($cstate != $_POST['id_mst_state']){
		$old_data = selectColumn(TBL_STATE,'name'," WHERE `id_state` = '".$ccountry."'");
					 	...
					 	<div class="box-body" style="padding-top:0px">
				            ...
				            <div class="row">
				            	<div class="form-group col-md-12 col-sm-12">
				            		...
				            		<input type="text" class="form-control" placeholder="General Services" id="ids_mst_hotel_general_services" name="ids_mst_hotel_general_services"value="<?php if($_POST['ids_mst_hotel_general_services']) echo $_POST['ids_mst_hotel_general_services'];else echo stripslashes($row->ids_mst_hotel_general_services);?>" >	
							 				
				            		<select class="form-control select2" name="ids_mst_hotel_general_services[]" multiple="multiple" style="width:100%;display: none;" >				  
                  					<?php 
				            ...
				            <div class="row">
				            	<div class="form-group col-sm-12 col-md-12">
				            		...
				            		<select class="form-control select2" name="ids_mst_hotel_outdoor_services[]" multiple="multiple" style="width:100%">				  
				                  <?php 
				            ...
				            <div class="row">
				            	<div class="form-group col-sm-12 col-md-12">
				            		...
				            		<select class="form-control select2" name="ids_mst_hotel_dining_services[]" multiple="multiple" style="width:100%">				  
				                  	<?php 
				            ...
				            <div class="row">
				            	<div class="form-group col-sm-12 col-md-12">
				            		...
				            		<select class="form-control select2" name="ids_mst_hotel_kids_related_services[]" multiple="multiple" style="width:100%">				  
                  					<?php 
				            ...
				            <div class="row">
				            	<div class="form-group col-sm-12 col-md-12">
				            		...
				            		<select class="form-control select2" name="ids_mst_hotel_conference_services[]" multiple="multiple" style="width:100%" >				  
					                <?php 
