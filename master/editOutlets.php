	...
	if($err == 0){//No error
		if(($_POST['Save'] == 'Add') && empty($_POST['eId'])){//add
			...
			$addSql = "   	INSERT INTO `".TBL_OUTLETS."` SET
							...
							`display_logo_on_the_pos_bill` = '".$_REQUEST['display_logo_on_the_pos_bill']."',
...
<!-- End Audit trail Modal -->
			 ...
			 <form name="form1"  method="post" enctype="multipart/form-data" data-parsley-validate autocomplete="off" >
              ...
              <div class="box-body">
                ...
                <div class="form-group col-md-4">
				  ...
				  <div class="form-group col-md-4">
                  <label for="name">SAC NO.</label>
                  <div class="input-group"> 
              			<div class="input-group-addon">
							<i class="fa fa-legal"></i> 
					   	</div>
                  <input  type="text" class="form-control" placeholder="Enter SAC No." id="sac_no" name="sac_no" value="<?php if($_POST) echo $_POST['sac_no'];else echo stripslashes($row->sac_no);?>" >
				  </div>
                </div> 
	...
	<div class="form-group col-md-4">
                  <label for="name">Display Logo on the pos bill</label>
                  <div class="input-group"> 
              			<div class="input-group-addon">
							<i class="fa fa-legal"></i> 
					   	</div>
					<?php
						...
						if($row->display_logo_on_the_pos_bill==1)
							$selectedLogoYes="selected='selected'";
						else
							$selectedLogoYes="";
					?>   	
                  <select name="display_logo_on_the_pos_bill" id="display_logo_on_the_pos_bill" class="select2 form-control" style="width:100%">
                  	<option  value="0">No</option>
                  	<option <?php echo $selectedLogoYes; ?> value="1">Yes</option>
