	...
	if($err == 0){//No error
		...
		if(($_POST['Save'] == 'Add') && empty($_POST['eId'])){//add
			...
			$addSql = "   	INSERT INTO `".TBL_CHARGES."` SET
							...
							`sac_no` = '".addslashes($_POST['sac_no'])."',
...
<div class="form-group">
        ...
        ?>
		  ...
		  <div class="form-group" id="sac" name="sac">
                  <label for="name">SAC No <font color="#FF0000">*</font></label>
                  <div class="input-group"> 
              			<div class="input-group-addon">
							<i class="fa fa-check-circle-o"></i> 
					   	</div>
                  <input type="text" class="form-control" placeholder="Enter SAC Number" id="sac_no" name="sac_no" value="<?php if($_POST) echo $_POST['sac_no'];else echo stripslashes($row->sac_no);?>" > 
                  	</div>
                </div>
