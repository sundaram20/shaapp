        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
               <h3 class="box-title"><?php echo $_REQUEST['tname']==''?'Add':'Edit'?> <?php echo currentNavigation()['submenu']; ?> : <span style="color:#3c8dbc"> <?php echo encryptor(decrypt, $_REQUEST['tname']); ?> </span>  
            </div>
            <!-- /.box-header -->
            <!-- form start -->   
            <form name="phpForm" id="reportConfig_form" method="post" enctype="multipart/form-data">
...
print_r($rowShowTables);
  ...
  <script type="text/javascript">
    ...
    $("#reportConfig_form").submit(function(e){
      //alert("hello");
      e.preventDefault();
      $.ajax({
        url:'ajax/ajaxUpdateReportCongif.php',
        type:'post',
        data:$(this).serialize(),
        success:function(data){
         alert(data);
