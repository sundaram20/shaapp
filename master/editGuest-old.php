	...
	if($err == 0){//No error
		if(($_POST['Save'] == 'Add') && empty($_POST['eId'])){//add
			...
			$addSql = "   	INSERT INTO `".TBL_COMPANY."` SET 
							...
							`primary_contact` = '".addslashes($_POST['primaryContact'])."',
							`primary_mobile` = '".addslashes($_POST['priContactMobile'])."',
							`primary_landline` = '".addslashes($_POST['priContactLandline'])."',
							`secondary_contact` = '".addslashes($_POST['secondaryContact'])."',
							`secondary_landline` = '".addslashes($_POST['secContactLandline'])."',
							`secondary_mobile` = '".addslashes($_POST['secContactMobile'])."',
...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
    	<div class="col-md-12">
    		<?php include_once("../frontoffice/editGuestForm.php"); ?>
    	</div>
            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <!--<div class="form-group  col-sm-4">
	             ...
	             <div class="form-group col-sm-2">
	                ...
	                <?php } ?>  
	               	...
	               	<span id="primaryContactError"><?php echo $err_priContactMobile;?></span>
	            </div>
	            ...
	            <div id="primaryContactDiv">
                  ...
                  <div class="form-group col-md-2 col-sm-2">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Mobile" id="priContactMobile" name="priContactMobile" value="<?php if($_POST) echo $_POST['priContactMobile']; else echo $row->primary_mobile;?>" data-parsley-type="digits" data-parsley-length="[10, 10]" data-parsley-required />
                    <span><?php echo $err_priContactMobile;?></span>
                  </div>
              		<?php }else if($row->primary_contact == 2){?>
              		<div class="form-group col-md-2 col-sm-2">
                    <label for="priContactLandline">Landline<font color="#FF0000">*</font>
                    </label>
                    <input type="text" class="form-control" placeholder="Enter Mobile" id="priContactLandline" name="priContactLandline" value="<?php if($_POST) echo $_POST['priContactLandline']; else echo $row->primary_landline;?>" data-parsley-type="digits"  data-parsley-required />
                    <span><?php echo $err_priContactMobile;?></span>
                  </div>
              		<?php }else{ ?>
              		<div class="form-group col-md-2 col-sm-2">
	            ...
	            <div id="secondaryContactDiv">
	              <?php if($row->secondary_contact == 1){ ?>
		              <div class="form-group col-md-2 col-sm-2">
		                ...
		                <input type="text" class="form-control" placeholder="Enter Landline" id="secContactLandline" name="secContactLandline" value="<?php if($_POST) echo $_POST['secContactLandline']; else echo $row->secondary_landline;?>"data-parsley-type="digits" />
		              </div>
	            	<?php }else if($row->secondary_contact == 2){ ?>
	            		<div class="form-group col-md-2 col-sm-2">
		                <label for="secContactMobile">Mobile</label>
		                <input type="text" class="form-control" placeholder="Enter Landline" id="secContactMobile" name="secContactMobile" value="<?php if($_POST) echo $_POST['secContactMobile']; else echo $row->secondary_mobile;?>"data-parsley-type="digits" />
		              </div>
	            	<?php }else{ ?>
	            		<div class="form-group col-md-2 col-sm-2">
		                <label for="secContactLandline">Landline</label>
              ...
              <div class="row">
                <div class="form-group col-sm-4">
                  ...
                  <select class="form-control select2" style="width:100%" name="id_country" id="id_country" data-parsley-errors-container="#countryError" onchange="getState(this.value,'','');" required="required" data-parsley-required>
                ...
                <div class="form-group col-sm-4">
                  ...
                  <div id="state">
                    <select class="form-control select2" style="width:100%" name="id_state" id="id_state" data-parsley-errors-container="#stateError">
...
<script type="text/javascript">
	$(document).ready(function(){
		$(document).on('change', '#primaryContact', function(){
          ...
          if(primaryContact == 1){
            var mobile = '<div class="form-group col-md-2 col-sm-2"><label for="priContactMobile">Mobile<font color="#FF0000">*</font></label><input type="text" class="form-control" placeholder="Enter Mobile" id="priContactMobile" name="priContactMobile" value="<?php if($_POST) echo $_POST['priContactMobile']; else echo $row->primary_mobile;?>" data-parsley-type="digits" data-parsley-length="[10, 10]" data-parsley-required /><span><?php echo $err_priContactMobile;?></span></div>';

              $("#primaryContactDiv").html(mobile);

          }else if(primaryContact == 2){
            var landline = '<div class="form-group col-md-2 col-sm-2"><label for="priContactLandline">Landline<font color="#FF0000">*</font></label><input type="text" class="form-control" placeholder="Enter Landline" id="priContactLandline" name="priContactLandline" value="<?php if($_POST) echo $_POST['priContactLandline']; else echo $row->primary_landline;?>"data-parsley-type="digits" data-parsley-required /><span><?php echo $err_priContactLandline;?></span></div>';
        ...
        $(document).on('change', '#secondaryContact', function(){
          ...
          if(secondaryContact == 1){
            var landline = '<div class="form-group col-md-2 col-sm-2"><label for="secContactLandline">Landline</label><input type="text" class="form-control" placeholder="Enter Landline" id="secContactLandline" name="secContactLandline" value="<?php if($_POST) echo $_POST['secContactLandline']; else echo $row->secondary_landline;?>"data-parsley-type="digits"/></div>';

              $("#secondaryContactDiv").html(landline);

          }else if(secondaryContact == 2){
            var mobile = '<div class="form-group col-md-2 col-sm-2"><label for="secContactMobile">Mobile</label><input type="text" class="form-control" placeholder="Enter Mobile" id="secContactMobile" name="secContactMobile" value="<?php if($_POST) echo $_POST['secContactMobile']; else echo $row->secondary_mobile;?>"data-parsley-type="digits" data-parsley-length="[10, 10]"/></div>';
