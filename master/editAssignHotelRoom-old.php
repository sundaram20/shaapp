	...
	if($err == 0){//No error
		if(($_POST['Save'] == 'Add') && empty($_POST['id'])){//add
			...
			$addSql = "   	INSERT INTO `".TBL_ASSIGN_HOTEL_ROOM."` SET 
							`id_room` = '".addslashes($_POST['room_id'])."',
							`id_hotel` = '".addslashes(encryptor(decrypt,$_REQUEST['eId']))."',
              ...
              <div class="box-body">			  
			   <div class="form-group">
                 ...
                 <?php $categoryDropDown = '<select class="form-control select2" name="room_id" id="room_id">
											  ...
											  if(num_rows($resCat)){
											  	while($resultCat = $db->fetch_object2($resCat)){
													...
													}elseif($row->id_room == $resultCat->id){
														$selected = 'selected="selected"';
													}else{
														$selected = '';
													}
                ...
                <div class="form-group">
				  ...
				  <select class="form-control select2" name="idroom_amenities[]" multiple="multiple">				  
                  <?php 
