...
$auditquery = "SELECT * From `".TBL_COMPANY."` WHERE id = '".addslashes(encryptor(decrypt,$_POST[eId]))."'  ";
  ...
  $auditresSQL = mysqli_query($connNew, $auditquery);	
	...
	if($c2 != $_POST['name']){
		 $ch2 ="Company Name Changed from " .  $c2." - to - ".$_POST['name'];
	}
	if($c3 != $_POST['email']){
	...
	if($c18 != $_POST['id_mst_portfolio_account']){
		...
		$ch15 ="Area Details Changed from " .$old_data." - to - " .$new_data;
	}
          ...
          <form name="form1"  method="post" enctype="multipart/form-data" role="form" data-parsley-validate autocomplete="off" >
            ...
            <div class="box-body" style="padding-top: 0px">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Email Id" id="email" name="email" value="<?php if($_POST) echo $_POST['email'];else echo $row->email;?>" >
                  <?php echo $err_email;?> 
              	</div>
          	</div>
          	<div class="row">
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Seconday Email Id" id="secondary_email" name="secondary_email" value="<?php if($_POST) echo $_POST['secondary_email'];else echo $row->secondary_email;?>"   >
                ...
                <!--<div class="form-group  col-sm-4">
	             ...
	             <div class="form-group col-sm-2">
	              	...
	              	<select name="primary_contact_type" id="primary_contact_type" class="form-control select2" style="width: 100%" >
	            ...
	            <div id="primaryContactDiv">
                  ...
                  <div class="form-group col-md-2 col-sm-2">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Mobile" id="primary_mobile" name="primary_mobile" value="<?php if($_POST) echo $_POST['primary_mobile']; else echo $row->primary_mobile;?>"  data-parsley-type="digits" />
                    ...
                    <input type="text" class="form-control" placeholder="Enter Mobile" id="primary_landline" name="primary_landline" value="<?php if($_POST) echo $_POST['primary_landline']; else echo $row->primary_landline;?>" data-parsley-type="digits"   />
