...
if($_REQUEST['action'] == 'change'){
	...
	if(checkUserLevelPermission($_SESSION['userLevel'],TBL_DOC_TYPE_CONFIG,'delete')){
		$delSql = "DELETE FROM `".TBL_DOC_TYPE_CONFIG."` WHERE `id` = '".$_REQUEST['delId']."'";
...
<div class="content-wrapper">
	 ...
	 <div class="form-group has-error" align="center">
        ...
        <div class="box-header with-border"> 
		  <div class="btn-group  pull-right">
							  <a type="button" class="btn btn-success" href="editGuestDocumentType.php" >Add Guest Document Type Configuration</a>
        ...
        <div class="col-xs-12">		     
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Guest Document Type Configuration List</h3>
            </div>
            ...
            <div class="box-body table-responsive">
		        ...
		        <tbody>  
		        	<?php  
		        	 ...
		        	 $resCat = selectSql(TBL_DOC_TYPE_CONFIG," where id_shop= '".addslashes($_SESSION['shop'])."' and id_app_modules = 3"); 
                  ...
                  <td><?php echo $row->status=='1'?'<span onclick="location.href=\'manageGuestDocumentType.php?inactiveId='.encryptor(encrypt, $row->id).'&action=change&page='.$_REQUEST['page'].'\'" style="color:green;cursor:pointer;">Active</span>':'<span onclick="location.href=\'manageGuestDocumentType.php?activeId='.encryptor(encrypt,$row->id).'&action=change&page='.$_REQUEST['page'].'\'"  style="color:red;cursor:pointer;">Inactive</span>';?>&nbsp;</td>		

				  <td><img src="../images/view_edit.gif" style="cursor:pointer;" title=" View / Edit " onClick="window.location.href='editGuestDocumentType.php?eId=<?=encryptor(encrypt, $row->id)?>&action=edit&page=<?=$_REQUEST['page']?>';" />&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <script type="text/javascript">
	  ...
	  swal({
	   ...
	   if (isConfirm)
	   {  
	        self.location='manageGuestDocumentType.php?delId='+sid+'&action=delete&page=<?=$_REQUEST['page']?>';
	   } 
	   else
	   {
	      self.location='manageGuestDocumentType.php';
	    }
	   });
	  }
  </script> 
