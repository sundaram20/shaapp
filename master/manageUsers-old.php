        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label> User Level Title</label>				
				 <?php $categoryDropDown = '<select class="form-control select2" name="userlevelId" style="width:100%">
            ...
            <div class="form-group">
               ...
               <?php $categoryDropDown = '<select class="form-control select2" name="username" style="width:100%">
											  								<option value="">All user Name</option>';
											  $resUserLevel = selectSql(TBL_USERS," WHERE `status` = '1' and `id_shop` = '".addslashes($_SESSION['shop'])."'",' ORDER BY `name`');
											  if($db->num_rows2($resUserLevel)){
											  	while($resultUserLevel = $db->fetch_object2($resUserLevel)){
             ...
             <div class="form-group">
               ...
               <?php $categoryDropDown = '<select class="form-control select2" name="hotel_id" style="width:100%">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <td>
				  	<?php 
					if($rowUser->ids_hotel_access !=""){				  
				  	$hotels = explode(",",$rowUser->ids_hotel_access);
				  	?>
				  	<ul>
				  	<?php 
