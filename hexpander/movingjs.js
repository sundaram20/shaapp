...
function toggleSlide(did,iid)
{
	if(document.getElementById(did).style.display == "none")
		...
		slidedown(did);
                document.getElementById(iid).setAttribute('src','http://localhost:8080/app/hexpander/remove.jpg');
		...
		slideup(did);
                document.getElementById(iid).setAttribute('src','http://localhost:8080/app/hexpander/insert.jpg');
	}
}
