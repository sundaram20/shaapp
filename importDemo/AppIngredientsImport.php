...
if($_REQUEST['submit']	==	'Upload csv'){
	 ...
	 echo $target_dir = $_SERVER['DOCUMENT_ROOT']."/importDemo/";
    ...
    <th   style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a; ">Sale Tax Structure</th>
	<th   style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a; ">Sale Tax Rate</th>
	<th   style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a; ">Purchase Tax Structure</th>
	<th   style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a; ">Purchase Tax Rate</th>
	<th   style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a; ">Printer</th>
	<th   style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a; ">Remarks</th>
   ';
...
//echo "<pre>";print_r($emapData);
	...
	$ItemNameSql= "SELECT item_code,name FROM inv_items WHERE name LIKE '%".$ItemName."%' " ;
				$resultItemName = mysqli_query($connNew2,$ItemNameSql);
				$ItemNameVerify = mysqli_num_rows($resultItemName);
	if($ItemNameVerify!=''){
	$StausRemark .='Item Name is Alreay Exist'.$ItemNameVerify;
	}
	...
	//$ItemCodeVerify	=	selectColumn2('inv_items','item_code'," WHERE item_code='".$itemCode."'");				
	if($ItemCodeVerify!=''){
	$StausRemark .='Item Code is Alreay Exist'.$ItemNameVerify;
	}
   ...
   $content .='<tr><td style="border:1px solid #000;text-align:center;">'.$sno++.'</td>
	...
	<td style="border:1px solid #000;text-align:center;">'.$StausRemark.'</td>';
 ...
 $content .='</tr>';
  ...
  $StausRemark='';
	...
	if($success=0 && $_REQUEST['success']=1){						
				...
				if($NumberCompany=='0'){		
							$addNewCompanyName ="INSERT INTO `inv_items` SET 
											 ...
											 `id_mst_charges_sales_local`='".$id_mst_charges_sales_local."',
