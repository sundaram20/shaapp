...
$sqlRoomNumber = mysqli_query($connNew, "SELECT DISTINCT 
    ...
    AND resdetails.id_mst_room_no_allocation = '".$attribute_id."'   and resdetails.id_mst_guest = '".$guest_id."' and resdetails.`room_availability`='Checkin' order by resdetails.dated desc");
