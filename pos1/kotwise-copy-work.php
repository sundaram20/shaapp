					...
					<div id="kwbox2" class="col-md-2 kw-sidebar floating">
						<div class="kw-box">
							...
							<table class="table table-responsive">
								...
								?>
									<tr>
										<td id="<?php echo $Mrow1->item_description; ?>" onclick="item_test(this.id);"><?php echo $Mrow1->item_description; ?></td>
