...
if($crs_sales_both_active==1){ ?>
    ...
    <div class="form-group col-sm-3 row-fluid">
...
if (in_array("sales", $Recpath)) {
    $foldername =    "sales";
       ...
       </div><div class="form-group col-sm-2" style="float:right;" >
    ...
    <div class="overlay__inner">
        <div class="overlay__content"><span class="spinner"></span></div>
         ...
         <div id="blk-FinancialYear" class="toHide" >
             ...
             <div id="chartCompleteView">
            <h4 class="text-center" style="background-color: #1c4c7c;margin: 5px;padding: 10px;color: #fff;"><strong><span class="showReportTypeHeadingChart"> </span> - MTD - YTD <span class="showPeriodChart"> </span> </strong></h4>
            <div class="row" >
           
                
                
             <div class="col-md-12">
                        <p class="text-center"> <strong class="col-lg-offset-2">Room Nights </strong>
                            <!--<div class="row">
                    ...
                    <div class="chart ">
                      <canvas id="horizontalBar-Ytd-Mtd" <?php echo $HeightWidth; ?>></canvas>
                    </div>
              </div>
            
            <div class="col-md-12" >
                        <p class="text-center"> <strong class="col-lg-offset-2">Revenue(Lacs) </strong>
                            <!--<div class="row">
                              <div class="col-md-3  col-sm-3 col-xs-3 text-center"> &nbsp; </div>
                              <div class="col-md-3  col-sm-3 col-xs-3 text-center" style="background-color: #87CEFA;"> Last Year </div>
                              <div class="col-md-3 col-sm-3 col-xs-3 text-center" style="background-color: #3b8bba ;"> This Year </div>
           ...
           <div class="row">
              ...
              <h4 class="text-center " style="background-color: #1c4c7c;margin: 5px;padding: 10px;color: #fff;">
                  <strong><span class="showReportTypeHeadingChart"> </span>Booking Through Report <span class="showPeriodChart"> </span></strong></h4>
              ...
              <div class="col-md-12" >
              <h4 class="text-center " style="background-color: #1c4c7c;margin: 5px;padding: 10px;color: #fff;">
                  <strong><span class="showReportTypeHeadingChart"> </span>Room Nights Segment Wise <span class="showPeriodChart"> </span></strong></h4>
  ...
  downloadSummaryPdf = (pdf,excel) => {
   ...
   downloadComparePdf = (pdf,excel) => {
    ...
    if(CompareTypedownload=='5'){
        ...
        let url1 = 'ajax/DashboardCompareAgentTop.php?pdf='+pdf+'&excel='+excel+'&period='+period+'&id_hotel='+id_hotel+'&id_group_master='+id_group_master+'&id_group_sub_master='+id_group_sub_master+'&reportType='+reportType+'&summaryReportType='+summaryReportType+'&CompareFinancialYear='+CompareFinancialYear+'&CurrentFinancialYear='+CurrentFinancialYear+'&ComparePeriodDate='+ComparePeriodDate;
         window.open(url1);
	}else if(CompareTypedownload=='61'){
        let url12 = 'ajax/DashboardCompareAgentDropOut.php?pdf='+pdf+'&excel='+excel+'&period='+period+'&id_hotel='+id_hotel+'&id_group_master='+id_group_master+'&id_group_sub_master='+id_group_sub_master+'&reportType='+reportType+'&summaryReportType='+summaryReportType+'&CompareFinancialYear='+CompareFinancialYear+'&CurrentFinancialYear='+CurrentFinancialYear+'&ComparePeriodDate='+ComparePeriodDate;
         window.open(url12);
	   ...
	   let url = 'ajax/DashboardCompareView.php?pdf='+pdf+'&excel='+excel+'&period='+period+'&id_hotel='+id_hotel+'&id_group_master='+id_group_master+'&id_group_sub_master='+id_group_sub_master+'&reportType='+reportType+'&summaryReportType='+summaryReportType+'&CompareFinancialYear='+CompareFinancialYear+'&CurrentFinancialYear='+CurrentFinancialYear; 
	   window.open(url);
	}
...
var monthNameDataHalfYearArrayValue    =[];
    ...
    function fetchPerformanceGraphData(viewMonthwise){
		...
		let CurrentFinancialYear = $("#financialyearselected").val();
        if(reportType==1){
            reportTypeFile  ='DashboardGraphData.ajax.php';
        }else{
            reportTypeFile  ='DashboardGraphDataBOB.ajax.php'; //reportType =2 BOB
            //alert('BOB');
        }
         if(reportType==1){
...
CompleteChartHorizontalBar = new Chart(ytdMtdChartHorizontalBar, {
            type: 'horizontalBar',
            data: {
                labels: horizontalBarNameArrayValue,
                datasets: [
                {
                    ...
                    backgroundColor: 'rgba(60,141,188,0.8)',
        			borderColor: 'rgba(54, 162, 235,1)',
                    data: horizontalBarThisYearArrayValue
                },{
                    //label: 'Year ('+LYLable+'): '+horizontalBarLastYearArrayValue+'',
                     backgroundColor: 'rgba(54, 162, 235,0.5)',
					borderColor: 'rgba(54, 162, 235,1)',
                    data: horizontalBarLastYearArrayValue
                }
  ...
  type: 'bar',
  	// The data for our dataset
            data: {
                ...
                datasets: [{
                    label: 'Year ('+LYLable+'): '+CompanyGroupListLastYearArray.reduce(sumofArray)+'',
                  	 backgroundColor: 'rgba(54, 162, 235,0.5)',
					borderColor: 'rgba(54, 162, 235,1)',
					margin: 1,
                ...
                {
                    label: 'Year ('+CYLable+'): '+companygroupDatalist.reduce(sumofArray)+'',
                   backgroundColor: 'rgba(60,141,188,0.8)',
        			borderColor: 'rgba(54, 162, 235,1)',
					margin: 1,
  ...
  function fetchPerformanceSummaryData(viewMonthwise,summaryReportType){
	...
	//	alert(id_group_master);
        ...
        if(summaryReportType==8){
            ...
            reportTypeFile  ='DashboardForecastReport1.php'
        }else{
            reportTypeFile  ='DashboardTableView.php';
        }
...
function SalesSummaryDateQuickForSearchfunction(viewMonthwise,summaryReportType){
      $("#loading").show();
	    ...
	    let ComparePeriodDate = $("#SelectedComparePeriodDate").val();
        //if(reportType==1){
            reportTypeFile  ='DashboardSalesActivity.ajax.php';
       // }
        if(reportType==1){
            reportHeading  =' Pickup ';
       }else{
