...
<?php include_once("../includes/header.php")?>
  ...
  <?php 
  include_once("include/functionSettlementReportItemWise.php");
  if($_REQUEST['Download'] == 'Generate'){
	...
	$id_shift=implode(',',$_REQUEST['id_shift']);
	 ...
	 $objPHPExcel = new PHPExcel(); 
	  settlementSummaryReportItemWise($Date,$id_outlet,$id_shift,$objPHPExcel,$appConnect,$connNew,$id_shop,$cronSet,$pdfName);
