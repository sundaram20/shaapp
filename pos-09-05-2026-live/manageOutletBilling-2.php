    ...
    <section class="content">
      <div class="box box-default">
        ...
        <div class="box-header with-border">
          ...
          <div class="btn-group  pull-right"> <a type="button" class="btn n-btn" href="kotbilling.php?submenu=<?php echo $_GET['submenu'] ?>&session=<?php echo $_GET['session'] ?>" >Add <?php echo currentNavigation()['submenu']; ?></a> </div>
        </div>
        <?php //echo $sql;?>
        <!-- /.box-header -->
                ...
                <table id="myTable" class="table table-striped table-bordered dataTable no-footer" cellspacing="0" >
                  ...
                  <tbody>
                   ...
                   <td><?php echo (($_REQUEST['page']-1)*$setpage)+$counter++;?>.&nbsp;</td>
					 ...
					 ?></td>            
                      <th><?php echo $row->grant_total_amount;?></th>
                      <th><?php
                      ...
                      <a href="printPreview.php?printPreviewid=<?=encryptor(encrypt, $row->id);?>&session=<?php echo $_REQUEST['session'] ?>&submenu=<?php echo $_REQUEST['submenu'] ?>" ><img src="../images/preview.png" style="cursor:pointer;height:20px;" title=" Page Preview "  /></a>
                       ...
                       <?php if($row->payment_status=='Pending'){?>
                        ...
                        <a class="showSingle" onClick="ajaxcancel(<?php echo $purch_id;?>);" style="cursor:pointer;"><img src="../images/cash-register.png" style="cursor:pointer;width:20px; height:20px;" title=" Cancel Bill "   /></a>
                          &nbsp;&nbsp; 
                      <?php } ?>
...
'.$resultCat->mdoc_no.'---    Room No:'.$roomNumber.' ---  Guest: '.$guestName.'</option>';
											  ...
											  }?>   <?php /*?> <?php  $resCat = selectSql(FO_BILL," where  status='1' and id_mst_shops='".addslashes($_SESSION['shop'])."'  ",' ');
