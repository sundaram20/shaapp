...
<?php include_once("../includes/header.php")?>
  ...
  <?php 
  include_once("include/functionalterationHistoryReport.php");
  if($_REQUEST['Download'] == 'Generate'){
	$Date =$_REQUEST['datefilterreport'];
	$id_outlet=implode(',',$_REQUEST['id_outlet']);
	$id_shift=implode(',',$_REQUEST['id_shift']);

	 alterationHistoryReportReport($Date,$id_outlet,$id_shift,$objPHPExcel);
            ...
            <div class="col-md-2">
              <div class="form-group">
               <label>Period</label>	 
							...
							<input type="text" class="form-control pull-right dateRangeReport" placeholder="Select From -  To" name="datefilterreport" id="dateRangeReport" data-parsley-required value="<?php echo date('d-m-Y').' to '.date('d-m-Y') ?>" data-parsley-errors-container="#report_dateError"  autocomplete="off">
