                            ...
                            <div class="header-content">
							  ...
							  <?php } ?>
                                ...
                                <div class="company-details">
                                    ...
                                    <p> <?php echo $HotelAddress; ?>
                                  <?php echo $HotelCity .' - '.$HotelPincode,','.$HotelState; ?></p>
									<p>GST NO: <?php echo $HotelGST; ?></p>
									
									<?php 
$tin   = $row_Hotel->tin;
$udyam = $row_Hotel->udyam;
$fssai = $row_Hotel->fssai;

//if (!empty($tin)) {
    //echo "<p>TIN: " . htmlspecialchars($tin) . "</p>";
//}
$detailsTin = array();

if (!empty($Hotelpan)) {
    $detailsTin[] = "PAN: " . htmlspecialchars($Hotelpan);
}

if (!empty($tin)) {
    $detailsTin[] = "TIN: " . htmlspecialchars($tin);
}

if (!empty($detailsTin)) {
    echo '<p>' . implode(', ', $detailsTin) . '</p>';
}										
if (!empty($udyam)) {
    echo "<p> " . htmlspecialchars($udyam) . "</p>";
}
									if (!empty($fssai)) {
    echo "<p>FSSAI: " . htmlspecialchars($fssai) . "</p>";
}
