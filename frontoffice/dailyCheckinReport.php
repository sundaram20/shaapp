...
<div class="col-md-2 col-sm-12">
  <div class="form-group">
    <label> Period</label>
      ...
      <input type="text" class="form-control pull-right pickerdate" placeholder="Select From -  To" name="per_report_date" id="per_report_date" data-parsley-required value="<?php echo date('d-m-Y'); ?>" data-parsley-errors-container="#report_dateError"  autocomplete="off">
...
//Form Data Clear
	...
	var showItemReport = $("#showItemReport").val();
        ...
        let url2 = 'ajax/ajaxDailyCheckInReports.php?period='+period+'&id_report_type='+id_report_type+'&id_main_group='+id_main_group+'&id_sub_group='+id_sub_group+'&id_item='+id_item+'&ReportShowType='+ReportShowType+'&id_order_by='+id_order_by+'&showItemReport='+showItemReport;
         window.open(url2);
     ...
     $("#loading").show();
	  var id_order_by = $("#id_order_by").val();
		...
		var id_item = $("#id_item").val();
		 ...
		 reportTypeFile  ='ajaxDailyCheckInReports.php';
		
		 $.ajax({
				url:'ajax/'+reportTypeFile,
				type:'POST',
				data:'period='+period+'&id_main_group='+id_main_group+'&id_data_main_group='+id_data_main_group+'&id_item='+id_item+'&ReportShowType='+ReportShowType+'&id_order_by='+id_order_by+'&id_sub_group='+id_sub_group+'&showItemReport='+showItemReport,
