...
<?php include_once("../includes/header.php")?>
  ...
  <?php 
  include_once("functions/functionfrontofficeSalesRegisterReportTally.php");
  if($_REQUEST['Download'] == 'Generate'){
	...
	$id_shift=implode(',',$_REQUEST['id_shift']);
	 ...
	 $shop=$_SESSION['shop'];
	  frontofficeSalesRegisterReportTally($Date,$id_outlet,$id_shift,$objPHPExcel,$connNew,$shop,$cronSet,$pdfNameReport3);
