...
#guestNewaddeditModal{
  z-index : 99999999999!important;
}
#guestMultipleeditModal{
  z-index : 99999999999!important;
}
...
<style>
  ...
  @media only screen and (max-width: 1200px) {.daybtn {
    min-height: 40px;
    position: absolute;
    top: -45px;
    right: 130px;
  ...
  #EditCheckinModal .modal-dialog .modal-content {
    min-height: 100vh;
  }
  ...
  .fc-widget-header:first-of-type .fc-expander-space {
  ...
  .fc-widget-header:first-of-type .fc-cell-text {
  ...
  div .fc-cell-content .fc-cell-text {
    font-size: 12px !important;
    text-align: center !important;
  }
  ...
  <section class="content container-fluid">
    ...
    <div class="row">
      ...
      <?php 
					 ...
					 ?>
                     <input type="hidden" id="startDateInput" name="startDateInput" value="<?php echo date('Y-m-d',strtotime($Dated));?>" />
        ...
        <div class="info-box daybtn" style="min-height: 40px;">
          ...
          <span class="dayclose">
            <span class="info-box-text"> <b>
                <div id="auditDate">Date Open : <?php echo $Dated;?></div>
              </b></span>
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        <li class="active">
          <a href="#tab_1" data-toggle="tab" id="tabs1" onClick="reloadCalander();">
            <!--  onClick="reload()" --> Reservation Chart</a>
        </li>
       <!-- <li id="reservation_tab"><a href="#">Reservation Form</a></li>-->
        <li>
          <a href="#tab_3" data-toggle="tab" id="tabs3">Expected Arrivals</a>
        </li>
        <li><a href="#tab_4" data-toggle="tab" id="tabs4" onClick="roomStats();">Room Occupancy</a></li>
        ...
        <?php /*?> <li id="list_view_tab"><a href="#tab_9" data-toggle="tab" id="tabs9"
            onClick="list_ajax();">Reservations</a></li><?php */?>

        <li><a href="<?php echo $SITE_URL; ?>/frontoffice/manageReservation.php?submenu=275&session=0">Reservations</a>
        </li>

        <!-- <li id="list_view_tab"><a href="#tab_10" data-toggle="tab" id="tabs10">Room View</a></li> -->
        <li><a  href="<?php echo $SITE_URL; ?>/frontoffice/roomView.php">Room View</a></li>
		  <?php 
		  if($_SESSION['id_app_shop']=='23'){?>
		  <li><a  href="<?php echo $SITE_URL; ?>/frontoffice/onewindowRoomView.php">Change Room Status</a></li>
		  <?php } ?>
        <li class="active_cart" id="roomaloc"><a href="#tab_8" data-toggle="tab" id="tabs8"
            onClick="LoadRoomAllocation();">Room Allocation</a></li>
      </ul>
      <div class="tab-content">
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group">
              ...
              <div class="input-group date">
                ...
                <input type="text" class="form-control pull-right " value="<?php echo date('d-m-Y');  ?>" name="date"
                  id="datepicker">
              </div>
            </div>
            ...
            <div class="col-xs-12">
              <div class="box box-info">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="<?php echo date('d-m-Y',strtotime($Dated)); ?>"
                          name="expectedarrivals" id="expectedarrivals" class="form-control pull-right  datepicker">
                    ...
                    <div class="col-md-1 col-sm-2 col-xs-3">
                      <div class="form-group">
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                        <button class="btn btn-success" class="form-control" onClick="searchArrivals();">Search</button>
                      </div>
                    </div>
                    <button class="btn btn-danger" class="form-control"></button>&nbsp;&nbsp;Occupied Rooms&nbsp;&nbsp;
                    <button class="btn btn-primary" class="form-control"></button>&nbsp;&nbsp;Allocated Rooms&nbsp;&nbsp;
                    <button class="btn btn-success" class="form-control"></button>&nbsp;&nbsp;Available Rooms&nbsp;&nbsp;
                ...
                <div class="box-body table-responsive">
                  <div id="expectedarrivals_datalist">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-5">
                      ...
                      <div class="input-group date">
                        ...
                        <input data-parsley-required type="text" class="form-control frontofficedatepicker"
                          placeholder="Enter Date" id="room_statistics_date" name="room_statistics_date"
                          value="<?php echo date('d-m-Y',strtotime($Dated)); ?>">
        ...
        <div class="tab-pane" id="tab_10">
          <?php include_once("tableView.php") ?>
        </div>
          ...
          <div class="row mt-5">
            <div class="col-xs-12">
              <div class="box box-info">
                    ...
                    <div class="row">
                      <div class="col-md-2 col-sm-6 col-xs-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="reference_no_search" id="reference_no_search"
                            value="<?php echo trim($_REQUEST['reference_no_search']);?>" class="form-control" />
                        </div>
                      ...
                      <div class="col-md-2 col-sm-6 col-xs-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="other_reference_no_search" id="other_reference_no_search"
                            value="<?php echo trim($_REQUEST['other_reference_no_search']);?>" class="form-control" />
                        </div>
                      ...
                      <div class="col-md-2 col-sm-6 col-xs-6">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control pull-right" placeholder="Select From -  To"
                              name="datefilter" id="dateRangeReport" data-parsley-required
                              value="<?php if($_REQUEST['datefilter']!=''){echo $_REQUEST['datefilter'];}else{ }?>"
                              autocomplete="off">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-1 col-sm-2 col-xs-3">
                        <button class="btn btn-success" onClick="LoadRoomAllocation();">Search</button>
                      </div>
                ...
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                  <table id="roomAllocationList" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>Reservation ID</th>
                        <th>Other Reservation ID</th>
                        <th>Room Type</th>
                        <th>Guest</th>
                        <th>Source</th>
                        <th>Check In</th>
                    ...
                    <tbody>
                      <!-- Data rows will be inserted here by LoadRoomAllocation -->
                    </tbody>
                  </table>
...
<!-- Checkin Modal -->
<div class="modal" id="EditReservationModal" tabindex="-1" role="dialog" aria-labelledby="EditReservationModalLabel" style="overflow:auto;">
...
<!-- Extend DATE --------------->
<div class="modal fade" id="ExtedDateModal" tabindex="-1" role="dialog" aria-labelledby="checkinModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">

      <form id="AmendmentStayform" method="post" class="AmendmentStayform" data-parsley-validate autocomplete="off">

        <input type="hidden" name="ext_id" id="ext_id" value="<?php echo $ext_id;?>">
        <input type="hidden" name="amend_room_no" id="amend_room_no">
        <input type="hidden" name="amend_order_by_room" id="amend_order_by_room">




        <div class="box-header with-border">
          <h3 class="box-title">Amend Stay</h3>

          <div class="box-tools pull-right">

            <button type="button" class="viewincPopUp_close btn btn-box-tool" data-widget="remove"><i
        ...
        <?php /*?><div class="form-group col-sm-2">
          ...
          <input type="text" class="form-control datepickercheckin" <?php echo $readonly; ?>
            placeholder="Enter checkin Date" id="checkinExtend_date" name="checkinExtend_date"
        ...
        <div class="modal-footer">
          <button class="btn n-btn" onclick="saveAmendmentStayform();" type="button">Save</button> &nbsp;
...
<div class="modal fade" id="additionalchargesModal" tabindex="-1" role="dialog" aria-labelledby="additionalchargesModalLabel" style="width: 100%; height: 100%;">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header" style="background-color: #1296f3; color: #fff;text-align: center;">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
            aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="additionalchargesModalLabel">Booker By Details</h4>
      </div>
      <div style="text-align:center">
            <!-- <input name="save" id="save" type="submit" class="btn btn-primary" value="Save" /> -->
            <input type="submit" name="submit" class="btn btn-primary" value="Save">           
             <button type="button" class="btn btn-danger" onClick="closeModaladditionalchargesFooterButton();" >Close</button>
...
<div class="modal fade" id="guestOtherDetailModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">

            <div class="modal-header" style="border-bottom: 1px solid #f0f0f0; padding: 14px 20px;">
                <div>
                    <h5 class="modal-title" style="margin:0; font-weight:500;">Guest details</h5>
                    <small class="text-muted">C Form & Other information</small>
                </div>
            ...
            <div class="modal-footer" style="border-top: 1px solid #f0f0f0; padding: 12px 20px;">
                ...
                <button type="button" class="btn btn-sm btn-dark" onclick="SaveOtherDetails()">Save details</button>
            </div>
...
<?php include_once('multiguestModal.php');	?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header" style="background-color: #1296f3; color: #fff;text-align: center;">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
            aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="roomratesModalLabel">Add Guest Details</h4>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="" id="housepopupform" name="housepopupform" data-parsley-validate=""
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control input-sm" id="room_type" name="room_type" value="" readonly
                  data-parsley-required="">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control input-sm" placeholder="Enter last name" id="room_no"
                  name="room_no" value="" readonly data-parsley-required="">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control input-sm" placeholder="Enter last name" id="block_floor"
                  name="block_floor" value="" readonly data-parsley-required="">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div id="ajaxPlanData">
          <div class="box box-success  table-responsive no-padding">
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody id="roombutton1">
                <tr>
                  <td style="padding:0px 15px"> 301 </td>
                  <td style="padding:0px 15px"> Block 3 </td>
                  <td style="padding:0px 15px"> <input type="checkbox" id="btn301" name="all_room_select1"
                      onclick="btncolorchange(this.id)" style="height:17px;width:20px"> </td>
                </tr>
              </tbody>
      ...
      <div class="modal-footer" style="background-color: #e4e4e4;color: #fff;">
        <button type="button" class="btn btn-success" data-dismiss="modal" id="submit">
          <!-- onclick="bd_apply();" --> <span class="glyphicon glyphicon-ok"></span> Submit</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"> <span class="glyphicon glyphicon-off"></span>
          Cancel</button>
...
<div class="modal fade" id="reservationModal" tabindex="-1" role="dialog" aria-labelledby="reservationModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
            ...
            <div class="col-md-6" style="padding-right: 0px">
              ...
              <div class="col-md-8 form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="bookingno" id="bookingno" class="form-control" placeholder="Enter Booking No"
                    readonly>
                </div>
              </div>
            ...
            <div class="col-md-6" style="padding-right: 0px">
              <div class="col-md-8 form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="bookingguestname" id="bookingguestname" class="form-control"
                    placeholder="Enter Guest Name" readonly>
                </div>
              </div>
            </div>
      ...
      <div class="modal-footer" style="background-color: #e4e4e4;color: #fff;">
        <button type="button" class="btn btn-success" id="Checkin"> <span class="glyphicon glyphicon-ok"></span>
          CheckIn</button>
        <button type="button" class="btn btn-warning" id="Checkout"><span class="glyphicon glyphicon-remove"></span>
          CheckOut</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"> <span class="glyphicon glyphicon-off"></span>
          Cancel</button>
        <!--<input name="addBaseRate" id="addBaseRate" type="submit" class="btn btn-primary" value="Add" />
...
<div class="modal fade" id="roomratesModal_night" tabindex="-1" role="dialog" aria-labelledby="roomratesModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input value="0" type="text" name="basevalue1" id="basevalue1" class="form-control"
                  onkeyup="basevalue_night()">
              </div>
            </div>
            ...
            <div class="col-md-3 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input value="0" type="text" name="intax1" id="intax1" class="form-control" readonly
                  onkeyup="basevalue_night()">
              </div>
            </div>
          </div> <br>
          <div class="row">
            ...
            <div class="col-md-4 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input type="text" name="basevalue2" id="basevalue2" class="form-control" value="0"
                  onkeyup="basevalue_night()">
              </div>
            </div>
            <div class="col-md-3 col-sm-2">
            ...
            <div class="col-md-3 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input type="text" name="intax2" id="intax2" class="form-control" readonly value="0"
                  onkeyup="basevalue_night()">
              </div>
            </div>
          </div><br>
          <div class="row">
            ...
            <div class="col-md-4 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input type="text" name="basevalue3" id="basevalue3" class="form-control" value="0"
                  onkeyup="basevalue_night()">
              </div>
            </div>
            <div class="col-md-3 col-sm-2">
            ...
            <div class="col-md-3 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input type="text" name="intax3" id="intax3" class="form-control" readonly value="0"
                  onkeyup="basevalue_night()">
              </div>
            </div>
          </div> <br>
          <div class="row">
            ...
            <div class="col-md-4 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input type="text" name="basevalue4" id="basevalue4" class="form-control" value="0"
                  onkeyup="basevalue_night()">
              </div>
            </div>
            <div class="col-md-3 col-sm-2">
            ...
            <div class="col-md-3 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input type="text" name="intax4" id="intax4" class="form-control" readonly value="0"
                  onkeyup="basevalue_night()">
              </div>
            </div>
          </div><br>
      ...
      <div class="modal-footer" style="background-color: #e4e4e4;color: #fff;">
        <button type="button" class="btn btn-info" data-dismiss="modal" id="submit" onclick="breakdown();"> <span
            class="glyphicon glyphicon-asterisk"></span> Daily Breakup</button>
        <button type="button" class="btn btn-success" data-dismiss="modal" id="submit" onclick="rrtaxset();"> <span
...
<div class="modal fade" id="roomtypeModal1" tabindex="-1" role="dialog" aria-labelledby="roomtypeModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <input type="checkbox" id="all_room_select1" name="all_room_select1" onclick="selectall1();"
            style="margin: 0px 5px 20px 17px;">Select All <br>
      ...
      <div class="modal-footer" style="background-color: #e4e4e4;color: #fff;">
        <button type="button" class="btn btn-success" data-dismiss="modal" onclick="roomselectzero()"> <span
            class="glyphicon glyphicon-ok"></span> Submit</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"> <span class="glyphicon glyphicon-off"></span>
          Skip</button>
      </div>
...
<div class="modal fade" id="roomtypeModal" tabindex="-1" role="dialog" aria-labelledby="roomtypeModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="background-color: #e4e4e4;color: #fff;">
        <button type="button" class="btn btn-success" data-dismiss="modal" id="submit"> <span
            class="glyphicon glyphicon-ok"></span> Submit</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"> <span class="glyphicon glyphicon-off"></span>
          Cancel</button>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input value="0" type="text" readonly name="basevalue6" id="basevalue6" class="form-control"
                  onkeyup="basevalue()">
              </div>
            </div>
            <div class="col-md-3 col-sm-2">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input type="text" readonly name="basevalue7" id="basevalue7" class="form-control" value="0"
                  onkeyup="basevalue()">
              </div>
            </div>
            <div class="col-md-3 col-sm-2">
          ...
          <div class="row" id="extra_bed">
            ...
            <div class="col-md-4 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input type="text" readonly name="basevalue8" id="basevalue8" class="form-control" value="0"
                  onkeyup="basevalue()">
              </div>
            </div>
            <div class="col-md-3 col-sm-2">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-2">
              ...
              <div class="input-group date">
                ...
                <input type="text" readonly name="basevalue9" id="basevalue9" class="form-control" value="0"
                  onkeyup="basevalue()">
              </div>
            </div>
            <div class="col-md-3 col-sm-2">
      ...
      <div class="modal-footer" style="background-color: #e4e4e4;color: #fff;">
        <button type="button" class="btn btn-info" data-dismiss="modal" id="submit" onclick="breakdown();"> <span
            class="glyphicon glyphicon-asterisk"></span> Daily Breakup</button>
        <button type="button" class="btn btn-success" data-dismiss="modal" id="submit" onclick="rrintaxset();"> <span
            class="glyphicon glyphicon-ok"></span> Submit</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"> <span class="glyphicon glyphicon-off"></span>
          Cancel</button>
...
<?php /*?><div class="modal fade" id="roomunallocModal" tabindex="-1" role="dialog"
  aria-labelledby="roomunallocModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style=" width: 120%;">
      ...
      <div class="modal-footer" style="background-color: #e4e4e4;color: #fff;">
        <button type="button" class="btn btn-success" data-dismiss="modal" id="submit" onclick="bd_apply();"> <span
            class="glyphicon glyphicon-ok"></span> Submit</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"> <span class="glyphicon glyphicon-off"></span>
          Cancel</button>
...
<div id="ratePoint" class="" style="display:none;">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">

        <button type="button" class="ratePoint_close close" data-dismiss="modal" aria-label="Close"> <span
            aria-hidden="true">×</span> </button>
      </div>
      <div class="modal-body" style="text-align:center;">
        <p id="updatestatussuccess"></p>
      </div>
      <div class="modal-footer justify-content-between">
        <button type="button" class="ratePoint_close btn btn-default" data-dismiss="modal">Close</button>
        <?php /*?><button type="button" class="btn btn-primary">Save changes</button><?php */?>
      </div>
    </div>
  </div>
</div>
...
<div id="viewincPopUp" class="well" style="display:none; background-color:#fff;">
  <div class="modal-content">
    ...
    <div class="modal-header" style=" color: #fff;text-align: center;">
      ...
      <label>
        <h6 style="color:#172635" id="daymessage"> </h6>
      </label>
    </div>
    <!-- Modal body -->
    <div class="modal-body" id="dayclose_help">
    ...
    <div class="modal-footer">
      ...
      <button class="viewincPopUp_close btn c-btn"><i class="far fa-window-close" aria-hidden="true"></i>
        &nbsp;Close</button>
    </div>
...
<div class="modal fade" id="roomAllocationModal" tabindex="-1" role="dialog" aria-labelledby="roomAllocationModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form name="formroomAllocation" id="formroomAllocation" method="post" enctype="multipart/form-data" role="form">
        <div class="modal-header" style="background-color: #1296f3; color: #fff;text-align: center;">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
              aria-hidden="true">&times;</span></button>
          <label class="modal-title" id="roomtitle" style="font-size:22px;">Rooms Select</label>
          ...
          <div id="ajaxPlanData">
            <div class="box box-success  table-responsive no-padding">
              ...
              <table class="table table-bordered table-striped">
                ...
                <input type="hidden" id="roomAllocation_id_room" name="roomAllocation_id_room" value="0" hidden="">
                <input type="hidden" id="roomAllocation_id_hotel" name="roomAllocation_id_hotel" value="0" hidden="">
                <input type="hidden" id="roomAllocation_id_reservations" name="roomAllocation_id_reservations" value="0"
                  hidden="">
        ...
        <div class="modal-footer" style="background-color: #e4e4e4;color: #fff;">
          ...
          <button type="button" class="btn btn-success" onClick="UpdateroomAllocation();" id="submit"> <span
              class="glyphicon glyphicon-ok"></span> Submit</button>
...
<!-- No Show Off --------------->
<div class="modal fade" id="NoShowOffModal" tabindex="-1" role="dialog" aria-labelledby="checkinModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">

      <form id="NoShowOffform" method="post" class="NoShowOffform" data-parsley-validate autocomplete="off">

        <input type="hidden" name="noshowoff_id" id="noshowoff_id" value="<?php echo $ext_id;?>">
        <input type="hidden" name="id_RoomNoShowOff" id="id_RoomNoShowOff" value="<?php echo $ext_id;?>">
        <input type="hidden" name="RoomNoShowOff_orderbyroom" id="RoomNoShowOff_orderbyroom" value="<?php echo $ext_id;?>">




        <div class="box-header with-border">
          <h3 class="box-title">No Show Off</h3>

          
        </div>

<div id="NoShowOffView"></div>
        ...
        <div class="modal-footer">
          <button class="btn n-btn" onclick="saveNoShowOffform();" type="button">Mark as No Show Off</button> &nbsp;
          <button type="button" class="btn n-btn" data-dismiss="modal">Close</button>
        </div>
  ...
  $(document).ready(function () {
    ...
    initializeTableArrivals = (target, targetArr, ordering = false) => {
      $(target || '#booking_list').DataTable({
        ...
        'autoWidth': false,
        "oLanguage": {
          "sSearch": "Search By Guest Or Room:"
        },
        "columnDefs": [{
          "searchable": false,
          "targets": targetArr
    ...
    initializeTableFolio = (target, targetArr, ordering = false) => {
      $(target || '#foliotable').DataTable({
        ...
        'autoWidth': false,
        "oLanguage": {
          "sSearch": "Search By Room Type/No:"
        },
        "columnDefs": [{
          "searchable": false,
          "targets": targetArr
        ...
        success: function (data) {
          ...
          data.forEach((value, key, arr) => {
            tableData += `
                                <tr>
                                    <td>${(key+1)}</td>
                                    <td onclick="reservationDetails('${value.id_fo_reservations}')"><a href="#" style="color:black;">${(value.booking_no)}</a></td>
...
<td>${(value.checkin)}</td>
                                    ...
                                    <td><button class="btn btn-success btn-xs" onclick="getRoomDetails('${value.reservation_id}',${value.pending},'${value.id}','${value.date}');" data-toggle="tooltip" title="view rooms"><i class="fa fa-eye"></i></button></td>
                                </tr>
                                <tr id="tr_${value.reservation_id}"  class="Exparrivals" style="display:none"></tr>
                            `;
          });
          $("#expected_arrivals")
            .DataTable()
      ...
      $.ajax({
        ...
        success: function (resp) {
          ...
          resp.forEach((value, key, arr) => {
            ...
            if (value.status == 1) {
              tableData += `<td><small class="label pull-right bg-red">OCCUPIED</small></td>`;
            } else if (value.status == 2) {
              tableData += `<td><small class="label pull-right bg-red">Dirty</small></td>`;
            } else if (value.status == 3) {
              tableData += `<td><small class="label pull-right bg-red">OCCUPIED</small></td>`;
            } else if (value.status == 4) {
              tableData += `<td><small class="label pull-right bg-green">CLEAN</small></td>`;
            }

            //var guestname = value.guest;    

            tableData += `<td onclick="ReservationSingleForm('${value.id_fo_reservations}','Edit','${value.id_fo_view_folio}','${value.id_fo_view_folio}')"><a href="#" style="color:black;">${value.res_id}</a></td>
                                    <td onClick="guestDetails('${value.id_mst_guest}','edit')"><a href="#" style="color:black;">${value.guest}</a></td> `;
			  
			tableData += `<td onClick="guestDetails('${value.id_mst_guest}','edit')"><a href="#" style="color:black;">${value.adults_per_room} | ${value.total_child}</a></td>`;
									  
			  
			  
                                    tableData += `<td onclick="folioTabDetails('${value.id_fo_view_folio}')"><a href="#" style="color:black;">${value.folio}</a></td>
                                    <td>${value.checkin}</td>
                                    <td>${value.checkout}</td>`;
            tableData += `<td>`;
            if (value.status == 3) {
              tableData +=
                `<button class="btn btn-warning"  data-toggle="modal" data-target="#ExtedDateModal" onClick="updateExtendDate('${value.checkin}','${value.checkout}','${value.id_fo_reservations}','${value.id_mst_room_no_allocation}','${value.order_by_room}');">Amend Stay</button>&nbsp;&nbsp;`;
              //tableData += `<button class="btn btn-info" onClick="ChangeReservationData('${value.id_fo_reservations}','${value.id_mst_room_no_allocation}','${value.order_by_room}');" >Edit</button>`;
              tableData +=
          ...
          initializeTableRoom("#room_statistics", [1, 2, 3, 4, 5]);
        }
      });
    }
    ...
    /*arrivals_cart = (date='') =>{
                $.ajax({
                    ...
                    success:function(data){
                            ...
                            tableData += `
                                <tr>
                                   <!-- <td>${(key+1)}</td> -->
									...
									<td><a href="javascript:;" style="color:black;">${(value.NoOfRoom)}</a></td>
                                    
                                    <!-- <td><button class="btn btn-success btn-xs" onclick="getRoomDetails_cart('${value.reservation_id}',${value.pending},'${value.id}');" data-toggle="tooltip" title="view rooms"><i class="fa fa-eye"></i></button></td> -->//unassigned_popup();
									<td><button class="btn btn-success btn-xs" onclick="roomAllocationPopup(${(value.id_mst_hotels)},${(value.id_mst_room_types)},${(value.id)},'${(value.checkIn)}','${(value.checkOut)}');" title="view rooms"><i class="fa fa-eye"></i></button>
                                </tr>
                       ...
                       initializeTableRoomAllocation('#calendar_cart',[0,1,3],true);
                    }
                });
        }*/
      ...
      success: function (resp) {
        ...
        resp.forEach((value, key, arr) => {
          ...
          value.RoomDetails.forEach((datavalue, keys, arrays) => {
            tableData +=
              `<div class="col-md-1 col-sm-1 col-xs-1" style="padding-right:0px; margin-top: 2px; margin-left:0px; margin-right: 0px;"><button class="btn btn-success btn-block" style="padding:6px 5px;" onclick="selectRoom_cart(${value.room_id},${datavalue},this.id,'` +
              resId + `',` + pending + `);" id="btn-` + resId +
              `-${datavalue}">${datavalue}</button></div> `;
          });
  ...
  function reservationDetails(resId) {
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        //alert(result.additional_charges);
        ...
        $("#res_hotelName").val(result
        .Hotel); //html('<option value="'+ result.id_mst_hotels +'">'+ result.Hotel +'</option>'); 
        ...
        $("#res_paymentStatus").val(result.res_paymentStatus).change();
        ...
        $("#res_bookingStatus").val(result.booking_status).change();
        ...
        var list_fieldHTML = result.roomdetails;
        ...
        var list_fieldAddHTML = result.OtherChargesAddon;
        $('table.order-list2').html('');
        $('table.order-list2').append(list_fieldAddHTML);
      }
    });
  }
      ...
      bootbox.confirm({
        ...
        callback: function (result) {
          if (result == true) {
            if (btnValue == "open") {
              $("#foliostatus").html(
                '<button class="btn btn-danger btn-sm" type="button" id="f_status">close</button>');
            } else {
              $("#foliostatus").html(
                '<button class="btn btn-success btn-sm" type="button" id="f_status">open</button>');
            }
          }
        }
      });
...
<script type="text/javascript">
  ...
  function selectRoom(roomTypeId, roomNo, btnId, resvId, pending, pendingRooms) {
    //alert(roomTypeId+"====="+roomNo+"====="+btnId+"====="+resvId+"====="+pending);
    var btn = "#" + btnId;
    ...
    let roomCount = 0;
    if ($(btn).hasClass("btn-success")) { //  alert("btn-success");        
      ...
      if (pending == roomCount) {
        ...
        for (var key in roomArr) {
          ...
          for (var i = 0; i < roomArr[key].length; i++) {
            if (roomArr[key][i] == 0) {
              roomArr[key].splice(i, 1); //data[i] is replaced with data
              i--; //reduce the i counter;
            }
          }
          //alert(roomArr[key].length+'========='+pendingRooms);
          if (roomArr[key].length <= pendingRooms) {
            ...
            alert('You have already selected the rooms');
          }
    ...
    } else if ($(btn).hasClass("btn-danger")) { //alert("btn-danger");  //===========================btn-danger
    ...
    } else if ($(btn).hasClass("btn-warning")) { //alert("btn-primary");        
      for (var key in roomArr) {
        // roomCount = roomCount + roomArr[key].length;   //(only select 2 pending option code)
      }
      if (pending == roomCount) {
...
*/
  ...
  function userCheckIn(resvId, id_mst_room_types, checkin_time = '', room_id) {
    var expected_arrivals_rooms = $("input[name='expected_arrivals_rooms[]']:checked").map(function () {
      ...
      $.ajax({
        url: 'ajax/ajaxUserCheckIn.php',
        type: 'POST',
        data: 'resvId=' + resvId + '&id_mst_room_types=' + id_mst_room_types + '&dataselected=' +
          expected_arrivals_rooms+ '&checkin_time='+checkin_time+'&room_id='+room_id, //{resvId : resvId,id_mst_room_types:id_mst_room_types},
        //dataType: 'JSON',
        success: function (data) {
...
for (let i = 0; i < expected_arrivals_rooms.length; i++) {
    

    // Get the value of the input with id `id_mst_guest_form_<key>`
    var id_mst_guest_by_room = $('#id_mst_guest_form_' + expected_arrivals_rooms[i].key).val();
	 var room_check_folio_guest = $('#room_check_folio_guest_' + expected_arrivals_rooms[i].key).val();
    
    // Push the object with the key and value into the guest_room array
    guest_room.push({
        id_room_no: expected_arrivals_rooms[i].key,
        id_mst_guest: id_mst_guest_by_room,
		id_folio_guest: room_check_folio_guest
    });
}
			userRoomByGuest(resvId, id_mst_room_types, checkin_time, JSON.stringify(guest_room));
			
          searchArrivals();
          roomStats();
          // alert(data);
         //bootbox.alert(data);
		  //$(".btn-secondary").modal("hide");
		 // $('.bootbox').modal('hide');
		 bootbox.alert(data, function() {
    // Callback function after the alert is closed
    $(".btn-secondary").modal("hide");  // Hides a modal with the .btn-secondary class
    $('.bootbox').modal('hide');         // Hides any Bootbox modal
});
        }
      });
  }
 ...
 /* function updateCheckinTime(resvId, id_mst_room_types, today = "", pending_folio_id, check_checkout_date) {
    if (check_checkout_date) {
        bootbox.alert("System date and day close date mismatch, so you cannot check in.");
        return false;
    }

    var expected_arrivals_rooms = $("input[name='expected_arrivals_rooms[]']").map(function () {
        if ($(this)[0].checked && !$(this).data('is_confirm')) {
            return {
                key: $(this).data('room_id'),
                value: $(this).val()
            };
    ...
    $.ajax({
        type: "POST",
        url: "ajax/ajaxGetFolioWithRooms.php",
        data: {
            id_mst_room_types: id_mst_room_types,
            reservation_id: resvId,
            today: today,
            expected_arrivals_rooms: JSON.stringify(expected_arrivals_rooms)
        },
 ...
 var text = result.text;
             //if (text == "") {
                //text = '<div class="form-group"><label for="selectInput">New Folio:</label><select data-folio="0" class="form-control selectInput" id="selectInput_0"></select></div>'
            //  }
var folioLinked =result.folioLinked;
if (folioLinked != "") {
                folioLinked2 = `<div class="form-group"><label>${result.folioLinked}</label></div>`;
             }else{
				 folioLinked2 ='';
				 }
            ...
            bootbox.dialog({
                ...
                message: `
                    <div class="form-group">
                        <label>Checkin Date: ${today}</label>
                    </div>
                    <div class="form-group">
                    ...
                    ${folioLinked2}
                    ${result.text}${result.RoomCheckinList}
                `,
                buttons: {
                    cancel: {
                        label: "Cancel",
	...
	if(id_mst_guest_by_room==''){
		
		var check_id_mst_guest_by_room=0;
		}
}
...
//alert(JSON.stringify(guest_room));
                            var checkin_time = $('#timeInput').val();
                            var room_no = [];
                            ...
                            if (checkin_time!=''   && check_id_mst_guest_by_room!=0) {
                                userCheckIn(resvId, id_mst_room_types, checkin_time, JSON.stringify(room_no));
								//userRoomByGuest(resvId, id_mst_room_types, checkin_time, JSON.stringify(guest_room));
								//searchArrivals();
          						//roomStats();
            ...
            if (text !== "") {
                var roomOptions = result.roomOptions;
                Object.entries(roomOptions).forEach(([key, room]) => {
                    $(`#selectInput_${key}`).append(room);
                });
            }
        },
        error: function (xhr, status, error) {
            console.error("Error: " + error);
            bootbox.alert("An error occurred while fetching room data.");
        }
    });
}
 ...
 */
 function updateCheckinTime(resvId, id_mst_room_types, today = "", pending_folio_id, check_checkout_date) {
    ...
    $.ajax({
        type: "POST",
        url: "ajax/ajaxValidateBeforeCheckin.php", // ðŸ" Create this PHP file
        data: {
            reservation_id: resvId,
            id_mst_room_types: id_mst_room_types,
			 expected_arrivals_rooms: JSON.stringify(expected_arrivals_rooms)
        ...
        success: function (validateResponse) {
            var result = JSON.parse(validateResponse);

            if (!result.allow) {
                bootbox.alert(result.message || "Check-in not allowed.");
                return;
            }

            // ðŸ"' Step 2: Check day-close mismatch
            if (check_checkout_date) {
                bootbox.alert("System date and day close date mismatch, so you cannot check in.");
                return false;
            }

            // âœ… Step 3: Gather selected room data
            var expected_arrivals_rooms = $("input[name='expected_arrivals_rooms[]']").map(function () {
                if ($(this)[0].checked && !$(this).data('is_confirm')) {
                    return {
                        key: $(this).data('room_id'),
            ...
            // ðŸ" Step 4: AJAX call to get folios and room data
            $.ajax({
                type: "POST",
                url: "ajax/ajaxGetFolioWithRooms.php",
                data: {
                ...
                success: function (response) {
                    var result = JSON.parse(response);
                    var text = result.text || '';
                    var folioLinked2 = result.folioLinked
                        ? `<div class="form-group"><label>${result.folioLinked}</label></div>`
                        : '';

                    // ðŸ§© Step 5: Bootbox dialog
                    bootbox.dialog({
                        title: "Checkin Time",
                        message: `
                            <div class="form-group">
                        ...
                        buttons: {
                            ...
                            confirm: {
                                ...
                                callback: function () {
                                    ...
                                    for (let i = 0; i < expected_arrivals_rooms.length; i++) {
                                        var key = expected_arrivals_rooms[i].key;
                                        var id_mst_guest_by_room = $('#id_mst_guest_form_' + key).val();
                                        var room_check_folio_guest = $('#room_check_folio_guest_' + key).val();
                                    ...
                                    if (!checkin_time) {
                                        bootbox.alert("Please select a check-in time.");
                                        return false;
                                    }

                                    if (check_id_mst_guest_by_room === 0) {
                                        bootbox.alert("Please assign guest(s) to selected room(s).");
                                        return false;
                                    }
        ...
        $('#timeInput').val(currentTime);
                ...
                error: function () {
                    bootbox.alert("Error loading check-in details.");
                }
            });
        },
        error: function () {
            bootbox.alert("Something went wrong during validation.");
        }
    });
}
...
<script>
 ...
 var selectedDate = $('#startDateInput').val();
  ...
  window.appCalendar = new FullCalendar.Calendar(calendarEl, {
    ...
    selectable: true,
    defaultDate: moment(selectedDate).subtract(2, 'days').format('YYYY-MM-DD'),
    slotLabelFormat: [{
      day: "2-digit",
      weekday: "short"
    }],
    ...
    eventMouseEnter: function (calEvent) {
      //alert(JSON.stringify(calEvent.event));
      // console.log(calEvent.event);

      $.ajax({
        type: "POST",
        url: "ajax/popup_event.php",
        data: "&id=" + calEvent.event.id + '&booking_no=' + calEvent.event.extendedProps.booking_no,
        success: function (response) {
          var response = JSON.parse(response);
          var id = response['id_value'];
          var enc_id = response['enc_id'];
          var pendingCheckin = response['pendingCheckin'];
          ...
          var tooltip =
            '<div  id="removepopup" onmouseLeave="tooltippopup()" class="tooltipevent container-fluid"><div class="card1"><h1 class="titlee">Guest Information <span style="float:right;font-size:20px;" onclick="normalImg(this)"> <span class="glyphicon glyphicon-remove"></span> </span></h1><table id="customers1"> <tr> <tr><td>Guest Name</td><td>' +
            guest_name + '</td></tr><tr><td>Booking No</td><td>' + booking_no +
            '</td></tr><tr><td>Source</td><td>' + source + '</td></tr></table>';
          tooltip += '<ul class="social-icons">';
          tooltip +=
            '<li><a href="#" class="btn btn-success"  onclick="ReservationSingleFormOnMouseOver(\'' +
            enc_id + '\');" > <span class="glyphicon glyphicon-edit"></span> Edit</a></li>';
          if (pendingCheckin == '1' && calEvent.event.extendedProps.checkin_status == '0') {
            tooltip += '<li><a href="#"><button type="button" onclick="userCheckInCalendar(\'' + enc_id +
              '\',\'' + calEvent.event.extendedProps.id_mst_room_types + '\',\'' + calEvent.event
              .extendedProps.id_room + '\',\'' + calEvent.event.extendedProps.order_by_room +
              '\');" class="btn btn-success" id="Checkin" style="padding:5px 5px;"> <span class="glyphicon glyphicon-ok"></span> CheckIn</button></a></li>';

          }
          //tooltip += '<li><a href="#"><button type="button" class="btn btn-success" id="Checkin" style="padding:5px 5px;"> <span class="glyphicon glyphicon-ok"></span> CheckIn</button></a></li>';
          //tooltip += '<li><a href="#"><button type="button" class="btn btn-warning" id="Checkout" style="padding:5px 5px;"><span class="glyphicon glyphicon-remove"></span> CheckOut</button></a></li>';
          tooltip +=
            '<li><button onclick="normalImg(this)" type="button" class="btn btn-danger" data-dismiss="modal" style="padding:5px 5px;"> <span class="glyphicon glyphicon-off"></span> Cancel</button></li></ul></div></div>';
          $("body").append(tooltip);
          //$("#reservationModal").modal("show");
        }
      });

      //reservation_id,room_type,id_room,order_by_room
      //$("body").append(tooltip);
    ...
    select: function (info) {
      ...
      var hotels = id_hotel.split('-');
      var id_hotel = hotels[0];
      var hotelname = hotels[1];
      let id_room = 0;
      id_room = info.resource._resource.parentId == "" ? info.resource._resource.id : info.resource._resource
        .parentId;
      /* Setting vaules in reserve form */

      let roomType = info.resource._resource.parentId == "" ? info.resource._resource.title : window.appCalendar
        .getResourceById(info.resource._resource.parentId).title;
      let label = 'Room : ' + roomType + ',Checkin : ' + moment(checkin).format('DD-MM-YYYY') + ',Checkout : ' +
        moment(checkout).subtract(1, 'days').format('DD-MM-YYYY');
      $("#reservationModalLabel").html(label);
      $("#res_checkinDate").val(checkin);
      $("#res_checkOutDate").val(checkout);
      $("#res_hotelName").val(hotelname);
      $("#res_room").val(id_room);
      $("#id_mst_hotels").val(id_hotel);
      ...
      ReservationSingleFormCalander('', 'New Reservation Form', id_room, id_hotel, checkin, checkout);
      hotelnameget(1);
  ...
  $(document).ready(function () {
    ...
    $(document).on('change', '#bookingType', function () {
      ...
      if (bookingTypeId == 1) {
        var directGuest =
          "<option value='Guest Company1'>Guest Company1</option><option value='Guest Company2'>Guest Company2</option><option value='Guest Company3'>Guest Company3</option>";
        $("#bookingSource").html(directGuest);
      } else if (bookingTypeId == 2) {
        var travelAgent =
          "<option value='Travel Agent1'>Travel Agent1</option><option value='Travel Agent2'>Travel Agent2</option><option value='Travel Agent3'>Travel Agent3</option>";
        $("#bookingSource").html(travelAgent);
      } else if (bookingTypeId == 3) {
        var corporate =
          "<option value='Corporate1'>Corporate 1</option><option value='Corporate2'>Corporate2</option><option value='Corporate3'>Corporate3</option>";
    ...
    $(document).on('change', '#rateType', function () {
      ...
      if (rateType == "Adoc") {
        var directGuest =
          "<option value='Adoc1'>Adoc1</option><option value='Adoc2'>Adoc2</option><option value='Adoc3'>Adoc3</option>";
        $("#rateLetter").html(directGuest);
      } else if (rateType == "Contract") {
        var travelAgent =
          "<option value='Contract1'>Contract1</option><option value='Contract2'>Contract2</option><option value='Contract3'>Contract3</option>";
...
<script type="text/javascript">
  ...
  */
  ...
  $(document).ready(function () {
    ...
    $("#roomsRates").on("click", function () {
      ...
      if (rrcounter < list_maxField) {
        ...
        var list_fieldHTML =
          '<tr><td><select class="form-control parsley-error" name="roomtype[]" id="roomtype' + rrcounter +
          '" onchange="roomtypechange(this.id,this.value);"  style="width: 140px;"></select> <input value="" type="hidden" name="roomno[]" id="roomno' +
          rrcounter +
          '" class="form-control" ></td><td><select class="form-control parsley-error" name="plan[]" id="plan' +
          rrcounter +
          '" onchange="getval(this.id)" style="width: 110px;"></select><input type="hidden" name="plantype[]" id="plantype' +
          rrcounter +
          '" value=""></td><td class="form-group" style="display:inline-flex"><select name="noofRooms[]" id="noofRooms' +
          rrcounter +
          '" onchange="countcolorchange(this.id);tariffCalculation(this.id,this.value);" class="form-control parsley-error"  style="width: 80px;"><option value="">Rooms</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option></select></td><td><select class="form-control parsley-error" name="adultperroom[]" id="adultperroom' +
          rrcounter +
          '" style="width: 70px;"><option value="1">1</option><option selected="selected"class="2">2</option><option class="3">3</option></select></td><td><select class="form-control parsley-error" name="childbelow[]" id="childbelow' +
          rrcounter +
          '" style="width: 70px;"><option selected="selected" value="0">0</option><option value="1">1</option><option class="2">2</option></select></td><td><select class="form-control parsley-error" name="childabove[]" id="childabove' +
          rrcounter +
          '"  style="width: 70px;"><option selected="selected" value="0">0</option><option value="1">1</option><option class="2">2</option></select></td><td style="display:inline-flex"><input type="text" class="form-control parsley-error" style="width: 60px;" name="tariffperroom[]" value="0" onkeyup="tariffCalculation(this.id,this.value);"  id="tariffperroom' +
          rrcounter + '" /><a class="btn btn-success btn-sm" id="night' + rrcounter +
          '" onclick="id_get_night(this.id)"><i class="fa fa-edit"></i></a></td><td><input type="text" class="form-control parsley-error" style="width: 70px;" name="taxes[]" id="taxes' +
          rrcounter +
          '" value="" readonly /></td><td style="display:inline-flex"><input type="text" class="form-control parsley-error" style="width: 60px" name="tariffperroomtax[]" id="tariffperroomtax' +
          rrcounter +
          '" onkeyup="tariffCalculation(this.id,this.value);" value="" /><a class="btn btn-success btn-sm" id="itform' +
          rrcounter +
          '"  onclick="id_get_night(this.id)"><i class="fa fa-edit"></i></a></td><td><input type="text" class="form-control parsley-error" style="width: 70px;" value="" name="chargespernight[]" id="chargespernight' +
          rrcounter +
          '"  readonly /></td><td><button class="btn btn-danger roomsRates_remove" type="button"><i class="fa fa-trash"></i></button></td></tr>';
        ...
        $.ajax({
          ...
          data: {
            id_room: id_room,
            id_hotel: id_hotel,
            res_checkinDate: res_checkinDate,
            res_checkOutDate: res_checkOutDate
          },
          dataType: "JSON",
          success: function (data) {
            // alert(data);
    ...
    $("#addons_row").on("click", function () {
      ...
      if (addonscounter < list_maxField) {
        ...
        var list_fieldHTML =
          '<tr><td><select class="form-control parsley-error" style="width: 120px;" name="item[]" id="item' +
          addonscounter +
          '"><option selected="selected" value="">Select Item</option><option value="Item1">Item1</option><option class="Item2">Item2</option></select></td><td><input type="text" class="form-control parsley-error" style="width:140px;" name="additionalcharges[]" value="" id="additionalcharges' +
          addonscounter +
          '" /></td><td><input type="text" class="form-control parsley-error" style="width:100px;" name="qty[]" id="qty' +
          addonscounter +
          '" /></td><td><select class="form-control parsley-error" style="width: 120px;" name="unit[]" id="unit' +
          addonscounter +
          '"><option selected="selected" value="">Select Unit</option><option value="Day">Day</option><option class="Nos">Nos</option></select></td><td><input type="text" class="form-control parsley-error" style="width:110px;" name="rate[]" id="rate' +
          addonscounter +
          '" /></td><td><input type="text" class="form-control parsley-error" style="width:110px;" name="tax[]" id="tax' +
          addonscounter +
          '" /></td><td><input type="text" class="form-control parsley-error" style="width:110px;" name="taxvalue[]" id="taxvalue' +
          addonscounter +
          '" /></td><td><input type="text" class="form-control parsley-error" style="width:110px;" name="amount[]" id="amount' +
          addonscounter +
          '" value="" /></td><td><button class="btn btn-danger addons_remove" type="button"><i class="fa fa-trash"></i></button></td></tr>'; //New input field html 
    ...
    $("#payments_row").on("click", function () {
      ...
      if (paymentscounter < list_maxField) {
        ...
        var list_fieldHTML =
          '<tr><td><select onchange="payment_mode(this.id)" class="form-control parsley-error" style="width: 250px;" name="mode[]" id="mode' +
          paymentscounter +
          ...
          paymentscounter +
          '" /></td><td><input type="text" class="form-control parsley-error" style="width:250px;" name="amount[]" id="amount' +
          paymentscounter +
          '" /></td><td><button class="btn btn-danger payment_remove" type="button"><i class="fa fa-trash"></i></button></td></tr>'; //New input field html  
  ...
  function payment_mode(clicked_id) {
    ...
    if (mode == 'Cash') {
      var val = "Cash Details";
    }
    if (mode == 'Card') {
      var val = "Card Number";
    }
    if (mode == 'Online Transfer') {
      var val = "Reference number";
    }
    if (mode == 'Cheque') {
      var val = "Cheque Details";
    }
    if (mode == 'Gift Voucher') {
      var val = "Gift Voucher Details";
    }
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $("#reservationDetailss").submit(function (e) {
      ...
      var strtDt = new Date(res_checkinDate);
      var endDt = new Date(res_checkOutDate);
      var flag = 0; // false

      if (endDt <= strtDt) {
        flag = 1; // true
        alert("Check in and checkout date can’t be same.");
        exit;
      }
...
<?php if($_REQUEST['p']=='6' && $_REQUEST['folio']!=''){?>
 <script>
  
  $(document).ready(function () {
    folioTabDetails(<?php echo $_REQUEST['folio'];?>);
  
  });
    //$("#tab_3,#tab_1,#tab_2,#tab_4,#tab_5,.nav-tabs li").removeClass("active");
    //$("#tab_6,#folio_tab").addClass("active");
    //folioDetails('581');
    //folioTabDetails('581');//InvoiceDetails('581', '');//folioTabDetails('581');
...
<script>
  $('#tabs1').click(function () {
    ...
    if (id_mst_hotels >= 1) {
      $('col').removeAttr("style");InvoiceDetails(id, folio_type = '');
    }
...
<script>
  ...
  function id_get_night(clicked_id) {
    ...
    for (var i = 0; i < DiffDays; i++) {
      ...
      var list_fieldHTML = '<tr name="rows' + count + i + '" id="rows' + count + i +
        '"><td><input style="width:95px;" type="text" name="bd_date[]" id="bd_date' + count + i + '" value="' +
        dates_new +
        '" class="form-control"></td><td> <select class="form-control parsley-error" name="bd_plan[]" id="bd_plan' +
        count + i +
        '" style="width: 110px;"></select> </td><td><input value="0" type="text" name="bd_tariff[]"  id="bd_tariff' +
        count + i +
        '" class="form-control" onkeyup="bd_basevalue(this.id)"></td><td><input value="0" type="text" name="bd_food[]" id="bd_food' +
        count + i +
        '" class="form-control" onkeyup="bd_basevalue(this.id)"></td><td><input value="0" type="text" name="bd_extrabed[]" id="bd_extrabed' +
        count + i +
        '" class="form-control" onkeyup="bd_basevalue(this.id)"></td><td><input value="0" type="text" name="bd_extrachild[]" id="bd_extrachild' +
        count + i +
        '" class="form-control" onkeyup="bd_basevalue(this.id)"></td><td><input value="0" type="text" name="bd_price[]" id="bd_price' +
        count + i + '" class="form-control" readonly></td><td><input value="0" type="text" name="bd_tax[]" id="bd_tax' +
        count + i +
        '" class="form-control" onkeyup="bd_basevalue(this.id)"></td><td><input value="0" type="text" name="bd_intax[]" id="bd_intax' +
        count + i + '" class="form-control" readonly></td></tr>'; //New input field html 
  ...
  function source_labelchange() {
    ...
    $.ajax({
      ...
      type: 'POST',
      data: {
        id: id_mst_attributes_company_group
      },
      dataType: "JSON",
      success: function (data) {
...
$("#newbookerpopupform").submit(function () {
        ...
        $.ajax({
          ...
          success: function (result) { 
			...
			//$("#id_mst_company_contacts_new")[0].reset();
  ...
  /*function bookeredit() {
    ...
    /*  $("#newbookerpopupform").submit(function () {
        ...
        $.ajax({
          url: "ajax/ajaxSaveBookerEdit.php",
          data: $("#newbookerpopupform").serialize() + "&id=" + search_name,
          type: "POST",
          dataType: 'JSON',
  ...
  function list_ajax123() {
      ...
      columns: [{
        ...
        },
        {
          ...
          "render": (data, type, row, meta) =>
            `<a href="#" onclick="reservationDetails(${data});"><img height="20px" src="../images/view2.png" style="cursor:pointer;" title="View  "></a>`
        },
      ],
    });
    $('#BookingList').DataTable({
    ...
    //$('#BookingList').DataTable({order:[[id,"DESC"]]});
    /* 
    $.ajax({
  ...
  function bookerby_labelchange2(res_source, res_bookerName) {
    ...
    $.ajax({
      ...
      type: 'POST',
      data: {
        id_mst_company: res_source,
        'res_bookerName': res_bookerName
      },
  ...
  function getFolioInvoiceDetails(field) {
    var id = $(field).val();
    var folio_type = $(field).data('folio_type');
    InvoiceDetails(id, folio_type);
  }

  function InvoiceDetails(id, folio_type = '') {
    if (folio_type == 'main') {
      $('#sub_folio_id').empty();
    }
    //$('#res_bookerName').html('<option>Select Booker Name</option>');  
  ...
  function getSubFolio(id_folio) {
    $.ajax({
      type: "POST",
      url: 'ajax/ajaxGetSubFolio.php',
      data: {
        id_folio: id_folio
      },
      success: function (data) {
        $('#sub_folio_id').append(data);
      }
    });
  }
  ...
  function changeFolioStatus(status, id_fo_folio, id_reservation, id_fo_bill, ReservationAvaliable, BalanceAmount) {
    //var d= validateCheckoutStatus(id_fo_bill,id_reservation);
    ///alert(d+'shafeer');

    if (BalanceAmount > 0 || BalanceAmount < 0) {
      bootbox.alert({
        title: "Folio Bill Pending",
        message: "Please Close bill first",
        backdrop: true
      });
      return false;
    }
    bootbox.confirm({
      ...
      callback: function (result) {
        $("#select_foliostatus").each(function () {
        ...
        if (result == true) {
          $.ajax({
            ...
            data: 'status=' + status + '&id_fo_folio=' + id_fo_folio + '&id_reservation=' + id_reservation +
              '&id_fo_bill=' + id_fo_bill + '&ReservationAvaliable=' + ReservationAvaliable,
            success: function (result) {
              if (result == 0) {
                bootbox.alert({
                  title: "Checkout",
                ...
                bootbox.alert({
                  title: "Folio",
                  message: "Sub folio, FO Bill not Generate. or Receipt Balance Is Pending. pls close",
                  backdrop: true
                });
              } else {
                bootbox.alert({
                  title: "Folio",
                  message: "Folio Closed Sucessfully",
                  backdrop: true
                });
				folioDetails();
  ...
  function ajaxGenerateBill(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room, id_folio) {

    //alert('ajaxGenerateBill');
    $.ajax({
      type: "GET",
      url: 'ajax/ajaxgetDocumentNo.php',
      data: 'id_mst_hotels=' + id_mst_hotels + '&id_fo_bill=' + id_fo_bill + '&id_reservation=' + id_reservation +
        '&doc_type=' + doc_type + '&id_room=' + id_room+'&id_folio='+id_folio,
      success: function (result) {
  ...
  function updateCheckoutTime(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room, checkout_time='') {
    ...
    $.ajax({
        ...
        success: function(result) {
            let datas = JSON.parse(result);
//alert(datas.checkoutdate);
            // Check the response status
            if (datas.status === 5) {
                // Proceed with checkout date update if the status is 5
                UpdateCheckoutDate(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room, checkout_time);
            } else {
				 if (datas.status == 1) {
				
				$("#folio_checkout_display").html(datas.checkoutdate);
				
				 }
                // Show an error message in a Bootbox alert if status is not 5
                bootbox.alert({
                    title: "Checkout",
        ...
        error: function(xhr, status, error) {
            ...
            bootbox.alert({
                title: "Error",
                message: "An error occurred while updating checkout time: " + error,
                backdrop: true
            });
        }
    });
  ...
  function UpdateCheckout(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room, is_pre_checkout, check_checkout_date,CheckFoBillStatus,BalanceAmount) {

    if (check_checkout_date) {
      bootbox.alert("you are in wrong date, pls do Day Close");
      return false
    }
	// if (CheckFoBillStatus==0) {
  //     bootbox.alert("Please Generate FO Bill.");
  //     return false
  //   }
	// if (BalanceAmount>0) {
  //     bootbox.alert("Your Receipt Balance Is Pending.");
  //     return false
  //   }

  $.ajax({
        type: "post",
        url: 'ajax/ajaxGetPendingFolio.php',
        data: {
            id_fo_bill: id_fo_bill,
        },
        success: function(result) {
          ...
          if (Object.keys(data).length > 0) {
            ...
            updateCheckoutAfterFolio(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room, is_pre_checkout);
          }
        }
  });
}

function updateCheckoutAfterFolio(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room, is_pre_checkout) {
  const message = is_pre_checkout ? "Do you want to Pre-Checkout?" : "Do you want to Checkout?";
  bootbox.confirm({
        title: "Checkout",
        message: message,
        buttons: {
        ...
        callback: function (confirmed) {
            if (confirmed) {
                ...
                bootbox.prompt({
                    title: 'Checkout Time',
                    inputType: 'time', value: currentTime,
                    callback: function (checkoutTime) {
                        if (checkoutTime === null) {
                            return;
                        }
                        if (checkoutTime.trim() === '') {
                            bootbox.alert("Please select a time.");
                        } else {
                            if (is_pre_checkout) {
                                UpdateCheckoutDate(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room, checkoutTime);
                            } else {
                                updateCheckoutTime(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room, checkoutTime);
                            }
                        }
                    }
                });
  ...
  function UpdateCheckoutDate(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room, checkout_time='') {
    var requestData = {
        id_mst_hotels: id_mst_hotels,
        id_fo_bill: id_fo_bill,
        id_reservation: id_reservation,
    ...
    $.ajax({
        ...
        success: function (result) {
          console.log(result);
            try {
                ...
                bootbox.alert({
                    title: "Error",
                    message: "An error occurred while processing your checkout request.",
                    backdrop: true
                });
            }
        },
        error: function (xhr, status, error) {
            ...
            bootbox.alert({
                title: "Error",
                message: "There was an issue with the checkout process. Please try again.",
                backdrop: true
            });
        }
    });
  ...
  function paymenForm(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room, amount) {
    ...
    $.ajax({
      ...
      data: 'id_mst_hotels=' + id_mst_hotels + '&id_fo_bill=' + id_fo_bill + '&id_reservation=' + id_reservation +
        '&doc_type=' + doc_type + '&id_room=' + id_room + '&amount=' + amount,
      success: function (result) {
        $('#cancelpop').popup({
          transition: 'all 0.3s',
          autoopen: true,
          ...
          $.ajax({
            ...
            success: function (result) {
              ...
              if (response.status == '1') {
                $('#auditDate').html('Date Open : '+response.dated);
  ...
  //Room  Statistics	start============================================================


  function ChangeReservationData(id, id_mst_room_no_allocation, order_by_room) {

    $.ajax({
      type: "POST",
      url: 'ajax/ajaxChangeReservationForm.php',
      data: 'selectType=view&id=' + id + '&id_mst_room_no_allocation=' + id_mst_room_no_allocation +
        '&order_by_room=' + order_by_room,
      success: function (result) {
        $("#EditReservationModal").modal('show');
  ...
  function ChangeRoomNumber(id, id_mst_room_no_allocation) {

    $.ajax({
      type: "POST",
      url: 'ajax/ajaxChangeRoomNumber.php',
      data: 'selectType=view&id=' + id + '&id_mst_room_no_allocation=' + id_mst_room_no_allocation,
      success: function (result) {
        $("#EditReservationModal").modal('show');
        $('#EditReservationForm').html(result);
  ...
  function fillLeft(from, checkout, till, id) {
    ...
    var fillVal = $("#tariffperroom_" + till).val();

    var end = new Date(checkout);
    var start = new Date(till);
    ...
    while (start <= end) {
      ...
      $("#tariffperroom_" + date).val(fillVal);

      start.setDate(start.getDate() + 1);
      tariffCalculationEdit(date, fillVal);

    }
    //subtotalCalculation();
  }

  function fillRight(from, checkout, dated, id) {

    var fillVal = $("#tariffperroom_" + dated).val();


    var end = new Date(dated);
  ...
  //======================================================================
  function fillLeftInc(from, checkout, till, id) {

    var fillVal = $("#tariffperroomtax_" + till).val();
    //alert(fillVal);
    var end = new Date(checkout);
    var start = new Date(till);
    ...
    while (start <= end) {
      ...
      $("#tariffperroomtax_" + date).val(fillVal);

      start.setDate(start.getDate() + 1);
      tariffCalculationIncEdit(date, fillVal);

    }
    //	subtotalCalculation();
  }

  function fillRightInc(from, checkout, dated, id) {

    var fillVal = $("#tariffperroomtax_" + dated).val();
  ...
  function tariffCalculationIncEdit(id, value) {


    var items = [];
    var x = id;
    var item = {
      roomtype: $("#roomtype_" + x).val(),
      plan: $("#plan_" + x).val(),
      noofRooms: $("#noofRooms_" + x).val(),
      adultperroom: $("#adultperroom_" + x).val(),
      childbelow: $("#childbelow_" + x).val(),
      childabove1: $("#childabove1_" + x).val(),
      tariffperroom: $("#tariffperroom_" + x).val(),
      taxes: $("#taxes_" + x).val(),
      tariffperroomtax: $("#tariffperroomtax_" + x).val(),
      chargespernight: $("#chargespernight_" + x).val()
    ...
    var res_checkOutDate = document.getElementById("res_checkOutDate").value;
    var reservation_date = res_checkinDate + ' to ' + res_checkOutDate;
    var total_addon_price = $("#total_addon_price").val();
    var discount = $("#discount").val();
    var balance = $("#balance").val();
    var total_addon_price = $("#total_addon_price").val();
    var net_booking_amount = $("#net_booking_amount").val();
    var total_taxes = $("#total_taxes").val();
    var payment_received = $("#payment_received").val();
    //alert('LOad');
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        var x = id;
        //for(var y=0;y<=result.length;y++){alert(result.Data[y].tariffperroom);
        $("#tariffperroom_" + x).val(result.Data[0].tariffperroom);
        $("#taxes_" + x).val(result.Data[0].taxes);
        $("#tariffperroomtax_" + x).val(result.Data[0].tariffperroomtax);
        $("#chargespernight_" + x).val(result.Data[0].chargespernight);
  ...
  function tariffCalculationEdit(id, value) {
    ...
    $.ajax({
      type: "POST",
      url: 'ajax/ajaxTariffExceCalculation.php',
      data: {
        "reservation_date": reservation_date,
        "id_hotel": id_hotel,
        "total_addon_price": total_addon_price,
      ...
      success: function (result) {
        ...
        /*$("#subtotal").val(result.subtotal);
        $("#total_taxes").val(result.total_taxes);
        $("#net_booking_amount").val(result.total);
        $("#payment_received").val(result.payment_received);
        $("#balance").val(result.balance);
        $("#additional_charges").val(result.additional_charges);*/
        var x = id;
  ...
  function subtotalCalculation() {
    ...
    var checkin_extend_date = $("#checkin_extend_date").val();
    var checkout_extend_date = $("#checkout_extend_date").val();


    var checkinarray = checkin_extend_date.split('-');
    var checkoutarray = checkout_extend_date.split('-');



    var end = new Date(checkoutarray[2] + "-" + checkoutarray[1] + "-" + checkoutarray[0]);
    var start = new Date(checkinarray[2] + "-" + checkinarray[1] + "-" + checkinarray[0]);
    var tariffperroomtaxsum = 0;
    var tariffperroomsum = 0;
    var taxessum = 0;
    while (start < end) {
      //alert(start);
      ...
      var date = (year + '-' + month + '-' + day);
      //alert(date);
      tariffperroomsum += parseFloat($("#tariffperroom_" + date).val());
      taxessum += parseFloat($("#taxes_" + date).val());
      tariffperroomtaxsum += parseFloat($("#tariffperroomtax_" + date).val());


      start.setDate(start.getDate() + 1);

    } // alert(taxessum);
    $("#room_tariff_price").val(parseFloat(tariffperroomsum).toFixed(2));
    $("#total_tax_edit").val(parseFloat(taxessum).toFixed(2));
    $("#net_booking_amount_edit").val(parseFloat(tariffperroomtaxsum).toFixed(2));
    $("#balance_edit").val(parseFloat(tariffperroomtaxsum).toFixed(2));


  }

  function saveEditReservationForm() {

    $.ajax({
      url: "ajax/ajaxSaveEditReservation.php",
  ...
  function saveAmendmentStayform() {

    $.ajax({
      url: "ajax/ajaxAmendmentStayform.php",
      data: $("#AmendmentStayform").serialize(),
      type: "POST",
      success: function (data) {
         $("#ExtedDateModal").modal("hide");
        alert(data);
        roomStats();
      }
    });
  ...
  function roomAllocationPopup(id_hotel, id_room, id_reservations, res_checkinDate, res_checkOutDate) {
    //alert('1');
...
//$('#roomtype'+matches).click(); 
   //alert(matches[0]);
   $('#idcount_color').val(matches[0]);*/
    $("#roomAllocation_id_room").val(id_room);
    $("#roomAllocation_id_hotel").val(id_hotel);
    $("#roomAllocation_id_reservations").val(id_reservations);
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $('#roombuttonAllocation').html(data);
      }
    });
  }
  ...
  function UpdateroomAllocation() {
    ...
    $.ajax({
      url: "ajax/UpdateroomAllocation.php",
      data: $("#formroomAllocation").serialize(),

      success: function (data) {
        alert('Sucessfully Updated');
        $('#roomAllocationModal').modal('hide');
        //unassignedload();
        // $("#reservationModal").modal("hide");
        // window.appCalendar.refetchEvents()
      }
  ...
  /*function unassignedload(){
                ...
                $("#calendar_cart tbody").html(tableData);
                //initializeTableRoomAllocation("#calendar_cart", [1, 3, 4, 5],true);
  ...
  function searchArrivals() {
    ...
    $.ajax({
      'url': 'arrivals.php',
      'data': 'date=' + expectedarrivals,

      success: function (data) {
        $("#expectedarrivals_datalist").html(data);
      }
    });
  }
...
//Reload Cander End==========================================
  ...
  function list_ajax() {
    ...
    //});
    //  $('#BookingList').DataTable({order:[data,'asc']});
    //$('#BookingList').DataTable({order:[[id,"DESC"]]});
    /* 
    $.ajax({
      url: "ajax/ajaxListOnLoad.php",
...
<script type="text/javascript">
  ...
  function ajaxAddBillPaymentUnsettledFO(get_purch_id, savetype, id_receipt) {



    var dataString = 'get_purch_id=' + get_purch_id + '&savetype=' + savetype + '&id_receipt=' + id_receipt;
    $.ajax({
      type: "POST",
      url: 'ajax/ajaxAddBillPaymentFO.php',
      data: dataString,
  ...
  /*function saveUpdateRoomNumbers() {

    $.ajax({
      url: "ajax/ajaxUpdateRoomNumbers.php",
      data: $("#saveReservationDateform").serialize(),
      type: "POST",
      success: function (data) {
...
function saveUpdateRoomNumbers() {
    ...
    // 🔥 Initialize Parsley (important for AJAX-loaded form)
    form.parsley();
  ...
  function roomtypechangepopup(clicked_id, clicked_value) {
    ...
    var regex = /[+-]?\d+(?:\.\d+)?/g;
    var match = parseInt(regex.exec(clicked_id));
	var id_mst_room_no_allocation = document.getElementById("old_id_mst_room_no_allocation").value;


    $.ajax({
      url: "ajax/id_room_no_load.php",
      type: 'POST',
      data: {
        id_hotel: id_hotel,
        id_room: clicked_value,
  ...
  function nightAduitValidate(resId, pending, userid, id_mst_room_types,dated) {
    //  alert(userid);
    //$("#tr").html(tableData).toggle();
...
//tableData += `<div class="col-md-1 col-sm-1 col-xs-1"  style="padding-right:0px; margin-top: 2px; margin-left:0px; margin-right: 0px;"><button class="btn btn-block btn-primary"  onclick="selectRoom(${value.room_id},${datavalue},this.id,'`+ resId +`',`+ pending +`);" id="btn-`+resId+`-${datavalue}">${datavalue}</button></div> `;
  ...
  function getRoomDetails(resId, pending, userid, id_mst_room_types,dated) {
   // alert(dated);
    //$("#tr").html(tableData).toggle();
    $.ajax({
      type: "GET",
      ...
      success: function (result) {
        ...
        if (response.status == '1') {
          nightAduitValidate(resId, pending, userid, id_mst_room_types,dated);
        } else {
          alert(response.msg);
        }
  ...
  function ReservationSingleFormOnMouseOver(id) { 
    var id_hotel = $("#id_hotel").val();
    var BookingType = 'Edit';
    $.ajax({
      type: "POST",
  ...
  function ReservationSingleForm(id, BookingType,id_folio,id_room, id_hotel) {
    ...
    $.ajax({
      type: "POST",
      url: 'ajax/ReservationSingleForm.php',
      data: 'id=' + id + '&BookingType=' + BookingType + '&id_room=' + id_room + '&id_hotel=' + id_hotel+ '&id_folio=' + id_folio,
      success: function (result) {
        $("#EditReservationModal").modal('show');
        $('#EditReservationForm').html(result);
        $(".select3").select2({});
  ...
  function ReservationSingleFormCalander(id, BookingType, id_room, id_hotel, checkin, checkout) {
    //var id_hotel = $("#id_hotel").val();
    $.ajax({
      type: "POST",
      url: 'ajax/ReservationSingleForm.php',
      data: 'id=' + id + '&BookingType=' + BookingType + '&id_room=' + id_room + '&id_hotel=' + id_hotel +
...
if (res_payment_status.trim() === "") {
    ...
    if (id_mst_hotels.trim() === "" || id_mst_company_new.trim() === "" || id_mst_company_contacts_new.trim() === "" ||
      res_bookingStatus_new.trim() === "" || id_mst_guest_form.trim() === "" || res_payment_status.trim() === "") {
      return false;
    }
...
if(response.status=='0'){
          ...
          if (response.editid == '') {
            ...
            searchArrivalsInForm(response.id_fo_reservations);
          }
  ...
  function tariffCalculationNew(uncode) {
    ...
    $.ajax({
      ...
      data: {
        "res_tariff_per_room_per_night": res_tariff_per_room_per_night,
        "uncode": uncode
      },
      success: function (result) {
  ...
  function PostCharges(id, BookingType,id_folio) {
 ...
 /* function ValidateRoomSelected(roomNumber, roomId, checkboxValue) { alert(roomNumber+'============'+roomId+'============'+checkboxValue);
    ...
    $('input[name="expected_arrivals_rooms[]"]:checked').each(function () {
      ...
      if (selectedValues.length != roomNumber) { //alert('Count= '+selectedValues.length)
        ...
        $('input[name="expected_arrivals_rooms[]"][id="myCheckboxData_' + roomNumber + '_' + roomId + '"]').not(
          this).prop('disabled', false);alert('false');
        if (selectedValues.length == roomNumber) {

          $('input[name="expected_arrivals_rooms[]"][id="myCheckboxData_' + roomNumber + '_' + roomId + '"]').not(
            this).prop('disabled', true);
          var myArray = selectedValues.length;
          for (var i = 0; i < myArray; i++) {  alert('disabled');

            $('input[name="expected_arrivals_rooms[]"][class="roomdata_' + roomNumber + '_' + roomId + '_' +
              selectedValues[i] + '"]').not(this).prop('disabled', false);
        ...
        var checkbox = $('input[name="expected_arrivals_rooms[]"].roomdata_' + roomNumber + '_' + roomId + '_' +
          checkboxValue);
...
function ValidateRoomSelected(roomNumber, roomId, checkboxValue) {
    ...
    $('input[name="expected_arrivals_rooms[]"]').each(function () {
        // Push the value of each checked checkbox to the array
        if($(this)[0].checked && selectedValues.length != roomNumber) {
          selectedValues.push($(this).val());
        }
        if (selectedValues.length == roomNumber && $(this).attr('type') == "checkbox") {
    ...
    // If the length of selectedValues is less than roomNumber
    if (selectedValues.length <=roomNumber) {
        // Enable all checkboxes that are not currently checked
        $('input[name="expected_arrivals_rooms[]"][id^="myCheckboxData_' + roomNumber + '_' + roomId + '"]').prop('disabled', false);
        
        // If the number of selected values matches roomNumber
        if (selectedValues.length == roomNumber) {
            // Disable checkboxes that have not been selected
            $('input[name="expected_arrivals_rooms[]"]').not(':checked').prop('disabled', true);
        }
    } else {
        // Deselect the checkbox if more than roomNumber checkboxes are selected
        var checkbox = $('input[name="expected_arrivals_rooms[]"][class^="roomdata_' + roomNumber + '_' + roomId + '_' + checkboxValue + '"]');
        checkbox.prop('checked', false);
    }

    // Update the UI with the number of selected rooms
    $("#RoomCountSelected_" + roomNumber + "_" + roomId).html('Selected Room(' + selectedValues.length + ')');

    // Log the selected checkbox values and count
    console.log("Selected checkbox values: " + selectedValues.join(', '));
    console.log("Number of selected checkboxes: " + selectedValues.length);
}

/*function ValidateRoomSelected(roomNumber, roomId, checkboxValue, checkin_pending) {
    var selectedValues = [];

    if (roomNumber == checkin_pending) {
      $('input[name="expected_arrivals_rooms[]"]').not(':checked').prop('disabled', true);
      return false;
    }
    ...
    // If the length of selectedValues is less than roomNumber
    if (selectedValues.length <= checkin_pending) {
        // Enable all checkboxes that are not currently checked
        $('input[name="expected_arrivals_rooms[]"][id^="myCheckboxData_' + roomNumber + '_' + roomId + '"]').prop('disabled', false);
  ...
  function ChangeFolioGuest(id, BookingType, id_folio) {
    var id_hotel = $("#id_hotel").val();
    $.ajax({
      type: "POST",
      url: 'ajax/ajaxChangeFolioGuest.php',
      data: 'id=' + id + '&BookingType=' + BookingType + '&id_folio=' + id_folio,
      success: function (result) {
        $("#EditReservationModal").modal('show');
        $('#EditReservationForm').html(result);
  ...
  function nightAduitValidateSingleForm(resId, pending, userid, id_mst_room_types,dated) {
    ...
    var tr = "#tr_" + resId + "_" + id_mst_room_types;
    $.ajax({
      // url: 'ajax/ajaxGetRoomsSingleForm.php',
      url: 'ajax/ajaxGetRooms1.php',
      type: 'POST',
      data: {
        resId: resId,
  ...
  function getRoomDetailsSingleForm(resId, pending, userid, id_mst_room_types,dated) {
    //alert(userid);
    //$("#tr").html(tableData).toggle();
    $.ajax({
      type: "GET",
      ...
      success: function (result) {
        ...
        if (response.status == '1') {
          nightAduitValidateSingleForm(resId, pending, userid, id_mst_room_types,dated);
  ...
  function RoomAllocationsingleForm(resvId, id_mst_room_types) {
    ...
    if (expected_arrivals_rooms != '') {
      $.ajax({
        ...
        type: 'POST',
        data: 'resvId=' + resvId + '&id_mst_room_types=' + id_mst_room_types + '&dataselected=' +
          expected_arrivals_rooms, //{resvId : resvId,id_mst_room_types:id_mst_room_types},
        //dataType: 'JSON',
        success: function (data) {
          searchArrivals();
          roomStats();
  ...
  function userCheckInSingleForm(resvId, id_mst_room_types) {
  ...
  function userCheckInCalendar(resvId, id_mst_room_types, id_room, order_by_room) {



    if (resvId != '') {
      $.ajax({
        url: 'ajax/ajaxUserCheckInCalendar.php',
        type: 'POST',
        data: 'resvId=' + resvId + '&id_mst_room_types=' + id_mst_room_types + '&id_room=' + id_room +
          '&order_by_room=' + order_by_room, //{resvId : resvId,id_mst_room_types:id_mst_room_types},
        //dataType: 'JSON',
        success: function (data) {
          searchArrivals();
          roomStats();
      ...
      bootbox.alert("Please Select a Reservation");
    }

  }


  function LoadRoomAllocation() {
    var dateRangeReport = $("#dateRangeReport").val();
    var reference_no_search = $("#reference_no_search").val();
    var other_reference_no_search = $("#other_reference_no_search").val();

    $.ajax({
      url: 'newRoomAlloctionList.php',
      data: {
        date: dateRangeReport,
        reference_no_search: reference_no_search,
        other_reference_no_search: other_reference_no_search
      },
      dataType: 'json',
      success: function (data) {
        var tableData = '';
        data.forEach((value) => {
          tableData += `
                    <tr>
                        <td><a href="javascript:;" style="color:black;">${value.reservation_id}</a></td>
                        <td><a href="javascript:;" style="color:black;">${value.other_reservation_id}</a></td>
                        <td><a href="javascript:;" style="color:black;">${value.roomType}</a></td>
                        <td><a href="javascript:;" style="color:black;">${value.guest}</a></td>
                        <td><a href="javascript:;" style="color:black;">${value.source}</a></td>
                        <td><a href="javascript:;" style="color:black;">${value.checkIn}</a></td>
                        <td><a href="javascript:;" style="color:black;">${value.checkOut}</a></td>
                        <td><a href="javascript:;" style="color:black;">${value.NoOfRoom}</a></td>
                        <td><button class="btn btn-success btn-xs" onclick="showAll(${value.id});" title="view rooms"><i class="fa fa-eye"></i></button></td>
                    </tr>
                `;
        });

        var $calendarCart = $("#roomAllocationList");

        // Destroy existing DataTable instance if it exists
        if ($.fn.DataTable.isDataTable('#roomAllocationList')) {
          $calendarCart.DataTable().destroy();
        }

        // Update table body
        $calendarCart.find('tbody').html(tableData);

        // Initialize DataTable
        initializeTableRoomAllocation2("#roomAllocationList", [1, 4, 8], true);
      },
      error: function (xhr, status, error) {
        console.error('AJAX error:', status, error);
      }
  ...
  function initializeTableRoomAllocation2(target, targetArr, ordering = false) {
    $(target).DataTable({
      'paging': true,
      'lengthChange': false,
      'searching': true,
  ...
  /*function LoadRoomAllocation(){
	...
	var other_reference_no_search = $("#other_reference_no_search").val();	
                ...
                $.ajax({
                    'url':'newRoomAlloctionList.php',
                    'data':'date='+dateRangeReport+'&reference_no_search='+reference_no_search+'&other_reference_no_search='+other_reference_no_search,
                    'dataType':'JSON',
                    success:function(data){
                        var tableData = '';
                        data.forEach((value,key,arr)=>{
                     ...
                     //  $("#calendar_cart").DataTable().destroy();
               // $("#calendar_cart tbody").html(tableData);
                //initializeTableRoomAllocation("#calendar_cart", [1, 2,3, 4, 5]);    
  ...
  function showAll(id_fo_reservations) {

    $("#EditCheckinModal").modal('show');
    getAlloctionInForm(id_fo_reservations);
  }

 function getAlloctionInForm(id_fo_reservations) {
    var expectedarrivals = $("#expectedarrivals").val();
    
    $.ajax({
        url: 'roomAllocationList.php',
        type: 'GET', // It's better to use 'GET' for retrieving data
        data: {
            date: expectedarrivals,
            id_fo_reservations: id_fo_reservations
        },
         // Use 'json' instead of 'JSON'
        success: function(response) {
            // No need to parse the response; jQuery does this automatically
           // var content = response.reservation_id;
          
           // var response = JSON.parse(response);
          //var id = response['id_value'];
            // Example of updating HTML content
             $("#expectedarrivals_datalistInForm").html(response);
             var LoadAllocationText = $("#LoadAllocationText").val();
             $('#alloctiontitle').html(LoadAllocationText);
        },
...
function UpdateCheckoutRoomWise(id_reservation,id_room,id_fo_folio ,id_fo_bill, is_pre_checkout, check_checkout_date) {
  const message = is_pre_checkout ? "Do you want to Pre-Checkout?" : "Do you want to Checkout?";
...
if (check_checkout_date) {
                ...
                bootbox.prompt({
                    ...
                    callback: function (checkoutTime) {
                        ...
                        if (checkoutTime.trim() === '') {
                            ...
                            // Proceed with the checkout based on pre-checkout status
                            if (is_pre_checkout) {
                              UpdateCheckoutDateRoomWise(id_reservation,id_room,id_fo_folio ,id_fo_bill, checkoutTime);
                            } else {
                              updateCheckoutTimeRoomWise(id_reservation,id_room,id_fo_folio ,id_fo_bill, checkoutTime);
                            }
                        }
                    }
                });
 ...
 function UpdateCheckoutDateRoomWise(id_reservation,id_room,id_fo_folio ,id_fo_bill, checkout_time = '') {
    $.ajax({
      type: "GET",
      url: 'ajax/ajaxUpdateCheckoutRoomWise.php',
      data: 'id_fo_bill=' + id_fo_bill + '&id_reservation=' +
        id_reservation + '&id_fo_folio=' + id_fo_folio + '&id_room=' + id_room + '&precheckout=1&checkout_time='+checkout_time,
      success: function (result) {
        let datas = JSON.parse(result);
        bootbox.alert({
          title: "Checkout",
  ...
  function updateCheckoutTimeRoomWise(id_reservation,id_room,id_fo_folio ,id_fo_bill, checkout_time='') {
    $.ajax({
      type: "GET",
      url: 'ajax/ajaxUpdateCheckoutRoomWise.php',
      data: 'id_fo_bill=' + id_fo_bill + '&id_reservation=' +
        id_reservation + '&id_fo_folio=' + id_fo_folio  + '&id_fo_bill=' + id_fo_bill  + '&id_room=' + id_room + '&precheckout=0&checkout_time='+checkout_time,
      success: function (result) {
        let datas = JSON.parse(result);
        if (datas.status == 5) {
          UpdateCheckoutDateRoomWise(id_reservation,id_room,id_fo_folio ,id_fo_bill,checkout_time);
        } else {
          bootbox.alert({
            title: "Checkout",
            message: datas.message,
  ...
  function ChangeNoshowOff(id_reservation, id_mst_room_types, pending_rooms, GetOrderByRoom) {
  

    $("#NoShowOffModal").modal('show');
    $('#noshowoff_id').val(id_reservation);
    $('#id_RoomNoShowOff').val(id_mst_room_types);
	 $('#RoomNoShowOff_orderbyroom').val(GetOrderByRoom);

    // Build the select options based on GetOrderByRoom values
    let optionsHtml = '';
   let maxOptions = Math.min(pending_rooms, GetOrderByRoom.length);

    for (let i = 1; i <= maxOptions; i++) {
        // Here GetOrderByRoom[i] is used as the value and display text
        optionsHtml += `<option value="${i}">${i}</option>`;
    }

    // Update the modal content with the dynamically generated options
    $('#NoShowOffView').html(`
        <div class="form-group col-sm-6">
            <label for="checkin" style="float:left;">No Of Rooms :</label>
            <select class="form-control select2" name="RoomNoShowOff" id="RoomNoShowOff" style="width: 140px;">
                ${optionsHtml}
            </select>
        </div>
    `);
 ...
 /*function ChangeNoshowOff(id_reservation, id_mst_room_types, pending_rooms,GetOrderByRoom) { alert(pending_rooms);alert(GetOrderByRoom);
    
	$("#NoShowOffModal").modal('show');
 	$('#noshowoff_id').val(id_reservation);
	$('#id_RoomNoShowOff').val(id_mst_room_types);
    // Build the select options based on pending_rooms count
    let optionsHtml = '';
	optionsHtml += `<option value="0">--Select No Of Rooms--</option>`;
    for (let i = 1; i <= pending_rooms; i++) {
        optionsHtml += `<option value="${i}"> ${i}</option>`;
    }
...
function saveNoShowOffform(){
	
	
	  var noshowoff_id = $("#noshowoff_id").val();
	  var RoomNoShowOff = $("#RoomNoShowOff").val();
	  var id_RoomNoShowOff = $("#id_RoomNoShowOff").val();
    
    $.ajax({
        url: 'ajax/ajaxSaveNoshowOff.php',
        type: 'POST', // It's better to use 'GET' for retrieving data
         data: $("#NoShowOffform").serialize(),
         // Use 'json' instead of 'JSON'
        success: function(response) {
			
			
			$("#NoShowOffModal").modal('hide');			
			 bootbox.alert({
                title: "",
                message: 'Room Show Updated Sucessfully',
                backdrop: true
              });
           searchArrivals();
             // $("#expectedarrivals_datalistInForm").html(response);
	...
	function AddRemarks(id, BookingType, id_folio) {
    var id_hotel = $("#id_hotel").val();
    $.ajax({
      type: "POST",
      url: 'ajax/ajaxAddRemarksPopup.php',
      data: 'id=' + id + '&BookingType=' + BookingType + '&id_folio=' + id_folio,
      success: function (result) {
        $("#EditReservationModal").modal('show');
        $('#EditReservationForm').html(result);
  ...
  function AddnewCompany() {
    ...
    $.ajax({
      type: "POST",
      url: 'ajax/ajaxAddNewCompanyPopup.php',
      data: 'id=new',
      success: function (result) {
        $("#EditReservationModal").modal('show');
        $('#EditReservationForm').html(result);
 ...
 function getCompanyContact(companyId,contactId){	
  ...
  function FolioTransfer(id, BookingType, id_folio) {
    var id_hotel = $("#id_hotel").val();
...
$.each($("input[name='folio_split[]']:checked"), function(){                    
 ...
 //alert(folio_split);
    $.ajax({
      type: "POST",
      url: 'ajax/ajaxFolioTransfer.php',
      data: 'id=' + id + '&BookingType=' + BookingType + '&id_folio=' + id_folio+'&folio_split='+folio_split,
      success: function (result) {
        $("#EditReservationModal").modal('show');
        $('#EditReservationForm').html(result);
        $(".select3").select2({});
  ...
  function changeRoomType(reservation_id, id_mst_room_types, pending_rooms) {
      $.ajax({
          type: "POST",
          url: 'ajax/ajaxGetRoomTypeWithCount.php',
          data: 'reservation_id=' + reservation_id + '&id_mst_room_types=' + id_mst_room_types + '&pending_rooms=' + pending_rooms,
          success: function (result) {
              var data = JSON.parse(result);

               var room_type = data.room_type_text;
              var room_count = data.room_count_text;
              ...
              bootbox.dialog({
                  ...
                  message: `
                    ...
                    <div class="form-group">
                      <label for="room_count">Select Room:</label>
                      
                    </div>
					${data.html}
					<div class="form-group">
                      <label for="room_type">Migrate to:</label>
                      <select id="room_type_text" class="form-control">
                        <option value="">select</option>
                        ${room_type}
                      </select>
                    <div>`,
                  buttons: {
                      ...
                      confirm: {
                          ...
                          className: 'btn-primary',
                          callback: function () {
                              //var selected_room_type = $('#room_type_text')[0].value
							  var selected_room_type = $('#room_type_text').val();
							 
							var selected_rooms = [];

// Collect all checked checkboxes with class "selected_rooms"
$('.selected_rooms_changed_room:checked').each(function () {
    selected_rooms.push($(this).val());
});

// Count selected checkboxes
var selected_room_count = selected_rooms.length;
//alert(selected_room_count);
// Output to console or alert
//console.log("Selected Rooms:", selected_rooms);
//alert("Checked Rooms: " + selected_rooms.join(', '));

    // Validation
    if (selected_room_type !== '' && selected_room_count > 0) {
                                  $.ajax({
                                      type: "POST",
                                      url: 'ajax/ajaxChangeRoomType.php',
                                      data: 'reservation_id=' + reservation_id + '&id_mst_room_types=' + id_mst_room_types + '&updated_room_type=' + selected_room_type + '&room_count=' + selected_room_count+'&selected_rooms='+selected_rooms,
                             /* var selected_room_count = $('#room_count_count')[0].value;

                              if (selected_room_type != '' && selected_room_count != '') {
                                  $.ajax({
                                      type: "POST",
                                      url: 'ajax/ajaxChangeRoomType.php',
                                      data: 'reservation_id=' + reservation_id + '&id_mst_room_types=' + id_mst_room_types + '&updated_room_type=' + selected_room_type + '&room_count=' + selected_room_count,*/
                                      success: function (data) {
                                          bootbox.alert(data);
                                          searchArrivals();
                                      }
...
function onlyOne(checkbox,room) { 

        var checkboxes = document.getElementsByName('room_check_folio_guest');
		
		let elements = document.getElementsByName('room_check_folio_guest');
elements.forEach(function(element) {
    element.value = '0'; // Set the new value for each element
});
		...
		$("#room_check_folio_guest_"+room).val('1');
    }
	function OpenGuestRoomModel(room_id) {
		    $('#guestMultipleeditModal').modal('show');
			$("#multiple_id_guest_room").val(room_id);

}
  //data-target="#guestMultipleeditModal"
     
  function userRoomByGuest(resvId, id_mst_room_types, checkin_time = '', guest_room) {
    var expected_arrivals_rooms = $("input[name='expected_arrivals_rooms[]']:checked").map(function () {
      return $(this).val();
    }).get();
      $.ajax({
        url: 'ajax/ajaxUserRoomByGuest.php',
        type: 'POST',
        data: 'resvId=' + resvId + '&id_mst_room_types=' + id_mst_room_types + '&dataselected=' +
          expected_arrivals_rooms+ '&checkin_time='+checkin_time+'&guest_room='+guest_room, //{resvId : resvId,id_mst_room_types:id_mst_room_types},
        //dataType: 'JSON',
        success: function (data) {
          //searchArrivals();
          //roomStats();
...
function guestTransferSharedToMain(id_fo_reservations,id_mst_room_no_allocation,order_by_room,room_no,id_shared_guest,id_folio){
	   ...
	   url: 'ajax/ajaxGuestTransferSharedToMain.php',

	   data: "id_fo_reservations="+id_fo_reservations+'&id_mst_room_no_allocation='+id_mst_room_no_allocation+"&order_by_room="+order_by_room+'&room_no='+room_no+"&id_shared_guest="+id_shared_guest+"&id_folio="+id_folio, 
	...
	function guestSharedCheckout(id_fo_reservations,id_mst_room_no_allocation,order_by_room,room_no,id_shared_guest,id_folio,timeValue){
	   ...
	   url: 'ajax/ajaxGuestSharedCheckout.php',

	   data: "id_fo_reservations="+id_fo_reservations+'&id_mst_room_no_allocation='+id_mst_room_no_allocation+"&order_by_room="+order_by_room+'&room_no='+room_no+"&id_shared_guest="+id_shared_guest+"&id_folio="+id_folio+"&timeValue="+timeValue, 
...
function promptCheckinTimeAndCheckout(id_fo_reservations, id_mst_room_no_allocation, order_by_room, room_no, id_shared_guest, id_folio) {
    ...
    // ✅ Set current time after modal shown
        ...
        buttons: {
            ...
            confirm: {
                ...
                callback: function () {
                    ...
                    // Optionally, you can pass timeValue to your function
                    guestSharedCheckout(id_fo_reservations, id_mst_room_no_allocation, order_by_room, room_no, id_shared_guest, id_folio,timeValue);
                }
            }
        },
...
function GetOtherGuestDetails(id, id_fo_reservations, id_mst_room_no_allocation, order_by_room, room_no, guest_type, id_folio) {
    $('#guestOtherDetailModal .modal-body').html('<p class="text-center text-muted">Loading...</p>');
    $('#guestOtherDetailModal').modal('show');

    $.ajax({
        type: "POST",
        url: 'ajax/ajaxOtherDetailsPopup.php',
        data: {
            id: id,
            id_folio: id_folio,
			id_fo_reservations: id_fo_reservations,
        ...
        success: function(response) {
            $('#guestOtherDetailModal .modal-body').html(response);
        },
        error: function() {
            $('#guestOtherDetailModal .modal-body').html('<p class="text-danger">Error loading data.</p>');
        }
    });
}
	
function SaveOtherDetails() {
    var formData = $('#otherDetailsForm').serialize();

    $.ajax({
        type: "POST",
        url: 'ajax/ajaxSaveOtherDetails.php',
        data: formData,
        dataType: 'json',
        success: function(response) {
            if (response.status === 'success') {
                $('#guestOtherDetailModal').modal('hide');
                // Show success alert — replace with your own toast/alert if you have one
                alert(response.message);
            } else {
                alert(response.message);
            }
