...
<?php include_once("../includes/header.php")?>
  ...
  <?php 
  include_once("functions/functionfrontofficeSalesRegisterReceiptsOld.php");
  if($_REQUEST['Download'] == 'Generate'){
	...
	$id_shift=implode(',',$_REQUEST['id_shift']);
	 ...
	 $shop=$_SESSION['shop'];
	  frontofficeSalesRegisterReceipts($Date,$id_outlet,$id_shift,$objPHPExcel,$connNew,$shop,$cronSet,$pdfNameReport3);
