						...
						<tr>
						  <td width="30%" style="padding:0!important;">';
						   ...
						   <td width="70%" style="padding:0!important; border:0px solid red; float:right;text-align:right;" >
							...
							$content .= '<span style="font-size:12px;line-height:18px;"><b>Contact No: </b> '.$resultHotelDetail->phone1.'';
...
<td style="width:350px;font-size:9px;padding-top:0!important;"><span style="font-weight:bold">AMOUNT PAID :  </span><span style="color:#000;font-size:10px;"> '.$currency.' '.round($receipt_amount).'</span></td>
...
if($row_fo_receipt->is_advance == 1){
			...
			$contentreceipt .=' <table class="table" border="0" style="" >
                <tr >
...
$contentreceipt .='	
		...
		$contentreceipt .= '<hr  style="border:0.3px solid grey;">';
	}
...
$content .= '
<table class="table" border="0" style="page-break-before: always;padding:0!important;margin:0!important;width:100%;">
    <tr>
