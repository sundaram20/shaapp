...
<?php include_once("../includes/header.php")?>
  ...
  <?php 
  include_once("functions/nightAuditReportDemo.php");
  if($_REQUEST['Download'] == 'Generate'){
	$Date =$_REQUEST['datefilterNightAudit'];
	$id_outlet=implode(',',$_REQUEST['id_outlet']);
	$id_shift=implode(',',$_REQUEST['id_shift']);

	 nightAuditReportsDemo($Date,$id_report_type,$report_show,$showItemReport,$kot_nc,$appConnect,$connNew,$shop,$cronSet,$pdfNameReport3,$objPHPExcel);
            ...
            <div class="col-md-2">
              <div class="form-group">
               <label>As On</label>	 
							...
							<!-- <input type="text" name="datefilter" id="datefilter" placeholder="Date" class="form-control"  value="" /> dateRangeReport-->
							<input type="text" class="form-control pull-right pickerdate" placeholder="Select From -  To" name="datefilterNightAudit" id="datefilterNightAudit" data-parsley-required value="<?php echo date('d-m-Y'); ?>" data-parsley-errors-container="#report_dateError"  autocomplete="off">
