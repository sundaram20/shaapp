...
$guestName=$Title.' '.ucwords(strtolower($Firstname)).' '.ucwords(strtolower($Lastname));
	...
	?>
                                 ...
                                 <tr>
                                    ...
                                    onclick="getRoomDetails(<?php echo $reservation_id;?>,2,'<?php echo $id; ?>','<?php echo $row->id_mst_room_types;?>');" data-toggle="tooltip" title="view rooms"><i class="fa fa-eye"></i></button></td>
...
?>
        ...
        <button type="button" class="btn n-btn" data-dismiss="modal" style="padding: 7px 20px!important; ">Close</button>
              ...
              <script> 
    window.onload = function() { alert('qwe');
        // Define your variables or retrieve them if needed
        var reservation_id = <?php echo $reservation_id; ?>;
        var room_type_id = <?php echo $row->id_mst_room_types; ?>;
        var id = '<?php echo $id; ?>';

        // Call the function with the appropriate arguments
        getRoomDetails(reservation_id, 2, id, room_type_id);
    };
</script> 
<?php 
