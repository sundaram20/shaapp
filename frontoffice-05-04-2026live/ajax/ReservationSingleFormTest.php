...
if ($_REQUEST['BookingType'] == 'Edit') {
	...
	$balance = $net_booking_amount - ($receipt_result->amount ?? 0);
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td id="folio_balance">
                                    <input type="text" class="form-control" name="res_tax" id="res_tax" value="0" >
                                </td>
                                <td id="foliostatus" class="text-center">
                                    <input type="text" class="form-control" name="res_tariff_per_room_inclusive_tax" value="0" id="res_tariff_per_room_inclusive_tax"  onkeyup="tariffCalculationInclusiveNew('');">
                                </td>
                                <td>
                            ...
                            <tbody id="tableBody">
                                ...
                                <?php echo $RecordTD; ?>
                                    ...
                                    <td style="width: 180px;">
                                        <select name="ReservationDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][room_type_id][]" id="room_type_id[]" data-parsley-required="" class="form-control mst_room_types room_type_id_<?php echo $rowOrderDetail->id;?>" data-hotel_id="<?php echo $id_mst_hotels?>" data-id="<?php echo $rowOrderDetail->id;?>" data-order_by_room="<?php echo $rowOrderDetail->order_by_room;?>">
                                        <?php
                                            $selectneww="SELECT * FROM ".TBL_ASSIGN_HOTEL_ROOM."  where id_mst_hotels = '1'";
                                            $resneww = mysqli_query($connNew,$selectneww);
                                            $dataArr = '';
                                    ...
                                    <td style="width: 100px;">
                                        ...
                                        <select name="ReservationDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][room_number][]" id="room_number[]" data-parsley-required="" class="form-control id_mst_room_number room_type_id" data-hotel_id="<?php echo $id_mst_hotels?>" data-id="<?php echo $rowOrderDetail->id;?>" data-order_by_room="<?php echo $rowOrderDetail->order_by_room;?>"  data-room_no="<?php echo $rowOrderDetail->id_mst_room_no_allocation ?>">
                                    ...
                                    <td style="width: 100px;">
                                        ...
                                        ?>
                                        <select id="postcharges_<?php echo $rowOrderDetail->id;?>" name="ReservationDataArray[<?php echo $Array_id_mst_room_types; ?>][<?php echo $Random;?>][postcharges][]" class="select2 form-control" style="width:100%">
                                    ...
                                    <?php if ($start == 1) {?>
                                    <td style="width: 83px;">
                                        <button type="button" value="Remove" onClick="RemoveTextBoxEdit('<?php echo $Random; ?>')" class="deleteBox"> <i class="fas fa-trash"></i></button></td>
                                    <?php } else {?>
