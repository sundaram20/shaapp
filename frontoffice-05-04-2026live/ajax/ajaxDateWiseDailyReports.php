...
include_once("../functions/functionDateWiseDailyReport.php");
...
//print_r($_REQUEST);die;
	$pdfNameReport3='';
echo FoDateWiseReportDaily($_REQUEST['period'],$id_main_group,$id_sub_group,$id_items,$_REQUEST['id_report_type'],$report_show,$_REQUEST['id_order_by'],$_REQUEST['showItemReport'],$_REQUEST['res_bookingStatus_new'],$_REQUEST['hk_status'],$_SESSION['shop'],$pdfNameReport3); 
