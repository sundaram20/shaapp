...
$roomNumber= implode(',',$roomNumberArray);
 if($id_fo_folio_to>0 && $set==''){ 
	 ...
	 $id_mst_guest = selectColumn('fo_reservations_details', 'id_mst_guest', "WHERE id_fo_reservations = '$id_fo_reservations' AND id_mst_room_no_reserved='$id_owner_room' AND id_fo_folio = '$id_fo_folio_to'");
