...
function nightAuditReportsDemo($Date,$id_report_type,$report_show,$showItemReport,$kot_nc,$appConnect,$connNew,$shop,$cronSet,$pdfNameReport3,$objPHPExcel){
...
while($Records	   =	mysqli_fetch_object($query)){
	...
	//$outlet_Name =$Records->outlet_Name;
				...
				$Records->id_fo_folio	=$outlet_Name;//'Front Office';	
