  ...
  <div class="form-group">
   ...
   <!--<div class="input-group-addon"> <i class="fa fa-dot-circle-o"></i> </div>-->
      <select class="form-control select2 parsley-error"  name="id_report_type" data-parsley-required id="id_report_type" style="width:100%">
        ...
        <option <?php echo $selected ?> value="1">Expected Arrivals Report</option>
...
<div class="col-md-2 col-sm-12">
  <div class="form-group">
    <label> Period</label>
      ...
      <input type="text" class="form-control pull-right future_calendar" placeholder="Select From -  To" name="per_report_date" id="per_report_date" data-parsley-required value="<?php echo date('d-m-Y').' to '.date('d-m-Y') ?>" data-parsley-errors-container="#report_dateError"  autocomplete="off">
...
//Form Data Clear
	...
	var showItemReport = $("#showItemReport").val();
        ...
        let url2 = 'ajax/ajaxDateWiseExpectedArrivals.php?period='+period+'&id_report_type='+id_report_type+'&id_main_group='+id_main_group+'&id_sub_group='+id_sub_group+'&id_item='+id_item+'&ReportShowType='+ReportShowType+'&id_order_by='+id_order_by+'&showItemReport='+showItemReport;
         window.open(url2);
	...
	// alert(id_report_type);
     ...
     $("#loading").show();
	  var id_order_by = $("#id_order_by").val();
		...
		if(id_report_type=='1'){
		 reportTypeFile  ='ajaxDateWiseExpectedArrivals.php';
		}else{
