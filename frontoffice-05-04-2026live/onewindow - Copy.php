...
<!-- Begain Guest Model -->
<?php /*?><div class="modal fade" id="guestaddeditModal" tabindex="-1" role="dialog"
  aria-labelledby="guestaddeditModalLabel" style="width: 100%; height: 100%;">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="guestpopupform" data-parsley-validate="" autocomplete="off" method="post" action="" novalidate>
          ...
          <div style="text-align:center">
            <input type="button" class="btn btn-primary" onClick="saveGuestPopupform();" value="Save">
            <button type="button" class="guest_close btn btn-danger" data-dismiss="modal"
...
<div class="modal fade" id="bookereditModal" tabindex="-1" role="dialog" aria-labelledby="bookereditModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" id="bookerpopupform" name="bookerpopupform" data-parsley-validate="" autocomplete="off"
          novalidate>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="first_name">First Name</label>
                <input type="text" class="form-control input-sm" placeholder="Enter first name" id="booker_first_name"
                  name="booker_first_name" value="" data-parsley-required="">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="last_name">Last Name</label>
                <input type="text" class="form-control input-sm" placeholder="Enter last name" id="booker_last_name"
                  name="booker_last_name" value="" data-parsley-required="">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="email">Email Id</label>
                <input type="text" name="booker_email" id="booker_email" class="form-control"
                  placeholder="Enter Email Id" automcomplete="off">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="mobile">Mobile No.</label>
                <input type="text" name="booker_mobile" id="booker_mobile" class="form-control"
                  placeholder="Enter mobile number" automcomplete="off">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="mobile">City</label>
                <input type="text" name="booker_city" id="booker_city" class="form-control" placeholder="Enter City"
                  automcomplete="off">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="booker_postcode" id="booker_postcode" class="form-control"
                  placeholder="Enter Postcode" automcomplete="off">
              </div>
            </div>
          </div>
          <div style="text-align:center">
        ...
        success: function (resp) {
          ...
          resp.forEach((value, key, arr) => {
            ...
            tableData += `<td onclick="ReservationSingleForm('${value.id_fo_reservations}','Edit','','')"><a href="#" style="color:black;">${value.res_id}</a></td>
                                    <td onClick="guestDetails('${value.id_mst_guest}','edit')"><a href="#" style="color:black;">${value.guest}</a></td>    
                                    <td onclick="folioTabDetails('${value.id_fo_view_folio}')"><a href="#" style="color:black;">${value.folio}</a></td>
                                    <td>${value.checkin}</td>
                                    <td>${value.checkout}</td>`;
            tableData += `<td>`;
            if (value.status == 3) {
			...
			tableData +=
                `<button class="btn btn-info" onClick="UpdateCheckoutRoomWise('${value.id_fo_reservations}','${value.id_mst_room_no_allocation}','${value.id_fo_view_folio}','${value.id_fo_bill}');" >Checkout</button>`;
            tableData += `</td>
                                </tr>`;
          });
...
*/
  ...
  function userCheckIn(resvId, id_mst_room_types) {
...
<script>
  ...
  function bookeredit() {
    ...
    $(document).ready(function () {
      alert('1');
      // var search_name = $('.bookername :selected').val();
      $("#bookerpopupform").submit(function () {
        alert('55');
        $.ajax({
  ...
  function ajaxGenerateBill(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room) {
    ...
    $.ajax({
      ...
      data: 'id_mst_hotels=' + id_mst_hotels + '&id_fo_bill=' + id_fo_bill + '&id_reservation=' + id_reservation +
        '&doc_type=' + doc_type + '&id_room=' + id_room,
      success: function (result) {
      ...
      callback: function (result) { // alert(result);
        ...
        if (result == true) {
          $.ajax({
            ...
            data: 'id_mst_hotels=' + id_mst_hotels + '&id_fo_bill=' + id_fo_bill + '&id_reservation=' +
              id_reservation + '&doc_type=' + doc_type + '&id_room=' + id_room + '&precheckout=0',
            success: function (result) {
              let datas = JSON.parse(result);

              if (datas.status == 5) {
                UpdateCheckoutDate(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room);
  ...
  function UpdateCheckoutDate(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room) {
    ...
    bootbox.confirm({
      title: "Checkout",
      message: "Do you want to Pre-Checkout?",
      buttons: {
        cancel: {
          label: '<i class="fa fa-times"></i> Cancel'
        },
      ...
      callback: function (result) { // alert(result);
        ...
        if (result == true) {
          $.ajax({
            ...
            url: 'ajax/ajaxUpdateCheckout.php',
            data: 'id_mst_hotels=' + id_mst_hotels + '&id_fo_bill=' + id_fo_bill + '&id_reservation=' +
              id_reservation + '&doc_type=' + doc_type + '&id_room=' + id_room + '&precheckout=1',
            success: function (result) {
              let datas = JSON.parse(result);
...
//tableData += `<div class="col-md-1 col-sm-1 col-xs-1"  style="padding-right:0px; margin-top: 2px; margin-left:0px; margin-right: 0px;"><button class="btn btn-block btn-primary"  onclick="selectRoom(${value.room_id},${datavalue},this.id,'`+ resId +`',`+ pending +`);" id="btn-`+resId+`-${datavalue}">${datavalue}</button></div> `;
  ...
  function ReservationSingleForm(id, BookingType, id_room, id_hotel) {
    //var id_hotel = $("#id_hotel").val();
    $.ajax({
      type: "POST",
      url: 'ajax/ReservationSingleForm.php',
...
function UpdateCheckoutRoomWise(id_reservation,id_room,id_fo_folio ,id_fo_bill  ) {
        ...
        if (result == true) {
          $.ajax({
            ...
            data: 'id_fo_bill=' + id_fo_bill + '&id_reservation=' +
              id_reservation + '&id_fo_folio=' + id_fo_folio  + '&id_fo_bill=' + id_fo_bill  + '&id_room=' + id_room + '&precheckout=0',
            success: function (result) {
              let datas = JSON.parse(result);
              ...
              if (datas.status == 5) {
                UpdateCheckoutDateRoomWise(id_reservation,id_room,id_fo_folio ,id_fo_bill);
 ...
 function UpdateCheckoutDateRoomWise(id_reservation,id_room,id_fo_folio ,id_fo_bill) {
      ...
      callback: function (result) { // alert(result);
        ...
        if (result == true) {
          $.ajax({
            ...
            url: 'ajax/ajaxUpdateCheckoutRoomWise.php',
            data: 'id_fo_bill=' + id_fo_bill + '&id_reservation=' +
              id_reservation + '&id_fo_folio=' + id_fo_folio + '&id_room=' + id_room + '&precheckout=1',
            success: function (result) {
              let datas = JSON.parse(result);
