...
<?php include_once("../includes/header.php")?>
  ...
  <?php 
  include_once("functions/nightAuditReport.php");
  if($_REQUEST['Download'] == 'Generate'){
	...
	$id_shift=implode(',',$_REQUEST['id_shift']);
	 ...
	 nightAuditReports($Date,$id_report_type,$report_show,$showItemReport,$kot_nc,$appConnect,$connNew,$shop,$cronSet,$pdfNameReport3,$objPHPExcel);
