...
$connMenu = mysqli_connect($DB_HOST,$DB_USERNAME,$DB_PASSWORD,'inroomhu_app');
          ...
          <li>
            ...
            $sqlSubMenu="SELECT * FROM ".APP_SUB_MENU." WHERE id_menu='".$rowMenu->id."' AND id_module='".$rowModuleMenu->id."' ORDER BY display_order";
              ...
              ?>
                ...
                <input onchange="updateMe('<?php echo $rowSubMenu->id; ?>',this.name,this.value);" type="number" name="id_document"  style="width: 60px;" value="<?php echo $rowSubMenu->id_document ;?>">
                ...
                <input onchange="updateMe('<?php echo $rowSubMenu->id; ?>',this.name,this.value);" required="required" name="file_name" type="text" value="<?php echo $rowSubMenu->file_name ;?>">

                
                <label>Display Order : </label>
                <input onchange="updateMe('<?php echo $rowSubMenu->id; ?>',this.name,this.value);" required="required" name="display_order" type="text" style="width: 60px;" value="<?php echo $rowSubMenu->display_order ;?>">
