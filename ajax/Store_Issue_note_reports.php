...
//Popup Table Show  
 ...
 $sql = "SELECT inv_purch.po_date, inv_purch.mdoc_no,  inv_purch.po_no, 
                        ...
                        $mpdf->Output('../pdf/Store_Issue_Note.pdf','F');
                         //Excel Sheet Work 
                         $file_pointer = fopen("../excel/Store_Issue_Note.csv","w");
...
<a href="../excel/Store_Issue_Note.csv"><button class="btn btn-danger btn-sm btn-labeled" id="download" type="button">
