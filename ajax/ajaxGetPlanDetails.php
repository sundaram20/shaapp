...
$double_pax_price = $rowRoom->double_pax_price;
$single_pax_price = $rowRoom->single_pax_price;
...
$availableData .= '				  <td > <div><i class="fa fa-inr"></i> '.$single_pax_price.' <button class="pull-left btn btn-success btn-xs" type="button" onclick="ajaxAddRoom('.$row->id.','.$row->rate_assign_id.','.$rowRoom->room_id.','.$rowRoom->rate_plan_id.',1);" ><i class="fa fa-plus-circle"></i></button></div></td>';				  
				  
$availableData .= '				  <td > <div><i class="fa fa-inr"></i> '.$double_pax_price.' <button class="pull-left btn btn-success btn-xs" type="button" onclick="ajaxAddRoom('.$row->id.','.$row->rate_assign_id.','.$rowRoom->room_id.','.$rowRoom->rate_plan_id.',0);" ><i class="fa fa-plus-circle"></i></button></div></td>';
