...
if(num_rows($resState) > 0){	
	$state  =	'<select class="form-control select2" name="id_state" id="id_state" data-parsley-errors-container="#stateError" >
		...
		$state = '<input type="text" name="other_state" id="id_state" class="form-control" value="'.$otherState.'" placeholder="Enter State" data-parsley-errors-container="#stateError" automcomplete="off">';
	}	
echo $state;
?>