...
//Popup Table Show  
 ...
 $sql = "SELECT inv_purch.po_date, inv_purch.mdoc_no,  inv_purch.po_no, 
                        ...
                        $mpdf->Output('../pdf/Purchase_Register_items.pdf','F');
                        //Excel Sheet Work 
                         $file_pointer = fopen("../excel/Purchase_Register_items.csv","w");
...
<a href="../excel/Purchase_Register_items.csv"><button class="btn btn-danger btn-sm btn-labeled" id="download" type="button">
