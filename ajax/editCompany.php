...
if($_POST['Save']){
	...
	}else if($db->num_rows2(selectSql(TBL_COMPANY,"WHERE `id_company` NOT IN('".addslashes(encryptor(decrypt,$_POST[eId]))."') and `id_shop` = '".addslashes($_SESSION['shop'])."'  AND `name` = '".addslashes($_POST['name'])."'",''))){
		$err++;
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control awesomplete" data-list="#mylist" placeholder="Enter Company name" id="name" name="name" value="<?php if($_POST) echo $_POST['name'];else echo stripslashes($row->name);?>" data-parsley-required >
                  <ul id="mylist" style="display:none;">
                    <?php  $resCat = selectSql(TBL_COMPANY," where 1  and id_shop='".addslashes($_SESSION['shop'])."'",' ORDER BY `id_company`');
											  if($db->num_rows2($resCat)){
											  	while($resultCat = $db->fetch_object2($resCat)){
													$companyDropDown .= '<li>'.ucfirst($resultCat->name).'</li>';
												}
											  }
              ...
              <div class="row">
                ...
                <div class="form-group  col-sm-4">
                  ...
                  <input type="text" class="form-control" placeholder="Enter phone number" id="phone" name="phone" value="<?php if($_POST) echo $_POST['phone'];else echo $row->phone;?>" data-parsley-required>
                  <?php echo $err_phone;?> </div>
                <div class="form-group  col-sm-4">
                  <label for="mobile">Mobile Number</label>
                  <input type="text" class="form-control" placeholder="Enter mobile number" id="mobile" name="mobile" value="<?php if($_POST) echo $_POST['mobile'];else echo $row->mobile;?>" data-parsley-type="digits" data-parsley-length="[10, 10]" >
              ...
              <div class="row">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <?php $areaDropDown = '<select class="form-control select2" name="area" id="area" data-parsley-required>
											  ...
											  ?>
                  <span id="areaError"><?php echo $err_area;?></span> </div>
                <div class="form-group col-sm-4">
                  <label for="company_credibility">Company Credibility<font color="#FF0000">*</font></label>
                  <select class="form-control" name="company_credibility" id="company_credibility" data-parsley-errors-container="#company_credibilityError" data-parsley-required>
                    ...
                    <option value="2" <?php if($_REQUEST['company_credibility']=='2'){echo 'selected="selected"';}elseif($row->company_credibility=='2'){echo 'selected="selected"';} ?>>Credit Not Allowed</option>
                  </select>
                  <span id="company_credibilityError"><?php echo $err_company_credibility;?></span> </div>
              </div>
              <div class="row">
                <div class="form-group col-sm-4">
                  <label for="deals_in">Deals In<font color="#FF0000">*</font></label>
                  <?php $dealsInDropDown = '<select class="form-control select2" name="deals_in" id="deals_in" data-parsley-required data-parsley-errors-container="#deals_inError">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <select class="form-control select2" name="id_rate_level[]" id="id_rate_level" multiple="multiple" data-parsley-required data-parsley-errors-container="#rate_level_idError">
