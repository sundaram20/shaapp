...
if($remove == 'removeAll'){
	...
	unset($_SESSION['editCart'][$OrderUniqueID]['inclusion_food']);
 ...
 echo '<td colspan="8"><strong>Please add room again with new details.</strong></td>' ;
	...
	unset($_SESSION['editCart'][$OrderUniqueID]['tarrif_price'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['room_quantity'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['adult_no'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['infant_no'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['child_no'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['room_price'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['pkg_extra'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['pkg_description'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['inclusion_food'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['room_tax_price'][$uniqueCode]);
	
	

	
	$hackers = $_SESSION['editCart'][$OrderUniqueID]['OtherChargesUniqueCodeID'];

$pos = array_search($uniqueCode, $hackers);
unset($_SESSION['editCart'][$OrderUniqueID]['OtherChargesUniqueCodeID'][$pos]);


$k	= $_SESSION['editCart'][$OrderUniqueID]['OtherChargesUniqueCodeID'];
...
echo "</pre>";	*/
	...
	unset($_SESSION['editCart'][$OrderUniqueID]['otherChargeTypeNoOfDays'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['charges_total'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['charges_total'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['charges_price'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['id_othercharges_detail'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['charges_description'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['charges_tax'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['charges_net'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['charges_price'][$uniqueCode]);
	unset($_SESSION['editCart'][$OrderUniqueID]['charges_total'][$uniqueCode]);
...
//$_SESSION['editCart'][$OrderUniqueID]['taxablePrice']=	$_SESSION['editCart'][$OrderUniqueID]['taxablePrice']+$TotalAdditionalChargesTaxValue;
...
$_SESSION['editCart'][$OrderUniqueID]['otherChargeType']	=$_REQUEST['otherChargeType'];	
if($_SESSION['editCart'][$OrderUniqueID]['otherChargeType'] == '2'){
	$otherChargeType	=	$noOfDays;
	}
...
$seasonIdnew	= $query14data['id'];	
		...
		//$taxablePrice	+=	round($_SESSION['editCart'][$OrderUniqueID]['tarrif'][$UniqueDateFor][$uniqueCode]*$_SESSION['editCart'][$OrderUniqueID]['room_quantity'][$UniqueDateFor][$uniqueCode]*($rowNewTax->tax_percent/100));
