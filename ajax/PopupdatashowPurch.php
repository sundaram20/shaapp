...
if($checkbox){ 
	...
	$where = " inv_purch_details.id_inv_purch = inv_purch.id AND inv_purch.id_mst_party_supplier ='".$id_mst_party_supplier."' AND inv_purch.id_shop = '".addslashes($_SESSION['shop'])."' AND inv_purch_details.bal_qty>0 AND inv_purch_details.id_inv_purch = '".$id."' AND inv_purch_details.doc_type = '4'  " ;
}
