...
//Popup Table Show  
 ...
 $sql = "SELECT inv_indent.indent_date, inv_indent.mdoc_no,  inv_indent.indent_no, 
                        ...
                        $mpdf->Output('../pdf/Requistion_Note_party_items.pdf','F');
                        
                        //Excel Sheet Work 
                         $file_pointer = fopen("../excel/Requistion_Note_party_items.csv","w");
...
<a href="../excel/Requistion_Note_party_items.csv"><button class="btn btn-danger btn-sm btn-labeled" id="download" type="button">
