...
if($phpfun == 'Stock_balance_reports'){
 Stock_balance_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Stock_Ledger_reports') {
   Stock_Ledger_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Stock_Statement_reports') {
   Stock_Statement_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Requisition_note_reports') {
   Requisition_note_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Requisition_note_Party_item_reports') {
   Requisition_note_Party_item_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Purchase_order_reports') {
   Purchase_order_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Purchase_order_reports_Party_item_reports') {
   Purchase_order_reports_Party_item_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Purchase_Register_reports') {
   Purchase_Register_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Purchase_Register_reports_item_reports') {
   Purchase_Register_reports_item_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Store_Receipt_reports') {
   Store_Receipt_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Store_Receipt_reports_Party_item_reports') {
   Store_Receipt_reports_Party_item_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Store_Issue_note_reports') {
   Store_Issue_note_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}elseif ($phpfun == 'Store_Issue_note_Party_item_reports') {
   Store_Issue_note_Party_item_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel);
}
...
function Stock_balance_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){  
...
//Popup Table Show  
 ...
 $sql = "SELECT * FROM inv_items WHERE $where"; 
    ...
    print_r($sql);
                      ...
                      //Excel Method Generation
                      $objPHPExcel->getProperties()->setCreator("Stock Balance Reports")
                      ->setLastModifiedBy("Stock Balance Reports")
                      ->setTitle("Stock Balance Reports")
                      ->setSubject("Stock Balance Reports")
                      ->setDescription("Stock Balance Reports")
                      ->setKeywords("Stock Balance Reports")
                      ->setCategory("Report");
                      ...
                      if(!isset($cron)){  
                        ...
                        $signature = '/home/admingcs/public_html/sales/uploaded_files/shop/'.$logo;
                      ...
                      if(file_exists($signature)){
                        ...
                        // $objDrawing->setWidth(15);                 //set width, height
                    ...
                    ->setCellValue('A6', 'Stock Balance Reports '.date('d F').' Till '.date('d F Y') );
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                      ->setCellValue($head_cntr_column++.$head_hotel_row, 'ITEM CODE')
                      ->setCellValue($head_cntr_column++.$head_hotel_row, 'ITEM DESCRIPTION')
                      ->setCellValue($head_cntr_column++.$head_hotel_row, 'UNIT')
                      ->setCellValue($head_cntr_column++.$head_hotel_row, 'MIN')
                      ->setCellValue($head_cntr_column++.$head_hotel_row, 'STOCK')
                      ->setCellValue($head_cntr_column++.$head_hotel_row, 'VALUE');  
                       ...
                       $head_hotel_row=8; 
                        ...
                        while($row22 = $db->fetch_object()){  
                          ...
                          $head_cntr_column='A';
                          $objPHPExcel->setActiveSheetIndex(0)
                            ->setCellValue($head_cntr_column++.$head_hotel_row, $row22->item_code) 
                            ->setCellValue($head_cntr_column++.$head_hotel_row, $row22->name) 
                            ->setCellValue($head_cntr_column++.$head_hotel_row, $unit_main) 
                            ->setCellValue($head_cntr_column++.$head_hotel_row, $row22->min_qty) 
                            ->setCellValue($head_cntr_column++.$head_hotel_row, $stock_in_hand) 
                            ->setCellValue($head_cntr_column++.$head_hotel_row, '0'); 
                            $head_hotel_row++;
                        }


              $objPHPExcel->getActiveSheet()->getStyle('A6:F'.($head_hotel_row-1))->applyFromArray($styleThinBlackBorderOutline);
              ...
              $forTotal = 'C';
              $objPHPExcel->getActiveSheet()->setTitle('Stock Balance Reports');
           ...
           if(!isset($cron)){ 
            ...
            header('Content-Disposition: attachment;filename="Stock_Balance_Reports '.date('d-m-Y H:i:s').'.xls"');
            ...
            $excelName =  "../excel/Stock_Balance_Reports.xls";
            $objPHPExcel->setActiveSheetIndex(0); 
            $objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
            $objWriter->save($excelName); 
            ?>
            <a href="../excel/Stock_Balance_Reports.xls" target="_blank" download><button class="btn btn-danger btn-sm btn-labeled" id="download" type="button" style="display: none;"></button></a>
          ...
          <?php
           // echo $excelName;
            ...
            $objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
            //$objWriter->save('../mailattach/Stock_Balance_Reports '.$startDate.'.xls');

            //cron server
            $objWriter->save('/home/admingcs/public_html/sales/adminpanel/mailattach/Stock_Balance_Reports.xls');
...
function Stock_Ledger_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){ 
...
//#################################################################
  function Stock_Statement_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){ 
      $mdoc_no = '';
      $date = explode(' to ', $datefilter); 
      $minimum_date = $date[0];
      $maximum_date = $date[1]; 
...
//#################################################################
    ...
    function Requisition_note_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){
...
//#################################################################
  ...
  function Requisition_note_Party_item_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){
...
//#################################################################
  ...
  function Purchase_order_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){
...
//#################################################################
   ...
   function Purchase_order_reports_Party_item_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){
...
//#################################################################
   ...
   function Purchase_Register_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){
...
//#################################################################
   ...
   function Purchase_Register_reports_item_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){
...
//#################################################################
   ...
   function Store_Receipt_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){
...
//#################################################################
   ...
   function Store_Receipt_reports_Party_item_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){
...
//#################################################################
   ...
   function Store_Issue_note_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){
...
//#################################################################
   function Store_Issue_note_Party_item_reports($clicked_id,$doc_type,$multiple_item_val,$main_group_val,$id_mst_attributes_department,$pia,$check_value,$datefilter,$party_val,$db,$objPHPExcel){
