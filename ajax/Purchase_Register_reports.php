...
//Popup Table Show  
 ...
 $sql = "SELECT inv_purch.*,  inv_purch_details.*,inv_others_charges_purch.*,
                        ...
                        $mpdf->Output('../pdf/Purchase_Register.pdf','F');
                        //Excel Sheet Work 
                         $file_pointer = fopen("../excel/Purchase_Register.csv","w");
...
<a href="../excel/Purchase_Register.csv"><button class="btn btn-danger btn-sm btn-labeled" id="download" type="button">
