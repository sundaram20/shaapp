                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md- col-sm-6 col-xs-12 right_border">
                                              <div class="form-horizontal">
                                                  <div class="form-group row">
                                                      <label for="res_guestName" class="col-sm-3 col-md-3 col-form-label">Guest Name</label>
                                                      <div class="col-sm-9 col-md-9">
                                                  ...
                                                  <div class="form-group row">
                                                      <label for="res_bookingType" class="col-sm-3 col-md-3 col-form-label">Booking Type</label>
                                                      <div class="col-sm-6 col-md-6">
                                                  ...
                                                  <div class="form-group row">
                                                      <label for="res_source" class="col-sm-3 col-md-3 col-form-label">Source</label>
                                                      <div class="col-sm-6 col-md-6">
                                            ...
                                            <div class="col-md- col-sm-6 col-xs-12">
                                              <div class="form-horizontal">
                                                  <div class="form-group row">
                                                      <label for="for="res_bookerName" class="col-sm-3 col-md-3 col-form-label">Booker Name</label>
                                                      <div class="col-sm-6 col-md-6">
                                                  ...
                                                  <div class="form-group row">
                                                      <label for="res_rateType" class="col-sm-3 col-md-3 col-form-label">Rate Type</label>
                                                      <div class="col-sm-6 col-md-6">
                                                  ...
                                                  <div class="form-group row">
                                                      <label for="res_rateLetter" class="col-sm-3 col-md-3 col-form-label">Rate Letter</label>
                                                      <div class="col-sm-6 col-md-6">
                                     ...
                                     <div class="box-body table-responsive">
                                        <table class="table table-hover">
                                            <tr>
                                             ...
                                             <tr>
                                                 <td>
                                                     <select class="form-control parsley-error" name="roomtype[]" data-parsley-required>
                                                 ...
                                                 <td>
                                                     <select class="form-control parsley-error" name="plan[]" data-parsley-required>
                                                 ...
                                                 <td class="form-group">
                                                     <input type="text" class="form-control parsley-error" style="width: 60px;" name="noofRooms[]" id="noofRooms[]" data-parsley-type="digits" data-parsley-required/>
                                                 </td>
                                                 <td>
                                                     <input type="text" class="form-control parsley-error" style="width: 60px;" name="adultperperson[]" id="adultperperson[]" data-parsley-type="digits" data-parsley-required/>
                                                 </td>
                                                 <td>
                                                     <input type="text" class="form-control parsley-error" style="width: 60px;" name="childperperson[]" id="childperperson[]" data-parsley-type="digits" data-parsley-required/>
                                                 </td>
                                                 <td>
                                                     <input type="text" class="form-control parsley-error" style="width: 120px;" name="extrachild[]" id="extrachild[]" data-parsley-required/>
                                                 </td>
                                                 <td>
                                                     <input type="text" class="form-control parsley-error" style="width: 90px;" name="tariffperperson[]" id="tariffperperson[]" data-parsley-required/>
                                                 </td>
                                                 <td>
                                                     <input type="text" class="form-control parsley-error" style="width: 60px;" name="taxes[]" id="taxes[]" data-parsley-required/>
                                                 </td>
                                                 <td>
                                                     <input type="text" class="form-control parsley-error" style="width: 60px;" name="chargespernight[]" id="chargespernight[]" data-parsley-required/>
                                                 </td>
                                             </tr>
                                        </table>
                                     </div>
                                 ...
                                 <div class="box box-info ">
                                     ...
                                     <div class="box-body table-responsive">
                                          <table class="table table-hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <select class="form-control parsley-error" style="width: 100px;" name="item[]" id="item[]"data-parsley-required>
                                                 ...
                                                 <td>
                                                     <input type="text" class="form-control parsley-error" style="width:80px;" name="additionalcharges[]" id="additionalcharges[]" data-parsley-required/>
                                                 </td>
                                                 <td>
                                                     <input type="text" class="form-control parsley-error" style="width:80px;" name="qty[]" id="qty[]" data-parsley-required/>
                                                 </td>
                                                 <td>
                                                 ...
                                                 <td>
                                                     <input type="text" class="form-control parsley-error" style="width:80px;" name="rate[]" id="rate[]" data-parsley-required/>
                                                 </td>
                                                 <td>
                                 ...
                                 <div class="box box-success">
                                     <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="box-header with-border bg-color">
                                                <h3 class="box-title with-border">Pickup and Arrival Details</h3>
                                            </div>
                                             <div class="box-body">
                                               <div class="form-horizontal">
                                                  <div class="form-group row">
