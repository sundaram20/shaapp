                        ...
                        <div class="col-xs-12">
                            ...
                            <form name="form1"  method="post" enctype="multipart/form-data" data-parsley-validate autocomplete="off">
                                <div class="box box-success">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="form-group col-xs-6 col-md-3 col-sm-3">
                                                <label for="res_bookingDate">Booking Date</label>
                                            ...
                                            <div class="form-group col-xs-6 col-md-5 col-sm-3">
                                                <label for="res_hotelName">Hotel Name</label>
                                                <div class="input-group"> 
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-hotel"></i> 
                                                    </div>
                                                  <input type="text" class="form-control" id="res_hotelName" name="res_hotelName" placeholder="Enter Hotel Name"   data-parsley-errors-container="#res_hotelNameError" data-parsley-required />
                                                </div>
                                                 <span id="res_hotelNameError"><?php echo $err_res_hotelNameError;?></span>
                                            </div>
                                            <div class="form-group col-xs-6 col-md-2 col-sm-3">
                                                <label for="res_checkinDate">Check In</label>
                                                <div class="input-group"> 
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-calendar"></i> 
                                                    </div>
                                            ...
                                            <div class="form-group col-xs-6 col-md-2 col-sm-3">
                                                <label for="res_checkoutDate">Check Out</label>
                                                <div class="input-group"> 
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-calendar"></i> 
                                                    </div>
                                                 ...
                                                 <span id="res_checkoutDateError"><?php echo $err_res_checkoutDateError;?></span>
                                            </div>
                                        </div>  
                                        <div class="row">
                                            <div class="form-group col-xs-6 col-md-3 col-sm-3">
                                                <label for="res_bookingStatus">Booking Status</label>
                                                <div class="input-group"> 
                                                    <div class="input-group-addon">
                                 ...
                                 <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="form-group col-xs-6 col-md-5 col-sm-3">
                                                <label for="res_guestName">Guest Name</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="res_guestName" id="res_guestName"/>
                                                    <div class="input-group-addon">
                                                        <a href="#" style="color:black;"
                                                        onclick="guestDetails(1);"><i class="fa fa-plus"></i> </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group col-xs-6 col-md-4 col-sm-3">
                                                <label for="res_bookingType">Booking Type</label>
                                                <div class="input-group"> 
                                                    <div class="input-group-addon">
                                            ...
                                            <div class="form-group col-xs-6 col-md-3 col-sm-3">
                                                <label for="res_source">Source</label>
                                                <select class="form-control select2" style="width: 100%;" id="res_source" name="res_source" data-parsley-errors-container="#res_sourceError" data-parsley-required>
                                                  <option selected="selected" value="-1">Select Source</option>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-xs-6 col-md-3 col-sm-3">
                                                <label for="res_bookerName">Booker Name</label>
                                                <select class="form-control select2" style="width: 100%;" id="res_bookerName" name="res_bookerName" data-parsley-errors-container="#res_bookerNameError" data-parsley-required>
                                                  <option selected="selected" value="-1">Select Contacts</option>
                                            ...
                                            <div class="form-group col-xs-6 col-md-4 col-sm-3">
                                                <label for="res_rateType">Rate Type</label>
                                                <select class="form-control select2" style="width: 100%;" id="res_rateType" name="res_rateType" data-parsley-errors-container="#res_rateTypeError" data-parsley-required>
                                                  <option selected="selected" value="-1">Select Rate Type</option>
                                            ...
                                            <div class="form-group col-xs-6 col-md-5 col-sm-3">
                                                <table>
                                                    <tr>
                                                        <td width="85%">
                                                            <label for="res_rateLetter">Rate Letter</label>
                                                            <select class="form-control select2" style="width: 100%;" id="res_rateLetter" name="res_rateLetter" data-parsley-errors-container="#res_rateLetterError" data-parsley-required>
                                                                <option selected="selected" value="-1">Select Rate Letter</option>
                                 ...
                                 <div class="box box-success">
                                     ...
                                     <div class="box-body table-responsive">
                                        <table class="table table-hover">
                                            <tr>
                                                <th width="">Room Type</th>
                                                <th>Plan</th>
                                                <th>No. of Rooms</th>
                                                <th>Adult Per Person</th>
                                                <th>Child Per Room</th>
                                                <th>Extra Child/Person with Bed per Room</th> 
                                 ...
                                 <div class="row">
                                     <div class="col-md-6 col-xs-12 col-sm-12">
                                        <div class="box box-info block-shadow">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Charges Summary</h3>
                                            </div>
                                            <div class="box-body">
                                               <div class="row">
                                                    <div class="form-group col-xs-6 col-md-4 col-sm-4">
                                                        <label for="res_tariffamt">Tariff Amount</label>
                                                        <input type="text" class="form-control" id="res_tariffamt" name="res_tariffamt" value="5000" disabled />
                                                    </div> 
                                                    <div class="form-group col-xs-6 col-md-4 col-sm-4">
                                                        <label for="res_addonamt">Add On Amount</label>
                                                        <input type="text" class="form-control" id="res_addonamt" name="res_addonamt" value="5000" disabled />
                                                    </div> 
                                                     <div class="form-group col-xs-6 col-md-4 col-sm-4">
                                                        <label for="res_discount">Discount</label>
                                                        <input type="text" class="form-control" id="res_discount" name="res_discount" value="500" disableddata-parsley-errors-container="#res_discountError" data-parsley-required />
                                                        <span id="res_discountError"><?php echo $err_res_discountError;?></span>
                                                    </div> 
                                               </div> 
                                               <div class="row">
                                                    <div class="form-group col-xs-6 col-md-4 col-sm-4">
                                                        <label for="res_taxes">Taxes</label>
                                                        <input type="text" class="form-control" id="res_taxes" name="res_taxes" value="5000" disabled />
                                                    </div> 
                                                    <div class="form-group col-xs-6 col-md-4 col-sm-4">
                                                        <label for="res_advance">Advance</label>
                                                        <input type="text" class="form-control" id="res_advance" name="res_advance" value="5000"
                                                         disableddata-parsley-errors-container="#res_advanceError" data-parsley-required />
                                                        <span id="res_advanceError"><?php echo $err_res_advanceError;?></span>
                                                    </div> 
                                                     <div class="form-group col-xs-6 col-md-4 col-sm-4">
                                                        <label for="res_balance">Balance</label>
                                               ...
                                               <div class="row">
                                                    <div class="form-group col-xs-6 col-md-4 col-sm-4">
                                                        <label for="res_paymentStatus">Payment Status</label>
                                                        <select class="form-control  select2" style="width:100%" id="res_payment" name="res_paymentStatus" disableddata-parsley-errors-container="#res_paymentStatusError" data-parsley-required>
                                                            <option selected="selected" value="-1">Select Payment</option>
                                                        </select>
                                                        <span id="res_paymentStatusError"><?php echo $err_res_paymentStatusError;?></span>
                                                    </div> 
                                                    <div class="form-group col-xs-6 col-md-4 col-sm-4">
                                                        <label for="res_billto">Bill to</label>
                                                        <input type="text" class="form-control" id="res_billto" name="res_billto" value="5000"
                                                         disableddata-parsley-errors-container="#res_billtoError" data-parsley-required />
                                                        <span id="res_billtoError"><?php echo $err_res_billtoError;?></span>
                                                    </div> 
                                                    <div class="form-group col-xs-6 col-md-4 col-sm-4">
                                                        <label for="res_remarks">Remarks</label>
                                                        <select class="form-control  select2" style="width:100%" id="res_remarks" name="res_remarks" disableddata-parsley-errors-container="#res_remarksError" data-parsley-required>
                                                            <option selected="selected" value="-1">Select please</option>
                                               ...
                                               <div class="row">
                                                    <div class="form-group col-xs-6 col-md-8 col-sm-4">
                                                        <label for="res_reference">Reference</label>
                                                        <textarea class="form-control" id="res_reference" name="res_reference" disableddata-parsley-errors-container="#res_referenceError" data-parsley-required>
                                     ...
                                     <div class="col-md-6 col-xs-12 col-sm-12">
                                        <div class="box box-success block-shadow">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Pickup and Arrival Details</h3>
                                            </div>
                                            <div class="box-body">
                                                <div class="row">
                                                    <div class="form-group col-xs-6 col-md-6 col-sm-4">
                                                        <label for="res_pickuprequired">Pickup Required</label>
                                                        <select class="form-control  select2" style="width:100%" id="res_pickup" name="res_pickuprequired" disableddata-parsley-errors-container="#res_pickuprequired" data-parsley-required>
                                                            <option selected="selected" value="-1">Select please</option>
                                                    ...
                                                    <div class="form-group col-xs-6 col-md-6 col-sm-4">
                                                        <label for="res_modeoftravel">Mode of Travel</label>
                                                        <select class="form-control  select2" style="width:100%" id="res_modeoftravel" name="res_modeoftravel" disableddata-parsley-errors-container="#res_modeoftravelError" data-parsley-required>
                                                            <option selected="selected" value="-1">Select please</option>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-xs-6 col-md-6 col-sm-4">
                                                        <label for="res_pickupdetails">Pickup Details</label>
                                                    ...
                                                    <div class="form-group col-xs-6 col-md-6 col-sm-4">
                                                        <label for="res_arrivingfrom">Arriving from</label>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-xs-6 col-md-6 col-sm-4">
                                                        <label for="res_departingto">Departing to</label>
                                                    ...
                                                    <div class="form-group col-xs-6 col-md-6 col-sm-4">
                                                        <label for="res_specialrequest">Special Requests</label>
                                                        <input type="text" class="form-control" id="res_specialrequest" name="res_specialrequest"
                                                        placeholder="Enter Special Requests" disableddata-parsley-errors-container="#res_specialrequestError" data-parsley-required />
    ...
    $.ajax({
       ...
       success: function (result) {   
           // $("#tab_2,#tab_1,#tab_3,.nav-tabs li").removeClass("active");
            ...
            /* filling more options form here */
            $("#newHotel").val(result.Hotel) ; 
            $("#newRoom").val(result.Room) ; 
            $("#newGuest").val(result.Guest) ;  
            $("#newCheckin").val(result.CheckIn) ; 
    ...
    $(document).ready(function(){
        $(document).on('change','#res_bookingStatus', function(){
            ...
            if(bookingStatus == "Tentative"){
                ...
                var holdtill = '<div class="form-group col-xs-6 col-md-3 col-sm-3"><label for="res_holdTillDate">Hold Till Date</label><div class="input-group"><div class="input-group-addon"><i class="fa fa-calendar"></i> </div><input type="text" class="form-control datepicker" name="res_holdTillDate" id="res_holdTillDate" placeholder="dd-mm-yyyy"data-parsley-errors-container="#res_holdTillDateError" data-parsley-required></div><span id="res_holdTillDateError"><?php echo $err_res_holdTillDateError;?></span></div>';

                $("#res_bookingList").html(holdtill);

            }else if(bookingStatus == "Cancelled"){
                var cancelled = '<div class="form-group col-xs-6 col-md-3 col-sm-3"><label for="res_cancellation">Cancellation Reason</label><div class="input-group"><div class="input-group-addon"><i class="fa fa-arrows"></i></div><select class="form-control select2" style="width: 100%;" id="res_cancellation" name="res_cancellation" data-parsley-errors-container="#res_cancellationError" data-parsley-required><option value="Confirmed" selected="selected">A</option><option value="B">B</option><option value="C">C</option><option value="D">D</option></select></div><span id="res_cancellationError"><?php echo $err_res_cancellationError;?></span></div>';
