...
if($_REQUEST['id_kot']!=''){
 ...
 // echo $CheckBlockedTable_Sql = "SELECT * FROM pos_purch_details WHERE  id_pos_purch  IN  (".$kot_doc_no.") $Outlet AND id  IN  (SELECT id FROM pos_purch WHERE  id  IN (".$ResultupdateRow->id_pos_details_split.") )";
 $CheckBlockedTable_Sql = "SELECT * FROM ".TBL_PURCH_DETAILS." AS A  WHERE  id IN (".$ResultupdateRow->id_pos_details_split.")";
		...
		//echo $CheckBlockedTable_Sql;
          ...
          <?php
				...
				// $datasc = $ResultupdateRow->sc_reverse;
