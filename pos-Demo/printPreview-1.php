...
include_once("include/functionTest.php");  ?>
...
if($_REQUEST['printPreviewid']!=''){
	...
	echo $pos_purch_sqlDoc="SELECT max(id) as ids FROM ".TBL_DOC_TYPE_CONFIG." AS A  WHERE id='".$posPurchResult->id_doc_type_configuration."'";
