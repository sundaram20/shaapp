  ...
  <div class="form-group">
   ...
   <?php
      ...
      <select class="form-control select2 parsley-error"  onChange="" name="id_report_type" data-parsley-required id="id_report_type" style="width:100%">
        <option value="">---Select Report Type---</option>
        <?php
            $sqlSubMenu="SELECT * FROM ".APP_DOCTYPE." WHERE 1=1 and status='1' and id_app_modules='6' and id_doc_type IN('101','102')  order by display_order";
...
//Form Data Clear
	...
	var showItemReport = $("#showItemReport").val();
        ...
        let url2 = 'ajax/ajaxPurchaseOrderReport.php?period='+period+'&id_report_type='+id_report_type+'&id_main_group='+id_main_group+'&id_sub_group='+id_sub_group+'&id_item='+id_item+'&ReportShowType='+ReportShowType+'&id_order_by='+id_order_by+'&showItemReport='+showItemReport;
         window.open(url2);
	...
	// alert(id_report_type);
     ...
     $("#loading").show();
	  var id_order_by = $("#id_order_by").val();
		...
		var showItemReport = $("#showItemReport").val();
		var id_item = $("#id_item").val();
		 reportTypeFile  ='ajaxPurchaseOrderReport.php';
		 $.ajax({
