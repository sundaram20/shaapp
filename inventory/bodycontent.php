...
//echo " SELECT * FROM `".TBL_DOC_TYPE_CONFIG."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' AND `id`='".$row->id_doc_type_configuration."' "; ?>
		                  ...
		                  <input data-parsley-required type="text" class="form-control pickerdate" placeholder="Enter PO Date" id="doc_date" name="doc_date" value="<?php if($_POST) echo $_POST['doc_date'];elseif($row->doc_date!='') echo date('d-m-Y',strtotime($row->doc_date));else echo date('d-m-Y');?>" onchange="hideandshow()" onclick="hideandshow()" <?php echo $readonly0; ?>>
...
$id_inv_po_select = explode(',', $row->id_inv_po);
	...
	//	echo "SELECT * FROM `".TBL_INV_PURCH."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' AND  `id_mst_party_supplier`='".$row->id_mst_party_supplier."' AND `doc_type`='4' ";	
				...
				<label for="name"> <?php echo $name ?> <?php echo $mand ?> </label><!-- onchange="popupshow(this.id);"  -->
									...
									<div class="modal-dialog  modal-wd95">">
										<div class="modal-content">
											...
											<div class="modal-body ox-sl">
												<input type="text" id="myInput"  class=" p-5 br-grey search-wid" onkeyup="myFunction()"
											...
											<div class="modal-footer">
												<button type="button" id="test" class="btn o-btn ok"
													data-dismiss="modal" onclick="po();"><i class="fa fa-plus-circle"
														aria-hidden="true"></i> Insert</button>
												<button type="button" class="btn c-btn" data-dismiss="modal"
													onclick="dismiss()"><i class="far fa-window-close"
														aria-hidden="true"></i> Close</button>
											</div>
										</div>
									</div>
								</div>
								<input type="hidden" name="inv_item_array" id="inv_item_array" value="">
				            	...
				            	?>
					                 ...
					                 $ledger_id = 1; ?>
												...
												<?php } if(!empty($_REQUEST['eId']) && $_REQUEST['action']=='edit'){
													$partyLedger =selectColumn(TBL_PARTY,'ledger','WHERE id="'.$row->id_mst_party_billtobe.'" ');											if($partyLedger==1){ 
					                 $ledger_id = 1; ?>
												<style type="text/css">
													#locals<?php echo $k;
												...
												<tr id="edittrdelete<?php echo $k;?>">
													...
													<td style="width:10%;" class="form-group col-md-2">
								...
								?>
										...
										if($array['id_inv_po'.''.$j] == 0){
										 ...
										 -->
													...
													<td style="width:9%" class="form-group col-md-2">
														<input type="text" autocomplete="off"
                      ...
                      $sqlResult1 = "SELECT * FROM ".TBL_ATTRIBUTES." WHERE table_name = 'items_type' AND field_category IN ('Ingredients Items','Both','Other Items','Store Items') AND id_shop = ".$_SESSION['shop'] ." ";
                        ...
                        $item_list = rtrim($string,',');
										...
										?>
													...
													<td style="width:21%" class="form-group col-md-2 ">
														<input type="text" autocomplete="off"
													...
													<td style="width:6%" class="form-group col-md-1">
														<select class="form-control select2"
				                    ...
				                    ?>
													<td style="width:7%" class="form-group  col-md-1 ">
													...
													<td style="width:8%" class="form-group col-md-1">
														<input type="text" autocomplete="off"
													...
													<td style="width:3%" class="form-group col-md-2">
														<input type="text" autocomplete="off"
				                	 ...
				                	 ?>
												...
												<tr id="edittrdeletes<?php echo $k;?>">-->
													...
													<td style="width:6%" class="form-group col-md-2">
										  ...
										  ?>
											...
											?>
											  ...
											  ?>
													...
													<td style="width:21%" class="form-group col-md-1">
														<input style="width:124px" type="text" autocomplete="off"
															name="item_remarks<?php echo $k;?>"
															id="item_remarks<?php echo $k;?>" placeholder="Remarks"
															class="form-control"
															value="<?php if($_POST) echo $_POST['item_remarks'];else echo stripslashes($array['item_remarks'.''.$j]); ?>" />
				            	...
				            	?>
										...
										<div id="others<?php echo $k;?>" name="others<?php echo $k;?>">
											<select class="form-control select2"
												...
												<?php $categoryDropDown = '<option value="">Select Others Charges</option>';
												   ...
												   /*$sql = "SELECT mst_charges.* FROM mst_charges WHERE mst_charges.id_shop = '".addslashes($_SESSION['shop'])."' AND mst_charges.charges_account IN (4,7) ";
							                    ...
							                    while($row1 = $db->fetch_object()){	
													...
													$categoryDropDown .= '<option '.$selected.' value="'.$row1->id.'">00'.ucfirst($row1->name).'</option>';
												*/
									...
									<td>
										...
										<a class="btn n-btn  abtn ibtnDel2" style="cursor:pointer;"
											title="Delete" id="ibtns<?php echo $k;?>" name="ibtns<?php echo $k;?>"><i class="fa fa-trash-o"></i></a>
												...
												<div class="col-xs-12 col-md-3 col-sm-2">
													...
													<div class="input-group">
														...
														<input type="text" class="form-control"
															...
															value="<?php echo $row->discount_percent_items;?>" >
													</div>
												</div>
												<div class="col-xs-12 col-md-3 col-sm-2">
			            	...
			            	<table id="myTable3" class="table table-bordered table-striped order-list3 mt-10 max-h2">
					            <thead>
					                <tr>
					                    ...
					                    <th class="p-0" style="width:4%;">	

						                  	 <a  type="button" title="Add Row" class="btn n-btn" id="addrow3" value="Add Row"> <span><i class="fa fa-plus"></i> </span> </a>
						             	</th>
					                </tr>
					            </thead>
					            <tbody>
...
if($numRows==0){ $i=1;
                ...
                <i class="fa fa-plus"></i>
                  ...
                  <i class="fas fa-tag"></i>  
                        ...
                        <input type="text" class="form-control" placeholder="0" id="disc_amount_additional" name="disc_amount_additional" value="<?php if($_POST) echo $_POST['disc_amount_additional'];else echo stripslashes($row->disc_amount_additional); ?>" onchange="amount_calc(this.id);" style="text-align:right;">
