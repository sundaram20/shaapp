...
<?php
	...
	$list = 'managePriceMatrix.php';
	$edit = 'editPriceMatrix.php';
	$NewKot='editPriceMatrix.php';
   ...
   <div class="row">
        ...
        <div class="col-md-7 col-lg-7">
          <!-- general form elements -->
            ...
            <!-- /.box-header -->
            <!-- form start -->  			        
			 <form name="price_matrix_form"  method="post" enctype="multipart/form-data" data-parsley-validate autocomplete="off" id="price_matrix_form">
              ...
              <div class="box-body" id="printTable" >
      			...
      			?>
      					<?php 
				            	...
				            	$sql22 = "SELECT * FROM  `".TBL_PRICE_MATRIX_DETAILS."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' AND `id_inv_price_matrix` = '".addslashes(encryptor(decrypt,$_REQUEST['eId']))."' limit 1";
								 $db->query($sql22);  
							     ...
							     <p> <b><?php echo $name_no; ?></b> <?php echo stripslashes($prefix).''.stripslashes($row->doc_no).''.stripslashes($suffix); ?> </p>
			                      ...
			                      <td class="pm" style="width: 40%;font-family: sans-serif;font-size:12px;">
									...
									<p ><b>Department : </b><?php 
									  	$resCat = selectSql(TBL_PARTY,"where id_shop='".$_SESSION['shop']."' and status = '1' AND id='".$row->id_mst_party_supplier."' ",' ORDER BY `company_name`');
									  if($db->num_rows2($resCat)){
									  	while($resultCat = $db->fetch_object2($resCat)){ 
											echo ucfirst($resultCat->company_name);
										}
									  } 
									?>
									</p>
		            	...
		            	<table   id="myTable1" class="table  dataTable no-footer" width="100%" border="0" cellspacing="0" cellpadding="10" >
				            <thead>
				                <tr >
				                    ...
				                    <td  class="pm" style="width:20%;font-family: sans-serif;border-right:.4px solid #000;border-bottom:.4px solid #000;" ><p style="font-size:12px;"><b>Last Rate</b></p></td>  
									<td  class="pm" style="width:20%;font-family: sans-serif;border-right:.4px solid #000;border-bottom:.4px solid #000;" ><p style="font-size:12px;"><b>Rate</b></p></td>  
									<td class="pm" style="width:30%;font-family: sans-serif;border-bottom:.4px solid #000;"><p style="font-size:12px;"><b>Approved</b></p></td> 
				            ...
				            <tbody>
				                ...
				                <tr>
				                	<td class="pm"  style="padding:0px!important;margin:0;border-right:.4px solid #000;font-family: sans-serif;border-bottom:.4px solid #000;"><p style="font-size:11px;font-family: sans-serif;padding:5px!important;padding-left:15px!important;margin:0!important;">
					                 	<?php 
					                ...
					                <td   class="pm" style="padding-top:4px!important;width:10%;padding:0px!important;padding-left:5px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;"><p style="font-size:11px;font-family: sans-serif;padding:5px!important;margin:0!important;">
					                 	...
					                 	?>  <?php if($rowsID->remarks_price_matrix_details!=''){?> <span style="display:block;font-size: 10px;"> remarks : <?php 
					                 		echo $rowsID->remarks_price_matrix_details ; 
					                 	?></span> <?php } ?></p>
				                    </td>
					                
				                      
				                    
				                    <td class="pm" style="border-right:.4px solid #000;border-bottom:.4px solid #000;padding-top:4px!important;width: 20%;padding:0px!important;padding-left:5px!important;margin:0;"><p style="font-size:11px;font-family: sans-serif;padding:5px!important;margin:0!important;">
				                    	<?php 
					                 		echo $rowsID->last_rate; 
