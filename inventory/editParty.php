            ...
            <!-- form start -->  			        
			 <form name="form1"  method="post" enctype="multipart/form-data" data-parsley-validate autocomplete="off" >
              ...
              <div class="box-body">
              	...
              	<div class="card text-dark bg-light">
		            ...
		            <div class="row">
		            	<div class="form-group col-xs-12 col-md-6 col-sm-2">
		                  ...
		                  <input type="text" class="form-control" placeholder="Enter Phone Number" id="phone" name="phone" value="<?php if($_POST) echo $_POST['phone'];else echo stripslashes($row->phone);?>"  >
	              ...
	              <select class="form-control select2" style="width:100%" name="id_mst_country_lang" id="id_mst_country_lang" data-parsley-errors-container="#countryError" required="required" data-parsley-required onChange="getState(this.value);">
	              ...
	              <span id="countryError"></span> 
		            	...
		            	<?php /*?><div class="form-group col-xs-12 col-md-6 col-sm-2">
...
function getState_countrybased() {
		var country_id = document.getElementById("id_mst_country_lang");
