...
$itemDetailSizeOf=	sizeof($_POST['id_inv_poo']);
 ...
 $id_inv_poo = rtrim($id_po,',');
			...
			if(1){
				$_SESSION['successMsg'] = 'New Details has been added successfully.';
				
				if($_POST['another']!=''){
					header("location:editPurch.php?submenu=".$_GET['submenu']."&session=".$_GET['session']."&doc_type=".$_GET['doc_type']."&print=1");	
				}else{
					header("location:".$print_redirect_page."?eId=".addslashes(encryptor(encrypt,$lastInsertId))."&submenu=".$_GET['submenu']."&session=".$_GET['session']."&action=edit&page=".$_REQUEST['page']."&doc_type=".$_REQUEST['doc_type']."&print=1");
				}
	...
	executeSql($auditeditSql);
			...
			if(1){  
				...
				if($_POST['another']!=''){
					...
					header("location:".$print_redirect_page."?eId=".$_GET['eId']."&submenu=".$_GET['submenu']."&session=".$_GET['session']."&action=edit&page=".$_REQUEST['page']."&doc_type=".$_GET['doc_type']."&print=1"); 
				}
...
//echo $row->id_inv_po;
								?>	
					                	...
					                	<select class="form-control select2" id="id_inv_po<?php echo $k;?>" name="id_inv_po<?php echo $k;?>" onchange="popupshow(this.id);" onclick="popupshow(this.id);" style="width:100%" required data-parsley-errors-container="#outletError2" ><option value="">Select <?php echo $table_field; ?></option>
										
										<?php if($_GET['doc_type'] == '12' && $_GET['doc_type'] != '4'){ ?><option value="na" selected >NA</option> 
								...
								<?php	if($row->id != ''){
										...
										<?php if($row->id !='' && $row->doc_type != '12'){
											...
											<option <?php echo $selected; ?> value="<?php echo $id;?>" > <?php echo $row2->doc_no .' | '.date('d-m-Y' , strtotime(addslashes($row2->doc_date)))?></option>
												...
												<?php }  } } ?>
					                  	 </select><span id="outletError2"></span>  
				                ...
				                <!--   </tr><tr id="edittrdeletes<?php echo $k;?>">-->
				                    ...
				                    <td  style="width:9%;">        
				                  	...
				                  	<td  width="12%"> 
				                  		<div id="localss<?php echo $k;?>" name="localss<?php echo $k;?>" >
					                  		<span class="color-red" id="s_amount<?php echo $k;?>">
												<?php echo $sgst;?>
											</span>
											<span class="color-red" id="c_amount<?php echo $k;?>">
												<?php echo $cgst;?>
											</span>
										</div>
										 <div id="interstatess<?php echo $k;?>" name="interstatess<?php echo $k;?>">
											<span class="color-red" id="i_amount<?php echo $k;?>">
													<?php echo $igst;?>
											</span>
										</div>
									</td>
										<td style="width:10%"> 
				                       <input type="text" style="width:200px" autocomplete="off"  name="item_remarks<?php echo $k;?>" id="item_remarks<?php echo $k;?>" placeholder="Remarks1"  class="form-control" value="<?php if($_POST) echo $_POST['item_remarks'];else echo stripslashes($array['item_remarks'.''.$j]); ?>" />
				                    </td>	
				            ...
				            <tfoot>
				                <tr> 
				                        <td colspan="13" style="text-align: left;">
											 ...
											 <a  type="button" class="btn n-btn btn-block"  id="addrow1" value="Add Row" ><span><i class="fa fa-plus"></i> Add Row2</span> </a>
				            ...
				            <tbody id="discountData">
				                ...
				                <tr>
				                   ...
				                   <?php if($k==0){?> <td>
				                    	   ...
				                    	   <a  type="button" class="btn n-btn abtn"  id="addrow2" value="Add Row">
...
<a class="btn n-btn  abtn ibtnDel2 "id="ibtns<?php echo $k;?>"  name="ibtns<?php echo $k;?>" style="cursor:pointer;" title="Delete"><i class="fa fa-trash-o"></i></a>
		        ...
		        ?>
		            <div class="row"> 	            	
						<div class="form-group mb-0 col-xs-12 col-md-6 col-sm-12"> 
	                ...
	                $sql = "SELECT mst_charges.*FROM mst_charges WHERE mst_charges.id_shop = '".addslashes($_SESSION['shop'])."' AND  charges_account = '2' and transaction_type = '2'";
	                    ...
	                    while($row1 = $db->fetch_object()){ ?>
	                  	...
	                  	cols2 += '<td></td>';
		 					 ...
		 					 cols1 += '<td><input type="text"  autocomplete="off" placeholder="Remarks2" class="form-control" name="item_remarks' + counter1 + '" id="item_remarks' + counter1 + '"/></td>';
...
/* if(counter21 == 0 && counter21 != ''){
	...
	var counter2 =  counter22; 
		...
		cols2 += '<td><a  class="btn n-btn  abtn ibtnDel2" id="deletes' + counter2 + '" name="deletes' + counter2 + '" style="cursor:pointer;" title="Delete"><i class="fa fa-trash-o  style="cursor:pointer;" title="Delete"/></i></td>';
		 $("</tr>"); 
...
var inv_item_array_exist 	= document.getElementById("inv_item_array").value;//$("#inv_item_array").val();
alert(inv_item_array_exist);
if(inv_item_array_exist != ''){	 alert('exist');
var id_po_update=inv_item_array_exist +','+ id_po;	
	   ...
	   //Table Row Add Section Here
        ...
        cols1 += '<td style="display:none;"><div id="taxconfig" id="taxconfig"><!-- SGST --><input type="text"  autocomplete="off"  name="id_mst_charges_sgst' + counter4 + '" id="id_mst_charges_sgst' + counter4 + '" placeholder="SGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_sgst_percent' + counter4 + '" id="item_sgst_percent' + counter4 + '" placeholder="SGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_sgst_amount' + counter4 + '" id="item_sgst_amount' + counter4 + '" placeholder="SGST Amount"  class="form-control"  /><!-- CGST --><input type="text"  autocomplete="off"  name="id_mst_charges_cgst' + counter4 + '" id="id_mst_charges_cgst' + counter4 + '" placeholder="CGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_cgst_percent' + counter4 + '" id="item_cgst_percent' + counter4 + '" placeholder="CGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_cgst_amount' + counter4 + '" id="item_cgst_amount' + counter4 + '" placeholder="CGST Amount"  class="form-control" /><!-- IGST --><input type="text"  autocomplete="off"  name="id_mst_charges_igst' + counter4 + '" id="id_mst_charges_igst' + counter4 + '" placeholder="IGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_igst_percent' + counter4 + '" id="item_igst_percent' + counter4 + '" placeholder="IGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_igst_amount' + counter4 + '" id="item_igst_amount' + counter4 + '" placeholder="IGST Amount"  class="form-control" /></div></td>';
		 	 ...
		 	 cols1 += '<td><div id="local'+counter4+'" name="local'+counter4+'" style="display:none;"><select  name="id_mst_charges_purchase_local' + counter4 + '" id="id_mst_charges_purchase_local' + counter4 + '" class="form-control select3" onchange="po_locals(this.id)" style="width:100%;"><option>Select</option><?php 
	                ...
	                cols1 += '<td><input type="text"  autocomplete="off" placeholder="Remark3" class="form-control" name="item_remarks' + counter4 + '" id="item_remarks' + counter4 + '"/></td>';
