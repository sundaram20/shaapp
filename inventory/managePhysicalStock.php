...
//filters start
 //if($_REQUEST['searchFormSubmit']==1){
	...
	$statuscase .= " AND `doc_no` ='".addslashes($_REQUEST['search_name'])."'";
            ...
            <div class="box-body table-responsive">
		        ...
		        <tbody>  
				  ...
				  <td><img src="../images/edit.png" style="height:20px;cursor:pointer;" title=" View / Edit " onClick="window.location.href='editPhysicalStock.php?eId=<?=encryptor(encrypt, $row->id)?>&submenu=<?php echo $_GET["submenu"]; ?>&session=<?php echo $_GET["session"]; ?>&action=edit&page=<?=$_REQUEST['page']?>&print=0';" />&nbsp;&nbsp;&nbsp;&nbsp;
				  	<img src="../images/preview.png" style="height:20px;cursor:pointer;" title="Page Preview" onClick="window.location.href='printPhysicalStock.php?eId=<?=encryptor(encrypt, $row->id)?>&submenu=<?php echo $_GET["submenu"]; ?>&session=<?php echo $_GET["session"]; ?>&action=edit&page=<?=$_REQUEST['page']?>'; " />&nbsp;&nbsp;&nbsp;&nbsp;
