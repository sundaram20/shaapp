...
if($_POST['Save']){
	...
	if($err == 0){//No error
		if(($_POST['Save'] == 'Add') && empty($_POST['eId'])){//add 
			 ...
			 $sql5 = " SELECT * FROM `".TBL_INV_PURCH."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' AND  `pu_no`='".$pu_no."'  and `doc_type` = '4'  ";
				$db->query($sql5);
				$numRows= $db->num_rows();
					if($numRows > 0)   {
			...
			if($_POST['prefix'] !='' && $_POST['suffix'] !=''){
				$mdoc_no = $_POST['prefix'].''.$pu_no.''.$_POST['suffix'];
			}else{
			...
			$addSql = "   	INSERT INTO `".TBL_INV_PURCH."` SET
							...
							`pu_no` = '".addslashes($pu_no)."',  
							`pu_date` = '".date('Y-m-d' , strtotime(addslashes($_POST['pu_date1'])))."',  
				...
				$addSql = " INSERT INTO `".TBL_INV_PURCH_DETAILS."` SET
							...
							`id_inv_pu` = '".addslashes($lastInsertId)."',  
			...
			if(1){
				...
				header("location:editGRN.php?eId=".addslashes(encryptor(encrypt,$lastInsertId))."&submenu=".$_GET['submenu']."&action=edit&page=".$_REQUEST['page']."&print=1");
				exit;
			}else{
				$err++;
		...
		//Update Section Here
			...
			if($_POST['prefix'] !='' && $_POST['suffix'] !=''){
				$mdoc_no = $_POST['prefix'].''.$_POST['pu_no'].''.$_POST['suffix'];
			}else{
				$mdoc_no = $_POST['mdoc_no'];
			}
			//Update Indent Table
			 $editSql = "   	UPDATE `".TBL_INV_PURCH."`  SET  
				...
				//Update INV PO DETAILS Details
  						...
  						if($per_unit == $transaction_unit){
							...
							`id_inv_pu` = '".addslashes(encryptor(decrypt,$_POST[eId]))."', 
							`id_inv_po` = '".addslashes($id_inv_po )."',  
							`id_inv_po_details` = '".addslashes($_POST["id_inv_po_details"])."',
							`base_currency_code` = '".addslashes($_POST['base_currency_code1'])."',
							`transaction_currency_code` = '".addslashes($_POST['transaction_currency_code1'])."',
			...
			if(1){  
				...
				header("location:editGRN.php?eId=".$_GET['eId']."&submenu=".$_GET['submenu']."&action=edit&page=".$_REQUEST['page']."&print=1"); 	exit;
			}else{
				$err++;
...
<title>RoomStatusHUB | Edit Goods Receipt Note Manager</title>
          ...
          <!-- general form elements -->
            ...
            <!-- form start -->  			        
              ...
              <div class="box-body">
              	...
              	<div class="card text-dark bg-light">
              		<div class="bg-primary text-center ">
              			<h5 style="padding: 5px;">Goods Receipt Note</h5>
              		</div> 
              		<hr>
	              	...
	              	<div class="row">	
	              			...
	              			<div class="input-group-addon">
								<i class="fa fa-book"></i> 
		              			...
		              			<select class="form-control select2" id="doc_type" name="doc_type" onchange="hideandshow()">	                	  		                  	  
			                  	 	<option selected="selected" value="4">Goods Receipt Note</option>  
			                  	</select>	 
	              			<?php 
		                  ...
		                  <input data-parsley-required type="text" class="form-control pickerdate" placeholder="Enter PO Date" id="pu_date" name="pu_date" value="<?php if($_POST) echo $_POST['pu_date'];else echo stripslashes($row->pu_date);?>" onchange="hideandshow()" onclick="hideandshow()" <?php echo $readonly; ?>>

		                   <input style="display: none;"  type="text" class="form-control pickerdate" placeholder="Enter PO Date" id="pu_date1" name="pu_date1" value="<?php if($_POST) echo $_POST['pu_date'];else echo stripslashes($row->pu_date);?>" >
		                  </div> 
	              		</div>
		                ...
		                <div class="form-group col-xs-12 col-md-6 col-sm-2">
		                  <?php if($row->id ==''){?>
	              			...
	              			<div id="ind" name="ind">
		              			...
		              			<div class=" col-xs-12 col-md-4 col-sm-6">
		              				<label for="name">PU No</label>
		              				<div class="input-group"> 
			              			<div class="input-group-addon">
										<i class="fa fa-list-ol"></i> 
								   	</div>
		              				<input type="text" class="form-control" placeholder="PU No" id="pu_no" name="pu_no" value="<?php if($_POST) echo $_POST['pu_no'];else echo stripslashes($row->pu_no);?>" readonly>
		              				</div> 
			                	</div>
			                	<div class=" col-xs-12 col-md-4 col-sm-6">
		            ...
		            <div class="row">	
	              		...
	              		<div class="form-group col-xs-12 col-md-6 col-sm-2" >
	              			...
	              			<select class="form-control select2" name="id_mst_party_supplier" id="id_mst_party_supplier" onchange="supplier()" data-parsley-required <?php echo $readonly; ?>>
		                ...
		                <div class="form-group col-xs-12 col-md-6 col-sm-2">
		                  ...
		                  <div class="input-group"> 
			                  ...
			                  <select onchange="billtobe()" class="form-control select2" name="id_mst_party_billtobe" id="id_mst_party_billtobe" data-parsley-required  >
		                ...
		                <div class="form-group col-xs-12 col-md-3 col-sm-6" id="base_currency" name="base_currency">
		                ...
		                <div class="form-group col-xs-12 col-md-3 col-sm-6" id="xchange_rate" name="xchange_rate">
		                ...
		                <div class="form-group col-xs-12 col-md-3 col-sm-6" id="trans_currency" name="trans_currency">
		        ...
		        <hr>
		         <div class="box-body">
              	...
              	<div class="card text-dark bg-light">
              		<div class="bg-primary text-center ">
              			<h5 style="padding: 5px;">Goods Receipt Note Details</h5>
              		</div>  
	              	<div class="row">
	              		<?php 
		                  ...
		                  <input type="text" class="form-control" id="id_inv_pu" name="id_inv_pu"  value="<?php echo $id_po_id; ?>" > 
		                </div>
		            </div>
		            
					<!-- The Modal -->
					<div class="modal" id="config_model"  style="margin-right: 10%;" >
					    <div class="modal-dialog">
					      <div class="modal-content"  style="width: 150%; padding-right: 3%;">
					      
					        <!-- Modal Header -->
					        <div class="modal-header">
					          <h4 class="modal-title">Pending Purchase Order</h4>
					          <button type="button" class="close" data-dismiss="modal">&times;</button>
					        </div>
					        
					        <!-- Modal body -->
					        <div class="modal-body">
					        	<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search For Item Description" title="Type In Item Description">
		            ...
		            <div class="row">
		            	...
		            	<table id="myTable1" class=" table order-list1">
				            ...
				            <tbody>
				            	...
				            	$sql2 = "  SELECT * FROM  `".TBL_INV_PURCH_DETAILS."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' AND `id_inv_pu` = '".addslashes(encryptor(decrypt,$_REQUEST['eId']))."' ";

								 $db->query($sql2); 

								while($rowsID = $db->fetch_object()){
							 		 $array['id'.''.$i] = $rowsID->id;
							 		 $array['id_inv_pu'.''.$i] = $rowsID->id_inv_pu; 
				                ...
				                <tr id="edittrdelete<?php echo $k;?>">
					                ...
					                <td class="form-group col-md-2">
					                	<select class="form-control select2" id="id_inv_po<?php echo $k;?>" name="id_inv_po<?php echo $k;?>"  onchange="popupshow(this.id);" > <?php if($row->id != ''){?> <option value="<?php echo $array['id_inv_po'.''.$j];?>" selected="selected"><?php echo $array['id_inv_po'.''.$j];?></option> <?php $sql2 = "SELECT * FROM `".TBL_INV_PO."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' AND  `id_mst_party_supplier`='".$row->id_mst_party_supplier."' ";
											$db->query($sql2);  
											$numRows= $db->num_rows();									
											while($row2 = $db->fetch_object()){  
					                ...
					                <td class="form-group col-md-1">  
					                	<select class="form-control select2" name="id_mst_attributes_store<?php echo $k;?>" id="id_mst_attributes_store<?php echo $k;?>" >
					               ...
					               <input type="text"  autocomplete="off" name="id_inv_po_details<?php echo $k;?>" id="id_inv_po_details<?php echo $k;?>" placeholder="ID"  class="form-control"  value="<?php if($_POST) echo $_POST['id_inv_po_details'];else echo stripslashes($array['id_inv_po_details'.''.$j]); ?>" readonly=""  style="display:none;" />
					                ...
					                <div id="hideshow_item_codes" style="display: none;">
					                	<select class="form-control select2" name="id_inv_items_po<?php echo $k;?>" id="id_inv_items_po<?php echo $k;?>" onchange="itemget(this.id)">
				                    ...
				                    ?>
				                    <td class="form-group  col-md-1 "> 
				                        <input type="text"  autocomplete="off"  name="qty<?php echo $k;?>" id="qty<?php echo $k;?>" placeholder="Qty" onkeyup="amount_calc(this.id);" onclick="amount_calc(this.id);"  class="form-control" value="<?php if($_POST) echo $_POST['qty'];else echo $qty; ?>" />
				                    </td>
				                    <td class="form-group col-md-1">  
				                        <select class="form-control select2" id="transaction_unit<?php echo $k;?>" name="transaction_unit<?php echo $k;?>" onchange="amount_calc(this.id);"> 
				                    ...
				                    <td class="form-group col-md-1"> 
					                 	 <input type="text"  autocomplete="off"  name="rate_per_main_unit<?php echo $k;?>" id="rate_per_main_unit<?php echo $k;?>" placeholder="Rate"  class="form-control" value="<?php if($_POST) echo $_POST['rate_per_main_unit'];else echo $rate_per_main_unit; ?>" onkeyup="amount_calc(this.id)" />
					                ...
					                <td class="form-group col-md-1">  
				                        <select class="form-control select2" id="per_unit<?php echo $k;?>" name="per_unit<?php echo $k;?>" onchange="amount_calc(this.id);"> 
					                ...
					                <td class="form-group col-md-1">
				                         <input type="text"  autocomplete="off"  name="discount_percent<?php echo $k;?>" id="discount_percent<?php echo $k;?>" placeholder="%Discount"  class="form-control" value="<?php if($_POST) echo $_POST['discount_percent'];else echo stripslashes($array['discount_percent'.''.$j]); ?>" onkeyup="amount_calc(this.id);"  onclick="amount_calc(this.id);" />
				                    </td>
					                <td class="form-group col-md-2"> 
					                 	 <input type="text"  autocomplete="off"  name="item_amount<?php echo $k;?>" id="item_amount<?php echo $k;?>" placeholder="Amount"  class="form-control" value="<?php if($_POST) echo $_POST['item_amount'];else echo stripslashes($array['item_amount'.''.$j]); ?>" readonly/>
					                </td>					                
				        ...
				        <div class="row"> 
				        	<div class="col-xs-12 col-md-3 col-sm-2">
						        ...
						        <select class="form-control select2" name="id_mst_charges_discounts_items" id="id_mst_charges_discounts_items"  style="width: 100%;" onchange="discount_all(this.id)">
		            ...
		            <div class="card text-dark bg-light">
	              		<div class="bg-primary text-center ">
	              			<h5 style="padding: 5px;">Others / Discounts</h5>
	              		</div>  
			            <div class="row">
				            ...
				            <tbody>
				            	...
				            	//Indent Details Here First Row Only Select
				            	$sql2 = "SELECT * FROM  `".TBL_INV_OTHERS_CHARGES_PURCH."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' AND `id_inv_pu` = '".addslashes(encryptor(decrypt,$_REQUEST['eId']))."' ";
								 $db->query($sql2); 
				                ...
				                <tr>
					                ...
					                <?php if($row->id == !''){  ?>			                 		 
			                 		<?php 
			                 		if($array['type'.''.$j] == '1'){ ?>
			                 			<select class="form-control select2" name="type<?php echo $k;?>" id="type<?php echo $k;?>" ><?php
			                 		...
			                 		<?php }else{
			                 			?>
					                	<select class="form-control select2" id="type<?php echo $k;?>" name="type<?php echo $k;?>" onchange="type_funt(this.id)" > 
					                ...
					                <td class="form-group col-xs-12 col-md-2 col-sm-1">
					                	<div id="others<?php echo $k;?>" name="others<?php echo $k;?>">
					                 		<select class="form-control select2" name="id_mst_charges_others<?php echo $k;?>" id="id_mst_charges_others<?php echo $k;?>"  style="width: 100%;" onchange="charges_others(this.id)">
												<?php $categoryDropDown = '<option value="">Select Others Charges</option>';
											 						 
							                   	$sql = "SELECT mst_charges.*FROM mst_charges WHERE mst_charges.id_shop = '".addslashes($_SESSION['shop'])."' AND mst_charges.charges_account = '4' ";
							                   	 $db->query($sql); 
							                    while($row1 = $db->fetch_object()){	
										...
										<div id="discounts<?php echo $k;?>" name="discounts<?php echo $k;?>">
											<select class="form-control select2" name="id_mst_charges_discounts<?php echo $k;?>" id="id_mst_charges_discounts<?php echo $k;?>"  style="width: 100%;" onchange="otherscharges_discount(this.id)">
									...
									<td class="form-group col-xs-12 col-md-1 col-sm-2" > 
				                        ...
				                        <input type="text"  autocomplete="off"  name="others_charges_percent<?php echo $k;?>" id="others_charges_percent<?php echo $k;?>" placeholder="Percentage"  class="form-control" value="<?php if($_POST) echo $_POST['others_charges_percent'];else echo stripslashes($array['others_charges_percent'.''.$j]); ?>" onkeyup="subtotal_calc(this.id)"  />
				                    	<?php //} ?>
				                    </td>			                
				                    
				                	<td class="form-group col-xs-12 col-md-2  col-sm-2">   

					                 	<input type="text"  autocomplete="off"  name="others_charges_amount<?php echo $k;?>" id="others_charges_amount<?php echo $k;?>" placeholder="Amount"  class="form-control" value="<?php if($_POST) echo $_POST['others_charges_amount'];else echo stripslashes($array['others_charges_amount'.''.$j]); ?>" onkeyup="charges_amount_calc(this.id)" onclick="charges_amount_calc(this.id)" />
				            ...
				            <tfoot>
				                <tr> 
				                        <td colspan="12" style="text-align: left;">
				                            <input  type="button" class="btn btn-sm btn-block" id="addrow2" value="Add More" /> 
				                        </td> 
				                </tr>
				                <tr>
				                </tr>
		            ...
		            <div class="card text-dark bg-light">
			            ...
			            <div class="row">
			                ...
			                <div class="form-group col-xs-12 col-md-3 col-sm-2">
			                  ...
			                  <input type="text" class="form-control" placeholder="Others Charges" id="others_charges_net_amount" name="others_charges_net_amount" value="<?php if($_POST) echo $_POST['others_charges_net_amount'];else echo stripslashes($row->others_charges_net_amount); ?>" readonly style="text-align:right;">
			           	...
			           	<div class="row">
			                ...
			                <div class="form-group col-xs-12 col-md-3 col-sm-2"></div>
			                <div class="form-group col-xs-12 col-md-3 col-sm-2"></div>
			                <div class="form-group col-xs-12 col-md-3 col-sm-2"> <label for="name">Additional Discount Amount</label></div>
			                 <div class="form-group col-xs-12 col-md-3 col-sm-2"> 
			                  <div class="input-group"> 
		              			<div class="input-group-addon">
									<i class="fa fa-cog"></i>
							   	</div>
			                  <input type="text" class="form-control" placeholder="Discount Amount" id="disc_amount_additional" name="disc_amount_additional" value="<?php if($_POST) echo $_POST['disc_amount_additional'];else echo stripslashes($row->disc_amount_additional); ?>" readonly style="text-align:right;">
			           	...
			           	<div class="row">
			                ...
			                <div class="form-group col-xs-12 col-md-3 col-sm-2"></div>
			                <div class="form-group col-xs-12 col-md-3 col-sm-2"></div>
			                <div class="form-group col-xs-12 col-md-3 col-sm-2"> <label for="name">Round Of Amount</label></div>
			                 <div class="form-group col-xs-12 col-md-3 col-sm-2"> 
			                  <div class="input-group"> 
		              			<div class="input-group-addon">
									<i class="fa fa-plus-square"></i>
							   	</div>
			                  <input type="text" class="form-control" placeholder="Round Amount" id="round_off_amount" name="round_off_amount" value="<?php if($_POST) echo $_POST['round_off_amount'];else echo stripslashes($row->round_off_amount); ?>" readonly style="text-align:right;">
			                  </div> 
			                </div>
			           	</div>
			           	...
			           	<div class="row">
			                ...
			                <div class="form-group col-xs-12 col-md-3 col-sm-2"> <label for="name">Net Amount</label></div>
			                 <div class="form-group col-xs-12 col-md-3 col-sm-2"> 
			                  ...
			                  <input type="text" class="form-control" placeholder="Net Amount" id="net_amount" name="net_amount" value="<?php if($_POST) echo $_POST['net_amount'];else echo stripslashes($row->net_amount); ?>" readonly style="text-align:right;">
			                  </div> 
			                </div>
			           	</div> 
		        	</div>
			 ...
			 <div class="box-footer">                                       
				...
				&nbsp;&nbsp;&nbsp;&nbsp; 
			   <input type='button' value='Cancel' class="btn btn-danger" onclick='location.replace("manageGRN.php?submenu=<?php echo $_GET['submenu']; ?>"); '>
			   <?php if($row->id !=''){?>
			   	<center>
		          <a href="editGRN.php?submenu=<?php echo $_GET['submenu']; ?>" type="button" class="btn btn-info"><i class="fa fa-plus-circle" aria-hidden="true"> Another GRN Order</i></a> 
		          <?php                   		 
...
<script type="text/javascript">
	...
	function net_amount(){
		...
		document.getElementById("round_off_amount").value = adjust_amount;
	 			...
	 			var disc_amount_additional1 = document.getElementById("disc_amount_additional1").value;
		 			...
		 			if(counter2 >=1){
		 				...
		 				if(ledger_id == 1){
			 				...
			 				document.getElementById("sgst_net_amount").value =Number(oc_sgst_total) + Number(sgst2);
			 				//CGST
			 				...
			 				document.getElementById("cgst_net_amount").value =Number(oc_cgst_toal) + Number(cgst2);
			 			}
			 			if(ledger_id == 2){
			 				//IGST
			 				...
			 				document.getElementById("igst_net_amount").value =Number(oc_igst_toal) + Number(igst2); 
			 			}
				...
				if(type == 1 ){ 
					...
					if(counter2 >=1){
		 				...
		 				if(ledger_id == 1){
			 				...
			 				document.getElementById("sgst_net_amount").value =Number(sgst_start) + Number(sgst2);
			 				//CGST
			 				document.getElementById("oc_cgst_total").value =cgst_start;
			 				document.getElementById("oc_cgst2").value =cgst_start;
			 				document.getElementById("cgst_net_amount").value =Number(cgst_start) + Number(cgst2);
			 			}
			 			if(ledger_id == 2){
			 				//IGST
			 				document.getElementById("oc_igst_total").value =igst_start;
			 				document.getElementById("oc_igst2").value =igst_start;
			 				document.getElementById("igst_net_amount").value =Number(igst_start) + Number(igst2);
			 			} 
		 			}
		 		}
		...
		$.ajax({
				...
				success: function(data){  
					...
					if(match >=1){ 
						 ...
						 var amount = document.getElementById("others_charges_amount"+match).value;
						 var igstnetamount = (amount * (igst / 100));
						...
						//Tax Config Method
						 ...
						 if(counter2 >=1){
							...
							if(condition == 1){
				 			...
				 			document.getElementById("oc_sgst_total").value =sgstnetamount;
				 			document.getElementById("oc_sgst1").value =sgstnetamount;  		 				
				 			document.getElementById("oc_sgst2").value =sgstnetamount;  		 				
				 			document.getElementById("sgst_net_amount").value =Number(sgstnetamount)+Number(sgst2);  		 				
				 			 
				 			document.getElementById("oc_cgst_total").value =cgstnetamount;
				 			document.getElementById("oc_cgst1").value =cgstnetamount; 		 				
				 			document.getElementById("oc_cgst2").value =cgstnetamount;
				 			document.getElementById("cgst_net_amount").value =Number(cgstnetamount)+Number(cgst2); 		 				
				 			 
				 			document.getElementById("oc_igst_total").value =igstnetamount;
				 			document.getElementById("oc_igst1").value =igstnetamount; 
				 			document.getElementById("oc_igst2").value =igstnetamount; 
				 			document.getElementById("igst_net_amount").value =Number(igstnetamount)+Number(igst2); 
				 			}
				 		}			 				
		...
		$.ajax({
				...
				success: function(data){  
					...
					if(match >=1){
						 ...
						 var sgstnetamount = (amount * (sgst / 100));
						 document.getElementById("item_sgst_amount"+match).value = sgstnetamount;
						 $("#s_amount"+match).html('SGST: ' + sgstnetamount);
						 //CGST
						 var cgst = mydata['cgst'];
						 var amount = document.getElementById("item_amount"+match).value;
						 var cgstnetamount = (amount * (cgst / 100));
						 document.getElementById("item_cgst_amount"+match).value =cgstnetamount;
						$("#c_amount"+match).html('CGST: ' + cgstnetamount);
						 ...
						 if(counter1 >=1){
			 				...
			 				document.getElementById("sgst_net_amount").value =sgstamount;
			 				document.getElementById("sgst2").value =sgstamount;
			 				//Discount Total Section 
			 				document.getElementById("cgst_net_amount").value =cgstamount;
			 				document.getElementById("cgst2").value =cgstamount;
						 ...
						 $("#s_amount").html('SGST: ' + sgstnetamount);
						 //CGST
						 var cgst = mydata['cgst'];
						 var amount = document.getElementById("item_amount").value;
						 var cgstnetamount = (amount * (cgst / 100));
						 document.getElementById("item_cgst_amount").value =cgstnetamount;
						 $("#c_amount").html('CGST: ' + cgstnetamount);
						 ...
						 if(counter1 >=1){
				 			...
				 			document.getElementById("sgst_net_amount").value =sgstnetamount;
				 			document.getElementById("cgst_net_amount").value =cgstnetamount;

				 			document.getElementById("sgst1").value =sgstnetamount;
				 			document.getElementById("cgst1").value =cgstnetamount;

				 			document.getElementById("sgst2").value =sgstnetamount;
				 			document.getElementById("cgst2").value =cgstnetamount;
				 			document.getElementById('qty').click();  
						 }
					}
				}
				...
				success: function(data){  
					...
					if(match >=1){
						...
						//Id Get Here
						 ...
						 var amount = document.getElementById("item_amount").value;
						 var igstnetamount = (amount * (igst / 100));
						 document.getElementById("item_igst_amount").value = igstnetamount;
						 $("#i_amount").html('IGST: ' + igstnetamount);
						 ...
						 if(counter1 >=1){
				 			...
				 			document.getElementById("igst_net_amount").value =igstnetamount;
				 			document.getElementById("igst1").value =igstnetamount;
				 			document.getElementById("igst2").value =igstnetamount;
				 			document.getElementById('qty').click(); 
				 		}
	...
	function amount_calc(clicked_id){
		...
		if(match >=1){
			...
			if(item_sgst_percent != '' && item_cgst_percent != ''){
				...
				$("#s_amount").html('SGST: ' + item_sgst_percent);
				//CGST
				var amount = document.getElementById("item_amount").value;
				var item_cgst_percent = (amount * (item_cgst_percent / 100));
				document.getElementById("item_cgst_amount").value = item_cgst_percent;
				$("#c_amount").html('CGST: ' + item_cgst_percent);  
			}
			if(item_igst_percent != ''){
				...
				$("#i_amount").html('IGST: ' + item_igst_percent); 
	 			...
	 			if(match >=1){
					...
					if(counter1 >=1){
						...
						document.getElementById("igst_net_amount").value =Number(igst_total) + Number(igst2);
		 				...
		 				document.getElementById("sgst_net_amount").value =Number(sgst_first) + Number(sgst2);
		 				//CGST
		 				document.getElementById("cgst_net_amount").value =cgst_first;
		 				document.getElementById("cgst2").value =cgst_first;
						document.getElementById("cgst_net_amount").value =Number(cgst_first) + Number(cgst2);
						//IGST
		 				document.getElementById("igst_net_amount").value =igst_first;
		 				document.getElementById("igst2").value =igst_first;
						document.getElementById("igst_net_amount").value =Number(igst_first) + Number(igst2);
	...
	function po(){
		...
		var counter1 = document.getElementById("counter1").value; 
		var wpop = document.getElementById("wpop").value;		 
			...
			for(var i = 1; i <= wcounts; i++){
				...
				if(wselect >=1 && loopcounting == 0){
				    ...
				    var id_mst_party_supplier = id_mst_party_supplier.options[id_mst_party_supplier.selectedIndex].value; 
						...
						$.ajax({
							type: "POST",
							url: "../ajax/GRNsuppliercreditdaysget.php",
							data:{id_mst_party_supplier:id_mst_party_supplier,counter1:counter1},
							success: function(data){
								//console.log(data);
								var mydata = JSON.parse(data); 
		...
		// document.getElementById("pu_date").disabled = true;
...
<script type="text/javascript">
	...
	//Popup Show Section
  	function popupshow(clicked_id){
		...
		if(match >=1){ 
			var id_inv_po = document.getElementById("id_inv_po"+match);
	    	var id_inv_po = id_inv_po.options[id_inv_po.selectedIndex].value; 
			
		}else{
			var id_inv_po = document.getElementById("id_inv_po");
	    	var id_inv_po = id_inv_po.options[id_inv_po.selectedIndex].value;
		}
		if(id_inv_po == 'na'){
			if(match >=1){ 
		   ...
		   // Pass Ajax Data
		    $.ajax({
					type: "POST",
					url: "../ajax/PopupdatashowGRN.php",
					data:{id_inv_po:id_inv_po, array:myArray,counter1:counter1,match:match},
					dataType: "html", 	
					success: function(data){  
  ...
  //Hide And Show Method
	...
	function hideandshow() {
	    ...
	    var pu_date = document.getElementById("pu_date").value; 
	    document.getElementById("pu_date1").value = pu_date; 
		...
		if(doc_type != '' && pu_date !='') {
			...
			$.ajax({
				...
				data:{doc_type:doc_type, pu_date:pu_date},
				success: function(data){
					var mydata = JSON.parse(data);  
					if(mydata['method'] == 1){
						$('#hideandshow').hide();   
						$('#ind').show();   
						<?php if($row->id == ''){?>
							document.getElementById("pu_no").value = mydata['pu_no'];
	    ...
	    if(id_mst_party_supplier != '') {
			...
			$.ajax({
				...
				success: function(data){
	    			...
	    			var count = mydata['i'];
	    			var join = "<option value='' selected='selected'> Select Purchase No </option>";
	    			for(var i=1; i<count;i++){
	    				join += "<option value='" + mydata['id'+i] + "'>" + mydata['id'+i] + "</option>";
	    			} 
					...
					if(mydata['ledger'] == 1) {
		    			...
		    			$('#c_amount').hide();
		    			$('#i_amount').hide();
						document.getElementById("id_mst_charges_purchase_local").innerHTML = "<option value='' selected='selected'> Select </option>"+"<?php 
	                $sql = "SELECT mst_charges.*FROM mst_charges WHERE mst_charges.id_shop = '".addslashes($_SESSION['shop'])."' AND  charges_account = '2' and transaction_type = '1'";$db->query($sql); while($row1 = $db->fetch_object()){ ?> <option value='<?php echo $row1->id; ?>''><?php echo $row1->name ?></option> <?php } ?>"; 
		    			...
		    			for(var i=1;i<=counter1;i++){
		    				...
		    				$('#i_amount'+i).hide(); 
			    			//Loop Sections
			    			document.getElementById("id_mst_charges_purchase_local"+i).innerHTML = "<option value='' selected='selected'> Select </option>"+"<?php 
	                $sql = "SELECT mst_charges.*FROM mst_charges WHERE mst_charges.id_shop = '".addslashes($_SESSION['shop'])."' AND  charges_account = '2' and transaction_type = '1'";$db->query($sql); while($row1 = $db->fetch_object()){ ?> <option value='<?php echo $row1->id; ?>''><?php echo $row1->name ?></option> <?php } ?>"; 
		    			}
					}else{
						$("#locals").hide();
...
<?php 
	$sql2 = " SELECT max(pu_date) as pu_date FROM `".TBL_INV_PURCH."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' AND  `doc_type`='".'4'."' ";
		$db->query($sql2);   
			while($row2 = $db->fetch_object()){ 
				$pu_date= $row2->pu_date;
				$pu_date = date('d-m-Y' , strtotime(addslashes($pu_date)));  
			} 
	...
	<div class="modal" id="myModal">
	    <div class="modal-dialog">
	      <div class="modal-content"  style="margin-top: 50%; width: 72%;margin-left: 20%;"> 
	        ...
	        <div class="modal-body">
	        	<center>
	          <a href="editGRN.php?submenu=<?php echo $_GET['submenu']; ?>" type="button" class="btn btn-success"  id="buttons_radius"><i class="fa fa-plus-circle" aria-hidden="true"> Another Indent</i></a> 
	          ...
	          <a href="manageGRN.php?submenu=<?php echo $_GET['submenu']; ?>" type="button" class="btn btn-info"  id="buttons_radius"><i class="fa fa-info-circle" aria-hidden="true"> Close</i></a>  
...
?>
 		var dates = '<?php echo $pu_date; ?>';
 		document.getElementById("pu_date").value = dates; 
 		document.getElementById('pu_date').click();  
...
//Select 2  Resolve Here
    ...
    $("#addrow1").on("click", function () { 
	    ...
	    if(id_mst_party_supplier != '') {
			...
			$.ajax({
				...
				success: function(data){
	    			...
	    			var count = mydata['i'];
	    			var join = "<option value=''> Select Purchase No </option>";
	    			for(var i=1; i<count;i++){
	    				join += "<option value='" + mydata['id'+i] + "'>" + mydata['id'+i] + "</option>";
	    			} 
	    			document.getElementById("id_inv_po"+counter1).innerHTML = join;
	   ...
	   //Table Row Add Section Here
        ...
        var cols1 = ""; 
        var cols2 = ""; 
        cols1 += '<td><select onchange="popupshow(this.id)"  name="id_inv_po' + counter1 + '" id="id_inv_po' + counter1 + '" class="form-control select3"  ><option>Select</option></select> </td>';

        cols1 += '<td><select  name="id_mst_attributes_store' + counter1 + '" id="id_mst_attributes_store' + counter1 + '" class="form-control select3"  ><option>Select Store</option><?php 
		...
		cols1 += '<td><input onkeyup="amount_calc(this.id)" onclick="amount_calc(this.id)"  type="text"  autocomplete="off" placeholder="Qty" class="form-control"  name="qty' + counter1 + '" id="qty' + counter1 + '"/></td>'; 


        cols1 += '<td> <select class="form-control select3" id="transaction_unit' + counter1 +'" name="transaction_unit' + counter1 +'" onchange="amount_calc(this.id);"></select><input type="text"  autocomplete="off" placeholder="Main Unit" class="form-control"  name="main_unit' + counter1 + '" id="main_unit' + counter1 + '" style="display:none;"/><input type="text"  autocomplete="off" placeholder="Alt Unit" class="form-control"  name="alt_unit' + counter1 + '" id="alt_unit' + counter1 + '" style="display:none;"/><input type="text"  autocomplete="off" placeholder="conver_rate_per_unit" class="form-control"  name="conver_rate_per_unit' + counter1 + '" id="conver_rate_per_unit' + counter1 + '" style="display:none;"/></td>'; 

		cols1 += '<td><input  onkeyup="amount_calc(this.id)" type="text"  autocomplete="off" placeholder="Rate" class="form-control" name="rate_per_main_unit' + counter1 + '" id="rate_per_main_unit' + counter1 + '"/><input style="display:none;" type="text"  autocomplete="off"  class="form-control"  name="item_amount_before_discount' + counter1 + '" id="item_amount_before_discount' + counter1 + '"/></td>'; 

		 cols1 += '<td> <select class="form-control select3" id="per_unit' + counter1 +'" name="per_unit' + counter1 +'" onchange="amount_calc(this.id);"></select></td>'; 

        cols1 += '<td><input onkeyup="amount_calc(this.id);" onclick="amount_calc(this.id);"  type="text"  autocomplete="off" placeholder="%Discount" class="form-control" name="discount_percent' + counter1 + '" id="discount_percent' + counter1 + '"/></td>'; 
        ...
        cols1 += '<td style="display:none;"><div id="taxconfig" id="taxconfig"><!-- SGST --><input type="text"  autocomplete="off"  name="id_mst_charges_sgst' + counter1 + '" id="id_mst_charges_sgst' + counter1 + '" placeholder="SGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_sgst_percent' + counter1 + '" id="item_sgst_percent' + counter1 + '" placeholder="SGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_sgst_amount' + counter1 + '" id="item_sgst_amount' + counter1 + '" placeholder="SGST Amount"  class="form-control"  /><!-- CGST --><input type="text"  autocomplete="off"  name="id_mst_charges_cgst' + counter1 + '" id="id_mst_charges_cgst' + counter1 + '" placeholder="CGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_cgst_percent' + counter1 + '" id="item_cgst_percent' + counter1 + '" placeholder="CGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_cgst_amount' + counter1 + '" id="item_cgst_amount' + counter1 + '" placeholder="CGST Amount"  class="form-control" /><!-- IGST --><input type="text"  autocomplete="off"  name="id_mst_charges_igst' + counter1 + '" id="id_mst_charges_igst' + counter1 + '" placeholder="IGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_igst_percent' + counter1 + '" id="item_igst_percent' + counter1 + '" placeholder="IGST"  class="form-control" /><input type="text"  autocomplete="off"  name="item_igst_amount' + counter1 + '" id="item_igst_amount' + counter1 + '" placeholder="IGST Amount"  class="form-control" /></div></td>';		 
		 ...
		 var newRow11 =  $('<tr id="trdeletes' + counter1 + '">');
		 	 ...
		 	 cols2 += '<td><div id="local'+counter1+'" name="local'+counter1+'" style="display:none;"><select  name="id_mst_charges_purchase_local' + counter1 + '" id="id_mst_charges_purchase_local' + counter1 + '" class="form-control select3" onchange="po_locals(this.id)" style="width:100%;"><option>Select</option><?php 
    ...
    $("#addrow2").on("click", function () { 	
        ...
        cols2 += '<td><select class="form-control select3" id="type' + counter2 + '" name="type' + counter2 + '" onchange="type_funt(this.id)"><option value="">select Charges</option><option value="1">OTHERS</option><option value="2">DISCOUNT</option></select></td>';


        cols2 += '<td><div style="display:none;"  id="otherss' + counter2 + '"name="otherss' + counter2 + '" ><select  name="id_mst_charges_others' + counter2 + '" id="id_mst_charges_others' + counter2 + '" class="form-control select3" style="width:100%;" onchange="charges_others(this.id)"><option>Select Others Charges</option><?php 
	                $sql = "SELECT mst_charges.*FROM mst_charges WHERE mst_charges.id_shop = '".addslashes($_SESSION['shop'])."' AND mst_charges.charges_account = '4' ";
	                   	 $db->query($sql); 
	                    while($row1 = $db->fetch_object()){ ?>
		...
		cols2 += '<td><input onkeyup="subtotal_calc(this.id)" type="text"  autocomplete="off" placeholder="Percentage" class="form-control" name="others_charges_percent' + counter2 + '" id="others_charges_percent' + counter2 + '" /></td>'; 

        cols2 += '<td><input onkeyup="charges_amount_calc(this.id);" onclick="charges_amount_calc(this.id);" type="text"  autocomplete="off" placeholder="Amount" class="form-control" name="others_charges_amount' + counter2 + '" id="others_charges_amount' + counter2 + '" /></td>';  
...
//Select 4  Resolve Here
    ...
    $("#addrow4").on("click", function () { 
	   ...
	   //Table Row Add Section Here
        ...
        var cols1 = ""; 
        var cols2 = ""; 
        cols1 += '<td><select onchange="popupshow(this.id)"  name="id_inv_po' + counter4 + '" id="id_inv_po' + counter4 + '" class="form-control select3"  ><option>Select</option></select> </td>';

        cols1 += '<td><select  name="id_mst_attributes_store' + counter4 + '" id="id_mst_attributes_store' + counter4 + '" class="form-control select3"  ><option>Select Store</option><?php 
	                $sql = "SELECT mst_attributes.field_value FROM  mst_attributes WHERE id_shop = '".addslashes($_SESSION['shop'])."' and table_name ='store' ";
	                   	 $db->query($sql); 
	                    while($row1 = $db->fetch_object()){ ?>
	                  		<option value="<?php echo $row1->id; ?>"><?php echo $row1->field_value; ?></option> <?php } 
		...
		cols1 += '<td><input onkeyup="amount_calc(this.id)" onclick="amount_calc(this.id)"  type="text"  autocomplete="off" placeholder="Qty" class="form-control"  name="qty' + counter4 + '" id="qty' + counter4 + '"/></td>'; 


        cols1 += '<td> <select class="form-control select3" id="transaction_unit' + counter4 +'" name="transaction_unit' + counter4 +'" onchange="amount_calc(this.id);"></select><input type="text"  autocomplete="off" placeholder="Main Unit" class="form-control"  name="main_unit' + counter4 + '" id="main_unit' + counter4 + '" style="display:none;"/><input type="text"  autocomplete="off" placeholder="Alt Unit" class="form-control"  name="alt_unit' + counter4 + '" id="alt_unit' + counter4 + '" style="display:none;"/><input type="text"  autocomplete="off" placeholder="conver_rate_per_unit" class="form-control"  name="conver_rate_per_unit' + counter4 + '" id="conver_rate_per_unit' + counter4 + '" style="display:none;"/></td>'; 

		cols1 += '<td><input  onkeyup="amount_calc(this.id)" type="text"  autocomplete="off" placeholder="Rate" class="form-control" name="rate_per_main_unit' + counter4 + '" id="rate_per_main_unit' + counter4 + '"/><input style="display:none;" type="text"  autocomplete="off"  class="form-control"  name="item_amount_before_discount' + counter4 + '" id="item_amount_before_discount' + counter4 + '"/></td>'; 

		 cols1 += '<td> <select class="form-control select3" id="per_unit' + counter4 +'" name="per_unit' + counter4 +'" onchange="amount_calc(this.id);"></select></td>'; 
