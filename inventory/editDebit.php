	...
	if($err == 0){//No error
		if(($_POST['Save'] == 'Save') && empty($_POST['eId'])){//add 
			 ...
			 $doc= $_GET['doc_type'];
				 ...
				 $sql5 = " SELECT * FROM `".TBL_INV_PURCH."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' AND  `doc_no`='".$doc_no."'  and `doc_type` = '8'  and `id_doc_type_configuration` = '".addslashes($_POST['id_doc_type_configuration'])."'  ";
 ...
 $id_inv_poo = rtrim($id_po,',');
			...
			if(1){
				...
				if($_POST['another']!=''){
					...
					header("location:printPurchasebill.php?eId=".addslashes(encryptor(encrypt,$lastInsertId))."&submenu=".$_GET['submenu']."&session=".$_GET['session']."&action=edit&page=".$_REQUEST['page']."&doc_type=".$_REQUEST['doc_type']."&print=1");
				}
		...
		executeSql($auditeditSql);
			...
			if(1){  
				...
				if($_POST['another']!=''){
					...
					header("location:printPurchasebill.php?eId=".$_GET['eId']."&submenu=".$_GET['submenu']."&session=".$_GET['session']."&action=edit&page=".$_REQUEST['page']."&doc_type=".$_REQUEST['doc_type']."&print=1"); 
				}
   ...
   <?php  $session=$_GET['submenu']; ?>
    <section class="content-header">
      <!--<h3 style="margin:0px 0px 0px 0px !important;padding:0px 0px 0px 0px !important;">
       ...
       <h5 class="box-title"><?php echo $_REQUEST['eId']==''?'Save':'Edit'?> <?php echo $add; ?> :<span style="color:#3c8dbc"> <?php echo $row->mdoc_no ?> </span></h5>
		                  ...
		                  <div class="input-group"> 
	              			<div class="input-group-addon">
								<i class="fas fa-people-carry"></i> 
						   	  ...
						   	  <?php                   		 
			                  $sql1 = " SELECT * FROM `".TBL_DOC_TYPE_CONFIG."` WHERE `id_shop` = '".addslashes($_SESSION['shop'])."' and `doc_type`='".$_GET['session']."' order by effective_date  DESC LIMIT 1 ";
			                // echo $sql1;
			                  //die();
			                   $db->query($sql1); 
		            ...
		            <!--    <div style="visibility: hidden;" class="form-group col-xs-12 col-md-6 col-sm-2">
		              ...
		              <div class="row">
		                ...
		                <div  id="credit_day" name="credit_day">
		                 <div class="in-box d-flex">
		                  ...
		                  <input type="text" class="form-control bg-none br-none" placeholder="Credit Days" id="credit_days" name="credit_days" value="<?php if($_POST) echo $_POST['credit_days'];else echo stripslashes($row->credit_days); ?>" readonly>
		                  </div> 
		                </div>
		                  ...
		                  <input type="text" class="form-control bg-none br-none" placeholder="" id="base_currency_code" name="base_currency_code" value="<?php echo stripslashes($base_currency); ?>" readonly>
		                  <input type="text" class="form-control bg-none br-none" placeholder="Base Currency Code" id="base_currency_code1" name="base_currency_code1" value="<?php echo $_SESSION['base_currency_code']; ?>"  style="display: none;">
		                  </div> 
		                </div>
		                <?php if($row->id !=''){ 
		                ...
		                <div  id="xchange_rate" name="xchange_rate">
		                  <div class="in-box d-flex">
		                     <label for="name" class="col-form-label">Exchange Rate :</label>
						   	...
						   	<input type="text" class="form-control bg-none br-none" placeholder="Exchange Rate" id="exchange_rate" name="exchange_rate" value="<?php if($_POST) echo $_POST['exchange_rate'];else echo stripslashes($row->exchange_rate); ?>" > 
		                  </div> 
		                </div>
		              ...
		              <div  id="trans_currency" name="trans_currency">
		                 <div class="in-box d-flex">
		                  ...
		                  <input type="text" class="form-control bg-none br-none" placeholder="Transaction Currency" id="transaction_currency_code" name="transaction_currency_code" value="<?php if($_POST) echo $_POST['transaction_currency_code'];else echo stripslashes($transaction_currency_code); ?>" readonly>
...
<div class="form-group col-xs-12 col-md-2 col-sm-6" id="supplier_inv_no" name="supplier_inv_no">
...
<div class="form-group col-xs-12 col-md-2 col-sm-6" id="sup_date" name="sup_date">
  <label for="name">Supplier Date <font color="#FF0000">*</font></label>
	...
	<input data-parsley-required type="text" class="form-control pickerdate" placeholder="Enter Date" id="supplier_date" name="supplier_date" value="<?php if($_POST) echo $_POST['supplier_date'];elseif($row->supplier_date!='') echo date('d-m-Y',strtotime($row->supplier_date));else echo date('d-m-Y'); ?>"> 
 						...
 						<div class="form-group col-xs-12 col-md-6 col-sm-6" style="display: none;">
					    ...
					    <div class="modal-dialog modal-wd95">
					      <div class="modal-content"  >
					        ...
					        <div class="modal-body ox-sl">
					        	<input type="text" id="myInput"  class="p-5 br-grey search-wid" onkeyup="myFunction()" placeholder="Search For Item Name" title="Type In Item Name">
					        	<input type="checkbox" name="checkbox" id="checkbox"  onclick="popupshow_checkbox(this.id);" >Show All
					        	<br><br>
					        	<table id="myTables"  class="table table-striped  table-bordered dataTable no-footer" style="background:#fff;width:1226px;display: table-caption;" border="1"></table> 
					        	
					        </div>
					        
					        <!-- Modal footer -->
					        <div class="modal-footer">
					        	<button type="button" id="test" class="btn o-btn ok"  data-dismiss="modal" onclick="po();"><i class="fa fa-plus-circle" aria-hidden="true" ></i> Insert</button>
				            ...
				            <tbody id="polist">
								...
								?>	
										...
										<?php if($row->id !=''){
											...
											<option <?php echo $selected; ?> value="<?php echo $id;?>" > <?php echo $row2->doc_no .' | '.date('d-m-Y' , strtotime(addslashes($row2->doc_date)))?></option>
				               ...
				               <!-- <tr id="edittrdeletes<?php echo $k;?>">-->
									...
									<td style="width:10%;"> 
				                  	...
				                  	<td style="width:1%;"><?php if($k>=1){ ?><img src="images/delete.gif"  class="ibtnDel1" style="cursor:pointer;" title="Delete" id="ibtn<?php echo $k;?>"  name="ibtn<?php echo $k;?>"/><?php } ?></td>
				            ...
				            <tfoot>
				                <tr> 
				                        <td colspan="13" style="text-align: left;">
											 ...
											 <a  type="button" class="btn n-btn btn-block" id="addrow1" value="Add Row">
											 	<span style="font-size:14px;font-weight:700"><i class="fa fa-plus"></i> Add Row</span> </a>

											   <input  type="button" class="btn btn-sm btn-block" style="display: none;" id="addrow4" value="Add"/>
				                        </td> 
				                </tr>
				            ...
				            <tbody id="discountData">
				                ...
				                <tr>
				                    ...
				                    <td> 
					                   ...
					                   <a   class="btn n-btn  abtn ibtnDel2" style="cursor:pointer;" title="Delete" id="ibtns<?php echo $k;?>"  name="ibtns<?php echo $k;?>" title="Delete"><i class="fa fa-trash-o"></i></a>
				           ...
				           <!-- <tfoot>
				                ...
				                <tr> 
				                    ...
				                    $counts; ?>" hidden=""> 
											  ...
											  <a  type="button" class="btn n-btn btn-block" style="font-size:14px;font-weight:700" id="addrow2" value="Add Row">
											  	<span style="font-size:14px;font-weight:700"><i class="fa fa-plus"></i> Add Row</span> </a>
				                        </td> 
				                </tr>
				                <tr>
		            ...
		            <div class="card text-dark bg-light add-l">
			            ...
			            <div class="row">
			           	...
			           	<div class="row">
			                ...
			                <div class="form-group col-xs-12 col-md-6 col-sm-6ss"> <label for="name">IGST</label></div>
			                 <div class="form-group mb-3 col-xs-12 col-md-6 col-sm-6"> 
			                  <div class="input-group"> 
		              			<div class="input-group-addon">
									<i class="fa fa-caret-square-o-right"></i>
			   ...
			   <a type='button' value='Cancel' class="btn c-btn" onclick='location.replace("<?=$redirect_page;?>"); '>  	<i class="far fa-window-close"></i>
			   	Close
			   </a>
				...
				<?php if($row->date_created){?>
					<div class="row mt-10">
						...
						<a type='button' value='Audit Trail' class="btn o-btn"  onclick="audittrial(this.value);" style="float:right">
		 	 ...
		 	 cols1 += '<td><div id="local'+counter1+'" name="local'+counter1+'" style="display:none;"><select  name="id_mst_charges_purchase_local' + counter1 + '" id="id_mst_charges_purchase_local' + counter1 + '" class="form-control select3" onchange="po_locals(this.id)" style="width:100%;"><option>Select Tax Register</option><?php 
	                ...
	                $sql = "SELECT mst_charges.*FROM mst_charges WHERE mst_charges.id_shop = '".addslashes($_SESSION['shop'])."' AND  charges_account = '2' and transaction_type = '2'";
	                    ...
	                    while($row1 = $db->fetch_object()){ ?>
	                  	...
	                  	cols1 += '<td><div id="localsss'+counter1+'" name="localsss'+counter1+'" style="display:none;"><span style="color:red;font-size:14px;" id="s_amount'+counter1+'"></span> <span style="color:red;font-size:14px;;font-size:14px;" id="c_amount'+counter1+'"></span></div><div id="interstatesss'+counter1+'" name="interstatesss'+counter1+'" style="display:none;"><span style="color:red;font-size:14px;" id="i_amount' + counter1 + '" name="i_amount' + counter1 + '"></span></div></td>';
	                  	 ...
	                  	 cols1 += '<td><input type="text"  autocomplete="off" placeholder="Remarks" class="form-control" name="item_remarks' + counter1 + '" id="item_remarks' + counter1 + '"/></td>';
	                  		...
	                  		cols1 += '<td><a class="btn n-btn abtn ibtnDel1" id="deletes' + counter1 + '" name="deletes' + counter1 + '" style="cursor:pointer;" title="Delete"/></td>';
    ...
    $("#addrow4").on("click", function () { 
	   ...
	   //Table Row Add Section Here
		...
		// var newRow11 =  $('<tr id="trdeletes' + counter4 + '">');
		 	 ...
		 	 cols1 += '<td><div id="local'+counter4+'" name="local'+counter4+'" style="display:none;"><select  name="id_mst_charges_purchase_local' + counter4 + '" id="id_mst_charges_purchase_local' + counter4 + '" class="form-control select3" onchange="po_locals(this.id)" style="width:100%;"><option>Select</option><?php 
	                $sql = "SELECT mst_charges.*FROM mst_charges WHERE mst_charges.id_shop = '".addslashes($_SESSION['shop'])."' AND  charges_account = '2' and transaction_type = '1'";
	                   	 $db->query($sql); 
	                    while($row1 = $db->fetch_object()){ ?>
	                ...
	                $sql = "SELECT mst_charges.*FROM mst_charges WHERE mst_charges.id_shop = '".addslashes($_SESSION['shop'])."' AND  charges_account = '2' and transaction_type = '2'";
	                    ...
	                    while($row1 = $db->fetch_object()){ ?>
	                  		<option value="<?php echo $row1->id; ?>"><?php echo $row1->name ?></option> <?php }?></select></div></td> '; 
	                  	cols1 += '<td><div id="localsss'+counter4+'" name="localsss'+counter4+'" style="display:none;"><span style="color:red;font-size:14px;" id="s_amount'+counter4+'"></span> <span style="color:red;font-size:14px;;font-size:14px;" id="c_amount'+counter4+'"></span></div><div id="interstatesss'+counter4+'" name="interstatesss'+counter4+'" style="display:none;"><span style="color:red;font-size:14px;" id="i_amount' + counter4 + '" name="i_amount' + counter4 + '"></span></div></td>';
						  cols1 += '<td><input type="text"  autocomplete="off" placeholder="Remarks" class="form-control" name="item_remarks' + counter4 + '" id="item_remarks' + counter4 + '"/></td>';
	                  		cols1 += '<td><a  class="btn n-btn abtn ibtnDel1" id="deletes' + counter4 + '" name="deletes' + counter4 + '" style="cursor:pointer;" title="Delete"><i class="fa fa-trash-o"></i></a></td>';
		 $("</tr>"); 
