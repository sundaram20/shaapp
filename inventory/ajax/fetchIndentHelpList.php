...
<?php 
	if($_REQUEST['id_department']!=''){
		//print_r($_REQUEST['id_department']);
...
if($seggstionQty >0){
						$returnData.='<tr>
                    		...
                    		<td>
                    				...
                    				<input type="text" class="form-control"   value="'.$item_name.'" readonly>
 ...
 $returnData.='<tr ><td style="padding:0px;"><input type="hidden" class="form-control" id="wcounts" name="wcounts"  value="'.$numRows.'" ></td></tr>';	
