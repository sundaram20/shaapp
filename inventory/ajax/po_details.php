...
$returnData.= '<td style="width:10%" class="form-group col-md-2"><select onchange="popupshow(this.id);" onclick="popupshow(this.id);" name="id_inv_po'.$i.'" id="id_inv_po'.$i.'" class="form-control select2" style="width:100%;">';
...
$returnData.= '<td style="width:21%" class="form-group col-md-1"><input style="width:154px" type="text"  autocomplete="off" class="form-control" name="item_remarks'.$i.'" id="item_remarks'.$i.'" placeholder="Remarks" value='.$row->item_remarks.' ></td>';
