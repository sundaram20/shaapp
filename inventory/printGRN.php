...
<!--end of row-->
              	...
              	<table  class="table table-striped  dataTable no-footer" width="100%" border="0" cellspacing="0" cellpadding="10"   >
			          ...
			          <tbody>
			                <tr>
								...
								<p class="p-5" style="padding:0px;margin:0;"><b>GRN No: </b><?php echo stripslashes($prefix).''.stripslashes($row->doc_no).''.stripslashes($suffix); ?> </p>
			     ...
			     <td  style="padding:0px!important;">
			       <table  class="table table-striped  dataTable no-footer" width="100%" border="0" cellspacing="0" cellpadding="10"   >
			    	<thead>
			    		...
			    		<td class="pm" style="width:50%;font-size:11px;font-family: sans-serif;border-bottom:.4px solid #000;padding:0;margin:0;"><b><center><p style="padding:5px;margin:0;">Supply To</p></center></b></td>
			    		<!--<td style="padding: 2px;"><b><center>Delivery</center></b></td>-->
			    	</thead>
			         
			          <tbody >
			                <tr>
			                    <td class="pm"  style="width:50%;border-right:.4px solid #000;border-bottom:.4px solid #000;font-size:11px;font-family: sans-serif;"> 
			                    ...
			                    <td  class="pm"  style="width:50%;border-bottom:.4px solid #000;font-size:11px;font-family: sans-serif;"> 
			                    	<left><p><?php 
 					...
 					<table id="myTable1" class="table table-striped  dataTable no-footer" width="100%" border="0" cellspacing="0" cellpadding="10" >
				            <thead>
				                <tr >
				                    ...
				                    <td  class="pm" style="font-size:11px;font-family: sans-serif;width: 5%;padding:5px;margin:0;border-right: 0.4px solid #000;border-bottom: 0.4px solid #000;"><p style="margin:3px;"><b>Rate</b></p></td> 
				            ...
				            <tbody>
				            	<tr>
				            		<p style="text-align: center;padding:5px;font-size:11px;font-family: sans-serif;border-bottom:0.4px solid #000;margin:0;"><b>Goods Order Details</b></p>
				            	</tr>
				            	<?php
				            	$k='';
				            	if($row->id ==''){
				                ...
				                <tr>
				                    ...
				                    <td class="pm" style="width: 3%;padding:0px!important;padding-left:5px!important;margin:0;border-right:.4px solid #000;"><p style="font-size:11px;font-family: sans-serif;padding:0!important;margin:0!important;"><?php echo stripslashes($array['qty'.''.$j]); ?>&nbsp;&nbsp;<?php echo $array['transaction_unit'.''.$j];?></p></td>   
				                    <td class="pm" style="width: 5%;padding:0px!important;padding-left:5px!important;margin:0;border-right:.4px solid #000;"><p style="font-size:11px;font-family: sans-serif;padding:0!important;margin:0!important;"><?php echo round($array['rate_per_main_unit'.''.$j],2); ?>/<?php echo $array['per_unit'.''.$j];?></p></td>  
				                    
				                    <td class="pm" style="width: 5%;padding:0px!important;padding-left:5px!important;margin:0;border-right:.4px solid #000;"><p style="font-size:11px;font-family: sans-serif;padding:0!important;margin:0!important;"><?php echo stripslashes($array['discount_percent'.''.$j]); ?></p></td>  
				                    <td class="pm" style="width: 10%;padding:0px!important;padding-left:5px!important;margin:0;border-right:.4px solid #000;"><p style="font-size:11px;font-family: sans-serif;padding:0!important;margin:0!important;"><?php echo stripslashes($array['item_amount'.''.$j]); ?></p></td>  
				                    <td class="pm" style="width: 20%;padding:0px!important;padding-left:5px!important;margin:0;"><p style="font-size:11px;font-family: sans-serif;padding:0!important;margin:0!important;"><?php 
 ...
 <?php
				     ...
				     <table id="myTable1" class="table table-striped  dataTable no-footer" width="100%" border="0" cellspacing="0" cellpadding="10" >
				            <thead>
				                <tr>
				                    ...
				                    <td style="width: 20%;padding:5px;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;"><p style="font-size:11px;font-family: sans-serif;margin:3px;"><b>Disc(%)</b></p></td> 
				            ...
				            <tbody>
				                ...
				                <tr>
				                    ...
				                    <td  class="pm" style="border-bottom:0.4px solid #000;font-family: sans-serif;border-right:.4px solid #000;padding:5px;margin:0;"><p style="font-size:11px;"><?php echo stripslashes($array['others_charges_percent'.''.$j]); ?></p></td>  
				                    <td  class="pm" style="border-bottom:0.4px solid #000;font-family: sans-serif;border-right:.4px solid #000;padding:5px;margin:0;"><p style="font-size:11px;"><?php  echo stripslashes($array['others_charges_amount'.''.$j]); ?></p></td>   
				    ...
				    <tr>
				       ...
				       <table id="myTable1" class="table table-striped  dataTable no-footer" border="0"  width="100%"  >
				        	<thead>
