...
<div class="col-md-2 col-sm-12">
  <div class="form-group">
   ...
   <?php
      ...
      <?php /*?><select class="form-control select2 parsley-error"  onChange="getReportOrderBy(this.value);" name="id_report_type" data-parsley-required id="id_report_type" style="width:100%">
        <option value="">---Select Report Type---</option>
        <?php
            $sqlSubMenu="SELECT * FROM ".APP_SUB_MENU." WHERE 1=1 and status='1' and type='3'  ".$subMenuCond."   order by display_order";
      ...
      <!--<select class="form-control select2 parsley-error"  onChange="" name="id_report_type" data-parsley-required id="id_report_type" style="width:100%">
        <option value="">---Select Report Type---</option>
        <?php
            $sqlSubMenu="SELECT * FROM ".APP_DOCTYPE." WHERE 1=1 and status='1' and id_app_modules='6' and id_doc_type IN ('1','14')  order by display_order";
           ...
           ?>
        <option <?php echo $selected ?>value="<?php echo $rowSubMenu->id_doc_type; ?>"><?php echo ucwords(strtolower($rowSubMenu->name)) ; ?></option>
        <?php } ?>
      </select>-->
	  <select class="form-control select2 parsley-error select2-hidden-accessible" onchange="" name="id_report_type" data-parsley-required="" id="id_report_type" style="width:100%" tabindex="-1" aria-hidden="true">
        <option value="">---Select Report Type---</option>
        				        <option value="500">Requestion Note</option>
                <option value="1">Requestion Note Pending</option>
              </select>
      
      
      
    <?php /*?><span style="margin-left:45px;color:red;font-size:11px;" id="id_report_type_error"></span><?php */?>
  </div>
</div>
<div class="col-md-2 col-sm-12">
  <div class="form-group">
...
<div class="form-group col-xs-12 col-md-4 col-sm-12 form-p" >
	              			...
	              			<select class="form-control select2" name="id_mst_party_supplier[]"  multiple="multiple" id="id_mst_party_supplier"  style="width: 100%">
...
<div class="col-md-2">
  <div class="form-group">
    <label>Select Main Group <span class="text-danger">*</span></label>
...
<div class="col-md-2">
  <div class="form-group">
    ...
    <label>Select Sub Group <span class="text-danger">*</span></label>
      ...
      <div id="ListSubGroup">
        <select class="form-control select2" name="id_sub_group[]" data-parsley-required id="id_sub_group" multiple="multiple"  onChange="subGroup(this);" style="width:100%">
                               ...
                               <?php $resCat = selectSql(TBL_ATTRIBUTES,"where id_shop='".$_SESSION['shop']."'  and status = '1' and `table_name` = 'item_group_sub' ",' ORDER BY `field_value`');
      ...
      <div class="form-group">
	              			...
	              			<div class="input-group"> 
  	              			<div class="input-group-addon">
	              			   ...
	              			   <select class="form-control select2 id_mst_party_supplier" name="id_mst_party_supplier" id="id_mst_party_supplier" data-parsley-required  data-parsley-errors-container="#outletError"  <?php echo $readonly; ?> style="width:100%">
  ...
  100% {
    ...
    <div class="overlay__inner">
        <div class="overlay__content"><span class="spinner"></span></div>
           ...
           <div class="box-body table-responsive showBox"> <div class="row">
...
//Form Data Clear
	...
	var showItemReport = $("#showItemReport").val();
        ...
        let url2 = 'ajax/ajaxStoreIssueNote.php?period='+period+'&id_report_type='+id_report_type+'&id_main_group='+id_main_group+'&id_sub_group='+id_sub_group+'&id_item='+id_item+'&ReportShowType='+ReportShowType+'&id_order_by='+id_order_by+'&showItemReport='+showItemReport+'&id_mst_party_supplier='+id_mst_party_supplier;
         window.open(url2);
	...
	// alert(id_report_type);
     ...
     $("#loading").show();
	  var id_order_by = $("#id_order_by").val();
		...
		var id_item = $("#id_item").val();
	   var id_mst_party_supplier = $("#id_mst_party_supplier").val();
		 reportTypeFile  ='ajaxStoreIssueNote.php';
		 $.ajax({
				url:'ajax/'+reportTypeFile,
				type:'POST',
				data:'period='+period+'&id_report_type='+id_report_type+'&id_main_group='+id_main_group+'&id_data_main_group='+id_data_main_group+'&id_item='+id_item+'&ReportShowType='+ReportShowType+'&id_order_by='+id_order_by+'&id_sub_group='+id_sub_group+'&showItemReport='+showItemReport+'&id_mst_party_supplier='+id_mst_party_supplier,
