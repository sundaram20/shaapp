...
//Form Data Clear
	...
	var showItemReport = $("#showItemReport").val();
        ...
        let url2 = 'ajax/ajaxInventoryReportsStockBalance.php?period='+period+'&id_report_type='+id_report_type+'&id_main_group='+id_main_group+'&id_sub_group='+id_sub_group+'&id_item='+id_item+'&ReportShowType='+ReportShowType+'&id_order_by='+id_order_by+'&showItemReport='+showItemReport;
         window.open(url2);
	...
	// alert(id_report_type);
     ...
     $("#loading").show();
	  var id_order_by = $("#id_order_by").val();
		...
		var showItemReport = $("#showItemReport").val();
		var id_item = $("#id_item").val();
		 reportTypeFile  ='ajaxInventoryReportsStockBalance.php';
		 $.ajax({
