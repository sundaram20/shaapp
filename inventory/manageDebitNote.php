...
<?php */?>
  ...
  <script type="text/javascript">
	  ...
	  swal({
	   ...
	   if (isConfirm)
	   {  
	        self.location='manageDebitNote.php?delId='+sid+'&action=delete&page=<?=$_REQUEST["page"]?>&session=<?php echo $_GET["session"] ?>&submenu=<?php echo $_GET["submenu"]; ?>&doc_type=<?=$_GET["session"]?>';
	   } 
	   else
	   {
	      self.location='manageDebitNote.php?doc_type=<?=$_REQUEST["doc_type"]?>&submenu=<?php echo $_GET["submenu"]; ?>&session=<?php echo $_GET["session"]; ?>&doc_type=<?=$_GET["session"]?>';
	    }
	   });
	  }
  </script> 
