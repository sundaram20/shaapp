...
if($id==''){
	...
	$select="SELECT * FROM ".TBL_ASSIGN_HOTEL_ROOM."  where id_mst_hotels=1";
	...
	$res = mysqli_query($connNew,$select);
			...
			$selectnew="SELECT * FROM ".TBL_ROOM_TYPE."  where id=$idnew";
 ...
 $select="SELECT * FROM ".TBL_ASSIGN_HOTEL_ROOM."  where id_mst_hotels=$id";
