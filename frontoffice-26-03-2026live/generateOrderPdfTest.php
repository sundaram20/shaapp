...
$content .='<table class="table" border="0" style="width:400px!important;">';
		...
		if($rowOrder->other_reference ==''){
			...
			$content .='<div style="margin-top:2px;"><span style="font-weight:bold">BOOKER BY: </span><span style="color:#000;font-size:10px;">'.$company_contacts.'</span></div>';
			 ...
			 if(($resultRatePlan->rate_name =='MAP' || $resultRatePlan->rate_name =='MAPAI') ){
			  ...
			  $remarks	=	strtolower($resultRatePlan->remarks);
				...
				while ($room_count_details = mysqli_fetch_object($room_count_detail_query)) {
					$room_quantity += $room_count_details->room_quantity;
...
<td style="width:350px;font-size:9px;padding-top:0!important;"><span style="font-weight:bold">PAYMENT STATUS : </span><span style="color:#000;font-size:10px;"> Pending </span></td>
