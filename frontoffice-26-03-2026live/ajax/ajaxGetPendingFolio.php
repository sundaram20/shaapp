...
function get_pending_records_folio_wise($connNew, $id_folio) {
    ...
    $pos_query = mysqli_query($connNew, "SELECT SUM(grant_total_amount) as grant_total_amount FROM `pos_purch` WHERE `id_fo_folio_to` = '".$folio_result->id."' GROUP by id_fo_folio_to");
