            ...
            <div class="box-body" id="frontprintTable">
              ...
              $colspan = $is_bill_to_company > 0 ? "3" : "4";
                          ...
                          ?>
                            ...
                            ?>
                              <!-- <td class="pm" style="text-align:left;font-family: sans-serif;margin:0;padding:5px !important;border-right: 0.4px solid #000;"> -->
                              <td class="pm" style="text-align:left;font-family: sans-serif;">
...
?>
              ...
              <tr>
                <td style="padding:0px!important;border-bottom: 0.4px solid #000;border-top: 0.4px solid #000;">
                  <table id="myTable1" class="table table-striped no-footer dataTable" width="100%" border="0" cellspacing="0" cellpadding="10" style="display:none">
                    <thead>
                      <tr>
                        <td class="pm"
