...
$folioArray = array();
$id_parent_folio = selectColumn('fo_folio','id_parent_folio'," WHERE `id` = '".$id_fo_folio_to."'");
$folios = $id_fo_folio_to;
$get_folio_query = mysqli_query($connNew, "SELECT * FROM fo_folio WHERE id_parent_folio = '".$id_fo_folio_to."'");
while ($folio_result = mysqli_fetch_object($get_folio_query)) {
	$folios .= ",".$folio_result->id;
}

$sqlOrderDetail = mysqli_query($connNew, "Select  `".FO_RESERVATIONS_DETAILS."`.* from `".FO_RESERVATIONS_DETAILS."` where id_fo_folio_to in (".$folios.")");
if (mysqli_num_rows($sqlOrderDetail) > 0) {
	...
	while ($rowOrderDetail = mysqli_fetch_object($sqlOrderDetail)) {
		...
		$folio_no = selectColumn('fo_folio','mdoc_no'," WHERE `id` = '".$rowOrderDetail->id_fo_folio_to."'");

		$folioArray[$RoomNoAndRoomName][$mdoc_no]['RoomType'] = $RoomNoAndRoomName;
		$folioArray[$RoomNoAndRoomName][$mdoc_no]['folio'] = $rowOrderDetail->id_fo_folio_to;
		$folioArray[$RoomNoAndRoomName][$mdoc_no]['folio_no'] = $folio_no;
...
$sqlOrderDetail = mysqli_query($connNew, "Select * from `pos_purch` where id_fo_folio_to in (".$folios.")");
if (mysqli_num_rows($sqlOrderDetail) > 0) {
	while($rowOrderDetail = mysqli_fetch_object($sqlOrderDetail)) {
		...
		$folioArray[$RoomNoAndRoomName][$rowOrderDetail->id]['folio_no'] = $folio_no;
		$folioArray[$RoomNoAndRoomName][$rowOrderDetail->id]['folio'] = $rowOrderDetail->id_fo_folio_to;
...
$sqlOrderDetail = mysqli_query($connNew, "Select * from `fo_reservations_addons_details` where id_fo_folio_to in (".$folios.")");
if (mysqli_num_rows($sqlOrderDetail) > 0) {
	...
	while ($rowOrderDetail= mysqli_fetch_object($sqlOrderDetail)) {
		...
		$folioArray[$RoomNoAndRoomName][$rowOrderDetail->id]['tariff'] = '-';
		$folioArray[$RoomNoAndRoomName][$rowOrderDetail->id]['tax'] = $rowOrderDetail->tax_per_day_per_room;
		$folioArray[$RoomNoAndRoomName][$rowOrderDetail->id]['InvoiceNo'] = '-';
...
$checkin_date =	date('d-m-Y',strtotime(selectColumn(FO_RESERVATIONS,'checkin','WHERE id="'.$id_resevation.'"')));
...
// $HotelCIN = selectColumn(TBL_OUTLETS,'cin_no','WHERE id="'.$id_mst_outlet.'" AND id_shop="'.$_SESSION['shop'].'" ');
  	...
  	<section class="content">
    	<div class="row">
          	...
          	<div class="form-group col-xs-12 col-md-2 col-sm-2 c-box">
        		<button class="btn c-btn btn-block" style="margin-right:15px" onclick="printdiv('div_print');">
            			...
            			<div class="box-body" id="frontprintTable">
              				<table class="table dataTable  no-footer table-responsive out-table" width="100%" border="0" cellspacing="0" cellpadding="10" style="border:0.4px solid #000;">
                				<tbody>
                  					<tr>
                    					<td style="border-bottom: 0.4px solid #000;padding:0px!important;">
                      						<table class="table table-striped  dataTable no-footer" width="100%" border="0" cellspacing="0" cellpadding="10">
                        						<tbody>
                          							<tr>
                            							<td class="pm" style="display:table-cell;display:none;width:20%;border-right:.4px solid #000!important;">
                              								<img src="" width="137px" alt="">
                            							</td>
                            							<td class="pm" style="width:80%;font-family: sans-serif;font-size:11px;">
                              								<center><p style="font-size:20px;font-weight:500;padding-bottom:0;"><b>Folio</b></p></center>
                              								<center>
                                								<p><b style="font-size:30px;"><?php echo $HotelName; ?></b><br>
                                 								<?php echo $HotelAddress; ?>
                                 								<?php echo $HotelCity .',  '.$HotelState. '-' .$HotelPincode; ?><br>
                                                                 <?php if($HotelCIN != '') { ?>
                                                                      <b> CIN:</b> <?php echo $HotelCIN; ?>
                                                                  <?php } ?>
                                                                  <b> GST NO : </b><?php echo $HotelGST; ?><br/>
                                                                  <?php echo '<b> PAN:</b> '.$Hotelpan; ?>
                                                                  <br><b> PH:</b> +91 <?php echo $Hotelsecondary_landline.' '; ?><br>
                  					...
                  					<tr>
                    					<td style="padding:0px!important;">
                      						<table class="table dataTable table-striped no-footer" width="100%" border="0" cellspacing="0" cellpadding="10">
                        						<thead>
                          							<tr>
                            							<td class="pm" style="width:40%;font-size:11px;font-family: sans-serif;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:0;margin:0;">
                              								<b>
                                								<center>
                            							...
                            							<td class="pm" style="width:20%;font-size:11px;font-family: sans-serif;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:0;margin:0;">
                              								<b>
                                								<center>
                            							...
                            							<td class="pm" style="width:20%;font-size:11px;font-family: sans-serif;border-bottom:.4px solid #000;padding:0;margin:0;">
                              								<b>
                                								<center>
                        						...
                        						<tbody>
                          							<tr>
                            							<td class="pm" rowspan="2" style="text-align:left;width:40%;border-bottom:.4px solid #000;border-right:.4px solid #000;font-size:11px;font-family: sans-serif;">
                                    						<left>
                                  						...
                                  						<td class="pm" style="text-align:center;width:20%;border-right:.4px solid #000;border-bottom:.4px solid #000;font-family: sans-serif;">
                                    						<p style="font-size:11px;"><?php echo $roomNumber;?></p>
                                  						</td>
                                  						<td class="pm" style="text-align:center;width:20%;border-right:.4px solid #000;border-bottom:.4px solid #000;font-family: sans-serif;">
                                    						<p style="font-size:11px;"><?php echo $checkin_date;?></p>
                                  						</td>
														<td class="pm" style="text-align:center;width:20%;border-bottom:.4px solid #000;font-family: sans-serif;">
															<p style="font-size:11px;"><?php echo $checkout_date; ?></p>
														</td>
                          							</tr>
                          							<td class="pm" style="width:20%;font-size:11px;font-family: sans-serif;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:0;margin:0;">
                              							<b>
                            						...
                            						<td class="pm" style="width:20%;font-size:11px;font-family: sans-serif;border-bottom:.4px solid #000;padding:0;margin:0;">
                          							...
                          							<tr>
														<td class="pm" style="width:20%;font-size:11px;font-family: sans-serif;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:0;margin:0;">
															<b>
																<center>
																	<p style="padding:5px;margin:0;">Company Name & Address</p>
																</center>
															</b>
														</td>
														<td class="pm" style="text-align:center;width:20%;border-right:.4px solid #000;border-bottom:.4px solid #000;font-family: sans-serif;">
															<p style="font-size:11px;"><?php echo $pax; ?></p>
														</td>
														<td class="pm" style="text-align:center;width:20%;border-right:.4px solid #000;border-bottom:.4px solid #000;font-family: sans-serif;">
                          							...
                          							<tr>
                              							<td class="pm" style="text-align:left;;border-right:.4px solid #000;border-bottom:.4px solid #000;font-family: sans-serif;">
                                							<p style="font-size:11px;"><span> <?php echo $CompanyName;?></span><br> <?php echo $CompanyAddress;?></span></p>
                              							</td>
                              							<td class="pm" colspan="3" style="text-align:left;border-bottom:.4px solid #000;font-family: sans-serif;">
                                							<p style="font-size:11px;"><b>Company GST :  <?php echo $CompanyGST;?></b></p>
                              							</td>
                         							</tr>
                          							<tr>
                              							<td class="pm" colspan="1" style="text-align:left;font-family: sans-serif;margin:0;padding:5px !important;border-right: 0.4px solid #000;">
                                							<p style="font-size:11px;"><span> <b>Authorised by :</b></span><?php echo $company_contacts;?></span></p>
                              							</td>
                              							<td class="pm" colspan="3" style="text-align:left;font-family: sans-serif;margin:0;padding:5px !important;">
                                							<p style="font-size:11px;"><span> <b>Booking Reference :</b></span>
                                								<?php echo $reservation_mdoc_no;?></span>
                              								</p>
                              							</td>
                         							</tr>
                        						</tbody>
                  					...
                  					<tr>
                    					<td style="padding:0px!important;border-bottom: 0.4px solid #000;border-top: 0.4px solid #000;">
                     						<table id="myTable1" class="table table-striped no-footer dataTable" width="100%" border="0" cellspacing="0" cellpadding="10">
                        						<thead>
                          							<tr>
                               							<td class="pm" style="width:6%;font-size:11px;font-family: sans-serif;padding:5px 4px!important;margin:0;border-right: 0.4px solid #000;border-bottom: 0.4px solid #000;">
                              								<p style="margin:3px;"><b>  S.No</b></p>
                            							</td>
                          								<td class="pm" style="width: 26%;font-size:11px;font-family: sans-serif;padding:5px 4px!important;margin:0;border-right: 0.4px solid #000;border-bottom: 0.4px solid #000;">
                              								<p style="margin:3px;"><b>Bill No</b></p>
                            							</td>
														<td class="pm" style="width: 20%;font-size:11px;font-family: sans-serif;padding:5px 4px!important;margin:0;border-right: 0.4px solid #000;border-bottom: 0.4px solid #000;">
															<p style="margin:3px;"><b>Date</b></p>
														</td>
														<td class="pm" style="font-size:11px;font-family: sans-serif;width:20%;padding:5px 4px!important;margin:0;border-right: 0.4px solid #000;border-bottom: 0.4px solid #000;">
															<p style="margin:3px;"><b>Description</b></p>
														</td>
														<td class="pm" style="width: 20%;font-size:11px;font-family: sans-serif;padding:5px 4px!important;margin:0;border-right: 0.4px solid #000;border-bottom: 0.4px solid #000;">
															<p style="margin:3px"><b>Receipt</b></p>
														</td>
														<td class="pm" style="font-size:11px;font-family: sans-serif;width: 8%;padding:5px 4px!important;margin:0;border-bottom: 0.4px solid #000;">
                       							...
                       							<?php
    												...
    												foreach ($folioArray as $RoomName => $Array1) {
      													foreach ($Array1 as $rowid=>$Array2) {
															if ($Array2['folio'] != $prev_folio) {
																$prev_folio = $Array2['folio'];
												?>
                          							<tr>
														<td colspan="6" class="pm"style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
															<p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;text-align:center;"><b> <?php echo $Array2['folio_no']; ?>  </b></p>
														</td>
													</tr>												
												<?php
															}
												?>
                          							<tr>
														<td class="pm"style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
															<p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;"> <?php echo $count++; ?>  </p>
														</td>
														<td class="pm" style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
															<p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
																<?php echo ($Array2['InvoiceNo']); ?>
															</p>
														</td>
														<td class="pm" style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
															<p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;"> <?php echo date('d-m-Y',strtotime($Array2['dated'])); ?></p>
														</td>
														<td class="pm" style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
															<p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
                           								...
                           								<td class="pm" style="border-bottom:.4px solid #000;padding-top:4px!important;width: 15%;padding:5px 4px!important;margin:0;border-right:.4px solid #000;">
                              								<p style="font-size:11px;font-family: sans-serif;margin:0!important;"><br>
                                							<b><?php //echo $Array2['RoomType'];?></b></p>
                            							</td>
														<td class="pm" style="width: 1%;padding:0px!important;margin:0;text-align:right;border-bottom:.4px solid #000;padding:5px 4px!important;">
															<p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
												...
												<?php
													...
													if (mysqli_num_rows($res_fo_receipt) > 0) {
  														$i = 1;
														$row_fo_receiptAmount = 0;
  														while ($row_fo_receipt = mysqli_fetch_object($res_fo_receipt)) {
        													$row_fo_receiptAmount += $row_fo_receipt->amount;
        										?>
      												<tr>
                             							<td class="pm"style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;"></td>
														<td class="pm" style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
															<p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
														...
														<td class="pm" style="width: 1%;padding:0px!important;margin:0;text-align:right;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
															<p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
																<?php echo $row_fo_receipt->amount;?>
															</p>
														</td>
														<td class="pm" style="border-bottom:.4px solid #000;padding-top:4px!important;width: 20%;padding:0px!important;padding-left:5px!important;margin:0;">
															<p style="font-size:11px;font-family: sans-serif;padding:0!important;margin:0!important;"> - </p>
														</td>
                          							</tr>
                          						<?php
														}
												...
												?>                          
                          							<tr>
														<td class="pm" style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;">
															<p style="font-size:11px;font-family: sans-serif;padding:5px!important;margin:0!important;"></p>
														</td>
														<td class="pm" style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;">
															<p style="font-size:11px;font-family: sans-serif;padding:5px!important;margin:0!important;"></p>
														</td>
														<td class="pm" style="width: 1%;padding:0px!important;margin:0;text-align:right;border-right:.4px solid #000;padding:5px 4px!important;">
															<p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
																<b>Sub Total  : </b>
															</p>
														</td>
														<td class="pm" style="width: 1%;padding:0px!important;margin:0;text-align:right;border-right:.4px solid #000;padding:5px 4px!important;">
															<p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
																<?php echo $row_fo_receiptAmount; ?>
															</p>
														</td>
														<td class="pm" style="width: 1%;padding:0px!important;margin:0;text-align:right;border-right:.4px solid #000;padding:5px 4px!important;">
															<p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
																<?php echo $CurrentTotal; ?>
															</p>
														</td>
                          							</tr>
                        						</tbody>
                  					...
                  					<tr>
                    					<td>
                      						<table id="myTable1" class="table table-striped  dataTable" border="0" width="100%">
                        						...
                        						<tbody>
                          							<tr>
                            							<td class="pm" colspan="3" style="font-family: sans-serif;font-size:12px;padding: 5px 4px !important;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="pm" style="padding: 5px 14px 16px 10px!important;font-family: sans-serif;font-size:11px;">
                                                            <p style="font-weight:100;font-size:10px;padding: 45px 17px 6px 4px!important"> Yours Faithfully <br> For <b class="text-uppercase"> <?php echo $HotelName; ?></b></p>
                                                            <p style="text-transform:uppercase; padding-top: 6.5rem; padding-bottom : 0.2rem;"><b>Authorised Signature</b></p>
                                                        </td>
                                                        <td class="pm" style="padding: 76px 14px 16px 10px!important;font-family: sans-serif;font-size:11px;text-align: center;">
                                                            <p class="text-uppercase"><b>Guest Signature</b></p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="text-transform:uppercase; text-align : center; margin-bottom : 0!important; padding : 5px 0px!important;"><b>Please Deposit your room key on Checkout</p>
                                        </td>
                                    </tr>
                				</tbody>
              				</table>
