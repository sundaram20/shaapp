            ...
            <div class="row">
              ...
              <!--col start-->
                <div class="form-group col-sm-3">
                       <?php //debugData($_REQUEST); ?>
                           <label for="booking_date"><input type="radio" name="checkin_radio" value="2" <?php if($_REQUEST['checkin_radio']=='2'){echo 'checked="checked"'; }else if(isset($_REQUEST['checkin_radio']) && $_REQUEST['checkin_radio']=='1'  ){}else{echo 'checked="checked"';}?>/>&nbsp;Booking Date/Modified Date : From - To</label>
