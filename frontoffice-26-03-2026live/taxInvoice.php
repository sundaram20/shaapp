		...
		foreach($folioArray as $RoomName=>$Array1){
			...
			foreach($Array1 as $rowid=>$Array2){?>
                          ...
                          <tr>
                            ...
                            <td class="pm"
                              style="border-bottom:.4px solid #000;padding-top:4px!important;width: 12%;padding:0px!important;padding-left:5px!important;margin:0;border-right:.4px solid #000;">
                              <p style="font-size:10px;font-family: sans-serif;padding:0!important;margin:0!important;">
                                <?php echo round($Array2['tariff']/$Array2['Days']);?> <?php echo $Array2['Days']!=''?' X '.$Array2['Days'].' Days':''; ?></p>
                            </td>
...
if(mysqli_num_rows($res_fo_receipt)>0){
	...
	while($row_fo_receipt = mysqli_fetch_object($res_fo_receipt)){
      ...
      <tr>
                           <td class="pm"
                              style="border-bottom:.4px solid #000;padding-top:4px!important;width: 6%;padding:5px 4px!important;margin:0;border-right:.4px solid #000;"></td>
                            <td class="pm"
                              style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
                              <p
