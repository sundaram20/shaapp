...
while($Records	   =	mysqli_fetch_object($query)){
	...
	//========================================
				...
				$Records->id_fo_folio	='Front Office-POS';	
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CASH']['outlet_Name']="CASH";
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['BIllONHOLD']['outlet_Name']="BIllONHOLD";
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CARD']['outlet_Name']="CARD";
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CHEQUE']['outlet_Name']="CHEQUE";
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['UPI']['outlet_Name']="UPI";
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['ONLINETRANSFER']['outlet_Name']="ONLINETRANSFER";
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['COMPANY']['outlet_Name']="COMPANY";
	//$SalesRegisterArrayPOS[$Records->id_fo_folio]['ROOMTO']['outlet_Name']="ROOMTO";
	...
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CASH']['Today']+=$Records->CASH_Today;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['BIllONHOLD']['Today']+=$Records->BIllONHOLD_Today;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CARD']['Today']+=$Records->CARD_Today;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CHEQUE']['Today']+=$Records->CHEQUE_Today;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['UPI']['Today']+=$Records->UPI_Today;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['ONLINETRANSFER']['Today']+=$Records->ONLINETRANSFER_Today;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['COMPANY']['Today']+=$Records->COMPANY_Today;
    //$SalesRegisterArrayPOS[$Records->id_fo_folio]['ROOMTO']['Today']+=$Records->ROOMTO_Today;
	
	
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CASH']['MTD']+=$Records->CASH_MTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['BIllONHOLD']['MTD']+=$Records->BIllONHOLD_MTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CARD']['MTD']+=$Records->CARD_MTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CHEQUE']['MTD']+=$Records->CHEQUE_MTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['UPI']['MTD']+=$Records->UPI_MTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['ONLINETRANSFER']['MTD']+=$Records->ONLINETRANSFER_MTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['COMPANY']['MTD']+=$Records->COMPANY_MTD;
	//$SalesRegisterArrayPOS[$Records->id_fo_folio]['ROOMTO']['MTD']+=$Records->ROOMTO_MTD;
	
	
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CASH']['YTD']+=$Records->CASH_YTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['BIllONHOLD']['YTD']+=$Records->BIllONHOLD_YTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CARD']['YTD']+=$Records->CARD_YTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['CHEQUE']['YTD']+=$Records->CHEQUE_YTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['UPI']['YTD']+=$Records->UPI_YTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['ONLINETRANSFER']['YTD']+=$Records->ONLINETRANSFER_YTD;
	$SalesRegisterArrayPOS[$Records->id_fo_folio]['COMPANY']['YTD']+=$Records->COMPANY_YTD;
	//$SalesRegisterArrayPOS[$Records->id_fo_folio]['ROOMTO']['YTD']+=$Records->ROOMTO_YTD;
...
$objPHPExcel->setActiveSheetIndex(0)
				->setCellValue('A'.$con, 'Front Office Collections');
				$objPHPExcel->getActiveSheet()->getStyle('A'.$con)->getFont()->setBold(true);
...
$objPHPExcel->getActiveSheet()->getStyle('A'.$con.':J'.$con)->getAlignment()->applyFromArray(
	...
	array('horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER,)
		...
		//foreach($SalesRegisterArray as $outlet=>$Datalist3){
			foreach($SalesRegisterArray as $Type=>$Datalist1){
	...
	if($Type=='POS'){
			...
			$objPHPExcel->setActiveSheetIndex(0)
				...
				->setCellValue('D'.$con, round($Datalist3['Today']))
				
				
				->setCellValue('E'.$con, '')
				->setCellValue('F'.$con, '')
						
				->setCellValue('G'.$con, round($Datalist3['MTD']))
				
				
				->setCellValue('H'.$con, '')
				->setCellValue('I'.$con, '')
								
				->setCellValue('J'.$con, round($Datalist3['YTD']));
				
				
				
				$pos_sub_Today +=	round($Datalist3['Today']);
				$Frontoffice_sub_Today +=	round($Datalist3['Today']);
				
				$Net_Today +=	round($Datalist3['Today']);
				
				
				$pos_sub_MTD +=	round($Datalist3['MTD']);
				$Frontoffice_sub_MTD +=	round($Datalist3['MTD']);
				
				$Net_MTD +=	round($Datalist3['MTD']);
				
				
				$pos_sub_YTD +=	round($Datalist3['YTD']);
				$Frontoffice_sub_YTD +=	round($Datalist3['YTD']);
				
				$Net_YTD +=	round($Datalist3['YTD']);
	...
	//debugData($roomTypeArray);die;
$objPHPExcel->setActiveSheetIndex(0)
				->setCellValue('A'.$con, 'POS Direct Collections');
				$objPHPExcel->getActiveSheet()->getStyle('A'.$con)->getFont()->setBold(true);
...
$objPHPExcel->getActiveSheet()->getStyle('A'.$con.':J'.$con)->getAlignment()->applyFromArray(
	...
	array('horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER,)
		...
		//foreach($SalesRegisterArray as $outlet=>$Datalist3){
			foreach($SalesRegisterArrayPOS as $Type=>$Datalist1){
		
		foreach($Datalist1 as $outlet=>$Datalist3){ 
	if($Type=='Front Office-POS'){
