                        						...
                        						<tbody>
                          							<tr>
                            							...
                            							<td class="pm" style="width:80%;font-family: sans-serif;font-size:11px;">
                              								<center><p style="font-size:15px;font-weight:600;padding-bottom:0;">Folio</p></center>
                              								<center>
                                								<p><b style="font-size:28px;"><?php echo $HotelName; ?></b><br>
                        						...
                        						<tbody>
                          							<tr>
														<td class="pm" style="padding: 5px 14px 16px 10px!important;font-family: sans-serif;font-size:11px;">
															...
															<p style="font-weight:100;font-size:10px;padding: 45px 17px 6px 4px!important"> Yours Faithfully <br><b> For <?php echo $HotelName; ?></b></p>
														</td>
