...
$guestName=$Title.' '.ucwords(strtolower($Firstname)).' '.ucwords(strtolower($Lastname));
    ...
    <span data-toggle="tooltip" data-placement="top" title="<?php echo htmlspecialchars($tooltipText); ?>">
        <?php echo $displayText; ?>
                                    ...
                                    <td><button class="btn btn-success btn-xs" onclick="getRoomDetails(<?php echo $reservation_id;?>,2,'<?php echo $id; ?>','<?php echo $row->id_mst_room_types;?>');" data-toggle="tooltip" title="Allocate / Checkin "><i class="fa fa-eye"></i></button>
