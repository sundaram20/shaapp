...
if($_POST['Save']){
	...
	if(empty($_POST['rate_id'])){
		...
		else if($db->num_rows2(selectSql(TBL_RATE_MAPPING,"WHERE  `id_shop` = '".addslashes($_SESSION['shop'])."' AND `rate_id` = '".addslashes($_POST['rate_id'])."' AND `booking_engine_id` = '".addslashes($_POST['booking_engine_id'])."' AND `id_hotel` = '".$_REQUEST['id_hotel']."' AND `channel_id` = '".addslashes($_POST['channel_id'])."'",'')) && empty($_POST['eId'])){
...
<div class="box-body">
  ...
  <label for="shop_id">Shop<font color="#FF0000">*</font></label>
   ...
   <?php $shopDropDown = '<select class="form-control select2" name="shop_id" onchange="getHotelMapping(this.value,'.$row->id_hotel.'); getRateMapping(this.value,'.$row->rate_id.');">
...
<div class="form-group">
  ...
  <label for="hotel_id">Hotel<font color="#FF0000">*</font></label>
   ...
   <?php $categoryDropDown = '<select onchange="fetchRoomsForHotel(this.value,\'id_room\');" class="form-control select2" name="id_hotel" id="hotel_id">
...
<div class="form-group">
 ...
 <select name="id_room" id="id_room" class="form-control select2">
...
window.onload = function() {
				...
				getHotelMapping('<?php echo $row->id_shop; ?>','<?php echo $row->id_hotel; ?>'); 
