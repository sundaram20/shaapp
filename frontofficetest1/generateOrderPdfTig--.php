              ...
              <table class="table" style="padding-top:0;margin-top:-10px;border:0px solid red;" width="100%">
						<tr>
						  <td width="30%" style="padding:0!important;">';
						   ...
						   $content .= '<div style="margin-top : 5.5rem;">
						   '.$hotelLogo.'
						  </div>
						 	</td>
						   <td width="70%" style="padding:0!important; border:0px solid red; float:right;text-align:right;" >
							...
							$content .= '<span style="font-size:12px;line-height:18px;"><b>Contact No: </b> '.$resultHotelDetail->primary_mobile.'';
							$content .= ''.($resultHotelDetail->secondary_landline!=""?"<b> , </b>".$resultHotelDetail->secondary_landline."<br/>":"");
...
$content .= '<table class="table" border="0" style="margin-bottom:0;">
						
						 
						 <tr>
						   <td  colspan="2" style="text-align:center;color:#961b1e;font-size:14px;">
...
$receipt_amount = $row->total_amount ?? 0;
			...
			$resRatePlan = executeSQl("SELECT * from fo_rate_plan where id='".addslashes($rowOrderDetail->id_fo_rate_plan)."'"); 
			  ...
			  $remarks='';
				...
				if($resultRatePlan->name =='EP' || $resultRatePlan->name =='EPAI'){
			   $remarks	=	'Room Only';
			  }else{
			 ...
			 if(($resultRatePlan->rate_name =='MAP' || $resultRatePlan->rate_name =='MAPAI') ){
			  ...
			  $remarks	=	strtolower($resultRatePlan->remarks);
				...
				$room_quantity = 0;
				$adults_per_room = 0;
				$child_below_5_year = 0;
				$child_above_5_year = 0;
				...
				$avg = (($room_details->tariff_price_per_day_per_room ?? 0) / $room_quantity);
					...
					$Tarrif_per_night = round($room_details->tariff_price_per_day_per_room+$total_tax)/$number_of_days;
			...
			$priceValue = 0;
					...
					<tr><td style="font-size:9px;padding-top:0!important;"><span style="font-weight:bold">NUMBER OF ROOMS: </span><span style="color:#000;font-size:10px;"> '.$room_quantity.'</span></td></tr>
...
<td style="font-size:9px;padding-top:0!important;"><span style="font-weight:bold">TARIFF PER NIGHT:  </span><span style="color:#000;font-size:10px;">'.$currency.' '.round(($Tarrif_per_night+$tax_per_night),2,PHP_ROUND_HALF_UP).'</span></td>
...
<tr>
<td style="width:350px;font-size:9px;padding-top:0!important;"><span style="font-weight:bold">TOTAL NUMBER OF ADULT: </span><span style="color:#000;font-size:10px;">'.$adults_per_room.'</span></td>
...
<td style="width:350px;font-size:9px;padding-top:0!important;"><span style="font-weight:bold">TOTAL NUMBER OF KIDS 0-5 YEARS : </span><span style="color:#000;font-size:10px;">'.$child_below_5_year.'</span></td>

<td style="font-size:9px;padding-top:0!important;"><span style="font-weight:bold">ROOM TOTAL : </span><span style="color:#000;font-size:10px;"> '.$currency.' '.round($room_details->tariff_price_per_day_per_room+$total_tax,2,PHP_ROUND_HALF_UP).'</span></td>
</tr>
...
<td style="width:350px;font-size:9px;padding-top:0!important;"><span style="font-weight:bold">TOTAL NUMBER OF KIDS 5-12 YEARS : </span><span style="color:#000;font-size:10px;">'.$child_above_5_year.'</span></td>
...
$content .= '<table class="table" border="0" width="100%" ><tr>
     <td colspan="2" style="padding-top:0!important;font-size:9px;border:0px solid red;"><span style="text-align:left;font-weight:bold;">INCLUSIONS : </span></b><span style="font-size:10px;color:#000;">'.ucwords(strtoupper($resultRatePlan->name)).' - '.ucwords(strtoupper($resultRatePlan->remarks)).'</span></td></tr>';
	...
	$content .= '</table>				
		...
		$item_list = implode(', ', $items);
			...
			$content .=' <table class="table" border="0" style="" >
                <tr >
<td style="font-size:9px;padding-top:0!important;"><span style="font-weight:bold">'.$roomLabel.' SUB TOTAL :  </span><span style="color:#000;font-size:10px;"> '.$currency.' '.round($sub_total +  $others_sub_total ).'</span></td>
...
$content .='<tr>
<!--<td style="width:350px;font-size:9px;padding-top:0!important;"><span style="font-weight:bold">'.$roomLabel.' TAXES :  </span><span style="color:#000;font-size:10px;">Prices are all inclusive of Taxes</span></td>-->
...
<td style="width:350px;font-size:9px;padding-top:0!important;"><span style="font-weight:bold">PAYMENT STATUS : </span><span style="color:#000;font-size:10px;"> '.$res_payment_status . (!empty($rowOrder->res_payment_instruction) ? ' ('.$rowOrder->res_payment_instruction.')' : '') .' </span></td>
...
//$content .= '<div style="page-break-before: always; margin-top: 20px;">';

// =============================================
// STATIC RESORT POLICIES
// =============================================

$content .= '<hr style="border:0.3px solid grey;">';

$content .= '
<table class="table" border="0" style="padding:0!important;margin:0!important;width:100%;">
    <tr>
        <td style="font-size:10px;line-height:14px;color:#000;">

            <!-- ===== SECTION TITLE ===== -->
            <div style="text-align:center;margin-bottom:8px;">
                <strong style="font-size:13px;text-transform:uppercase;color:#961b1e;font-family:Tahoma,sans-serif;">
                    Resort Policies
                </strong>
            </div>
            <hr style="border:0.3px solid #961b1e;margin-bottom:8px;">

            <!-- ===== ARRIVAL & DEPARTURE ===== -->
            <div style="margin-bottom:6px;">
                <strong style="font-size:10px;color:#961b1e;text-transform:uppercase;">
                    Arrival &amp; Departure Policy
                </strong><br>
                <span style="font-size:10px;">
                     Check-In: 1:00 PM &nbsp;|&nbsp; Check-Out: 11:00 AM
                </span>
                <ul style="margin:3px 0 0 0;padding-left:18px;font-size:9px;line-height:14px;">
                    <li>Early check-in and late check-out are subject to availability.</li>
                    <li>To guarantee early check-in, guests must book the room from the previous night.</li>
                    <li>Check-in after 11:00 PM is not permitted.</li>
                </ul>
            </div>
            <hr style="border:0.3px solid #ddd;margin:5px 0;">
            ...
            <div style="margin-bottom:6px;">
                ...
                <span style="font-size:9px;line-height:14px;">
                    In compliance with government regulations, all guests must present valid government-issued 
                    photo identification upon check-in.
                </span>
                <div style="margin-top:3px;font-size:9px;line-height:14px;">
                    <strong>Accepted IDs:</strong><br>
                     <strong>For Indian Nationals:</strong> Aadhaar Card, Passport, or Driving License<br>
                     <strong>For Foreign Nationals:</strong> Passport with a valid visa<br>
                     <strong>Not Accepted:</strong> PAN cards or office-issued ID cards
                </div>
            </div>
            <hr style="border:0.3px solid #ddd;margin:5px 0;">
            ...
            <div style="margin-bottom:6px;">
                ...
                <span style="font-size:9px;line-height:14px;">To confirm a reservation, guests must provide:</span>
                <ul style="margin:3px 0 0 0;padding-left:18px;font-size:9px;line-height:12px;">
                    <li>A bank deposit, valid credit/debit card details, or</li>
                    <li>A prepaid confirmation voucher from a registered travel agency. We accept all major credit &amp; debit cards.</li>
                </ul>
            </div>
            <hr style="border:0.3px solid #ddd;margin:5px 0;">
            ...
            <div style="margin-bottom:6px;">
                ...
                <span style="font-size:9px;line-height:14px;">
                    Cancellations must be made within the stipulated time to avoid retention charges.<br>
                    A no-show or late cancellation will result in 100% charges, including applicable taxes.<br>
                    The provided credit card will be charged in case of a late cancellation or no-show.
                </span>

                <div style="margin-top:5px;font-size:9px;">
                    <strong>Cancellation Schedule:</strong>
                </div>

                <table border="1" cellpadding="4" cellspacing="0" style="width:100%;font-size:9px;border-collapse:collapse;margin-top:3px;border-color:#ccc;">
                    <tr style="background-color:#961b1e;color:#fff;">
                        <td style="padding:4px 6px;"><strong>Stay Period</strong></td>
                        <td style="padding:4px 6px;"><strong>Free Cancellation Until</strong></td>
                        <td style="padding:4px 6px;"><strong>Cancellation Charges Apply From</strong></td>
                    </tr>
                    <tr>
                        <td style="padding:4px 6px;">1 July 2024 &ndash; 30 September</td>
                        <td style="padding:4px 6px;">3 days before check-in</td>
                        <td style="padding:4px 6px;">Cancellation within 3 days or No-show</td>
                    </tr>
                    <tr style="background-color:#f9f9f9;">
                        <td style="padding:4px 6px;">1 October &ndash; 20 December</td>
                        <td style="padding:4px 6px;">7 days before check-in</td>
                        <td style="padding:4px 6px;">Cancellation within 7 days or No-show</td>
                    </tr>
                    <tr>
                        <td style="padding:4px 6px;">21 December &ndash; 2 January</td>
                        <td style="padding:4px 6px;color:#961b1e;"><strong>No cancellation period</strong></td>
                        <td style="padding:4px 6px;">&mdash;</td>
                    </tr>
                    <tr style="background-color:#f9f9f9;">
                        <td style="padding:4px 6px;">3 January 2025 &ndash; 30 June</td>
                        <td style="padding:4px 6px;">7 days before check-in</td>
                        <td style="padding:4px 6px;">Cancellation within 7 days or No-show</td>
                    </tr>
                </table>
            ...
            <!-- ===== CHILD STAY & MEAL POLICY ===== -->
            <div style="margin-bottom:6px;">
                <strong style="font-size:10px;color:#961b1e;text-transform:uppercase;">
                    Child Stay &amp; Meal Policy
                </strong><br>
                <div style="font-size:9px;line-height:14px;margin-top:2px;">
                     <strong>Children Below 6 Years</strong> &ndash; Complimentary stay without an extra bed when sharing the room with parents.<br>
                     <strong>Children (6&ndash;12 Years)</strong> &ndash; 2,000 per night (includes all 3 meals &ndash; Breakfast, Lunch &amp; Dinner).<br>
                     <strong>Children (13 Years &amp; Above)</strong> &ndash; Considered adults and charged 3,000 per night (includes all 3 meals).
                </div>
                <div style="margin-top:4px;font-size:9px;font-weight:bold;">Additional Room for Children</div>
                <ul style="margin:2px 0 0 0;padding-left:18px;font-size:9px;line-height:14px;">
                    <li>Parents traveling with two children must book a separate room and will be charged accordingly.</li>
                    <li>If a separate room is required for children under 12 years, a 50% discount on the parent&#39;s room rate applies (subject to availability, not valid on weekends &amp; peak dates).</li>
                </ul>
            </div>
            <hr style="border:0.3px solid #ddd;margin:5px 0;">
            ...
            <div style="margin-bottom:6px;">
                ...
                <div style="font-size:9px;line-height:14px;margin-top:2px;">
                     <strong>Outside Liquor Policy:</strong> Bringing outside liquor into the resort is strictly prohibited.<br>
                     <strong>Alcohol Consumption:</strong> Alcohol may not be consumed in open areas or lawns unless a valid bar license is obtained for the event.<br>
                     <strong>Pet Policy:</strong> Pets are not allowed on the premises.<br>
                     <strong>Music Policy:</strong> Loud music is not permitted to maintain the tranquil ambiance of the resort.
                </div>
            </div>
            <hr style="border:0.3px solid #ddd;margin:5px 0;">
            ...
            <div style="margin-bottom:6px;">
                ...
                <div style="font-size:9px;line-height:14px;margin-top:2px;">
                    Our wellness &amp; spa services are exclusively available for in-house guests.
                </div>
            </div>
            <hr style="border:0.3px solid #ddd;margin:5px 0;">
            ...
            <div style="margin-bottom:4px;">
                ...
                <div style="font-size:9px;line-height:14px;margin-top:2px;">
                     <strong>Call Us:</strong> +91 9811897214<br>
                     <strong>Email:</strong> info@tigerinncomfortresort.com<br>
                     <strong>Policy Updates:</strong> The resort reserves the right to amend these policies as needed. 
                    Any changes will be communicated to guests with existing bookings.
                </div>
            </div>
...
color: #f5ca6d;                   
	...
	.address-font{			
	font-family: Tahoma, Verdana, Segoe, sans-serif; font-size: 14px; font-style: normal; font-variant: normal;  line-height: 16px;	
	}
	color:#961b1e;
	.hotel-name{
		font-family: Tahoma, Verdana, Segoe, sans-serif; font-size: 14px; font-style: normal; font-variant: normal; font-weight: bold; line-height: 20px;text-transform:uppercase;
		}
