...
<p class="error id_mst_hotels_new-error"></p>
            ...
            <div class="form-group col-sm-2">
              ...
              $categoryDropDown = '<select class="form-control select2" name="id_mst_company_contacts_new" id="id_mst_company_contacts_new" >
...
</table><table class="table order-list1 table-hover"  ><tbody id="TextBoxContainerForm"></tbody></table>
