                                ...
                                <div class="card text-dark bg-light">
                                    ...
                                    <div class="row">
                                       <div class="form-group col-md-3 col-sm-3">
                                        ...
                                        <div id="secondaryContactDiv"></div>
                                    </div>
                      ...
                      <div class="col-md-6" style="padding-right: 0px">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <div class="input-group-addon">
                                <a href="#" class="text-info" id="guestEditId" data-guestid="1"><i class="fa fa-edit"></i> </a>
                              </div>
                            </div>
                        </div>
    ...
    $(document).ready(function(){
        ...
        $(document).on('change', '#primaryContact', function(){
          ...
          if(primaryContact == "Mobile"){
            var mobile = '<div class="form-group col-md-3 col-sm-3"><label for="primaryContactMobile">Mobile<font color="#FF0000">*</font></label><input type="number" class="form-control" placeholder="Enter Mobile" id="primaryContactMobile" name="primaryContactMobile" data-parsley-errors-container="#primaryContactMobileError" data-parsley-required /><span id="primaryContactMobileError"><?php echo $err_primaryContactMobileError;?></span></div>';

              $("#primaryContactDiv").html(mobile);

          }else if(primaryContact == "Landline"){
            var landline = '<div class="form-group col-md-3 col-sm-3"><label for="primaryContactLandline">Landline<font color="#FF0000">*</font></label><input type="number" class="form-control" placeholder="Enter Landline" id="primaryContactLandline" name="primaryContactLandline" data-parsley-errors-container="#primaryContactLandlineError" data-parsley-required /><span id="primaryContactLandlineError"><?php echo $err_primaryContactLandlineError;?></span></div>';

              $("#primaryContactDiv").html(landline);
          }else{
              $("#primaryContactDiv").html('<div></div>');
            }
        });
        ...
        $(document).on('change', '#secondaryContact', function(){
          ...
          if(secondaryContact == "Mobile"){
            var mobile = '<div class="form-group col-md-3 col-sm-3"><label for="secondaryContactMobile">Mobile<font color="#FF0000">*</font></label><input type="number" class="form-control" placeholder="Enter Mobile" id="secondaryContactMobile" name="secondaryContactMobile" data-parsley-errors-container="#secondaryContactMobileError" data-parsley-required /><span id="secondaryContactMobileError"><?php echo $err_secondaryContactMobileError;?></span></div>';

              $("#secondaryContactDiv").html(mobile);

          }else if(secondaryContact == "Landline"){
            var landline = '<div class="form-group col-md-3 col-sm-3"><label for="secondaryContactLandline">Landline<font color="#FF0000">*</font></label><input type="number" class="form-control" placeholder="Enter Landline" id="secondaryContactLandline" name="secondaryContactLandline" data-parsley-errors-container="#secondaryContactLandlineError" data-parsley-required /><span id="secondaryContactLandlineError"><?php echo $err_secondaryContactLandlineError;?></span></div>';
                    ...
                    success:function(data){
                        ...
                        data.forEach((value,key,arr)=>{
                            tableData += `
                                ...
                                <tr id="tr_${value.reservation_id}"></tr>
                            `;
                        });
    ...
    $.ajax({
       ...
       success: function (result) {   
           // $("#tab_2,#tab_1,#tab_3,.nav-tabs li").removeClass("active");
            ...
            $("#res_guestAddId").attr('onClick','guestDetails('+0+')');
            $("#res_guestEditId").attr('onClick','guestDetails('+result.Id+')');
        }
     }); 
  } 
...
<script>
 ...
 $(document).ready(function() {
    ...
    $("#more-options").click(function() {
        ...
        /* filling more options form here */
        $("#res_hotelName").val($("#res_hotel").val()) ; 
        $("#res_guestName").val($("#guestname").val()) ; 
        $("#res_checkinDate").val($("#res_checkin").val()) ; 
        $("#res_checkOutDate").val($("#res_checkout").val()) ; 
        
    });

    $("#guestAddId").click(function() {
        guestDetails(null);
        $("#reservationModal").modal("hide");
        
    });

    //$("#guestEditId").click(function() {
      $(document).on('click', '#guestEditId', function(){
    ...
    $(document).on('change','#booking_status',function(){
            ...
            if(bookingStatus == "ten"){

                var holdtill = '<div class="col-md-3" style="padding-right: 0px;"><div class="form-group"><label for="holdTillDate">Hold Till Date</label><input type="text" class="form-control datepicker" name="holdTillDate" id="holdTillDate" placeholder="dd-mm-yyyy" /></div></div>';

                $("#holdtillDiv").html(holdtill);

            }
            else{
                $("#holdtillDiv").html("<div></div>");                
            }
...
<script type="text/javascript">
    ...
    function addOns(){
      ...
      if(x < list_maxField){ 
          ...
          var list_fieldHTML = '<tr><td><select class="form-control parsley-error" style="width: 120px;" name="item['+x+']" id="item"data-parsley-required><option selected="selected" value="">Select Item</option><option value="Item1">Item1</option><option class="Item2">Item2</option></select></td><td><input type="text" class="form-control parsley-error" style="width:140px;" name="additionalcharges['+x+']" id="additionalcharges" data-parsley-required/></td><td><input type="text" class="form-control parsley-error" style="width:100px;" name="qty['+x+']" id="qty" data-parsley-required/></td><td><select class="form-control parsley-error" style="width: 120px;" name="unit['+x+']" id="unit"data-parsley-required><option selected="selected" value="">Select Unit</option><option value="Day">Day</option><option class="Nos">Nos</option></select></td><td><input type="text" class="form-control parsley-error" style="width:110px;" name="rate['+x+']" id="rate" data-parsley-required/></td><td><input type="text" class="form-control parsley-error" style="width:110px;" name="tax['+x+']" id="tax" data-parsley-required/></td><td><input type="text" class="form-control parsley-error" style="width:110px;" name="taxvalue['+x+']" id="taxvalue" data-parsley-required/></td><td><input type="text" class="form-control parsley-error" style="width:110px;"name="amount['+x+']" id="amount" data-parsley-required/></td><td><button class="btn btn-danger addons_remove" type="button"><i class="fa fa-trash"></i></button></td></tr>'; //New input field html 
