							  ...
							  <?php } ?>
                                ...
                                <div class="company-details">
                                  ...
                                  <?php } ?>
                                    ...
                                    <p>PH: +44 <?php echo $Hotelsecondary_landline.' '; ?> Email: <?php echo $HotelEmail; ?></p>
                                </div>
                            </div>
                        </header>
                                ...
                                <table class="item-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-right" colspan="6">Amount</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                            <?php 
 ...
 <tr>
		...
		if($show_pos_bill_item=='1'){
                ...
                <?php } }?>
                                            ...
                                            <td class="align-right" colspan="6"> <?php echo number_format($Array2['Total'], 2); ?></td>
                                        </tr>
...
<!--<span id="rupees-in-words-text"></span>  need to check this  --> 
    <p style="text-align : right;">GBP(In Words): <span id="rupees-in-text"><?php echo $convert_amount_to_words; ?></span></p>
</div>
                        </div>
