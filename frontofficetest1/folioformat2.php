...
$id_fo_reservations =  selectColumn(FO_BILL,'id_reservations'," WHERE `id_fo_folio_to` = '".$id_fo_folio_to."'");
...
$folioArray=array();
		...
		if(mysqli_num_rows($sqlOrderDetail) >0 ){
		  ...
		  $folioArray[$RoomNoAndRoomName][$mdoc_no]['Days']+=$Days;
		  $folioArray[$RoomNoAndRoomName][$mdoc_no]['sgst_total_items']+=$sgst;
	      $folioArray[$RoomNoAndRoomName][$mdoc_no]['cgst_total_items']+=$cgst;
		  $folioArray[$RoomNoAndRoomName][$mdoc_no]['source']= 'Room Tariff';
          $folioArray[$RoomNoAndRoomName][$mdoc_no]['tariff']=$rowOrderDetail->tariff_price_per_day_per_room-$rowOrderDetail->tax_per_day_per_room;
		  ...
		  $folioArray[$RoomNoAndRoomName][$mdoc_no]['sac_code']= '996311';
		...
		if(mysqli_num_rows($sqlOrderDetail) >0 ){
				...
				while($rowOrderDetail= mysqli_fetch_object($sqlOrderDetail)){
					...
					$folioArray[$RoomNoAndRoomName][$rowOrderDetail->id]['sgst_total_items']=$rowOrderDetail->sgst_total_items;
					$folioArray[$RoomNoAndRoomName][$rowOrderDetail->id]['cgst_total_items']=$rowOrderDetail->cgst_total_items;
					$folioArray[$RoomNoAndRoomName][$rowOrderDetail->id]['sac_code']= '996331';
...
$sqlOrderDetail = mysqli_query($connNew,"Select  * from `fo_reservations_addons_details` where id_fo_folio_to='".addslashes($id_fo_folio_to)."' ");
		if(mysqli_num_rows($sqlOrderDetail) >0 ){
				...
				while($rowOrderDetail= mysqli_fetch_object($sqlOrderDetail)){
					...
					//$RoomName	=	selectColumn(TBL_ROOM_TYPE,'name'," WHERE `id` = '".$rowOrderDetail->id_mst_room_types."'");
					$tax = $rowOrderDetail->tax_value * $rowOrderDetail->qty;
					...
					$folioArray[$RoomNoAndRoomName][$rowOrderDetail->id]['tax']=$tax;
					$folioArray[$RoomNoAndRoomName][$rowOrderDetail->id]['sgst_total_items']=round($tax / 2);
					$folioArray[$RoomNoAndRoomName][$rowOrderDetail->id]['cgst_total_items']=round($tax / 2);
                            ...
                            <td class="pm" style="width:80%;font-family: sans-serif;font-size:11px;">
                              ...
                              <center>
                                <p><b style="font-size:30px;"><?php echo strtoupper($HotelName); ?></b><br>
                                  ...
                                  <?php echo $HotelCity .' - '.$HotelPincode; ?><br>
                                  <?php if($HotelCIN!=''){?>
                      ...
                      <table class="table dataTable table-striped no-footer " width="100%" border="0" cellspacing="0"
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="pm"
                              style="text-align:left;;border-right:.4px solid #000;border-bottom:.4px solid #000;font-family: sans-serif;">
                            ...
                            <td class="pm" colspan="3"
                              style="text-align:left;border-bottom:.4px solid #000;font-family: sans-serif;">
                        ...
                        <thead>
                          <tr>
                            ...
                            <td class="pm"
                              ...
                              <p style="margin:3px;"><b>SGST 2.5%</b></p>
                            </td>
                            <td class="pm"
                              style="font-size:10px;font-family: sans-serif;width: 11%;padding:5px 4px!important;margin:0;border-right: 0.4px solid #000;border-bottom: 0.4px solid #000;">
                              <p style="margin:3px;"><b>CGST 2.5%</b></p>
                            </td>
      ...
      foreach($Array1 as $rowid=>$Array2){?>
                          ...
                          <tr>
                            ...
                            <td class="pm"
                              style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
                              <p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
                                <?php echo date('d-m-Y',strtotime($checkin_date))." - ".date('d-m-Y',strtotime($rowFoBill->checkout_date)); ?>
                              </p>
                            </td>
                            ...
                            <td class="pm"
                             ...
                             <td class="pm"
                              style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
                              <p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
                                <?php echo $Array2['sac_code'];?> </p>
                            </td>

                            <td class="pm"
                              style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
                              <p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
                                <?php echo $Array2['tariff'];?>
                              </p>
                            </td>
                            ...
                            <td class="pm"
                              style="width: 1%;padding:0px!important;margin:0;border-right:.4px solid #000;border-bottom:.4px solid #000;padding:5px 4px!important;">
                              <p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
                                <?php echo $Array2['cgst_total_items'];?>
                              </p>
                            </td>
    ...
    //pos_purch_details
        ...
        ?>
                          <tr>
                            ...
                            <td class="pm"
                              style="border-bottom:.4px solid #000;padding-top:4px!important;border-right:.4px solid #000;width: 20%;padding:0px!important;padding-left:5px!important;margin:0;">
                              <p style="font-size:11px;font-family: sans-serif;padding:0!important;margin:0!important;">
                                -</p>
                            </td>
                            <td class="pm"
                              style="border-bottom:.4px solid #000;padding-top:4px!important;border-right:.4px solid #000;padding:0px!important;padding-left:5px!important;margin:0;">
                              <p style="font-size:11px;font-family: sans-serif;padding:0!important;margin:0!important;">
                                -</p>
                            </td>
                            <td class="pm"
                          ...
                          <tr>
                            ...
                            <td class="pm"
                              style="width: 1%;padding:0px!important;margin:0;text-align:right;padding:5px 4px!important;">
                              <p style="font-size:11px;font-family: sans-serif;margin:0!important;padding-left:10px;">
                          ...
                          <tr>
                            ...
                            <td class="pm" style="font-family: sans-serif;font-size:11px;text-align: left;">
                              <p style="padding-bottom :0;">
                                <?php echo round(round($CurrentTotal,0) - $CurrentTotal,2); ?> </p>
                        ...
                        <tbody>
                          <tr>
                            <td class="pm"
                              ...
                              <p style="font-weight:100;font-size:12px;padding: 45px 17px 6px 4px!important"> Yours
                                Faithfully <br> For <b class="text-uppercase"> <?php echo $HotelName; ?></b></p>
                              <p style="text-transform:uppercase; padding-top: 6.5rem; padding-bottom : 0.2rem;font-size:13px;"><b>Authorised Signatory</b></p>
                            </td>
                            <td class="pm"
                              style="padding: 76px 14px 16px 10px!important;font-family: sans-serif;font-size:13px;text-align: center;">
