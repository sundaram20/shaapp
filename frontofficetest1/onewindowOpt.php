      ...
      $.ajax({
        ...
        success: function (resp) {
          ...
          resp.forEach((value, key, arr) => {
            ...
            tableData += `<td onclick="ReservationSingleForm('${value.id_fo_reservations}','Edit','','')"><a href="#" style="color:black;">${value.res_id}</a></td>
                                    <td onClick="guestDetails('${value.id_mst_guest}','edit')"><a href="#" style="color:black;">${value.guest}</a></td> `;
...
<script>
  function showUser(str) {
    ...
    window.appCalendar = new FullCalendar.Calendar(calendarEl, {
      ...
      events: function (fetchInfo, successCallback, failureCallback) { alert('Second');
        // debugger;
        var startDate = formatDate(fetchInfo.start);
        var endDate = formatDate(fetchInfo.end);
        eventSourceCallback = successCallback;
...
//Reload Cander Start==========================================
  ...
  function reloadCalander() {
    ...
    events: function (fetchInfo, successCallback, failureCallback) { alert('Third');
      // debugger;
      var startDate = formatDate(fetchInfo.start);
      var endDate = formatDate(fetchInfo.end);
      eventSourceCallback = successCallback;
              ...
              bootbox.dialog({
                  ...
                  message: `
                    ...
                    <div class="form-group">
                      ...
                      <select id="room_count_count" class="form-control">
                          <option value="">select</option>
                        ${room_count}
                      </select>
                    </div>`,
