              ...
              <div class="box box-info">
                <div class="box-header">
                  <div class="row">
                    ...
                    <button class="btn btn-success" class="form-control"></button>&nbsp;&nbsp;Allocated Rooms&nbsp;&nbsp;
                    <button class="btn btn-primary" class="form-control"></button>&nbsp;&nbsp;Available Rooms&nbsp;&nbsp;
      ...
      $.ajax({
        ...
        success: function (resp) {
          ...
          resp.forEach((value, key, arr) => {
            ...
            if (value.status == 3) {
              tableData +=
                `<button class="btn btn-warning"  data-toggle="modal" data-target="#ExtedDateModal" onClick="updateExtendDate('${value.checkin}','${value.checkout}','${value.id_fo_reservations}');">Amend Stay</button>&nbsp;&nbsp;`;
...
*/
  ...
  function updateCheckinTime(resvId, id_mst_room_types, today = "", pending_folio_id, check_checkout_date) {
      if (check_checkout_date) {
        bootbox.alert("system date and day close date is mismatch, so you cannot checkin");
        return false
      }
          ...
          success: function (response) {
              ...
              if (expected_arrivals_rooms.length > 0) {
                  ...
                  bootbox.dialog({
                      ...
                      message: `
                      <div class="form-group">
                      <label for="timeInput">Checkin Date: ${today}</label>
                      </div>
                      <div class="form-group">
                      <label for="timeInput">Checkin time:</label>
                      <input type="time" class="form-control" id="timeInput">
                      </div>
                      <div class="form-group">
                      <label for="selectInput">Link Room:</label>
                      </div>${text}`,
                      buttons: {
                          cancel: {
                              label: "Cancel",
                          ...
                          confirm: {
                              ...
                              callback: function () {
                                  ...
                                  if (checkin_time && room_no.length > 0) {
...
$("#newbookerpopupform").submit(function () {
  ...
  function changeFolioStatus(status, id_fo_folio, id_reservation, id_fo_bill, ReservationAvaliable) {
  ...
  function UpdateCheckoutDate(id_mst_hotels, id_fo_bill, id_reservation, doc_type, id_room, checkout_time='') {
    ...
    var requestData = {
        ...
        id_room: id_room,
        precheckout: 1,
        checkout_time: checkout_time // can be empty or a specific time
    };
    ...
    $.ajax({
        ...
        success: function (result) {
          console.log(result);
            try {
                let datas = JSON.parse(result);  // Parse the JSON result from the server
				 if (datas.status == 1) {
  ...
  function updateExtendDate(checkin, checkout, ext_id) {
    $("#ext_id").val(ext_id);
