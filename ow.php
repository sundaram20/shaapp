            ...
            <div class="tab-content">
                ...
                <div class="tab-pane " id="tab_2">
                    ...
                    <div class="row ">
                        <div class="col-xs-12">
                            <!-- form start -->
                            <form  id="addForm"  method="post" enctype="multipart/form-data" data-parsley-validate autocomplete="off">
		...
		$("#reservationForm").submit(function(e){
      	...
      	e.preventDefault();
        	...
        	$.ajax({
        	    ...
        	    data: formData,
        	    success: function(data){
					 $("#result").load("onewindoww.php");
  
                  $.ajaxSetup({ cache: false });
        	       	window.location.href="onewindoww.php";
