...
$DB_PERSISTENT_CONN             = false;
	...
	$GroupShopid=array();
	$sqlAutoReport = "SELECT * FROM app_auto_report_config_details where id_auto_report_config='6' and status='1' ";	
	$resAutoReport = mysqli_query($appConnectReport,$sqlAutoReport);
$emailArray=array();
...
$objPHPExcel = new PHPExcel();
  $pdfNameReport3=$dataShopChk->shop_code.'-SalesRegisterReport-'.date('d-m-Y');
...
$msg 	 = "Please find the attachment for the Sales Register Report<br/><br/> RoomStatusHUB Team.";
$sub	 = $dataShopChk->shop_code.' - Sales Register Report';
$cc='';		
$cc=array();
/*
