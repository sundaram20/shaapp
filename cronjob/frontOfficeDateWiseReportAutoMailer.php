...
include_once($path."/frontoffice/functions/functionDateWiseDailyReport.php");
...
$objPHPExcel = new PHPExcel();
  $pdfNameReport3=$dataShopChk->shop_code.'-BookingReportSummary-'.date('d-m-Y');
...
$hk_status= "0";
echo FoDateWiseReportDaily($period,$id_main_group,$id_sub_group,$id_items,$id_report_type,$report_show,$id_order_by,$showItemReport,$res_bookingStatus_new,$hk_status,$shop,$pdfNameReport3); 
			//echo '111';
...
//die;		
echo $attachPath=$path.'/mailattach/';
//$attach=array();
...
$sub	 = $shopCodeSub.'- Date Wise Reservations Report';
$cc='';		
$cc=array();
/*
