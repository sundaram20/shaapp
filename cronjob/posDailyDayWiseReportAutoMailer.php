...
//Item WiseReport
//$id_report_type="196";
//$pdfNameReport2=$dataShopChk->shop_code.'-ItemWise-'.date('d-m-Y');
//echo consolidatedItemWiseReport($period,$id_main_group,$id_sub_group,$id_items,$id_report_type,$report_show,$id_order_by,$showItemReport,$kot_nc,$appConnectReport,$connNew,$shop,$cronSet,$pdfNameReport2);
...
$attach['settlementSummaryReport']['excel'][$dataShopChk->shop_code]=$pdfNameReport3;
...
//EMAIL START==================================================================================
 ...
 if($mailto !=''){// && file_exists($attach)){
	...
	if($reportType =='consolidatedItemWiseReport'){
		$msg 	 = "Please find the attachment for the POS Day wise Report<br/><br/> RoomStatusHUB Team.";
		$sub	 = 'POS Day wise Report';
		$cc='';		
$cc=array();
	//$cc[]= 'sundaram@roomstatushub.com';
		}else{
...
$mail->Subject = $sub;
$mail->Body = $msg;
$mail->AddAddress('cm@hirohama.co.in');	
$mail->AddAddress('cakrishnarajsingh@gmail.com');	
$mail->AddAddress('kuurakuacs@gmail.com');	
$mail->AddAddress('accounts.gurgaon@kuuraku.in');			
$mail->AddAddress('accounts.manager@kuuraku.in');
$mail->AddAddress("ravi@hirohama.co.in", "support");
//$mail->AddAddress('accounts.gurgaon@hirohama.co.in');			
//$mail->AddAddress('accounts.manager@hirohama.co.in');	
