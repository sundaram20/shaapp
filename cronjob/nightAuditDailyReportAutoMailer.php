...
$DB_PERSISTENT_CONN             = false;
	...
	$GroupShopid=array();
	$sqlAutoReport = "SELECT * FROM app_auto_report_config_details where id_auto_report_config='8' and status='1' ";	
	$resAutoReport = mysqli_query($appConnectReport,$sqlAutoReport);
$emailArray=array();
...
$objPHPExcel = new PHPExcel();
  $pdfNameReport3=$dataShopChk->shop_code.'-salesSummaryReports-'.date('d-m-Y');
