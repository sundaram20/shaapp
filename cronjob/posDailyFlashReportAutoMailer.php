...
include_once($path."/pos/include/functionFlashReport.php");
...
$DB_PERSISTENT_CONN             = false;
	...
	$GroupShopid=array();
	$sqlAutoReport = "SELECT * FROM app_auto_report_config_details where id_auto_report_config='5' and status='1' ";	
	$resAutoReport = mysqli_query($appConnectReport,$sqlAutoReport);
$emailArray=array();
...
$objPHPExcel = new PHPExcel();
  $pdfNameReport3=$dataShopChk->shop_code.'-FlashReportSummary-'.date('d-m-Y');
...
foreach($GroupShopid1['Email'] as $e=>$email1){
 ...
 if($mailto !=''){
	...
	{	 
	echo $reportType;
	//debugData($attachname2);
	
$msg 	 = "Please find the attachment for the Flash Summary Report<br/><br/> RoomStatusHUB Team.";
$sub	 = $reportType .'- Flash Summary Report';
$cc='';		
$cc=array();
/*
