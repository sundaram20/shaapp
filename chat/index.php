...
<script>
   ...
   // var websocket = new WebSocket("wss://localhost:2306/test/php-socket.php"); 
var websocket = new WebSocket("wss://3.111.0.237:30001/chat/php-socket.php");
//var websocket = new WebSocket("wss://app.roomstatushub.in:443/chat/php-socket.php");
//var websocket = new WebSocket("wss://app.roomstatushub.in:30001/chat/php-socket.php");
   window.start_load = function(){alert('ONE');
...
<script>
  websocket.onmessage = function(e){ alert('Test');
