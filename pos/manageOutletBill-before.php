                   ...
                   <!--   <td><?php echo ucfirst($shift_name);?></td>
                    ...
                    <!--  <td>
					  ...
					  <td style="width:130px;" >
                       ...
                       <a href="editOutletBill.php?updateid=<?=encryptor(encrypt, $row->id);?>"  ><img src="../images/view_edit.gif" style="cursor:pointer;" title=" View / Edit "  /></a> 
                      <?php } ?>
                      &nbsp;&nbsp; <a href="printPreviewlaudryspaothers.php?printPreviewid=<?=encryptor(encrypt, $row->id);?>" target="_blank" ><img src="../images/print.png" style="cursor:pointer;" title=" Reprint "  /></a>
					  
                       <?php if($row->payment_status!='cancelled'){?>
                       &nbsp;&nbsp;<!--<a href="billPayment.php?id=<?=encryptor(encrypt, $row->id);?>"><img src="../images/bill3.png" style="cursor:pointer;" title=" Bill Payment "  /></a>--> 
                      <a class="showSingle" target="<?php echo $purch_id;?>" style="cursor:pointer;"><img src="../images/bill3.png" style="cursor:pointer;" title=" Bill Payment " /></a>
                      &nbsp;&nbsp;<a class="showSingle" onClick="ajaxcancel(<?php echo $purch_id;?>);" style="cursor:pointer;"><img src="../images/cancel.png" style="cursor:pointer;width:20px; height:20px;" title=" Bill Cancel "   /></a>
