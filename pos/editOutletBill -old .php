				...
				<div id="ViewKotSelectedTable">
		         ...
		         <div class="form-group col-xs-12 col-md-2 col-sm-2" >
	              			...
	              			<div class="input-group"> 
								 ...
								 <?php $categoryDropDown = '<select class="form-control select2" name="id_attribute_steward" id="id_attribute_steward" data-parsley-required onchange="changeFunc()" style="width:100%">
...
function calculateDiscountSingleItem(lineUniqueCode,type,discount){
	...
	$.ajax({
		...
		data: 'id_attribute_table='+opts+'&DbConnect=1&discount='+discount+'&UniqueCode='+lineUniqueCode+'&outlet='+outlet+'&revServiceCharge='+revServiceCharge, 
...
// alert(idd);
	$.ajax({
		...
		data: 'id='+id+'&rowCount='+rowCount+'&DbConnect=1',
		success: function (result) {
			console.log(result);
			...
			//$( "#item_discount_percentage"+rowCount).val(data.dis);
			$( "#getid"+rowCount).val(data.dis);
			
			$( "#item_TotalAmountItem"+rowCount).val(data.item_TotalAmountItem);
			//$( "#item_tax_percentage"+rowCount).val(data.sumTaxPersentge);
...
function getItemRate1(id,rowCount){
//alert(id);
	$.ajax({
		type: "POST",
		url: 'ajax/ajaxGetAddItemList.php',
		data: 'idd='+id+'&rowCount='+rowCount+'&DbConnect=1',
		success: function (result) {
			/* console.log(result);
			data = JSON.parse(result);
			//alert(result);
...
function OrderItemList(opts){
	...
	$.ajax({
		type: "POST",
		url: 'ajax/ajaxGetLaundrySpaOrderItemList.php',
		data: 'id_attribute_table='+opts+'&DbConnect=1&outleType='+outleType+'&revServiceCharge='+revServiceCharge,
		success: function (result) {
				$( "#ViewOrderItemList" ).html(result);
				$( "#revServiceCharge" ).val(revServiceCharge);
