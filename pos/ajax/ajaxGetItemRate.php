	...
	<?php
	   ...
	   // $ItemRate['discountamount'] = $selectoption->discount_amount;
	    ...
	    $discount = $selectoption->item_discount_percent;	
				...
				$ItemRate['itemRate']	=	round($rowitemDetail->rate ,2);
				...
				$ItemRate['item_amount']	=	round(($rowitemDetail->rate*$itemqty) ,2);
				
				$item_TotalAmountItem	=	$rowitemDetail->rate*$itemqty;
				$Totalitem_amount	=	$rowitemDetail->rate*$itemqty;
				...
				$percentage1=($discount/100)*$item_TotalAmountItem;
				   ...
				   // $ItemRate['item_TotalAmountItem']		=	$Totalitem_amount;
					$SubTotalAmount		 +=($rowitemDetail->rate*$itemqty);
	...
	$ItemRate['RoundOfAmount']	=	$RoundOfAmount;
	   ...
	   // $ItemRate['discountamount'] = $selectoption->discount_amount;
		...
		$ItemRate['item_code']	=	$rowitemDetail1->item_code;		
				...
				$ItemRate['itemRate']	=	round($rowitemDetail1->sale_rate ,2);
				...
				$ItemRate['itemunit']	=	selectColumn(TBL_ATTRIBUTES,'field_value'," WHERE `id` = '".$rowitemDetail1->id_mst_attributes_unit_main."'  ");
					...
					$ItemRate['item_amount']	=	round(($rowitemDetail1->sale_rate*$itemqty),2);
				...
				$Totalitem_amount	=	$rowitemDetail1->sale_rate*$itemqty;
				
				$item_TotalAmountItem	=	$rowitemDetail1->sale_rate*$itemqty;
			...
			//$DiscountAmount		  =	($item_TotalAmountItem*($_SESSION['LINELEVEL']['outdetailitemID'][$rowitemDetail1->id])/100);
				...
				$percentage1=($discount/100)*$item_TotalAmountItem;
				    ...
				    //$ItemRate['item_TotalAmountItem']		=	$Totalitem_amount;
					$SubTotalAmount		 +=($rowitemDetail1->sale_rate*$itemqty);
					$DiscountTotalAmount	 += $percentage1;
				...
				if($Taxapplication==1){
						...
						$ItemRate['id_mst_charges_sgst']	=	$resultCat1->id_mst_charges_sgst;
							$ItemRate['id_mst_charges_cgst']	=	$resultCat1->id_mst_charges_cgst;
							$ItemRate['id_mst_charges_igst']	=	$resultCat1->id_mst_charges_igst;
							$ItemRate['id_mst_charges_cess']	=	$resultCat1->id_mst_charges_cess;
							//die;
