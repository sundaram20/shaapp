...
error_reporting(0);
function tableViewfunction($Report_period,$Report_id_hotel,$id_mst_hotel,$Report_id_group_master,$Report_reportType,$Report_viewMonthwise,$Report_summaryReportType,$CronSet){
global $connNew;
...
if($_REQUEST['id_group_sub_master']>0){
 ...
 if((($_REQUEST['pdf']=='1' || $_REQUEST['excel']=='1')  && $Report_summaryReportType == '7' && $Report_reportType=='1') || ($CronSet=='1' && $Report_reportType=='1')  || ($Report_summaryReportType == '7' && $Report_reportType==1)){//Team Wise  Summary PDF reportType Pickup Report
    ...
    $sql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`fs_users`.myownteam_id as MyOwnteam,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
       ...
       ".$cond." ".$allUser." ".$condTeamGroup.$HotelFilterConn." GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_COMPANY."`.id_default_group Order BY  `".TBL_GROUP_MASTER."`.display_order,`mst_team`.id_group,`fs_users`.myownteam_id";
	...
	while($rowList = mysqli_fetch_object($resultList)){
	  $companyname= selectColumn(TBL_TEAM,'name'," WHERE `id` = '".$rowList->MyOwnteam."'");
	   ...
	   $GroupName= selectColumn(TBL_GROUP_MASTER,'name'," WHERE `id` = '".$rowList->id_group."'");
	    ...
	    if($newConfirmednewTentative>0 || $rowList->newCancelled>0){
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."' AND ( ( `fs_order_detail` .dated BETWEEN '".date('Y-m-d',strtotime($from_book))."' And '".date('Y-m-d',strtotime($to_book))."'))".$allUser." ".$condBOB." ".$condTeamGroup.$HotelFilterConn."
...
if((($_REQUEST['pdf']=='1' || $_REQUEST['excel']=='1')  && $Report_summaryReportType == '1' && $Report_reportType=='1') ||($CronSet==1 && $Report_reportType==1) || ($Report_summaryReportType == '1' && $Report_reportType==1)){//Executivewise  Summary PDF
    ...
    $sql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`fs_users`.myownteam_id as MyOwnteam,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
       ...
       ".$cond." ".$allUser." ".$condTeamGroup.$HotelFilterConn."  GROUP BY `".TBL_USERS."`.myownteam_id,`fs_users`.id,`".TBL_ORDERS."`.id_company Order BY `".TBL_GROUP_MASTER."`.display_order,`mst_team`.id_group,`fs_users`.myownteam_id";
      //echo $sql;
      //die;
     //  LEFT JOIN  `".TBL_TEAM."` ON `".TBL_TEAM."`.ids_team REGEXP CONCAT('(^|,)(', REPLACE('".$id_teams."', ',', '|'), ')(,|$)') AND  FIND_IN_SET(myownteam_id,'".$id_teams."') 
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."' AND ( ( `fs_order_detail` .dated BETWEEN '".date('Y-m-d',strtotime($from_book))."' And '".date('Y-m-d',strtotime($to_book))."')) 
".$allUser." ".$condBOB." ".$condTeamGroup.$HotelFilterConn."  GROUP BY `".TBL_USERS."`.myownteam_id,`fs_users`.id,`".TBL_ORDERS."`.id_company Order BY `".TBL_GROUP_MASTER."`.display_order,`mst_team`.id_group,`fs_users`.myownteam_id";
...
////Hotel Wise Start=====================================================================================================================
 if((($_REQUEST['pdf']=='1' || $_REQUEST['excel']=='1')  && $Report_summaryReportType == '2' && $Report_reportType=='1') || ($CronSet==1 && $Report_reportType==1) || ($Report_summaryReportType == '2' && $Report_reportType==1)){//Hotel Wise  Summary PDF PICKUP Report
    ...
    $sql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`fs_users`.myownteam_id as MyOwnteam,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
       ...
       ".$cond." ".$allUser." ".$condTeamGroup.$HotelFilterConn."  GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_ORDERS."`.id_hotel,`".TBL_USERS."`.name Order BY `".TBL_GROUP_MASTER."`.display_order, `mst_team`.id_group,`fs_users`.myownteam_id";
      //echo $sql;
      //die;
     //  LEFT JOIN  `".TBL_TEAM."` ON `".TBL_TEAM."`.ids_team REGEXP CONCAT('(^|,)(', REPLACE('".$id_teams."', ',', '|'), ')(,|$)') AND  FIND_IN_SET(myownteam_id,'".$id_teams."') 
       $SummaryHedding='Hotel Wise ';
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."' AND ( ( `fs_order_detail` .dated BETWEEN '".date('Y-m-d',strtotime($from_book))."' And '".date('Y-m-d',strtotime($to_book))."')) 
".$allUser." ".$condBOB." ".$condTeamGroup.$HotelFilterConn."  GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_ORDERS."`.id_hotel,`".TBL_USERS."`.name Order BY `".TBL_GROUP_MASTER."`.display_order,`fs_users`.myownteam_id";
 ...
 // Booking Through======================================================================================================================
  if((($_REQUEST['pdf']=='1' || $_REQUEST['excel']=='1')  && $Report_summaryReportType == '5' && $Report_reportType=='1') || ($CronSet==1 && $Report_reportType==1) || ($Report_summaryReportType == '5' && $Report_reportType==1)){//Booking Through  Summary PDF PICKUP Report
    ...
    $sql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`fs_users`.myownteam_id as MyOwnteam,`".TBL_ORDERS."`.booking_hrough,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
       ...
       ".$cond." ".$allUser." ".$condTeamGroup.$HotelFilterConn."  GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_ORDERS."`.booking_hrough,`".TBL_USERS."`.name Order BY `".TBL_GROUP_MASTER."`.display_order, `mst_team`.id_group,`fs_users`.myownteam_id";
      //echo $sql;
      //die;
     //  LEFT JOIN  `".TBL_TEAM."` ON `".TBL_TEAM."`.ids_team REGEXP CONCAT('(^|,)(', REPLACE('".$id_teams."', ',', '|'), ')(,|$)') AND  FIND_IN_SET(myownteam_id,'".$id_teams."') 
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."' AND ( ( `fs_order_detail` .dated BETWEEN '".date('Y-m-d',strtotime($from_book))."' And '".date('Y-m-d',strtotime($to_book))."')) 
".$allUser." ".$condBOB."  ".$condTeamGroup.$HotelFilterConn."
...
//Sorting Order Number Height to Low
      ...
      foreach($subDataList as $list=> $DataList){
           if($DataList['roomnights']>0 || $DataList['CancelledRoomNights']>0){
            ...
            if($TotalTeamRoomNight>0 || $CancelledRoomNight>0){
...
//===============================================================================================================================================================
function CompareViewfunction($Report_period,$Report_id_hotel,$id_mst_hotel,$Report_id_group_master,$Report_reportType,$Report_viewMonthwise,$Report_summaryReportType,$CronSet,$ComparePeriodDate,$CurrentFinancialYearDate){
	global $connNew;
...
$lastYearPickUpsql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`fs_users`.myownteam_id as MyOwnteam,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
            ...
            LEFT JOIN `".TBL_GROUP_MASTER."` ON `".TBL_GROUP_MASTER."`.id = `mst_team`.id_group
            LEFT JOIN `".TBL_HOTELS."` ON `".TBL_HOTELS."`.id = `".TBL_ORDERS."`.id_hotel
            ".$cond.$allUser.$condTeamGroup.$HotelFilterConn.$GroupOrder ." ";// Order BY  `".TBL_GROUP_MASTER."`.display_order,`mst_team`.id_group,`fs_users`.myownteam_id";
}            
...
INNER join `fs_order_detail` on fs_orders.id_order=fs_order_detail.id_order 
 ...
 ".$cond.$allUser.$condTeamGroup.$HotelFilterConn.$GroupOrder;
...
//LASTYEAR SQL END >>  ================================================================================================================
 ...
 if((($_REQUEST['pdf']==1 || $_REQUEST['excel']==1 ) && $Report_reportType==1 && $Report_summaryReportType == '1') || ($Report_summaryReportType == '1' && $Report_reportType==1)){//Team Wise  Summary PDF reportType Pickup Report
    ...
    $sql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`fs_users`.myownteam_id as MyOwnteam,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
			...
			SUM(CASE WHEN `".TBL_ORDERS."`.booking_status = '4' AND DATE(`".TBL_ORDERS."`.last_modified) BETWEEN '".$FromLastYearDate."' AND '".$ToLastYearDate."' THEN ROUND(`".TBL_ORDERS."`.total_products*`".TBL_ORDERS."`.no_of_days,0)  ELSE 0 END) AS newCancelledToLastYear,
    		SUM(CASE WHEN `".TBL_ORDERS."`.booking_status = '3' AND DATE(`".TBL_ORDERS."`.invoice_date) BETWEEN '".$FromLastYearDate."' AND '".$ToLastYearDate."' THEN ROUND(`".TBL_ORDERS."`.total_products*`".TBL_ORDERS."`.no_of_days,0) ELSE 0 END) AS newWaitlistedToLastYear,
    		SUM(CASE WHEN `".TBL_ORDERS."`.booking_status = '1'  AND DATE(`".TBL_ORDERS."`.booking_confirm_date) BETWEEN '".$FromLastYearDate."' AND '".$ToLastYearDate."' THEN ROUND(`".TBL_ORDERS."`.total_products*`".TBL_ORDERS."`.no_of_days,0) ELSE 0 END ) AS newConfirmedToLastYear,
    		SUM(CASE WHEN `".TBL_ORDERS."`.booking_status = '2'  AND DATE(`".TBL_ORDERS."`.booking_confirm_date) BETWEEN '".$FromLastYearDate."' AND '".$ToLastYearDate."' THEN ROUND(`".TBL_ORDERS."`.total_products*`".TBL_ORDERS."`.no_of_days,0) ELSE 0 END ) AS newTentativeToLastYear,   
    		
    		SUM(CASE WHEN `fs_orders`.booking_status = '1' AND DATE(`".TBL_ORDERS."`.booking_confirm_date) BETWEEN '".$FromLastYearDate."' AND '".$ToLastYearDate."' THEN ROUND(`fs_orders`.subtotal,0) ELSE 0 END ) AS confimed_revenueToLastYear, 
            SUM(CASE WHEN `fs_orders`.booking_status = '2'AND DATE(`".TBL_ORDERS."`.booking_confirm_date) BETWEEN '".$FromLastYearDate."' AND '".$ToLastYearDate."' THEN ROUND(`fs_orders`.subtotal,0) ELSE 0 END ) AS tentative_revenueToLastYear ,
	...
	while($rowList = mysqli_fetch_object($resultList)){
	   ...
	   // print_r($rowList);
	    ...
	    $BusinessSourceName=  selectColumn(TBL_GROUP,'name'," WHERE `id_group` = '".$rowList->id_default_group."'");;
    	  ...
    	  // }
		  //Last Year
				$newConfirmednewTentativeToLastYear=($rowList->newConfirmedToLastYear+$rowList->newTentativeToLastYear);
				$newConfirmednewTentativeLastToLastYear=($rowList->newConfirmedLastToLastYear+$rowList->newTentativeLastToLastYear);
				
				$newConfirmednewTentative_revenueToLastYear=($rowList->confimed_revenueToLastYear+$rowList->tentative_revenueToLastYear);
				$newConfirmednewTentative_revenueLastToLastYear=($rowList->confimed_revenueLastToLastYear+$rowList->tentative_revenueLastToLastYear);
				$reportArray['Team Wise'][$GroupName][strtolower($companyname==''?$emptytext7:$companyname)][$BusinessSourceName]['lastYearroomnights']=$newConfirmednewTentativeToLastYear==''?'0':$newConfirmednewTentativeToLastYear;
				$reportArray['Team Wise'][$GroupName][strtolower($companyname==''?$emptytext7:$companyname)][$BusinessSourceName]['lastYearconfimed_revenue']=$newConfirmednewTentative_revenueToLastYear==''?'0':$newConfirmednewTentative_revenueToLastYear;
				
				
				$reportArray['Team Wise'][$GroupName][strtolower($companyname==''?$emptytext7:$companyname)][$BusinessSourceName]['lastYearroomnightsLastToLastYear']=$newConfirmednewTentativeLastToLastYear==''?'0':$newConfirmednewTentativeLastToLastYear;
				$reportArray['Team Wise'][$GroupName][strtolower($companyname==''?$emptytext7:$companyname)][$BusinessSourceName]['lastYearconfimed_revenueLastToLastYear']=$newConfirmednewTentative_revenueLastToLastYear==''?'0':$newConfirmednewTentative_revenueLastToLastYear;
		  //Last Year	
...
,sum(case when (`fs_orders`.`booking_status` = '1' ) AND ( ( `fs_order_detail` .dated BETWEEN '".$FromLastYearDate."' And '".$ToLastYearDate."')) then `fs_order_detail`.tarrif_price else 0 end) as `confimed_revenueToLastYear`

,sum(case when (`fs_orders`.`booking_status` = '1' ) AND ( ( `fs_order_detail` .dated BETWEEN '".$FromLastYearDate."' And '".$ToLastYearDate."')) then `fs_order_detail`.room_quantity else 0 end) as `newConfirmedToLastYear`
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'   ".$allUser." ".$condBOB.$condTeamGroup.$HotelFilterConn."   GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_COMPANY."`.id_default_group Order BY `mst_team`.id_group,`fs_users`.myownteam_id";
       
       
  //AND ( ( `fs_order_detail` .dated BETWEEN '".date('Y-m-d',strtotime($from_book))."'  And '".date('Y-m-d',strtotime($to_book))."'))     
	...
	while($rowList = mysqli_fetch_object($resultList)){
	    ...
	    //}
		 ...
		 //Last Year BOB
		$newConfirmednewTentativeToLastYear=($rowList->newConfirmedToLastYear);
		$newConfirmednewTentativeLastToLastYear=($rowList->newConfirmedLastToLastYear);
		
		$newConfirmednewTentative_revenueToLastYear=($rowList->confimed_revenueToLastYear);
...
//echo '<pre>';debugData($reportArray);
...
if((($_REQUEST['pdf']==1 || $_REQUEST['excel']==1 ) && $Report_reportType==1 && $Report_summaryReportType == '2') || ($Report_summaryReportType == '2' && $Report_reportType==1)){//Executivewise  Summary PDF PICK ASE
    ...
    $sql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`fs_users`.myownteam_id as MyOwnteam,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
       ...
       ".$cond.$allUser.$condTeamGroup.$HotelFilterConn."  GROUP BY `".TBL_USERS."`.myownteam_id,`fs_users`.id,`".TBL_COMPANY."`.id_company 
	...
	// $companyname= selectColumn(TBL_HOTELS,'name','WHERE id='.$rowList->id_hotel.' ');
	  ...
	  $companypincode = $companypincode!=''?'-'.$companypincode:'';
		...
		$newConfirmednewTentative_revenueToLastYear=($rowList->confimed_revenueToLastYear+$rowList->tentative_revenueToLastYear);
		$newConfirmednewTentative_revenueLastToLastYear=($rowList->confimed_revenueLastToLastYear+$rowList->tentative_revenueLastToLastYear);
		$reportArray['Executivewise'][$GroupName][$rowList->name_executive][$companyname]['lastYearroomnights']=$newConfirmednewTentativeToLastYear==''?'0':$newConfirmednewTentativeToLastYear;
		$reportArray['Executivewise'][$GroupName][$rowList->name_executive][$companyname]['lastYearconfimed_revenue']=$newConfirmednewTentative_revenueToLastYear==''?'0':$newConfirmednewTentative_revenueToLastYear;
		
		
		$reportArray['Executivewise'][$GroupName][$rowList->name_executive][$companyname]['lastYearroomnightsLastToLastYear']=$newConfirmednewTentativeLastToLastYear==''?'0':$newConfirmednewTentativeLastToLastYear;
		$reportArray['Executivewise'][$GroupName][$rowList->name_executive][$companyname]['lastYearconfimed_revenueLastToLastYear']=$newConfirmednewTentative_revenueLastToLastYear==''?'0':$newConfirmednewTentative_revenueLastToLastYear;
		//Last Year	Pickup
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."' ".$allUser." ".$condBOB.$condTeamGroup.$HotelFilterConn."  
	...
	while($rowList = mysqli_fetch_object($resultList)){
	 ...
	 $companyname= selectColumn(TBL_HOTELS,'name','WHERE id='.$rowList->id_hotel.' ');
	   ...
	   // if($newConfirmednewTentative>0){
		...
		$newConfirmednewTentative_revenueToLastYear=($rowList->confimed_revenueToLastYear+$rowList->tentative_revenueToLastYear);
		$newConfirmednewTentative_revenueLastToLastYear=($rowList->confimed_revenueLastToLastYear+$rowList->tentative_revenueLastToLastYear);
		$reportArray['Hotelwise'][$GroupName][strtolower($companyname==''?$emptytext7:$companyname)][$rowList->name_executive]['lastYearroomnights']=$newConfirmednewTentativeToLastYear==''?'0':$newConfirmednewTentativeToLastYear;
		$reportArray['Hotelwise'][$GroupName][strtolower($companyname==''?$emptytext7:$companyname)][$rowList->name_executive]['lastYearconfimed_revenue']=$newConfirmednewTentative_revenueToLastYear==''?'0':$newConfirmednewTentative_revenueToLastYear;
		
		
		$reportArray['Hotelwise'][$GroupName][strtolower($companyname==''?$emptytext7:$companyname)][$rowList->name_executive]['lastYearroomnightsLastToLastYear']=$newConfirmednewTentativeLastToLastYear==''?'0':$newConfirmednewTentativeLastToLastYear;
		$reportArray['Hotelwise'][$GroupName][strtolower($companyname==''?$emptytext7:$companyname)][$rowList->name_executive]['lastYearconfimed_revenueLastToLastYear']=$newConfirmednewTentative_revenueLastToLastYear==''?'0':$newConfirmednewTentative_revenueLastToLastYear;
		//Last Year	
	}  
  }    
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  ".$allUser." ".$condBOB.$condTeamGroup.$HotelFilterConn."  GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_ORDERS."`.id_hotel,`".TBL_USERS."`.name Order BY `fs_users`.myownteam_id";
...
array_multisort($roomnights, SORT_DESC, $confimed_revenue, SORT_ASC, $subDataList);
//Sorting Order Number Height to Low
//debugData($subDataList);

      foreach($subDataList as $list=> $DataList){
           if($DataList['roomnights']>0 || $DataList['lastYearroomnights']>0 || $DataList['lastYearroomnightsLastToLastYear']>0){
                    if($DataList['confimed_revenue']>0 ){
                    $mtrArr =($DataList['confimed_revenue']/$DataList['roomnights']);
                    }else{
                    $mtrArr =0;
                    ...
                    $lastYearComparViewmtrArrLastToLastYear =0;
					  ...
					  $contentTeamBody .='<td style="text-align:center;background-color:#e9f7cd;'.$ColorGolyListDataLastToLastYear.'">'.round($GolyListDataLastToLastYear,2).'</td>'; 
                         $contentTeamBody .='<td style="text-align:center;background-color:#e9f7cd;'.$ColorGolyListData.'">'.round($GolyListData,2).'</td>';
           ...
           $ColorSumTeamTotalOccpanGoly  =$SumTeamTotalOccpanGoly>=0?"":"color:red;";
		    ...
		    $ColorSumTeamTotalOccpanGolyLastToLastYear  =$SumTeamTotalOccpanGolyLastToLastYear>=0?"":"color:red;";
			
            //$contentTeam .='<tr style="font-weight:bold;background-color:#3C8DBC;color:white;"><td style="text-align:center;background-color:#5CB4E8;">'.ucwords($TeamName).' Total</td><td style="border-left:1px solid #fff;background-color:#5CB4E8;text-align:center;">'.$TotalTeamRoomNight.'</td><td style="border-left:1px solid #fff;background-color:#5CB4E8;text-align:center;">'.$TotalTeamConfimedRevenue.'</td><td style="border-left:1px solid #fff;background-color:#5CB4E8;text-align:center;">'.$SumTeamTotalArray.'</td></tr>';
            if($TotalTeamRoomNight>0 || $TotalRoomNightlastYear>0 || $TotalRoomNightLastToLastYear>0){
                $contentTeam .='<tr>
				...
				<th  style="vertical-align:central;text-align:center;color:#000;background-color:#e2f7b8; font-size:12px !important"><b> '.$SumTeamTotalLYArray.'</b></th>
				 ...
				 <th  style="vertical-align:central;text-align:center;color:#000;background-color:#e2f7b8; font-size:12px !important;'.$ColorSumTeamTotalOccpanGolyLastToLastYear.'"><b>'.$SumTeamTotalOccpanGolyLastToLastYear.'</b></th>
     ...
     foreach($GroupArray as $name => $GroupNameArray){    
                 ...
                 foreach($GroupArray as $name => $GroupNameArray){
                     ...
                     $vaColor=($GroupNameArray['RoomNights']-$GroupNameArray['lastYearroomnights'])>=0?"":"color:red;";
					   ...
					   if($GroupNameArray['lastYearroomnights']>0 || $GroupNameArray['RoomNights']>0 || $GroupNameArray['lastYearroomnightsLastToLastYear']){
                    $contentGroup .='<tr >';
