...
<td> <?php 
   ...
   $itemSql0 = "SELECT * FROM `".TBL_INV_ITEMS."` where id_shop='".addslashes($_SESSION['shop'])."' AND status='0' AND id_mst_attributes_item_type='".$id_item_type."' "; 
...
$resitem0 = mysqli_query($connNew,$itemSql0);
 ...
 while ($rowItem0 = mysqli_fetch_object($resitem0)){
    ...
    <td><img src="../images/delete.gif"  onclick="deleteitemRow(<?php echo $counter1?>,<?php echo $id_item_type_s?>);" class="ibtnDel1" id="deletes<?php echo $counter1?>" name="deletes<?php echo $counter1?>" style="cursor:pointer;" title="Delete"/></td>
