...
if($_POST['listsubgroup']==2){
 ...
 <input type="text" name="keywordsearch" id="keywordsearch" onKeyUp="keysearch(this.value)" placeholder="Search Menu" value="'.$_POST['keywordsearch'].'"></th>
				...
				$itemNameSelectSQL = "SELECT * FROM `".TBL_INV_ITEMS_DETAILS."` WHERE id_item='".$_POST['selectSubgroup']."' ";
				...
				if($itemNameNumRows>0){
					...
					$itemid = $row->id;
								...
								if (in_array($itemid, $_SESSION['POSKOT']['itemID'])){
	...
	$ItemList2	 ='<div class="box1 box-primary1">
		...
		<form name="listingForm" action="" method="post">
            <div class="box-body table-responsive" style="padding-top: 1px;padding-left: 1px;padding-right: 5px;">
				...
				$itemNameSelectSQLnew = "SELECT * FROM `".TBL_INV_ITEMS_DETAILS."` WHERE id_item='".$_POST['selectSubgroup']."' ";
				...
				$resCat = selectSql(TBL_INV_ITEMS," where id_shop= '".addslashes($_SESSION['shop'])."' AND  id='".$_POST['selectSubgroup']."' ");
					...
					$itemNameSelectSQL1 = "SELECT * FROM `".TBL_INV_ITEMS_DETAILS."` WHERE id='".$_POST['subid']."' ";
				...
				$reverseItemID = array_reverse($_SESSION['POSKOT'][$UniqueCodeGen]['itemID']);
					...
					foreach($reverseItemID as $uniqueCode =>$dataCode){
						...
						$itemNameSelectSQLcode = "SELECT * FROM `".TBL_INV_ITEMS_DETAILS."` WHERE id_item='".$_POST['selectSubgroup']."' ";
...
foreach($reverseItemID as $uniqueCode =>$dataCode){
	...
	$Total	+=	($_SESSION['POSKOT'][$UniqueCodeGen]['price'][$uniqueCode]*$_SESSION['POSKOT'][$UniqueCodeGen]['quantity'][$uniqueCode]);

	$SubTotal	=	($_SESSION['POSKOT'][$UniqueCodeGen]['price'][$uniqueCode]*$_SESSION['POSKOT'][$UniqueCodeGen]['quantity'][$uniqueCode]);
...
<a class="btn btn-danger btn-sm" href="javascript:void(0);"  id="'.$uniqueCode.'" onclick="calculateQuantityPrice($(this).attr(\'id\'),\'0\','.$_SESSION['POSKOT'][$UniqueCodeGen]['quantity'][$uniqueCode].');" style="float: left;">

 <i class="fa fa-minus fa-lg"></i> </a>
				  

<input type="text" class="form-control"  name="quantity|'.$uniqueCode.'" id="quantity|'.$uniqueCode.'" value="'.$_SESSION['POSKOT'][$UniqueCodeGen]['quantity'][$uniqueCode].'"   style="width: 40px;float: left;padding: 1px 12px;height: 24px;" onKeyUp="calculateQuantityPrice(\''.$uniqueCode.'\',\'2\',this.value);">

<a class="btn btn-success btn-sm" href="javascript:void(0);"  id="'.$uniqueCode.'" onclick="calculateQuantityPrice($(this).attr(\'id\'),\'1\','.$_SESSION['POSKOT'][$UniqueCodeGen]['quantity'][$uniqueCode].');" >
...
$ItemList2 .='</tbody>
    ...
    $ItemList2 .='<div class="col-md-6"></div>';
		  ...
		  $ItemList2 .='<div class="col-md-6"><a class="btn btn-block btn-primary btn-lg" href="javascript:void(0);"  id="'.$uniqueCode.'" onclick="ajaxUpdateKot($(this).attr(\'id\'),\''.$UniqueCodeGen.'\');">
...
if($_REQUEST['listsubgroup']==8){ 
				...
				unset($_SESSION['POSKOT']['id_sale_local']);
...
<td>'.$_SESSION['POSKOT'][$UniqueCodeGen]['name'][$uniqueCode].'</td>';
$ItemList2 .='<td>
<a class="btn btn-danger btn-sm" href="javascript:void(0);"  id="'.$uniqueCode.'" onclick="calculateQuantityPriceEdit($(this).attr(\'id\'),\'0\','.$_SESSION['POSKOT'][$UniqueCodeGen]['quantity'][$uniqueCode].','.$_REQUEST['id_pos_purch'].',\''.$_REQUEST['UniqueCodeGen'].'\');");" style="float: left;">
  <i class="fa fa-minus fa-lg"></i> </a>
<input type="text" class="form-control"  name="quantity|'.$uniqueCode.'" id="quantity|'.$uniqueCode.'" value="'.$_SESSION['POSKOT'][$UniqueCodeGen]['quantity'][$uniqueCode].'"   style="width: 40px;float: left;padding: 1px 12px;height: 24px;" onKeyUp="calculateQuantityPriceEdit(\''.$uniqueCode.'\',\'2\',this.value,'.$_REQUEST['id_pos_purch'].',\''.$_REQUEST['UniqueCodeGen'].'\');");">

<a class="btn btn-success btn-sm" href="javascript:void(0);"  id="'.$uniqueCode.'" onclick="calculateQuantityPriceEdit($(this).attr(\'id\'),\'1\','.$_SESSION['POSKOT'][$UniqueCodeGen]['quantity'][$uniqueCode].','.$_REQUEST['id_pos_purch'].',\''.$_REQUEST['UniqueCodeGen'].'\');");" >
				  <i class="fa fa-plus fa-lg"></i> </a>
				  </td>';
...
<input type="text" class="form-control" disabled="disabled"  name="quantity|'.$uniqueCode.'" id="quantity|'.$uniqueCode.'" value="'.$_SESSION['POSKOT'][$UniqueCodeGen]['quantity'][$uniqueCode].'"   style="width: 40px;float: left;padding: 1px 12px;height: 24px;" onKeyUp="calculateQuantityPriceEdit(\''.$uniqueCode.'\',\'2\',this.value,'.$_REQUEST['id_pos_purch'].',\''.$_REQUEST['UniqueCodeGen'].'\');");">
...
$ItemList2 .='</tbody>
    ...
    $ItemList2 .='<div class="col-md-2">
		  ...
		  $ItemList2 .='<div class="col-md-2"><a class="btn btn-block btn-primary " href="javascript:void(0);"  id="'.$uniqueCode.'" onclick="ajaxUpdateKot($(this).attr(\'id\'),\''.$_REQUEST['UniqueCodeGen'].'\');"); ">
...
$ItemList2 .='<div class="col-md-2"><a class="btn btn-block btn-primary " href="javascript:void(0);"  id="'.$uniqueCode.'" onclick="ajaxUpdateKot($(this).attr(\'id\'),\''.$UniqueCodeGen.'\');");">
...
if($_REQUEST['listsubgroup']==11){
	...
	if($remove == 'removeOne' && $ArrayCountItem>1){
				...
				unset($_SESSION['POSKOT']['id_outlet'][$OrderUniqueID]);
				unset($_SESSION['POSKOT']['id_sale_local'][$OrderUniqueID]);
...
<input type="hidden" value="'.$_REQUEST['id_pos_purch'].'" name="id_pos_purch" id="id_pos_purch">
			...
			$_SESSION['POSKOT']['id_outlet'][$AddsuniqueCode]	= $row->ids_mst_outlet;
			
			$_SESSION['POSKOT']['id_sale_local'][$AddsuniqueCode]	= $row->id_mst_charges_sales_local;
...
$ItemList2 .='</tbody>
  ...
  $ItemList2 .='<div class="col-md-3">
    ...
    $ItemList2 .='<div class="col-md-2"></div>';
