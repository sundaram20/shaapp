...
.daterangepicker .ranges li:hover {
 ...
 .showBox{
         ...
         #ShowResultContent{
          ...
          #head1,#showheadinglable,#hideheadinglable{
                position: sticky;
    top: -11px;
          }
          #head2,#showheadinglable,#hideheadinglable{
                position: sticky;
    top: -11px;
          }
...
<a type="button" class="btn c-btn"  href="javascript:void(0)"  onClick="printData();"><i class="fa fa-fw fa-print"></i> Print</a>
</div>
...
<div class="col-md-2 col-sm-12">
  <div class="form-group">
    <label>Format</label>
      ...
      <!--<div class="input-group-addon"> <i class="fa fa-dot-circle-o"></i> </div>-->
      <select class="form-control select2" name="id_report_format" data-parsley-required id="id_report_format" style="width:100%">
        <option  value="">---Select Format---</option>
        <option  value="1" selected>Table Format</option>
        <option  value="2">POS Format</option>
        
      </select>
   <span style="margin-left:45px;color:red;font-size:11px;" id="id_report_format_error"></span>
  </div>
</div>
<div class="col-md-2 col-sm-12">
  <div class="form-group">
    <label>KOT NC</label>
      ...
      <!--<div class="input-group-addon"> <i class="fa fa-dot-circle-o"></i> </div>-->
      <select class="form-control select2" name="kot_nc" data-parsley-required id="kot_nc" style="width:100%">
        <option  value="0">Without KOT NC</option>
        <option  value="1">With KOT NC</option>
        <option  value="2">Only KOT NC</option>
     
      </select>
   <span style="margin-left:45px;color:red;font-size:11px;" id="kot_nc_error"></span>
  </div>
</div>

<div class="col-md-2 col-sm-12">
  <div class="form-group">
    <label>Food Processed item</label>
   
      <!--<div class="input-group-addon"> <i class="fa fa-dot-circle-o"></i> </div>-->
      <select class="form-control select2" name="production_item" data-parsley-required id="production_item" style="width:100%">
        <option  value="">--Food Processed item--</option>
  ...
  <div class="form-group">
    <label>Select Outlet <span class="text-danger">*</span></label>
      ...
      <div id="ListSubGroup">
        ...
        <?php
                                $resCat = selectSql('mst_outlets',"where id_shop='".$_SESSION['shop']."'  and outlettype = '1'",'');
...
//Form Data Clear
	...
	var production_item = $("#production_item").val();
	var kot_nc = $("#kot_nc").val();
    var id_report_format = $("#id_report_format").val();
        let url2 = 'ajax/ajaxPosSalesReport.php?period='+period+'&id_report_type='+id_report_type+'&id_report_format='+id_report_format+'&id_main_group='+id_main_group+'&id_sub_group='+id_sub_group+'&id_item='+id_item+'&ReportShowType='+ReportShowType+'&id_order_by='+id_order_by+'&showItemReport='+showItemReport+'&kot_nc='+kot_nc+'&production_item='+production_item;
         window.open(url2);
	...
	// alert(id_report_type);
	 ...
	 var production_item = $("#production_item").val();
		 ...
		 $.ajax({
				...
				type:'POST',
				data:'period='+period+'&id_report_type='+id_report_type+'&id_report_format='+id_report_format+'&id_main_group='+id_main_group+'&id_data_main_group='+id_data_main_group+'&id_item='+id_item+'&ReportShowType='+ReportShowType+'&id_order_by='+id_order_by+'&id_sub_group='+id_sub_group+'&showItemReport='+showItemReport+'&kot_nc='+kot_nc+'&id_outlet='+id_outlet+'&production_item='+production_item,
