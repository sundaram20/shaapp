...
if($session=='25'){
	...
	$print = "Spa and Health Club Print";
}else if($session=='29'){
	$print = "Others Print";
}
...
<button class="btn btn-primary btn-block" style="margin-right:15px" onClick="printdiv('div_print');"><i class="fa fa-print fa-1x"> Print</i></button >
</div>
