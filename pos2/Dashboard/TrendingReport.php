  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Trending Report</li>
      </ol>
    </section>
...
?>
            ...
            <div class="form-group col-md-2" style="width:230px; display:none;">
              <div>
                <label> &nbsp;
  ...
  <div class="form-group">
    <label> Period</label>
      ...
      <input type="text" class="form-control pull-right dateRangeReport" placeholder="Select From -  To" name="per_report_date" id="per_report_date" data-parsley-required value="<?php echo date('d-m-Y'); ?>" data-parsley-errors-container="#report_dateError"  autocomplete="off">
  
  </div><br><br><div class="box-footer pt-0 pl-0">
          <input type="hidden" name="showItemReport" id="showItemReport" value="0">
            <button type="button" style="margin-right: 5px;" class="btn o-btn" id="rdb21"  title="Chart View"   name="CharSummarytoggler" value="SalesSummary" > Apply </button>
            
        </div>
  <!-- /.form-group --> 
</div> <div class="col-md-3" style="width:260px;display:none;">
              <div class="form-group">
...
"><option class='item' value="0">--All Group--</option>
  ...
  $SqlAttrbute = selectSql(TBL_ATTRIBUTES,"where id_shop='".$_SESSION['shop']."'  and status = '1' and `table_name` = 'item_group_sub' AND id= '".addslashes($row->id_mst_attributes_group_sub)."'");					
		...
		// echo $subGroup;
            ...
            <div  class="col-md-1"  style="width:245px;display:none;"> <div class="form-group">
          ...
          <div id="WholeDivshowContent" class="toHideWholeDiv" >
            <div id="performanceChart" class="toHideperformanceChar">
              <div id="blk-FinancialYear" class="toHide"  >
                ...
                <h5 class="text-center" style="background-color: #1c4c7c;margin: 5px;padding: 10px;color: #fff;"><strong>Trending Report </strong></h5>
                <div class="row">
                  ...
                  <div class="col-md-6" >
                    ...
                    <div class="tab-content">
                      <div role="tabpanel" class="tab-pane active" id="RevenueYTD">
                        <p class="text-center"> <strong class="col-lg-offset-2">Pax (Hourly)</strong> 
                          <!--<div class="row">
                  ...
                  <div class="col-md-6" >
                    ...
                    <div class="tab-content">
                      <div role="tabpanel" class="tab-pane active" id="RevenueYTD">
                        <p class="text-center"> <strong class="col-lg-offset-2">Amount (Hourly)</strong> 
                          <!--<div class="row">
                              <div class="col-md-3  col-sm-3 col-xs-3 text-center"> &nbsp; </div>
                              <div class="col-md-3  col-sm-3 col-xs-3 text-center" style="background-color: #87CEFA;"> Last Year </div>
                              <div class="col-md-3 col-sm-3 col-xs-3 text-center" style="background-color: #3b8bba ;"> This Year </div>
                        ...
                        <div class="chart ">
                          <canvas id="Room-Sub-Total-Items-chart" <?php echo $HeightWidthMonth; ?>></canvas>
                        </div>
                      </div>
...
var MonthWiseRoomSubTotalItems=[];
...
var NationalityNameArr=[];				  
    function fetchPerformanceGraphData(viewMonthwise){
		...
		let CurrentFinancialYear = $("#financialyearselected").val();
        if(reportType==1){
            reportTypeFile  ='DashboardTrendingGraphPickupData.ajax.php';
        }else{
		...
		//if(id_hotel){	
			$.ajax({
				...
				success:function(data){
					...
					MonthWiseRoomSubTotalItems=data.MonthWiseRoomSubTotalItems;
    ...
    function performanceChart(graphCount,viewMonthwise,enablenationality){
		...
		if(graphCount>0){
		    ...
		    RoomSubTotalItemsBarChartDest.destroy();
		...
		let RoomSubTotalItemsBarChart = document.getElementById('Room-Sub-Total-Items-chart').getContext('2d');
		let monthRevenueBarPerChart = document.getElementById('line-chart-revenue').getContext('2d'); 
		// HalfYearRevenueBarChart = document.getElementById('HalfYear-Revenue-chart').getContext('2d');
...
//CompleteChartHorizontalBarRevenue = new Chart(ytdMtdChartHorizontalBarRevenue, {});	
  ...
  data: {
    ...
    datasets: [ { 
        ...
        label: 'PAX ('+CYLable+'): '+MonthWiseRevenueCurrentYearData.reduce(sumofArray)+'',
 ...
 RoomSubTotalItemsBarChartDest = new Chart(RoomSubTotalItemsBarChart, {
  type: 'bar',
  data: {
    labels: monthNameData,
    datasets: [ { 
        data: MonthWiseRoomSubTotalItems,
        label: 'Amount ('+CYLable+'): '+MonthWiseRoomSubTotalItems.reduce(sumofArray)+'',
        backgroundColor: 'rgba(60,141,188,0.8)',
        borderColor: 'rgba(54, 162, 235,1)'
